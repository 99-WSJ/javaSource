...
abstract public class ObjectImpl implements org.omg.CORBA.Object
{
     ...
     */
    public org.omg.CORBA.portable.ServantObject _servant_preinvoke(String operation,
                                                                   Class expectedType) {
     ...
     * @throws org.omg.CORBA.portable.ApplicationException if the invocation
     *         meets application-defined exception
     * @throws org.omg.CORBA.portable.RemarshalException if the invocation leads
     *         to a remarshalling error
     * @see #_request
     */
    public org.omg.CORBA.portable.InputStream _invoke(OutputStream output)
