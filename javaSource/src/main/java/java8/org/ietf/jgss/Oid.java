...
public class Oid {
     ...
     * @exception org.ietf.jgss.GSSException may be thrown when the string is incorrectly
     *     formatted
     */
    public Oid(String strOid) throws org.ietf.jgss.GSSException {

        try {
            oid = new ObjectIdentifier(strOid);
            derEncoding = null;
        } catch (Exception e) {
            throw new org.ietf.jgss.GSSException(org.ietf.jgss.GSSException.FAILURE,
     ...
     * @exception org.ietf.jgss.GSSException may be thrown when the DER encoding does not
     *  follow the prescribed format.
     */
    public Oid(InputStream derOid) throws org.ietf.jgss.GSSException {
        try {
     ...
     *     follow the prescribed format.
     */
    public Oid(byte [] data) throws org.ietf.jgss.GSSException {
        try {
     ...
     * @exception org.ietf.jgss.GSSException may be thrown when the oid can't be encoded
     */
    public byte[] getDER() throws org.ietf.jgss.GSSException {
        ...
        if (derEncoding == null) {
            ...
            try {
                ...
                throw new org.ietf.jgss.GSSException(GSSException.FAILURE, e.getMessage());
            }
