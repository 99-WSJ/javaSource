 ...
 * org.ietf.jgss.GSSName GSSName}, {@link org.ietf.jgss.GSSCredential GSSCredential}, and {@link
 * org.ietf.jgss.GSSContext GSSContext}. It also has methods to query for the list
 ...
 * usage:  {@link #addProviderAtFront(Provider, org.ietf.jgss.Oid) addProviderAtFront} and
 * {@link #addProviderAtEnd(Provider, org.ietf.jgss.Oid) addProviderAtEnd}. These methods
...
public abstract class GSSManager {
     ...
     * {@link org.ietf.jgss.GSSName#NT_HOSTBASED_SERVICE GSSName.NT_HOSTBASED_SERVICE},
     * {@link org.ietf.jgss.GSSName#NT_EXPORT_NAME GSSName.NT_EXPORT_NAME}, and the
     ...
     *
     * @see #getMechsForName(org.ietf.jgss.Oid)
     *
     * @throws org.ietf.jgss.GSSException containing the following
     * major error codes:
     *    {@link org.ietf.jgss.GSSException#BAD_MECH GSSException.BAD_MECH}
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract  org.ietf.jgss.Oid[] getNamesForMech(org.ietf.jgss.Oid mech)
     ...
     * {@link org.ietf.jgss.GSSName#NT_HOSTBASED_SERVICE GSSName.NT_HOSTBASED_SERVICE},
     * {@link org.ietf.jgss.GSSName#NT_EXPORT_NAME GSSName.NT_EXPORT_NAME}, or
     ...
     *
     * @see #getNamesForMech(org.ietf.jgss.Oid)
     */
    public abstract  org.ietf.jgss.Oid[] getMechsForName(org.ietf.jgss.Oid nameType);
     ...
     *
     * @see org.ietf.jgss.GSSName
     * @see org.ietf.jgss.GSSName#NT_EXPORT_NAME
     *
     * @throws org.ietf.jgss.GSSException containing the following
     * major error codes:
     *    {@link org.ietf.jgss.GSSException#BAD_NAMETYPE GSSException.BAD_NAMETYPE},
     *    {@link org.ietf.jgss.GSSException#BAD_NAME GSSException.BAD_NAME},
     *    {@link org.ietf.jgss.GSSException#BAD_MECH GSSException.BAD_MECH},
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract org.ietf.jgss.GSSName createName(String nameStr, org.ietf.jgss.Oid nameType)
        throws org.ietf.jgss.GSSException;
     ...
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract org.ietf.jgss.GSSName createName(byte name[], org.ietf.jgss.Oid nameType)
        throws org.ietf.jgss.GSSException;
     ...
     * #createName(String, org.ietf.jgss.Oid) createName} and then also the {@link
     * org.ietf.jgss.GSSName#canonicalize(org.ietf.jgss.Oid) GSSName.canonicalize}.
     *
     * @param nameStr the string representing a printable form of the name to
     * create.
     * @param nameType the Oid specifying the namespace of the printable name
     ...
     */
    public abstract org.ietf.jgss.GSSName createName(String nameStr, org.ietf.jgss.Oid nameType,
                                                     org.ietf.jgss.Oid mech) throws org.ietf.jgss.GSSException;
     ...
     * #createName(byte[], org.ietf.jgss.Oid) createName} and then also {@link
     * org.ietf.jgss.GSSName#canonicalize(org.ietf.jgss.Oid) GSSName.canonicalize}.
     *
     * @param name the byte array containing the name to create
     * @param nameType the Oid specifying the namespace of the name supplied
     ...
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract org.ietf.jgss.GSSName createName(byte name[], org.ietf.jgss.Oid nameType, org.ietf.jgss.Oid mech)
        throws org.ietf.jgss.GSSException;
     ...
     * {@link org.ietf.jgss.GSSCredential#INITIATE_AND_ACCEPT
     * GSSCredential.INITIATE_AND_ACCEPT},
     * {@link org.ietf.jgss.GSSCredential#ACCEPT_ONLY GSSCredential.ACCEPT_ONLY}, and
     * {@link org.ietf.jgss.GSSCredential#INITIATE_ONLY GSSCredential.INITIATE_ONLY}.
     ...
     *    {@link org.ietf.jgss.GSSException#BAD_NAMETYPE GSSException.BAD_NAMETYPE},
     *    {@link org.ietf.jgss.GSSException#BAD_NAME GSSException.BAD_NAME},
     *    {@link org.ietf.jgss.GSSException#CREDENTIALS_EXPIRED
     *                                   GSSException.CREDENTIALS_EXPIRED},
     *    {@link org.ietf.jgss.GSSException#NO_CRED GSSException.NO_CRED},
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract org.ietf.jgss.GSSCredential createCredential (int usage)
        throws org.ietf.jgss.GSSException;
     ...
     * {@link org.ietf.jgss.GSSCredential#getRemainingLifetime() getRemainingLifetime}
     ...
     * valid.  Use {@link org.ietf.jgss.GSSCredential#INDEFINITE_LIFETIME
     * GSSCredential.INDEFINITE_LIFETIME} to request that the credentials
     * have the maximum permitted lifetime.  Use {@link
     * org.ietf.jgss.GSSCredential#DEFAULT_LIFETIME GSSCredential.DEFAULT_LIFETIME} to
     ...
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract org.ietf.jgss.GSSCredential createCredential (org.ietf.jgss.GSSName name,
                                                                  int lifetime, org.ietf.jgss.Oid mech, int usage)
        throws org.ietf.jgss.GSSException;
     ...
     * org.ietf.jgss.GSSCredential#getMechs() GSSCredential.getMechs} method.<p>
     *
     * GSS-API mechanism providers must impose a local access-control
     * policy on callers to prevent unauthorized callers from acquiring
     * credentials to which they are not entitled. The kinds of permissions
     ...
     */
    public abstract org.ietf.jgss.GSSCredential createCredential(org.ietf.jgss.GSSName name,
                                                                 int lifetime, org.ietf.jgss.Oid mechs[], int usage)
        throws org.ietf.jgss.GSSException;
     ...
     * {@link org.ietf.jgss.GSSContext#getLifetime() getLifetime} on the returned
     * context.<p>
     *
     ...
     * context. Use {@link org.ietf.jgss.GSSContext#INDEFINITE_LIFETIME
     * GSSContext.INDEFINITE_LIFETIME} to request that the context have the
     * maximum permitted lifetime. Use {@link org.ietf.jgss.GSSContext#DEFAULT_LIFETIME
     ...
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract org.ietf.jgss.GSSContext createContext(GSSName peer, org.ietf.jgss.Oid mech,
                                                           org.ietf.jgss.GSSCredential myCred, int lifetime)
        throws org.ietf.jgss.GSSException;
    ...
    *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
    */
    public abstract org.ietf.jgss.GSSContext createContext(GSSCredential myCred)
        throws org.ietf.jgss.GSSException;
     ...
     * the {@link org.ietf.jgss.GSSContext#isTransferable() GSSContext.isTransferable}
     ...
     * code {@link org.ietf.jgss.GSSException#UNAVAILABLE GSSException.UNAVAILABLE}.
     *
     * Some mechanism providers might require that the caller be granted
     ...
     * @throws org.ietf.jgss.GSSException containing the following
     * major error codes:
     *    {@link org.ietf.jgss.GSSException#NO_CONTEXT GSSException.NO_CONTEXT},
     *    {@link org.ietf.jgss.GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN},
     *    {@link org.ietf.jgss.GSSException#UNAVAILABLE GSSException.UNAVAILABLE},
     *    {@link org.ietf.jgss.GSSException#UNAUTHORIZED GSSException.UNAUTHORIZED},
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
     ...
     *    {@link org.ietf.jgss.GSSException#FAILURE GSSException.FAILURE}
     */
    public abstract void addProviderAtFront(Provider p, org.ietf.jgss.Oid mech)
        throws org.ietf.jgss.GSSException;
