 ...
 * set for the {@link org.ietf.jgss.GSSContext GSSContext} using the {@link
 * org.ietf.jgss.GSSContext#setChannelBinding(ChannelBinding) setChannelBinding} method
 * before the first call to {@link org.ietf.jgss.GSSContext#initSecContext(byte[], int, int)
