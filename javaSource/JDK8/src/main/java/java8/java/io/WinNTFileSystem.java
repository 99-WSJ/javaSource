 ...
 * @since 1.4
 */
class WinNTFileSystem extends java.io.FileSystem {
    ...
    private java.io.ExpiringCache cache       = new java.io.ExpiringCache();
    private java.io.ExpiringCache prefixCache = new java.io.ExpiringCache();
