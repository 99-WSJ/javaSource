...
public class Timestamp extends java.util.Date {
    ...
    public static java.sql.Timestamp valueOf(String s) {
        ...
        return new java.sql.Timestamp(year - 1900, month - 1, day, hour, minute, second, a_nanos);
    }
     ...
     */
    @SuppressWarnings("deprecation")
    public static java.sql.Timestamp valueOf(LocalDateTime dateTime) {
        return new java.sql.Timestamp(dateTime.getYear() - 1900,
     ...
     * @since 1.8
     */
    public static java.sql.Timestamp from(Instant instant) {
        try {
            java.sql.Timestamp stamp = new java.sql.Timestamp(instant.getEpochSecond() * MILLIS_PER_SECOND);
