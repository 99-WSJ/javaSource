...
public class DriverManager {
    ...
    private final static CopyOnWriteArrayList<java.sql.DriverInfo> registeredDrivers = new CopyOnWriteArrayList<>();
    ...
    public static synchronized void registerDriver(Driver driver,
        ...
        if(driver != null) {
            registeredDrivers.addIfAbsent(new java.sql.DriverInfo(driver, da));
        } else {
    ...
    public static synchronized void deregisterDriver(Driver driver)
        ...
        java.sql.DriverInfo aDriver = new java.sql.DriverInfo(driver, null);
        if(registeredDrivers.contains(aDriver)) {
            if (isDriverAllowed(driver, Reflection.getCallerClass())) {
                java.sql.DriverInfo di = registeredDrivers.get(registeredDrivers.indexOf(aDriver));
...
class DriverInfo {
    ...
    public boolean equals(Object other) {
        return (other instanceof java.sql.DriverInfo)
                && this.driver == ((java.sql.DriverInfo) other).driver;
    }
