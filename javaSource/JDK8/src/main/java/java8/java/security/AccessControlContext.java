...
public final class AccessControlContext {
     ...
     * @since 1.3
     */
    public AccessControlContext(java.security.AccessControlContext acc,
    ...
    AccessControlContext(ProtectionDomain caller, DomainCombiner combiner,
                         java.security.AccessControlContext parent, java.security.AccessControlContext context,
                         Permission[] perms)
    {
        /*
    ...
    java.security.AccessControlContext optimize() {
        ...
        java.security.AccessControlContext parent = null;
     ...
     */
    private void calculateFields(java.security.AccessControlContext assigned,
                                 java.security.AccessControlContext parent, Permission[] permissions)
    {
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof java.security.AccessControlContext))
            return false;

        java.security.AccessControlContext that = (java.security.AccessControlContext) obj;
     ...
     */
    private boolean equalContext(java.security.AccessControlContext that) {
     ...
     * scope is in effect.
     */
    private boolean equalLimitedContext(java.security.AccessControlContext that) {
        if (that == null)
            return false;
