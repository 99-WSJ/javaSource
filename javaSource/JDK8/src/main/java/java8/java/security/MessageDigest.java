...
public abstract class MessageDigest extends MessageDigestSpi {
    ...
    throws NoSuchAlgorithmException {
        try {
            ...
            if (objs[0] instanceof java.security.MessageDigest) {
                java.security.MessageDigest md = (java.security.MessageDigest)objs[0];
    ...
    static class Delegate extends java.security.MessageDigest {
        ...
        public Object clone() throws CloneNotSupportedException {
            if (digestSpi instanceof Cloneable) {
                ...
                java.security.MessageDigest that =
                    new java.security.MessageDigest.Delegate(digestSpiClone,
                                 ((java.security.MessageDigest)this).algorithm);
                that.provider = ((java.security.MessageDigest)this).provider;
                that.state = ((java.security.MessageDigest)this).state;
                return that;
            } else {
                throw new CloneNotSupportedException();
            }
