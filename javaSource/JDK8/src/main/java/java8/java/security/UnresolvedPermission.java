...
public final class UnresolvedPermission extends java.security.Permission
implements java.io.Serializable
{
     ...
     * that was passed in.
     */
    java.security.Permission resolve(java.security.Permission p, java.security.cert.Certificate certs[]) {
        if (this.certs != null) {
        ...
        try {
            ...
            if (name == null && actions == null) {
                try {
                    ...
                    return (java.security.Permission)c.newInstance(new Object[] {});
                } catch (NoSuchMethodException ne) {
                    try {
                        Constructor<?> c = pc.getConstructor(PARAMS1);
                        return (java.security.Permission) c.newInstance(
                              new Object[] { name});
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof java.security.UnresolvedPermission))
            return false;
        java.security.UnresolvedPermission that = (java.security.UnresolvedPermission) obj;
    ...
    public java.security.PermissionCollection newPermissionCollection() {
        return new java.security.UnresolvedPermissionCollection();
    }
