...
public abstract class Signature extends SignatureSpi {
    ...
    private static java.security.Signature getInstance(Instance instance, String algorithm) {
        java.security.Signature sig;
        if (instance.impl instanceof java.security.Signature) {
            sig = (java.security.Signature)instance.impl;
    ...
    private static java.security.Signature getInstanceRSA(Provider p)
            throws NoSuchAlgorithmException {
        // try Signature first
    ...
    private static class Delegate extends java.security.Signature {
        ...
        public Object clone() throws CloneNotSupportedException {
            ...
            if (sigSpi instanceof Cloneable) {
                ...
                // access them.
                java.security.Signature that =
                    new Delegate(sigSpiClone, ((java.security.Signature)this).algorithm);
                that.provider = ((java.security.Signature)this).provider;
                return that;
            } else {
                throw new CloneNotSupportedException();
            }
