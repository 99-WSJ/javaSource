...
public class SecureRandom extends Random {
    ...
    // Seed Generator
    private static volatile java.security.SecureRandom seedGenerator = null;
    ...
    private void getDefaultPRNG(boolean setSeed, byte[] seed) {
        ...
        if (prng == null) {
            ...
            try {
                java.security.SecureRandom random = java.security.SecureRandom.getInstance(prng);
        ...
        if (getClass() == java.security.SecureRandom.class) {
            this.algorithm = prng;
        }
    }
    ...
    public static java.security.SecureRandom getInstance(String algorithm)
        ...
        return new java.security.SecureRandom((SecureRandomSpi)instance.impl,
    ...
    public static byte[] getSeed(int numBytes) {
        if (seedGenerator == null) {
            seedGenerator = new java.security.SecureRandom();
        }
    ...
    public static java.security.SecureRandom getInstanceStrong()
        ...
        while (remainder != null) {
            ...
            if ((m = StrongPatternHolder.pattern.matcher(
                ...
                try {
                    if (prov == null) {
                        return java.security.SecureRandom.getInstance(alg);
                    } else {
                        return java.security.SecureRandom.getInstance(alg, prov);
                    }
