...
public class ECPoint {
     ...
     */
    public static final java.security.spec.ECPoint POINT_INFINITY = new java.security.spec.ECPoint();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof java.security.spec.ECPoint) {
            return ((x.equals(((java.security.spec.ECPoint)obj).x)) &&
                    (y.equals(((java.security.spec.ECPoint)obj).y)));
        }
        return false;
    }
