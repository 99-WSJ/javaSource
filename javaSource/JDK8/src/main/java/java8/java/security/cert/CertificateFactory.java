...
public class CertificateFactory {
     ...
     * @see Provider
     */
    public static final java.security.cert.CertificateFactory getInstance(String type)
            throws CertificateException {
        try {
            Instance instance = GetInstance.getInstance("CertificateFactory",
                CertificateFactorySpi.class, type);
            return new java.security.cert.CertificateFactory((CertificateFactorySpi)instance.impl,
