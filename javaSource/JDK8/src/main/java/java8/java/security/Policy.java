...
public abstract class Policy {
    ...
    private static class PolicyInfo {
        ...
        final java.security.Policy policy;
        // a flag indicating if the system-wide policy has been initialized
        final boolean initialized;

        PolicyInfo(java.security.Policy policy, boolean initialized) {
            this.policy = policy;
    ...
    static java.security.Policy getPolicyNoCheck()
    {
        ...
        if (pi.initialized == false || pi.policy == null) {
            synchronized (java.security.Policy.class) {
                ...
                if (pinfo.policy == null) {
                    ...
                    try {
                        pinfo = new PolicyInfo(
                            (java.security.Policy) Class.forName(policy_class).newInstance(),
                            true);
                    } catch (Exception e) {
                        /*
                        ...
                        java.security.Policy polFile = new sun.security.provider.PolicyFile();
                        pinfo = new PolicyInfo(polFile, false);
                        policy.set(pinfo);

                        final String pc = policy_class;
                        java.security.Policy pol = AccessController.doPrivileged(
                            new PrivilegedAction<java.security.Policy>() {
                            public java.security.Policy run() {
                                try {
                                    ...
                                    return (extcl != null ? (java.security.Policy)Class.forName(
     ...
     * @since 1.4
     */
    private static void initPolicy (final java.security.Policy p) {
        /*
        ...
        if (policyDomain.getCodeSource() != null) {
            java.security.Policy pol = policy.get().policy;
            if (pol != null) {
     ...
     * @since 1.6
     */
    public static java.security.Policy getInstance(String type, java.security.Policy.Parameters params)
     ...
     * @since 1.6
     */
    public static java.security.Policy getInstance(String type,
    ...
    private static java.security.Policy handleException(NoSuchAlgorithmException nsae)
                throws NoSuchAlgorithmException {
