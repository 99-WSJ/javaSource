...
public class ProtectionDomain {
     ...
     * @see Policy#refresh
     * @see Policy#getPermissions(java.security.ProtectionDomain)
     * @since 1.4
     */
    public ProtectionDomain(CodeSource codesource,
                            PermissionCollection permissions,
        ...
        PermissionCollection perms =
            ...
            (new PrivilegedAction<PermissionCollection>() {
                    public PermissionCollection run() {
                        ...
                        return p.getPermissions(java.security.ProtectionDomain.this);
                    }
                });
            ...
            new JavaSecurityProtectionDomainAccess() {
                public ProtectionDomainCache getProtectionDomainCache() {
                    return new ProtectionDomainCache() {
                        ...
                        public void put(java.security.ProtectionDomain pd,
                                        PermissionCollection pc) {
                            map.put((pd == null ? null : pd.key), pc);
                        }
                        public PermissionCollection get(java.security.ProtectionDomain pd) {
