    ...
    implements java.io.Serializable
{
    ...
    public boolean implies(Permission p) {
        ...
        java.security.BasicPermission that = (java.security.BasicPermission) p;
    ...
    public boolean equals(Object obj) {
        ...
        java.security.BasicPermission bp = (java.security.BasicPermission) obj;
    ...
    public PermissionCollection newPermissionCollection() {
        return new java.security.BasicPermissionCollection(this.getClass());
    }
    ...
    implements java.io.Serializable
{
    ...
    public void add(Permission permission) {
        if (! (permission instanceof java.security.BasicPermission))
            throw new IllegalArgumentException("invalid permission: "+
                                               permission);
        if (isReadOnly())
            throw new SecurityException("attempt to add a Permission to a readonly PermissionCollection");

        java.security.BasicPermission bp = (java.security.BasicPermission) permission;
