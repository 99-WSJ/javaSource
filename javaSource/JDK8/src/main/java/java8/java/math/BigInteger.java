...
public class BigInteger extends Number implements Comparable<java.math.BigInteger> {
    /**
     ...
     * @since 1.4
     */
    public static java.math.BigInteger probablePrime(int bitLength, Random rnd) {
        if (bitLength < 2)
            throw new ArithmeticException("bitLength < 2");
     ...
     */
    private static java.math.BigInteger smallPrime(int bitLength, int certainty, Random rnd) {
        ...
        while (true) {
            ...
            java.math.BigInteger p = new java.math.BigInteger(temp, 1);
     ...
     * test.
     */
    private static java.math.BigInteger largePrime(int bitLength, int certainty, Random rnd) {
        java.math.BigInteger p;
        p = new java.math.BigInteger(bitLength, rnd).setBit(bitLength-1);
        p.mag[p.mag.length-1] &= 0xfffffffe;

        // Use a sieve length likely to contain the next prime number
        int searchLen = getPrimeSearchLen(bitLength);
        BitSieve searchSieve = new BitSieve(p, searchLen);
        java.math.BigInteger candidate = searchSieve.retrieve(p, certainty, rnd);

        while ((candidate == null) || (candidate.bitLength() != bitLength)) {
            p = p.add(java.math.BigInteger.valueOf(2*searchLen));
    ...
    */
    public java.math.BigInteger nextProbablePrime() {
        ...
        java.math.BigInteger result = this.add(ONE);
        ...
        while (true) {
           ...
           java.math.BigInteger candidate = searchSieve.retrieve(result,
                                                 DEFAULT_PRIME_CERTAINTY, null);
           if (candidate != null)
               return candidate;
           result = result.add(java.math.BigInteger.valueOf(2 * searchLen));
        }
    }
    ...
    private boolean passesLucasLehmer() {
        java.math.BigInteger thisPlusOne = this.add(ONE);
        ...
        // Step 2
        java.math.BigInteger u = lucasLehmerSequence(d, thisPlusOne, this);
    ...
    private static int jacobiSymbol(int p, java.math.BigInteger n) {
        ...
        if ((p & u & 2) != 0)   // p = u = 3 (mod 4)?
            j = -j;
        // And reduce u mod p
        u = n.mod(java.math.BigInteger.valueOf(p)).intValue();
    ...
    private static java.math.BigInteger lucasLehmerSequence(int z, java.math.BigInteger k, java.math.BigInteger n) {
        java.math.BigInteger d = java.math.BigInteger.valueOf(z);
        java.math.BigInteger u = ONE; java.math.BigInteger u2;
        java.math.BigInteger v = ONE; java.math.BigInteger v2;
    ...
    private boolean passesMillerRabin(int iterations, Random rnd) {
        ...
        java.math.BigInteger thisMinusOne = this.subtract(ONE);
        java.math.BigInteger m = thisMinusOne;
        ...
        for (int i=0; i < iterations; i++) {
            ...
            do {
                b = new java.math.BigInteger(this.bitLength(), rnd);
            } while (b.compareTo(ONE) <= 0 || b.compareTo(this) >= 0);

            int j = 0;
            java.math.BigInteger z = b.modPow(m, this);
    ...
    private static java.math.BigInteger valueOf(int val[]) {
        return (val[0] > 0 ? new java.math.BigInteger(val, 1) : new java.math.BigInteger(val));
    }
    ...
    private static java.math.BigInteger posConst[] = new java.math.BigInteger[MAX_CONSTANT+1];
    private static java.math.BigInteger negConst[] = new java.math.BigInteger[MAX_CONSTANT+1];
    ...
    static {
        for (int i = 1; i <= MAX_CONSTANT; i++) {
            ...
            magnitude[0] = i;
            posConst[i] = new java.math.BigInteger(magnitude,  1);
            negConst[i] = new java.math.BigInteger(magnitude, -1);
        }
         ...
         * on demand.
         */
        powerCache = new java.math.BigInteger[Character.MAX_RADIX+1][];
        logCache = new double[Character.MAX_RADIX+1];

        for (int i=Character.MIN_RADIX; i <= Character.MAX_RADIX; i++) {
            powerCache[i] = new java.math.BigInteger[] { java.math.BigInteger.valueOf(i) };
     ...
     * @since   1.2
     */
    public static final java.math.BigInteger ZERO = new java.math.BigInteger(new int[0], 0);
     ...
     */
    private static final java.math.BigInteger TWO = valueOf(2);

    /**
     * The BigInteger constant -1.  (Not exported.)
     */
    private static final java.math.BigInteger NEGATIVE_ONE = valueOf(-1);
    ...
    public java.math.BigInteger add(java.math.BigInteger val) {
        ...
        if (val.signum == signum)
            return new java.math.BigInteger(add(mag, val.mag), signum);
        ...
        return new java.math.BigInteger(resultMag, cmp == signum ? 1 : -1);
    }
     ...
     */
    java.math.BigInteger add(long val) {
        if (val == 0)
            return this;
        if (signum == 0)
            return valueOf(val);
        if (Long.signum(val) == signum)
            return new java.math.BigInteger(add(mag, Math.abs(val)), signum);
        int cmp = compareMagnitude(val);
        if (cmp == 0)
            return ZERO;
    ...
    public java.math.BigInteger multiply(java.math.BigInteger val) {
        ...
        if ((xlen < KARATSUBA_THRESHOLD) || (ylen < KARATSUBA_THRESHOLD)) {
            ...
            return new java.math.BigInteger(result, resultSign);
        } else {
    ...
    private static java.math.BigInteger multiplyByInt(int[] x, int y, int sign) {
        if (Integer.bitCount(y) == 1) {
            return new java.math.BigInteger(shiftLeft(x,Integer.numberOfTrailingZeros(y)), sign);
        }
        int xlen = x.length;
        ...
        return new java.math.BigInteger(rmag, sign);
    }
     ...
     */
    java.math.BigInteger multiply(long v) {
        if (v == 0 || signum == 0)
          return ZERO;
        if (v == BigDecimal.INFLATED)
            return multiply(java.math.BigInteger.valueOf(v));
        ...
        if (carry == 0L)
            rmag = Arrays.copyOfRange(rmag, 1, rmag.length);
        return new java.math.BigInteger(rmag, rsign);
    }
     ...
     */
    private static java.math.BigInteger multiplyKaratsuba(java.math.BigInteger x, java.math.BigInteger y) {
        ...
        java.math.BigInteger xl = x.getLower(half);
        java.math.BigInteger xh = x.getUpper(half);
        java.math.BigInteger yl = y.getLower(half);
        java.math.BigInteger yh = y.getUpper(half);

        java.math.BigInteger p1 = xh.multiply(yh);  // p1 = xh*yh
        java.math.BigInteger p2 = xl.multiply(yl);  // p2 = xl*yl

        // p3=(xh+xl)*(yh+yl)
        java.math.BigInteger p3 = xh.add(xl).multiply(yh.add(yl));

        // result = p1 * 2^(32*2*half) + (p3 - p1 - p2) * 2^(32*half) + p2
        java.math.BigInteger result = p1.shiftLeft(32*half).add(p3.subtract(p1).subtract(p2)).shiftLeft(32*half).add(p2);
     ...
     *
     */
    private static java.math.BigInteger multiplyToomCook3(java.math.BigInteger a, java.math.BigInteger b) {
        ...
        java.math.BigInteger a0, a1, a2, b0, b1, b2;
        ...
        java.math.BigInteger v0, v1, v2, vm1, vinf, t1, t2, tm1, da1, db1;
        ...
        java.math.BigInteger result = vinf.shiftLeft(ss).add(t2).shiftLeft(ss).add(t1).shiftLeft(ss).add(tm1).shiftLeft(ss).add(v0);
     ...
     * numbers.
     */
    private java.math.BigInteger getToomSlice(int lowerSize, int upperSize, int slice,
                                              int fullsize) {
        ...
        return new java.math.BigInteger(trustedStripLeadingZeroInts(intSlice), 1);
    }
    ...
    private java.math.BigInteger exactDivideBy3() {
        ...
        result = trustedStripLeadingZeroInts(result);
        return new java.math.BigInteger(result, signum);
    }
    ...
    private java.math.BigInteger getLower(int n) {
        ...
        return new java.math.BigInteger(trustedStripLeadingZeroInts(lowerInts), 1);
    }
     ...
     * Karatsuba squaring.
     */
    private java.math.BigInteger getUpper(int n) {
        int len = mag.length;
        ...
        return new java.math.BigInteger(trustedStripLeadingZeroInts(upperInts), 1);
    }
    ...
    private java.math.BigInteger square() {
        ...
        if (len < KARATSUBA_SQUARE_THRESHOLD) {
            ...
            return new java.math.BigInteger(trustedStripLeadingZeroInts(z), 1);
        } else {
    ...
    private java.math.BigInteger squareKaratsuba() {
        ...
        java.math.BigInteger xl = getLower(half);
        java.math.BigInteger xh = getUpper(half);

        java.math.BigInteger xhs = xh.square();  // xhs = xh^2
        java.math.BigInteger xls = xl.square();  // xls = xl^2
    ...
    private java.math.BigInteger squareToomCook3() {
        ...
        java.math.BigInteger a0, a1, a2;
        a2 = getToomSlice(k, r, 0, len);
        a1 = getToomSlice(k, r, 1, len);
        a0 = getToomSlice(k, r, 2, len);
        java.math.BigInteger v0, v1, v2, vm1, vinf, t1, t2, tm1, da1;
     ...
     */
    private java.math.BigInteger divideKnuth(java.math.BigInteger val) {
    ...
    /** Long division */
    private java.math.BigInteger[] divideAndRemainderKnuth(java.math.BigInteger val) {
    ...
    /** Long division */
    private java.math.BigInteger remainderKnuth(java.math.BigInteger val) {
        MutableBigInteger q = new MutableBigInteger(),
                          a = new MutableBigInteger(this.mag),
                          b = new MutableBigInteger(val.mag);
     ...
     * @return {@code this / val}
     */
    private java.math.BigInteger divideBurnikelZiegler(java.math.BigInteger val) {
     ...
     * @return {@code this % val}
     */
    private java.math.BigInteger remainderBurnikelZiegler(java.math.BigInteger val) {
     ...
     */
    private java.math.BigInteger[] divideAndRemainderBurnikelZiegler(java.math.BigInteger val) {
        MutableBigInteger q = new MutableBigInteger();
        MutableBigInteger r = new MutableBigInteger(this).divideAndRemainderBurnikelZiegler(new MutableBigInteger(val), q);
        java.math.BigInteger qBigInt = q.isZero() ? ZERO : q.toBigInteger(signum*val.signum);
        java.math.BigInteger rBigInt = r.isZero() ? ZERO : r.toBigInteger(signum);
        return new java.math.BigInteger[] {qBigInt, rBigInt};
    }
    ...
    public java.math.BigInteger pow(int exponent) {
        ...
        java.math.BigInteger partToSquare = this.abs();
        ...
        if (partToSquare.mag.length == 1 && scaleFactor <= 62) {
            ...
            java.math.BigInteger answer = ONE;
    ...
    public java.math.BigInteger negate() {
        return new java.math.BigInteger(this.mag, -this.signum);
    }
    ...
    public java.math.BigInteger mod(java.math.BigInteger m) {
        ...
        java.math.BigInteger result = this.remainder(m);
    ...
    public java.math.BigInteger modPow(java.math.BigInteger exponent, java.math.BigInteger m) {
        ...
        java.math.BigInteger base = (this.signum < 0 || this.compareTo(m) >= 0
                           ? this.mod(m) : this);
        ...
        if (m.testBit(0)) { // odd modulus
            ...
            java.math.BigInteger m1 = m.shiftRight(p);  // m/2**p
            java.math.BigInteger m2 = ONE.shiftLeft(p); // 2**p

            // Calculate new base from m1
            java.math.BigInteger base2 = (this.signum < 0 || this.compareTo(m1) >= 0
                                ? this.mod(m1) : this);

            // Caculate (base ** exponent) mod m1.
            java.math.BigInteger a1 = (m1.equals(ONE) ? ZERO :
                             base2.oddModPow(exponent, m1));

            // Calculate (this ** exponent) mod m2
            java.math.BigInteger a2 = base.modPow2(exponent, p);

            // Combine results using Chinese Remainder Theorem
            java.math.BigInteger y1 = m2.modInverse(m1);
            java.math.BigInteger y2 = m1.modInverse(m2);
     ...
     */
        ...
        return new java.math.BigInteger(1, t2);
    }
    ...
    private java.math.BigInteger modPow2(java.math.BigInteger exponent, int p) {
         ...
         */
        java.math.BigInteger result = ONE;
        java.math.BigInteger baseToPow2 = this.mod2(p);
        int expOffset = 0;
    ...
    private java.math.BigInteger mod2(int p) {
        ...
        return (mag[0] == 0 ? new java.math.BigInteger(1, mag) : new java.math.BigInteger(mag, 1));
    }
    ...
    public java.math.BigInteger modInverse(java.math.BigInteger m) {
        ...
        java.math.BigInteger modVal = this;
    ...
    public java.math.BigInteger shiftLeft(int n) {
        if (signum == 0)
            return ZERO;
        if (n > 0) {
            return new java.math.BigInteger(shiftLeft(mag, n), signum);
        } else if (n == 0) {
            return this;
        } else {
     ...
     * @return {@code this >> n}
     */
    private java.math.BigInteger shiftRightImpl(int n) {
        int nInts = n >>> 5;
        int nBits = n & 0x1f;
        int magLen = mag.length;
        int newMag[] = null;
        ...
        return new java.math.BigInteger(newMag, signum);
    }
    ...
    public boolean isProbablePrime(int certainty) {
        if (certainty <= 0)
            return true;
        java.math.BigInteger w = this.abs();
        if (w.equals(TWO))
            return true;
     ...
     */
    final int compareMagnitude(java.math.BigInteger val) {
        int[] m1 = mag;
        int len1 = m1.length;
        int[] m2 = val.mag;
        int len2 = m2.length;
    ...
    public boolean equals(Object x) {
        ...
        java.math.BigInteger xInt = (java.math.BigInteger) x;
    ...
    private String smallToString(int radix) {
        ...
        java.math.BigInteger tmp = this.abs();
        int numGroups = 0;
        while (tmp.signum != 0) {
            java.math.BigInteger d = longRadix[radix];

            MutableBigInteger q = new MutableBigInteger(),
                              a = new MutableBigInteger(tmp.mag),
                              b = new MutableBigInteger(d.mag);
            MutableBigInteger r = a.divide(b, q);
            java.math.BigInteger q2 = q.toBigInteger(tmp.signum * d.signum);
            java.math.BigInteger r2 = r.toBigInteger(tmp.signum * d.signum);
     ...
     */
    private static void toString(java.math.BigInteger u, StringBuilder sb, int radix,
                                 int digits) {
        ...
        java.math.BigInteger v = getRadixConversionCache(radix, n);
     ...
     * {@code Future}.
     */
    private static java.math.BigInteger getRadixConversionCache(int radix, int exponent) {
        java.math.BigInteger[] cacheLine = powerCache[radix]; // volatile read
        ...
        java.math.BigInteger[][] pc = powerCache; // volatile read again
    ...
    private static java.math.BigInteger longRadix[] = {null, null,
        ...
        static {
            try {
                ...
                signumOffset = unsafe.objectFieldOffset
                    (java.math.BigInteger.class.getDeclaredField("signum"));
                magOffset = unsafe.objectFieldOffset
                    (java.math.BigInteger.class.getDeclaredField("mag"));
            } catch (Exception ex) {
                throw new ExceptionInInitializerError(ex);
            }
        }

        static void putSign(java.math.BigInteger bi, int sign) {
            unsafe.putIntVolatile(bi, signumOffset, sign);
        }

        static void putMag(java.math.BigInteger bi, int[] magnitude) {
