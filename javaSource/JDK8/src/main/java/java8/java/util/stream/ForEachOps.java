...
final class ForEachOps {
     ...
     */
    public static <T> java.util.stream.TerminalOp<T, Void> makeRef(Consumer<? super T> action,
                                                                   boolean ordered) {
     ...
     * @return the {@code TerminalOp} instance
     */
    public static java.util.stream.TerminalOp<Integer, Void> makeInt(IntConsumer action,
                                                                     boolean ordered) {
        Objects.requireNonNull(action);
     ...
     * @return the {@code TerminalOp} instance
     */
    public static java.util.stream.TerminalOp<Long, Void> makeLong(LongConsumer action,
                                                                   boolean ordered) {
        Objects.requireNonNull(action);
     ...
     * @return the {@code TerminalOp} instance
     */
    public static java.util.stream.TerminalOp<Double, Void> makeDouble(DoubleConsumer action,
                                                                       boolean ordered) {
        Objects.requireNonNull(action);
    ...
    static abstract class ForEachOp<T>
            implements java.util.stream.TerminalOp<T, Void>, java.util.stream.TerminalSink<T, Void> {
        ...
        public int getOpFlags() {
            return ordered ? 0 : java.util.stream.StreamOpFlag.NOT_ORDERED;
        }
    ...
    static final class ForEachTask<S, T> extends CountedCompleter<Void> {
        ...
        public void compute() {
            ...
            if ((sizeThreshold = targetSize) == 0L)
                targetSize = sizeThreshold = java.util.stream.AbstractTask.suggestTargetSize(sizeEstimate);
            boolean isShortCircuit = java.util.stream.StreamOpFlag.SHORT_CIRCUIT.isKnown(helper.getStreamAndOpFlags());
    ...
    static final class ForEachOrderedTask<S, T> extends CountedCompleter<Void> {
        ...
        private static <S, T> void doCompute(ForEachOrderedTask<S, T> task) {
            ...
            if (task.getPendingCount() == 0) {
                ...
                java.util.stream.Node.Builder<T> nb = task.helper.makeNodeBuilder(
