 ...
 */
public class Date
    implements java.io.Serializable, Cloneable, Comparable<java.util.Date>
{
     ...
     * @see     DateFormat
     * @see     java.util.Date#parse(String)
     * @deprecated As of JDK version 1.1,
    ...
    syntax:
        {
            ...
            if (year < 100) {
                synchronized (java.util.Date.class) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof java.util.Date && getTime() == ((java.util.Date) obj).getTime();
    }
     ...
     * value returned by the {@link java.util.Date#getTime}
