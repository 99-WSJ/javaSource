...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final class WorkQueue {
        ...
        WorkQueue(java.util.concurrent.ForkJoinPool pool, ForkJoinWorkerThread owner, int mode,
                  int seed) {
            this.pool = pool;
            this.owner = owner;
        ...
        final void push(ForkJoinTask<?> task) {
            ForkJoinTask<?>[] a; java.util.concurrent.ForkJoinPool p;
            int s = top, n;
    ...
    static WorkQueue commonSubmitterQueue() {
        java.util.concurrent.ForkJoinPool p; WorkQueue[] ws; int m, z;
    ...
    public static void managedBlock(ManagedBlocker blocker)
        ...
        if (t instanceof ForkJoinWorkerThread) {
            java.util.concurrent.ForkJoinPool p = ((ForkJoinWorkerThread)t).pool;
            while (!blocker.isReleasable()) {
    ...
    static {
        ...
        try {
            U = sun.misc.Unsafe.getUnsafe();
            Class<?> k = java.util.concurrent.ForkJoinPool.class;
