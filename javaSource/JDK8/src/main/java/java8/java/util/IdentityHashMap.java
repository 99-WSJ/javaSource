    ...
    implements Map<K,V>, Serializable, Cloneable
{
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (o instanceof java.util.IdentityHashMap) {
            java.util.IdentityHashMap<?,?> m = (java.util.IdentityHashMap<?,?>) o;
            if (m.size() != size)
                return false;
    ...
    public Object clone() {
        try {
            java.util.IdentityHashMap<?,?> m = (java.util.IdentityHashMap<?,?>) super.clone();
            m.entrySet = null;
            m.table = table.clone();
            return m;
    ...
    private abstract class IdentityHashMapIterator<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            if (tab != java.util.IdentityHashMap.this.table) {
                java.util.IdentityHashMap.this.remove(key);
                expectedModCount = modCount;
                return;
            }
            ...
            for (int i = nextKeyIndex(d, len); (item = tab[i]) != null;
                ...
                if ((i < r && (r <= d || d <= i)) ||
                    ...
                    if (i < deletedSlot && d >= deletedSlot &&
                        traversalTable == java.util.IdentityHashMap.this.table) {
        ...
        extends IdentityHashMapIterator<Entry<K,V>>
    {
        ...
        private class Entry implements Map.Entry<K,V> {
            ...
            public V setValue(V value) {
                ...
                if (traversalTable != java.util.IdentityHashMap.this.table)
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            int oldSize = size;
            java.util.IdentityHashMap.this.remove(o);
            return size != oldSize;
        }
        /*
        ...
        public void clear() {
            java.util.IdentityHashMap.this.clear();
        }
        public int hashCode() {
            int result = 0;
            for (K key : this)
        ...
        public Spliterator<K> spliterator() {
            return new KeySpliterator<>(java.util.IdentityHashMap.this, 0, -1, 0, 0);
        }
    }
    ...
    private class Values extends AbstractCollection<V> {
        ...
        public Spliterator<V> spliterator() {
            return new ValueSpliterator<>(java.util.IdentityHashMap.this, 0, -1, 0, 0);
        }
    }
    ...
    private class EntrySet extends AbstractSet<Entry<K,V>> {
        ...
        public Spliterator<Entry<K,V>> spliterator() {
            return new EntrySpliterator<>(java.util.IdentityHashMap.this, 0, -1, 0, 0);
        }
    }
    ...
    static class IdentityHashMapSpliterator<K,V> {
        ...
        IdentityHashMapSpliterator(java.util.IdentityHashMap<K,V> map, int origin,
    ...
    static final class KeySpliterator<K,V>
        ...
        KeySpliterator(java.util.IdentityHashMap<K,V> map, int origin, int fence, int est,
        ...
        public void forEachRemaining(Consumer<? super K> action) {
            ...
            java.util.IdentityHashMap<K,V> m; Object[] a;
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(java.util.IdentityHashMap<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(java.util.IdentityHashMap<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
