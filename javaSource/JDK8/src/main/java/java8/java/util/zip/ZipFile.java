 ...
 */
public
class ZipFile implements java.util.zip.ZipConstants, Closeable {
    ...
    public ZipFile(File file, int mode, Charset charset) throws IOException
    {
        ...
        this.zc = java.util.zip.ZipCoder.get(charset);
    ...
    private class ZipEntryIterator implements Enumeration<ZipEntry>, Iterator<ZipEntry> {
        ...
        public boolean hasNext() {
            synchronized (java.util.zip.ZipFile.this) {
                ensureOpen();
                return i < total;
            }
        }
            ...
            synchronized (java.util.zip.ZipFile.this) {
                ...
                if (jzentry == 0) {
                    ...
                    if (closeRequested) {
                        ...
                        message = getZipMessage(java.util.zip.ZipFile.this.jzfile);
                    }
                    throw new ZipError("jzentry == 0" +
                                       ",\n jzfile = " + java.util.zip.ZipFile.this.jzfile +
                                       ",\n total = " + java.util.zip.ZipFile.this.total +
                                       ",\n name = " + java.util.zip.ZipFile.this.name +
                                       ",\n i = " + i +
                                       ",\n message = " + message
                        );
                }
   ...
   private class ZipFileInputStream extends InputStream {
        ...
        public int read(byte b[], int off, int len) throws IOException {
            ...
            synchronized (java.util.zip.ZipFile.this) {
                ...
                len = java.util.zip.ZipFile.read(java.util.zip.ZipFile.this.jzfile, jzentry, pos, b,
                                   off, len);
            }
            if (len > 0) {
                pos += len;
        ...
        public void close() {
            ...
            rem = 0;
            synchronized (java.util.zip.ZipFile.this) {
                if (jzentry != 0 && java.util.zip.ZipFile.this.jzfile != 0) {
                    freeEntry(java.util.zip.ZipFile.this.jzfile, jzentry);
                    jzentry = 0;
                }
            }
            synchronized (streams) {
