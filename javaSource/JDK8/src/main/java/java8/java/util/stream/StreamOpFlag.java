...
enum StreamOpFlag {
    ...
    private static int createMask(Type t) {
        int mask = 0;
        for (java.util.stream.StreamOpFlag flag : java.util.stream.StreamOpFlag.values()) {
    ...
    static int combineOpFlags(int newStreamOrOpFlags, int prevCombOpFlags) {
        ...
        return (prevCombOpFlags & java.util.stream.StreamOpFlag.getMask(newStreamOrOpFlags)) | newStreamOrOpFlags;
    }
