...
public interface LongPredicate {
     ...
     */
    default java.util.function.LongPredicate and(java.util.function.LongPredicate other) {
     ...
     * @throws NullPointerException if other is null
     */
    default java.util.function.LongPredicate or(java.util.function.LongPredicate other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
}
