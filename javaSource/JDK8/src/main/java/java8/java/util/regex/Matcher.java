...
public final class Matcher implements MatchResult {
    ...
    public MatchResult toMatchResult() {
        java.util.regex.Matcher result = new java.util.regex.Matcher(this.parentPattern, text.toString());
    ...
    /**
      ...
      * @since 1.5
      */
    public java.util.regex.Matcher usePattern(Pattern newPattern) {
        if (newPattern == null)
     ...
     * <code>appendReplacement</code> method of the {@link java.util.regex.Matcher} class.
     ...
     */
    public java.util.regex.Matcher appendReplacement(StringBuffer sb, String replacement) {
