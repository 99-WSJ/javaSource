...
public class ConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    ...
    static final class KeySet<E>
        ...
        public Iterator<E> iterator() {
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<E,Object>)m).keyIterator();
            else
                return ((java.util.concurrent.ConcurrentSkipListMap.SubMap<E,Object>)m).keyIterator();
        }
        public boolean equals(Object o) {
            if (o == this)
                return true;
        ...
        public Spliterator<E> spliterator() {
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<E,?>)m).keySpliterator();
            else
    ...
    static final class Values<E> extends AbstractCollection<E> {
        ...
        public Iterator<E> iterator() {
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<?,E>)m).valueIterator();
            else
        ...
        public Spliterator<E> spliterator() {
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<?,E>)m).valueSpliterator();
            else
    ...
    static final class EntrySet<K1,V1> extends AbstractSet<Entry<K1,V1>> {
        ...
        public Iterator<Entry<K1,V1>> iterator() {
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<K1,V1>)m).entryIterator();
            else
        ...
        public Spliterator<Entry<K1,V1>> spliterator() {
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<K1,V1>)m).entrySpliterator();
            else
    ...
    static {
        try {
            UNSAFE = sun.misc.Unsafe.getUnsafe();
            Class<?> k = java.util.concurrent.ConcurrentSkipListMap.class;
