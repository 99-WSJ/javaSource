...
class SpinedBuffer<E>
     ...
     */
    static class OfInt extends java.util.stream.SpinedBuffer.OfPrimitive<Integer, int[], IntConsumer>
        ...
        public void forEach(Consumer<? super Integer> consumer) {
            if (consumer instanceof IntConsumer) {
                ...
                if (java.util.stream.Tripwire.ENABLED)
                    java.util.stream.Tripwire.trip(getClass(), "{0} calling SpinedBuffer.OfInt.forEach(Consumer)");
     ...
     */
    static class OfLong extends java.util.stream.SpinedBuffer.OfPrimitive<Long, long[], LongConsumer>
        ...
        public void forEach(Consumer<? super Long> consumer) {
            if (consumer instanceof LongConsumer) {
                ...
                if (java.util.stream.Tripwire.ENABLED)
                    java.util.stream.Tripwire.trip(getClass(), "{0} calling SpinedBuffer.OfLong.forEach(Consumer)");
                spliterator().forEachRemaining(consumer);
            }
        }
    ...
    static class OfDouble
            extends java.util.stream.SpinedBuffer.OfPrimitive<Double, double[], DoubleConsumer>
        ...
        public void forEach(Consumer<? super Double> consumer) {
            if (consumer instanceof DoubleConsumer) {
                ...
                if (java.util.stream.Tripwire.ENABLED)
                    java.util.stream.Tripwire.trip(getClass(), "{0} calling SpinedBuffer.OfDouble.forEach(Consumer)");
                spliterator().forEachRemaining(consumer);
            }
        }
