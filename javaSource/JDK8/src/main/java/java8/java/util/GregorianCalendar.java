...
/////////////////
    ...
    public boolean equals(Object obj) {
        return obj instanceof java.util.GregorianCalendar &&
            super.equals(obj) &&
            gregorianCutover == ((java.util.GregorianCalendar)obj).gregorianCutover;
    }
        ...
        case YEAR:
            {
                ...
                java.util.GregorianCalendar gc = (java.util.GregorianCalendar) clone();
                gc.setLenient(true);
    ...
    public int getActualMinimum(int field) {
        if (field == DAY_OF_MONTH) {
            java.util.GregorianCalendar gc = getNormalizedCalendar();
        ...
        case WEEK_OF_YEAR:
            {
                ...
                if (gc == this) {
                    gc = (java.util.GregorianCalendar) gc.clone();
                }
        ...
        case DAY_OF_WEEK_IN_MONTH:
            {
                ...
                if (!gc.isCutoverYear(normalizedYear)) {
                    ...
                    if (gc == this) {
                        gc = (java.util.GregorianCalendar) clone();
                    }
    ...
    public Object clone()
    {
        java.util.GregorianCalendar other = (java.util.GregorianCalendar) super.clone();
    ...
    public int getWeekYear() {
        ...
        java.util.GregorianCalendar cal = (java.util.GregorianCalendar) clone();
        cal.setLenient(true);
     ...
     * @see java.util.GregorianCalendar#isWeekDateSupported()
     * @see Calendar#getFirstDayOfWeek()
     * @see Calendar#getMinimalDaysInFirstWeek()
     * @since 1.7
     */
...
/////////////////////////////
    ...
    private java.util.GregorianCalendar getNormalizedCalendar() {
        ...
        if (isFullyNormalized()) {
            ...
            gc = (java.util.GregorianCalendar) this.clone();
            gc.setLenient(true);
            gc.complete();
        }
        return gc;
     ...
     * @since 1.8
     */
    public static java.util.GregorianCalendar from(ZonedDateTime zdt) {
        java.util.GregorianCalendar cal = new java.util.GregorianCalendar(TimeZone.getTimeZone(zdt.getZone()));
