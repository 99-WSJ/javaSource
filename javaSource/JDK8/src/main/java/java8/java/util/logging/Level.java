...
public class Level implements java.io.Serializable {
     ...
     */
    public static final java.util.logging.Level OFF = new java.util.logging.Level("OFF",Integer.MAX_VALUE, defaultBundle);
     ...
     */
    public static final java.util.logging.Level SEVERE = new java.util.logging.Level("SEVERE",1000, defaultBundle);
     ...
     */
    public static final java.util.logging.Level WARNING = new java.util.logging.Level("WARNING", 900, defaultBundle);
     ...
     */
    public static final java.util.logging.Level INFO = new java.util.logging.Level("INFO", 800, defaultBundle);
     ...
     */
    public static final java.util.logging.Level CONFIG = new java.util.logging.Level("CONFIG", 700, defaultBundle);
     ...
     */
    public static final java.util.logging.Level FINE = new java.util.logging.Level("FINE", 500, defaultBundle);
     ...
     */
    public static final java.util.logging.Level FINER = new java.util.logging.Level("FINER", 400, defaultBundle);

    /**
     * FINEST indicates a highly detailed tracing message.
     * This level is initialized to <CODE>300</CODE>.
     */
    public static final java.util.logging.Level FINEST = new java.util.logging.Level("FINEST", 300, defaultBundle);

    /**
     * ALL indicates that all messages should be logged.
     * This level is initialized to <CODE>Integer.MIN_VALUE</CODE>.
     */
    public static final java.util.logging.Level ALL = new java.util.logging.Level("ALL", Integer.MIN_VALUE, defaultBundle);
    ...
    static java.util.logging.Level findLevel(String name) {
        ...
        try {
            ...
            if (level == null) {
                // add new Level
                java.util.logging.Level levelObject = new java.util.logging.Level(name, x);
                level = KnownLevel.findByValue(x);
            }
            return level.mirroredLevel;
    ...
    private Object readResolve() {
        ...
        java.util.logging.Level level = new java.util.logging.Level(this.name, this.value, this.resourceBundleName);
        return level;
    }
     ...
     */
    public static synchronized java.util.logging.Level parse(String name) throws IllegalArgumentException {
    ...
    public boolean equals(Object ox) {
        try {
            java.util.logging.Level lx = (java.util.logging.Level)ox;
    ...
    static final class KnownLevel {
        ...
        final java.util.logging.Level levelObject;     // instance of Level class or Level subclass
        final java.util.logging.Level mirroredLevel;   // mirror of the custom Level
        KnownLevel(java.util.logging.Level l) {
            this.levelObject = l;
            if (l.getClass() == java.util.logging.Level.class) {
                this.mirroredLevel = l;
            } else {
                // this mirrored level object is hidden
                this.mirroredLevel = new java.util.logging.Level(l.name, l.value, l.resourceBundleName, false);
            }
        }

        static synchronized void add(java.util.logging.Level l) {
        ...
        static synchronized KnownLevel matches(java.util.logging.Level l) {
            List<KnownLevel> list = nameToLevels.get(l.name);
            if (list != null) {
                for (KnownLevel level : list) {
                    java.util.logging.Level other = level.mirroredLevel;
