...
public abstract class Preferences {
        ...
        try {
            return (PreferencesFactory)
                Class.forName(platformFactory, false,
                              java.util.prefs.Preferences.class.getClassLoader()).newInstance();
        } catch (Exception e) {
            throw new InternalError(
     ...
     */
    public static java.util.prefs.Preferences userNodeForPackage(Class<?> c) {
     ...
     * @see    RuntimePermission
     */
    public static java.util.prefs.Preferences systemNodeForPackage(Class<?> c) {
    ...
    {
        java.util.prefs.XmlSupport.importPreferences(is);
    }
}
