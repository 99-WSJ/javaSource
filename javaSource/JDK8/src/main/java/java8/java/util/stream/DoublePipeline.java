...
abstract class DoublePipeline<E_IN>
        extends java.util.stream.AbstractPipeline<E_IN, Double, DoubleStream>
     ...
     */
    DoublePipeline(java.util.stream.AbstractPipeline<?, E_IN, ?> upstream, int opFlags) {
    ...
    @Override
    final <P_IN> java.util.stream.Node<Double> evaluateToNode(java.util.stream.PipelineHelper<Double> helper,
    ...
    @Override
    final <P_IN> Spliterator<Double> wrap(java.util.stream.PipelineHelper<Double> ph,
                                          Supplier<Spliterator<P_IN>> supplier,
                                          boolean isParallel) {
        return new java.util.stream.StreamSpliterators.DoubleWrappingSpliterator<>(ph, supplier, isParallel);
    }

    @Override
    @SuppressWarnings("unchecked")
    final Spliterator.OfDouble lazySpliterator(Supplier<? extends Spliterator<Double>> supplier) {
        return new java.util.stream.StreamSpliterators.DelegatingSpliterator.OfDouble((Supplier<Spliterator.OfDouble>) supplier);
    }
    ...
    public final <U> Stream<U> mapToObj(DoubleFunction<? extends U> mapper) {
        Objects.requireNonNull(mapper);
        return new java.util.stream.ReferencePipeline.StatelessOp<Double, U>(this, java.util.stream.StreamShape.DOUBLE_VALUE,
                                                            java.util.stream.StreamOpFlag.NOT_SORTED | java.util.stream.StreamOpFlag.NOT_DISTINCT) {
            @Override
     ...
     * @param <E_IN> type of elements in the upstream source
     */
    static class Head<E_IN> extends java.util.stream.DoublePipeline<E_IN> {
        /**
     ...
     * @since 1.8
     */
    abstract static class StatelessOp<E_IN> extends java.util.stream.DoublePipeline<E_IN> {
        /**
     ...
     * @since 1.8
     */
    abstract static class StatefulOp<E_IN> extends java.util.stream.DoublePipeline<E_IN> {
        /**
        ...
        @Override
        abstract <P_IN> java.util.stream.Node<Double> opEvaluateParallel(java.util.stream.PipelineHelper<Double> helper,
                                                                         Spliterator<P_IN> spliterator,
                                                                         IntFunction<Double[]> generator);
    }
}
