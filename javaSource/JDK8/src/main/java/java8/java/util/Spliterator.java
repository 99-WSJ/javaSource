 ...
 * {@link java.util.Spliterator#tryAdvance(Consumer)}
 * and {@link java.util.Spliterator#forEachRemaining(Consumer)} box
 * primitive values to instances of their corresponding wrapper class.  Such
 * boxing may undermine any performance advantages gained by using the primitive
 * specializations.  To avoid boxing, the corresponding primitive-based methods
 * should be used.  For example,
 * {@link java.util.Spliterator.OfInt#tryAdvance(IntConsumer)}
 * and {@link java.util.Spliterator.OfInt#forEachRemaining(IntConsumer)}
 * should be used in preference to
 * {@link java.util.Spliterator.OfInt#tryAdvance(Consumer)} and
 * {@link java.util.Spliterator.OfInt#forEachRemaining(Consumer)}.
...
public interface Spliterator<T> {
     ...
     * @since 1.8
     */
    public interface OfPrimitive<T, T_CONS, T_SPLITR extends java.util.Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
