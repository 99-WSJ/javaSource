...
public final class Currency implements Serializable {
    ...
    private static ConcurrentMap<String, java.util.Currency> instances = new ConcurrentHashMap<>(7);
    private static HashSet<java.util.Currency> available;
    ...
    private static java.util.Currency getInstance(String currencyCode, int defaultFractionDigits,
                                                  int numericCode) {
        // Try to look up the currency code in the instances table.
        // This does the null pointer check as a side effect.
        // Also, if there already is an entry, the currencyCode must be valid.
        java.util.Currency instance = instances.get(currencyCode);
        if (instance != null) {
            return instance;
        }
        ...
        java.util.Currency currencyVal =
            new java.util.Currency(currencyCode, defaultFractionDigits, numericCode);
     ...
     */
    public static java.util.Currency getInstance(Locale locale) {
     ...
     * @since 1.7
     */
    public static Set<java.util.Currency> getAvailableCurrencies() {
        synchronized(java.util.Currency.class) {
            if (available == null) {
        ...
        Set<java.util.Currency> result = (Set<java.util.Currency>) available.clone();
        return result;
    }
