...
public class LogManager {
    ...
    static {
        manager = AccessController.doPrivileged(new PrivilegedAction<java.util.logging.LogManager>() {
            @Override
            public java.util.logging.LogManager run() {
                java.util.logging.LogManager mgr = null;
                String cname = null;
                try {
                    ...
                    if (cname != null) {
                        try {
                            Class<?> clz = ClassLoader.getSystemClassLoader()
                                    .loadClass(cname);
                            mgr = (java.util.logging.LogManager) clz.newInstance();
                ...
                if (mgr == null) {
                    mgr = new java.util.logging.LogManager();
                }
                return mgr;
    ...
    private class Cleaner extends Thread {
        ...
        public void run() {
            ...
            java.util.logging.LogManager mgr = manager;

            // If the global handlers haven't been initialized yet, we
            // don't want to initialize them just so we can close them!
            synchronized (java.util.logging.LogManager.this) {
    ...
    final void ensureLogManagerInitialized() {
        final java.util.logging.LogManager owner = this;
    ...
    class LoggerContext {
        ...
        final java.util.logging.LogManager getOwner() {
            return java.util.logging.LogManager.this;
        }
        ...
        Logger demandLogger(String name, String resourceBundleName) {
            ...
            final java.util.logging.LogManager owner = getOwner();
        ...
        private void ensureDefaultLogger(Logger logger) {
            ...
            if (!requiresDefaultLoggers() || logger == null
                    || logger != Logger.global && logger != java.util.logging.LogManager.this.rootLogger) {
    ...
    public void readConfiguration(InputStream ins) throws IOException, SecurityException {
        ...
        if (listeners != null) {
            ...
            Object ev = Beans.newPropertyChangeEvent(java.util.logging.LogManager.class, null, null, null);
    ...
    private final class RootLogger extends Logger {
        private RootLogger() {
            ...
            super("", null, null, java.util.logging.LogManager.this);
        }
    ...
    public static synchronized LoggingMXBean getLoggingMXBean() {
        if (loggingMXBean == null) {
            loggingMXBean =  new java.util.logging.Logging();
        }
