...
public abstract class Calendar implements Serializable, Cloneable, Comparable<java.util.Calendar> {
    ...
    public static class Builder {
         ...
         * {@code field} is an index to the {@link java.util.Calendar#fields}, such as
        ...
        public Builder setCalendarType(String type) {
            ...
            if (!java.util.Calendar.getAvailableCalendarTypes().contains(type)
                    && !type.equals("iso8601")) {
         ...
         *                       {@link java.util.Calendar#SUNDAY} to {@link java.util.Calendar#SATURDAY}
    ...
    private static java.util.Calendar createCalendar(TimeZone zone,
                                                     Locale aLocale)
    {
    ...
    public boolean equals(Object obj) {
        ...
        try {
            java.util.Calendar that = (java.util.Calendar)obj;
     ...
     * @see     #compareTo(java.util.Calendar)
     */
    public boolean before(Object when) {
        return when instanceof java.util.Calendar
            && compareTo((java.util.Calendar)when) < 0;
    }
    ...
    public int getActualMinimum(int field) {
        ...
        java.util.Calendar work = (java.util.Calendar)this.clone();
    ...
    {
        try {
            java.util.Calendar other = (java.util.Calendar) super.clone();
    ...
    private void invalidateWeekFields()
    {
        ...
        java.util.Calendar cal = (java.util.Calendar) clone();
        cal.setLenient(true);
