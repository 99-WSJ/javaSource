...
final class Nodes {
    ...
    private static abstract class EmptyNode<T, T_ARR, T_CONS> implements Node<T> {
        ...
        private static class OfRef<T> extends java.util.stream.Nodes.EmptyNode<T, T[], Consumer<? super T>> {
            private OfRef() {
                super();
            }
        ...
        private static final class OfInt
                extends java.util.stream.Nodes.EmptyNode<Integer, int[], IntConsumer>
        ...
        private static final class OfLong
                extends java.util.stream.Nodes.EmptyNode<Long, long[], LongConsumer>
        ...
        private static final class OfDouble
                extends java.util.stream.Nodes.EmptyNode<Double, double[], DoubleConsumer>
    ...
    static final class ConcNode<T>
        ...
        @Override
        public Spliterator<T> spliterator() {
            return new java.util.stream.Nodes.InternalNodeSpliterator.OfRef<>(this);
        }
        ...
        public Node<T> truncate(long from, long to, IntFunction<T[]> generator) {
            ...
            if (from >= leftCount)
                ...
                return java.util.stream.Nodes.conc(getShape(), left.truncate(from, leftCount, generator),
    ...
    private static abstract class InternalNodeSpliterator<T,
        ...
        private static final class OfRef<T>
                extends java.util.stream.Nodes.InternalNodeSpliterator<T, Spliterator<T>, Node<T>> {
        ...
        private static abstract class OfPrimitive<T, T_CONS, T_ARR,
                ...
                extends java.util.stream.Nodes.InternalNodeSpliterator<T, T_SPLITR, N>
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>,
                                                     K extends java.util.stream.Nodes.SizedCollectorTask<P_IN, P_OUT, T_SINK, K>>
        ...
        SizedCollectorTask(Spliterator<P_IN> spliterator,
            ...
            this.helper = helper;
            this.targetSize = java.util.stream.AbstractTask.suggestTargetSize(spliterator.estimateSize());
            this.offset = 0;
        ...
        static final class OfRef<P_IN, P_OUT>
                extends java.util.stream.Nodes.SizedCollectorTask<P_IN, P_OUT, Sink<P_OUT>, OfRef<P_IN, P_OUT>>
                implements Sink<P_OUT> {
        ...
        static final class OfInt<P_IN>
                extends java.util.stream.Nodes.SizedCollectorTask<P_IN, Integer, Sink.OfInt, OfInt<P_IN>>
            ...
            OfInt(java.util.stream.Nodes.SizedCollectorTask.OfInt<P_IN> parent, Spliterator<P_IN> spliterator,
                  long offset, long length) {
                super(parent, spliterator, offset, length, parent.array.length);
                this.array = parent.array;
            }
            ...
            @Override
            java.util.stream.Nodes.SizedCollectorTask.OfInt<P_IN> makeChild(Spliterator<P_IN> spliterator,
                                                                            long offset, long size) {
                return new java.util.stream.Nodes.SizedCollectorTask.OfInt<>(this, spliterator, offset, size);
            }
        ...
        static final class OfLong<P_IN>
                extends java.util.stream.Nodes.SizedCollectorTask<P_IN, Long, Sink.OfLong, OfLong<P_IN>>
            ...
            OfLong(java.util.stream.Nodes.SizedCollectorTask.OfLong<P_IN> parent, Spliterator<P_IN> spliterator,
                   long offset, long length) {
                super(parent, spliterator, offset, length, parent.array.length);
                this.array = parent.array;
            }
            ...
            @Override
            java.util.stream.Nodes.SizedCollectorTask.OfLong<P_IN> makeChild(Spliterator<P_IN> spliterator,
                                                                             long offset, long size) {
                return new java.util.stream.Nodes.SizedCollectorTask.OfLong<>(this, spliterator, offset, size);
            }
        ...
        static final class OfDouble<P_IN>
                extends java.util.stream.Nodes.SizedCollectorTask<P_IN, Double, Sink.OfDouble, OfDouble<P_IN>>
            ...
            OfDouble(java.util.stream.Nodes.SizedCollectorTask.OfDouble<P_IN> parent, Spliterator<P_IN> spliterator,
                     long offset, long length) {
                super(parent, spliterator, offset, length, parent.array.length);
                this.array = parent.array;
            }
            ...
            @Override
            java.util.stream.Nodes.SizedCollectorTask.OfDouble<P_IN> makeChild(Spliterator<P_IN> spliterator,
                                                                               long offset, long size) {
                return new java.util.stream.Nodes.SizedCollectorTask.OfDouble<>(this, spliterator, offset, size);
            }
    ...
    private static abstract class ToArrayTask<T, T_NODE extends Node<T>,
                                              K extends java.util.stream.Nodes.ToArrayTask<T, T_NODE, K>>
            extends CountedCompleter<Void> {
        ...
        @SuppressWarnings("serial")
        private static final class OfRef<T>
                extends java.util.stream.Nodes.ToArrayTask<T, Node<T>, OfRef<T>> {
        ...
        private static class OfPrimitive<T, T_CONS, T_ARR,
                ...
                extends java.util.stream.Nodes.ToArrayTask<T, T_NODE, OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>> {
    ...
    private static class CollectorTask<P_IN, P_OUT, T_NODE extends Node<P_OUT>, T_BUILDER extends Node.Builder<P_OUT>>
            extends java.util.stream.AbstractTask<P_IN, P_OUT, T_NODE, CollectorTask<P_IN, P_OUT, T_NODE, T_BUILDER>> {
        protected final PipelineHelper<P_OUT> helper;
        ...
        private static final class OfRef<P_IN, P_OUT>
                extends java.util.stream.Nodes.CollectorTask<P_IN, P_OUT, Node<P_OUT>, Node.Builder<P_OUT>> {
        ...
        private static final class OfInt<P_IN>
                extends java.util.stream.Nodes.CollectorTask<P_IN, Integer, Node.OfInt, Node.Builder.OfInt> {
            OfInt(PipelineHelper<Integer> helper, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, java.util.stream.Nodes::intBuilder, ConcNode.OfInt::new);
            }
        }

        @SuppressWarnings("serial")
        private static final class OfLong<P_IN>
                extends java.util.stream.Nodes.CollectorTask<P_IN, Long, Node.OfLong, Node.Builder.OfLong> {
            OfLong(PipelineHelper<Long> helper, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, java.util.stream.Nodes::longBuilder, ConcNode.OfLong::new);
            }
        }

        @SuppressWarnings("serial")
        private static final class OfDouble<P_IN>
                extends java.util.stream.Nodes.CollectorTask<P_IN, Double, Node.OfDouble, Node.Builder.OfDouble> {
            OfDouble(PipelineHelper<Double> helper, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, java.util.stream.Nodes::doubleBuilder, ConcNode.OfDouble::new);
            }
        }
    }
}
