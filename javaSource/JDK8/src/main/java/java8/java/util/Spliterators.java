...
public final class Spliterators {
    ...
    private static abstract class EmptySpliterator<T, S extends Spliterator<T>, C> {
        ...
        private static final class OfRef<T>
                extends java.util.Spliterators.EmptySpliterator<T, Spliterator<T>, Consumer<? super T>>
                implements Spliterator<T> {
            OfRef() { }
        }

        private static final class OfInt
                extends java.util.Spliterators.EmptySpliterator<Integer, Spliterator.OfInt, IntConsumer>
                implements Spliterator.OfInt {
            OfInt() { }
        }

        private static final class OfLong
                extends java.util.Spliterators.EmptySpliterator<Long, Spliterator.OfLong, LongConsumer>
                implements Spliterator.OfLong {
            OfLong() { }
        }

        private static final class OfDouble
                extends java.util.Spliterators.EmptySpliterator<Double, Spliterator.OfDouble, DoubleConsumer>
