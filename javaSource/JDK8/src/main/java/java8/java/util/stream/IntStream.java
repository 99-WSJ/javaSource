 ...
 * {@link Stream} and {@link java.util.stream.IntStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
...
public interface IntStream extends BaseStream<Integer, java.util.stream.IntStream> {
     ...
     */
    java.util.stream.IntStream filter(IntPredicate predicate);
     ...
     * @return the new stream
     */
    java.util.stream.IntStream map(IntUnaryOperator mapper);
     ...
     */
    java.util.stream.IntStream flatMap(IntFunction<? extends java.util.stream.IntStream> mapper);
     ...
     * @return the new stream
     */
    java.util.stream.IntStream peek(IntConsumer action);
    ...
    public static java.util.stream.IntStream of(int t) {
        return StreamSupport.intStream(new java.util.stream.Streams.IntStreamBuilderImpl(t), false);
    }
     ...
     */
    public static java.util.stream.IntStream iterate(final int seed, final IntUnaryOperator f) {
     ...
     */
    public static java.util.stream.IntStream generate(IntSupplier s) {
        Objects.requireNonNull(s);
        return StreamSupport.intStream(
                new java.util.stream.StreamSpliterators.InfiniteSupplyingSpliterator.OfInt(Long.MAX_VALUE, s), false);
    }
    ...
    public static java.util.stream.IntStream range(int startInclusive, int endExclusive) {
        if (startInclusive >= endExclusive) {
            ...
            return StreamSupport.intStream(
                    new java.util.stream.Streams.RangeIntSpliterator(startInclusive, endExclusive, false), false);
        }
    }
     ...
     *         elements
     */
    public static java.util.stream.IntStream rangeClosed(int startInclusive, int endInclusive) {
        if (startInclusive > endInclusive) {
            return empty();
        } else {
            return StreamSupport.intStream(
                    new java.util.stream.Streams.RangeIntSpliterator(startInclusive, endInclusive, true), false);
        }
    }
     ...
     */
    public static java.util.stream.IntStream concat(java.util.stream.IntStream a, java.util.stream.IntStream b) {
        Objects.requireNonNull(a);
        Objects.requireNonNull(b);

        Spliterator.OfInt split = new java.util.stream.Streams.ConcatSpliterator.OfInt(
                a.spliterator(), b.spliterator());
        java.util.stream.IntStream stream = StreamSupport.intStream(split, a.isParallel() || b.isParallel());
