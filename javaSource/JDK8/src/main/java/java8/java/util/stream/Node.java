...
interface Node<T> {
     ...
     */
    default java.util.stream.Node<T> getChild(int i) {
     ...
     */
    default java.util.stream.Node<T> truncate(long from, long to, IntFunction<T[]> generator) {
        if (from == 0 && to == count())
            return this;
        Spliterator<T> spliterator = spliterator();
        long size = to - from;
        java.util.stream.Node.Builder<T> nodeBuilder = java.util.stream.Nodes.builder(size, generator);
    ...
    interface Builder<T> extends Sink<T> {
         ...
         */
        java.util.stream.Node<T> build();

        /**
         * Specialized @{code Node.Builder} for int elements
         */
        interface OfInt extends java.util.stream.Node.Builder<Integer>, Sink.OfInt {
            @Override
            java.util.stream.Node.OfInt build();
        }

        /**
         * Specialized @{code Node.Builder} for long elements
         */
        interface OfLong extends java.util.stream.Node.Builder<Long>, Sink.OfLong {
            @Override
            java.util.stream.Node.OfLong build();
        }

        /**
         * Specialized @{code Node.Builder} for double elements
         */
        interface OfDouble extends java.util.stream.Node.Builder<Double>, Sink.OfDouble {
            @Override
            java.util.stream.Node.OfDouble build();
        }
    }
    ...
    public interface OfPrimitive<T, T_CONS, T_ARR,
            ...
            extends java.util.stream.Node<T> {
        ...
        default T[] asArray(IntFunction<T[]> generator) {
            ...
            long size = count();
            if (size >= java.util.stream.Nodes.MAX_ARRAY_SIZE)
                throw new IllegalArgumentException(java.util.stream.Nodes.BAD_SIZE);
    ...
    interface OfInt extends OfPrimitive<Integer, IntConsumer, int[], Spliterator.OfInt, OfInt> {
        ...
        default OfInt truncate(long from, long to, IntFunction<Integer[]> generator) {
            ...
            Builder.OfInt nodeBuilder = java.util.stream.Nodes.intBuilder(size);
            nodeBuilder.begin(size);
    ...
    interface OfLong extends OfPrimitive<Long, LongConsumer, long[], Spliterator.OfLong, OfLong> {
        ...
        default OfLong truncate(long from, long to, IntFunction<Long[]> generator) {
            ...
            Builder.OfLong nodeBuilder = java.util.stream.Nodes.longBuilder(size);
            nodeBuilder.begin(size);
    ...
    interface OfDouble extends OfPrimitive<Double, DoubleConsumer, double[], Spliterator.OfDouble, OfDouble> {
        ...
        default OfDouble truncate(long from, long to, IntFunction<Double[]> generator) {
            ...
            Builder.OfDouble nodeBuilder = java.util.stream.Nodes.doubleBuilder(size);
            nodeBuilder.begin(size);
