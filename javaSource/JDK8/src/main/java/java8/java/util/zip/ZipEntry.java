 ...
 */
public
class ZipEntry implements java.util.zip.ZipConstants, Cloneable {
     ...
     * @since 1.8
     */
    public java.util.zip.ZipEntry setLastModifiedTime(FileTime time) {
     ...
     * @since 1.8
     */
    public java.util.zip.ZipEntry setLastAccessTime(FileTime time) {
        Objects.requireNonNull(name, "time");
        this.atime = time;
        return this;
    }
     ...
     * @since 1.8
     */
    public java.util.zip.ZipEntry setCreationTime(FileTime time) {
        Objects.requireNonNull(name, "time");
        this.ctime = time;
        return this;
    }
    ...
    public Object clone() {
        try {
            java.util.zip.ZipEntry e = (java.util.zip.ZipEntry)super.clone();
