...
public class Logger {
    ...
    private volatile java.util.logging.Logger parent;    // our nearest parent.
     ...
     */
    @Deprecated
    public static final java.util.logging.Logger global = new java.util.logging.Logger(GLOBAL_LOGGER_NAME);
    ...
    private static java.util.logging.Logger demandLogger(String name, String resourceBundleName, Class<?> caller) {
    ...
    public static java.util.logging.Logger getLogger(String name, String resourceBundleName) {
        ...
        java.util.logging.Logger result = demandLogger(name, resourceBundleName, callerClass);
    ...
    static java.util.logging.Logger getPlatformLogger(String name) {
        ...
        java.util.logging.Logger result = manager.demandSystemLogger(name, SYSTEM_LOGGER_RB_NAME);
        return result;
    }
    ...
    public static java.util.logging.Logger getAnonymousLogger(String resourceBundleName) {
        ...
        java.util.logging.Logger result = new java.util.logging.Logger(null, resourceBundleName,
     ...
     * java.util.logging.Logger#getLogger(String, String) getLogger} factory
        ...
        synchronized (treeLock) {
            ...
            if (parent != null) {
                ...
                for (Iterator<LogManager.LoggerWeakRef> iter = parent.kids.iterator(); iter.hasNext(); ) {
                    ref = iter.next();
                    java.util.logging.Logger kid =  ref.get();
                    if (kid == this) {
    ...
    private LoggerBundle getEffectiveLoggerBundle() {
        ...
        // parent stack.
        java.util.logging.Logger target = this.parent;
        while (target != null) {
