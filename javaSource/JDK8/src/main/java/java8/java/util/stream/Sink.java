...
interface Sink<T> extends Consumer<T> {
     ...
     * {@code accept(int)}.
     */
    interface OfInt extends java.util.stream.Sink<Integer>, IntConsumer {
        @Override
        ...
        default void accept(Integer i) {
            if (java.util.stream.Tripwire.ENABLED)
                java.util.stream.Tripwire.trip(getClass(), "{0} calling Sink.OfInt.accept(Integer)");
            accept(i.intValue());
        }
    }
     ...
     * {@code accept(long)}.
     */
    interface OfLong extends java.util.stream.Sink<Long>, LongConsumer {
        @Override
        ...
        default void accept(Long i) {
            if (java.util.stream.Tripwire.ENABLED)
                java.util.stream.Tripwire.trip(getClass(), "{0} calling Sink.OfLong.accept(Long)");
            accept(i.longValue());
        }
    }
     ...
     * {@code accept(double)}.
     */
    interface OfDouble extends java.util.stream.Sink<Double>, DoubleConsumer {
        @Override
        ...
        default void accept(Double i) {
            if (java.util.stream.Tripwire.ENABLED)
                java.util.stream.Tripwire.trip(getClass(), "{0} calling Sink.OfDouble.accept(Double)");
     ...
     */
    static abstract class ChainedReference<T, E_OUT> implements java.util.stream.Sink<T> {
        protected final java.util.stream.Sink<? super E_OUT> downstream;

        public ChainedReference(java.util.stream.Sink<? super E_OUT> downstream) {
     ...
     * {@code accept()} method on the downstream {@code Sink}.
     */
    static abstract class ChainedInt<E_OUT> implements java.util.stream.Sink.OfInt {
        protected final java.util.stream.Sink<? super E_OUT> downstream;

        public ChainedInt(java.util.stream.Sink<? super E_OUT> downstream) {
            this.downstream = Objects.requireNonNull(downstream);
        }
     ...
     * {@code accept()} method on the downstream {@code Sink}.
     */
    static abstract class ChainedLong<E_OUT> implements java.util.stream.Sink.OfLong {
        protected final java.util.stream.Sink<? super E_OUT> downstream;

        public ChainedLong(java.util.stream.Sink<? super E_OUT> downstream) {
            this.downstream = Objects.requireNonNull(downstream);
        }
     ...
     * {@code accept()} method on the downstream {@code Sink}.
     */
    static abstract class ChainedDouble<E_OUT> implements java.util.stream.Sink.OfDouble {
        protected final java.util.stream.Sink<? super E_OUT> downstream;

        public ChainedDouble(java.util.stream.Sink<? super E_OUT> downstream) {
            this.downstream = Objects.requireNonNull(downstream);
        }
