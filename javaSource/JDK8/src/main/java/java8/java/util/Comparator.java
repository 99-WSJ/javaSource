 ...
 * Arrays#sort(Object[], java.util.Comparator) Arrays.sort}) to allow precise control
...
public interface Comparator<T> {
     ...
     * @see #comparing(Function, java.util.Comparator)
     * @see #thenComparing(java.util.Comparator)
     * @since 1.8
     */
     ...
     * @since 1.8
     */
    default <U extends Comparable<? super U>> java.util.Comparator<T> thenComparing(
            Function<? super T, ? extends U> keyExtractor)
    {
     ...
     * the specified {@link java.util.Comparator}.
      *
