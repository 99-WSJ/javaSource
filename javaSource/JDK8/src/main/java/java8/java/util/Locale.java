 ...
 * {@link java.util.Locale.FilteringMode} is a parameter to specify how filtering should
 * be done.
 *
 * <h5>Lookup</h5>
 *
...
public final class Locale implements Cloneable, Serializable {
     ...
     */
    static public final java.util.Locale ENGLISH = createConstant("en", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale FRENCH = createConstant("fr", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale GERMAN = createConstant("de", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale ITALIAN = createConstant("it", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale JAPANESE = createConstant("ja", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale KOREAN = createConstant("ko", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale CHINESE = createConstant("zh", "");

    /** Useful constant for language.
     */
    static public final java.util.Locale SIMPLIFIED_CHINESE = createConstant("zh", "CN");

    /** Useful constant for language.
     */
    static public final java.util.Locale TRADITIONAL_CHINESE = createConstant("zh", "TW");

    /** Useful constant for country.
     */
    static public final java.util.Locale FRANCE = createConstant("fr", "FR");

    /** Useful constant for country.
     */
    static public final java.util.Locale GERMANY = createConstant("de", "DE");

    /** Useful constant for country.
     */
    static public final java.util.Locale ITALY = createConstant("it", "IT");

    /** Useful constant for country.
     */
    static public final java.util.Locale JAPAN = createConstant("ja", "JP");

    /** Useful constant for country.
     */
    static public final java.util.Locale KOREA = createConstant("ko", "KR");

    /** Useful constant for country.
     */
    static public final java.util.Locale CHINA = SIMPLIFIED_CHINESE;

    /** Useful constant for country.
     */
    static public final java.util.Locale PRC = SIMPLIFIED_CHINESE;

    /** Useful constant for country.
     */
    static public final java.util.Locale TAIWAN = TRADITIONAL_CHINESE;

    /** Useful constant for country.
     */
    static public final java.util.Locale UK = createConstant("en", "GB");

    /** Useful constant for country.
     */
    static public final java.util.Locale US = createConstant("en", "US");

    /** Useful constant for country.
     */
    static public final java.util.Locale CANADA = createConstant("en", "CA");

    /** Useful constant for country.
     */
    static public final java.util.Locale CANADA_FRENCH = createConstant("fr", "CA");
     ...
     * @since 1.6
     */
    static public final java.util.Locale ROOT = createConstant("", "");
     ...
     */
    private static java.util.Locale createConstant(String lang, String country) {
    ...
    static java.util.Locale getInstance(String language, String script, String country,
    ...
    static java.util.Locale getInstance(BaseLocale baseloc, LocaleExtensions extensions) {
        LocaleKey key = new LocaleKey(baseloc, extensions);
        return LOCALECACHE.get(key);
    }

    private static class Cache extends LocaleObjectCache<LocaleKey, java.util.Locale> {
        private Cache() {
        }

        @Override
        protected java.util.Locale createObject(LocaleKey key) {
     ...
     *     of the Java Virtual Machine
     * @see #setDefault(java.util.Locale.Category, java.util.Locale)
     * @since 1.7
     */
     ...
     * @see PropertyPermission
     * @see #getDefault(java.util.Locale.Category)
     * @since 1.7
     */
    public static synchronized void setDefault(java.util.Locale.Category category,
     ...
     * to {@link java.util.Locale.Builder#setLanguageTag} which throws an exception
     * in this case.
     *
     ...
     */
    public String getDisplayLanguage(java.util.Locale inLocale) {
     ...
     * @exception NullPointerException if <code>inLocale</code> is <code>null</code>
     */
    public String getDisplayCountry(java.util.Locale inLocale) {
        return getDisplayString(baseLocale.getRegion(), inLocale, DISPLAY_COUNTRY);
    }

    private String getDisplayString(String code, java.util.Locale inLocale, int type) {
        if (code.length() == 0) {
            return "";
        }
     ...
     * @exception NullPointerException if <code>inLocale</code> is <code>null</code>
     */
    public String getDisplayVariant(java.util.Locale inLocale) {
     ...
     * @throws NullPointerException if <code>inLocale</code> is <code>null</code>
     */
    public String getDisplayName(java.util.Locale inLocale) {
        LocaleResources lr =  LocaleProviderAdapter.forJRE().getLocaleResources(inLocale);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof java.util.Locale))
            return false;
        BaseLocale otherBase = ((java.util.Locale)obj).baseLocale;
    ...
    private volatile static java.util.Locale defaultLocale = initDefault();
    private volatile static java.util.Locale defaultDisplayLocale = null;
    private volatile static java.util.Locale defaultFormatLocale = null;
     ...
     */
    private String[] getDisplayVariantArray(java.util.Locale inLocale) {
    ...
    public static final class Builder {
         ...
         *
         * <p>All fields of the locale must be well-formed, see {@link java.util.Locale}.
         *
         ...
         * java.util.Locale#forLanguageTag}) are converted to their canonical
         * form before being processed.  Otherwise, the language tag
         * must be well-formed (see {@link java.util.Locale}) or an exception is
         ...
         * is thrown.
         *
         * <p><b>Note:</b> The key {@link java.util.Locale#UNICODE_LOCALE_EXTENSION
         * UNICODE_LOCALE_EXTENSION} ('u') is used for the Unicode locale extension.
         * Setting a value for this key replaces any existing Unicode locale key/type
         * pairs with those defined in the extension.
         *
         * <p><b>Note:</b> The key {@link java.util.Locale#PRIVATE_USE_EXTENSION
         ...
         * on this builder.
         *
         * <p>This applies the conversions listed in {@link java.util.Locale#forLanguageTag}
     ...
     * @since 1.8
     */
    public static List<java.util.Locale> filter(List<LanguageRange> priorityList,
                                                Collection<java.util.Locale> locales,
                                                FilteringMode mode) {
     ...
     * @since 1.8
     */
    public static java.util.Locale lookup(List<LanguageRange> priorityList,
                                          Collection<java.util.Locale> locales) {
