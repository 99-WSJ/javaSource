    ...
    implements Cloneable, java.io.Serializable
{
     ...
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> copyOf(java.util.EnumSet<E> s) {
        return s.clone();
    }
     ...
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> copyOf(Collection<E> c) {
     ...
     * @throws NullPointerException if <tt>s</tt> is null
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> complementOf(java.util.EnumSet<E> s) {
        java.util.EnumSet<E> result = copyOf(s);
        result.complement();
        return result;
    }
     ...
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> of(E e) {
        java.util.EnumSet<E> result = noneOf(e.getDeclaringClass());
        result.add(e);
        return result;
    }
     ...
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> of(E e1, E e2) {
        java.util.EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        return result;
    }
     ...
     * @return an enum set initially containing the specified elements
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> of(E e1, E e2, E e3) {
        java.util.EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        result.add(e3);
     ...
     * @return an enum set initially containing the specified elements
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> of(E e1, E e2, E e3, E e4) {
        java.util.EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        result.add(e3);
     ...
     */
    @SafeVarargs
    public static <E extends Enum<E>> java.util.EnumSet<E> of(E first, E... rest) {
        java.util.EnumSet<E> result = noneOf(first.getDeclaringClass());
        result.add(first);
        for (E e : rest)
            result.add(e);
        return result;
     ...
     */
    public static <E extends Enum<E>> java.util.EnumSet<E> range(E from, E to) {
        if (from.compareTo(to) > 0)
            throw new IllegalArgumentException(from + " > " + to);
        java.util.EnumSet<E> result = noneOf(from.getDeclaringClass());
