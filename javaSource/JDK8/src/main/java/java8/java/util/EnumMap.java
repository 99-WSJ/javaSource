    ...
    implements java.io.Serializable, Cloneable
{
    ...
    public EnumMap(Map<K, ? extends V> m) {
        if (m instanceof java.util.EnumMap) {
            java.util.EnumMap<K, ? extends V> em = (java.util.EnumMap<K, ? extends V>) m;
            keyType = em.keyType;
    ...
    public void putAll(Map<? extends K, ? extends V> m) {
        if (m instanceof java.util.EnumMap) {
            java.util.EnumMap<?, ?> em = (java.util.EnumMap<?, ?>)m;
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            int oldSize = size;
            java.util.EnumMap.this.remove(o);
            return size != oldSize;
        }
        public void clear() {
            java.util.EnumMap.this.clear();
        }
    }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (o instanceof java.util.EnumMap)
            return equals((java.util.EnumMap<?,?>)o);
        if (!(o instanceof Map))
            return false;
    ...
    public java.util.EnumMap<K, V> clone() {
        java.util.EnumMap<K, V> result = null;
        try {
            result = (java.util.EnumMap<K, V>) super.clone();
