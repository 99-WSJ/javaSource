...
class JapaneseImperialCalendar extends Calendar {
    ...
    public boolean equals(Object obj) {
        return obj instanceof java.util.JapaneseImperialCalendar &&
            super.equals(obj);
    }
    ...
    public int getActualMinimum(int field) {
        ...
        int value = 0;
        java.util.JapaneseImperialCalendar jc = getNormalizedCalendar();
        ...
        case WEEK_OF_YEAR:
            {
                ...
                if (jc == this) {
                    jc = (java.util.JapaneseImperialCalendar) jc.clone();
                }
    ...
    public Object clone() {
        java.util.JapaneseImperialCalendar other = (java.util.JapaneseImperialCalendar) super.clone();
    ...
    private java.util.JapaneseImperialCalendar getNormalizedCalendar() {
        java.util.JapaneseImperialCalendar jc;
        if (isFullyNormalized()) {
            jc = this;
        } else {
            // Create a clone and normalize the calendar fields
            jc = (java.util.JapaneseImperialCalendar) this.clone();
            jc.setLenient(true);
            jc.complete();
        }
        return jc;
