 ...
 * {@link Stream#collect(java.util.stream.Collector)}, must adhere to the following constraints:
 * <ul>
 ...
 * {@link Collectors#groupingBy(Function, java.util.stream.Collector)}:
 *
 * <pre>{@code
...
public interface Collector<T, A, R> {
     ...
     * @return the new {@code Collector}
     */
    public static<T, A, R> java.util.stream.Collector<T, A, R> of(Supplier<A> supplier,
                                                                  BiConsumer<A, T> accumulator,
                                                                  BinaryOperator<A> combiner,
                                                                  Function<A, R> finisher,
                                                                  Characteristics... characteristics) {
