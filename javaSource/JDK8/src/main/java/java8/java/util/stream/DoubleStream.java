 ...
 * {@link Stream} and {@link java.util.stream.DoubleStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
...
public interface DoubleStream extends BaseStream<Double, java.util.stream.DoubleStream> {
     ...
     */
    java.util.stream.DoubleStream filter(DoublePredicate predicate);
     ...
     * @return the new stream
     */
    java.util.stream.DoubleStream map(DoubleUnaryOperator mapper);
     ...
     */
    java.util.stream.DoubleStream flatMap(DoubleFunction<? extends java.util.stream.DoubleStream> mapper);
     ...
     * @return the new stream
     */
    java.util.stream.DoubleStream peek(DoubleConsumer action);
    ...
    public static Builder builder() {
        return new java.util.stream.Streams.DoubleStreamBuilderImpl();
    }
    ...
    public static java.util.stream.DoubleStream of(double t) {
        return StreamSupport.doubleStream(new java.util.stream.Streams.DoubleStreamBuilderImpl(t), false);
    }
     ...
     */
    public static java.util.stream.DoubleStream iterate(final double seed, final DoubleUnaryOperator f) {
     ...
     */
    public static java.util.stream.DoubleStream generate(DoubleSupplier s) {
        Objects.requireNonNull(s);
        return StreamSupport.doubleStream(
                new java.util.stream.StreamSpliterators.InfiniteSupplyingSpliterator.OfDouble(Long.MAX_VALUE, s), false);
    }
     ...
     */
    public static java.util.stream.DoubleStream concat(java.util.stream.DoubleStream a, java.util.stream.DoubleStream b) {
        Objects.requireNonNull(a);
        Objects.requireNonNull(b);

        Spliterator.OfDouble split = new java.util.stream.Streams.ConcatSpliterator.OfDouble(
                a.spliterator(), b.spliterator());
        java.util.stream.DoubleStream stream = StreamSupport.doubleStream(split, a.isParallel() || b.isParallel());
     ...
     *
     * @see java.util.stream.DoubleStream#builder()
     * @since 1.8
     */
