...
public abstract class AbstractPreferences extends Preferences {
     ...
     * Our root node.
     */
    private final java.util.prefs.AbstractPreferences root; // Relative to this node
     ...
     */
    private Map<String, java.util.prefs.AbstractPreferences> kidCache = new HashMap<>();
    ...
    public void putByteArray(String key, byte[] value) {
        put(key, java.util.prefs.Base64.byteArrayToBase64(value));
    }
    ...
    public byte[] getByteArray(String key, byte[] def) {
        ...
        try {
            if (value != null)
                result = java.util.prefs.Base64.base64ToByteArray(value);
        }
    ...
    private static final java.util.prefs.AbstractPreferences[] EMPTY_ABSTRACT_PREFS_ARRAY
        = new java.util.prefs.AbstractPreferences[0];
    ...
    private Preferences node(StringTokenizer path) {
        ...
        synchronized(lock) {
            java.util.prefs.AbstractPreferences child = kidCache.get(token);
            if (child == null) {
    ...
    private void removeNode2() throws BackingStoreException {
        synchronized(lock) {
            ...
            for (Iterator<java.util.prefs.AbstractPreferences> i = kidCache.values().iterator();
                 i.hasNext();) {
                try {
                    i.next().removeNode2();
                    i.remove();
     ...
     *         communicate with it.
     */
    protected java.util.prefs.AbstractPreferences getChild(String nodeName)
            throws BackingStoreException {
        synchronized(lock) {
     ...
     */
    protected abstract java.util.prefs.AbstractPreferences childSpi(String name);
    ...
    private void sync2() throws BackingStoreException {
        java.util.prefs.AbstractPreferences[] cachedKids;
    ...
    private static class EventDispatchThread extends Thread {
        public void run() {
            while(true) {
                ...
                java.util.prefs.AbstractPreferences src=(java.util.prefs.AbstractPreferences)event.getSource();
