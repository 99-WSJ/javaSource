...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    static final class AsyncRun extends Async {
        final Runnable fn;
        final java.util.concurrent.CompletableFuture<Void> dst;
        AsyncRun(Runnable fn, java.util.concurrent.CompletableFuture<Void> dst) {
            this.fn = fn; this.dst = dst;
        }
        public final boolean exec() {
            java.util.concurrent.CompletableFuture<Void> d; Throwable ex;
    ...
    static final class AsyncSupply<U> extends Async {
        final Supplier<U> fn;
        final java.util.concurrent.CompletableFuture<U> dst;
        AsyncSupply(Supplier<U> fn, java.util.concurrent.CompletableFuture<U> dst) {
            this.fn = fn; this.dst = dst;
        }
        public final boolean exec() {
            java.util.concurrent.CompletableFuture<U> d; U u; Throwable ex;
            if ((d = this.dst) != null && d.result == null) {
                try {
                    u = fn.get();
                    ex = null;
    ...
    static final class AsyncApply<T,U> extends Async {
        ...
        AsyncApply(T arg, Function<? super T,? extends U> fn,
                   java.util.concurrent.CompletableFuture<U> dst) {
    ...
    static final class AsyncCombine<T,U,V> extends Async {
        ...
        final java.util.concurrent.CompletableFuture<V> dst;
        AsyncCombine(T arg1, U arg2,
                     BiFunction<? super T,? super U,? extends V> fn,
                     java.util.concurrent.CompletableFuture<V> dst) {
            this.arg1 = arg1; this.arg2 = arg2; this.fn = fn; this.dst = dst;
        }
        public final boolean exec() {
            java.util.concurrent.CompletableFuture<V> d; V v; Throwable ex;
            if ((d = this.dst) != null && d.result == null) {
                try {
    ...
    static final class AsyncAccept<T> extends Async {
        ...
        final java.util.concurrent.CompletableFuture<?> dst;
        AsyncAccept(T arg, Consumer<? super T> fn,
                    java.util.concurrent.CompletableFuture<?> dst) {
            this.arg = arg; this.fn = fn; this.dst = dst;
        }
        public final boolean exec() {
            java.util.concurrent.CompletableFuture<?> d; Throwable ex;
            if ((d = this.dst) != null && d.result == null) {
                try {
                    fn.accept(arg);
                    ex = null;
    ...
    static final class AsyncCompose<T,U> extends Async {
        ...
        public final boolean exec() {
            java.util.concurrent.CompletableFuture<U> d, fr; U u; Throwable ex;
            if ((d = this.dst) != null && d.result == null) {
                try {
    ...
    static final class AsyncWhenComplete<T> extends Async {
        ...
        final java.util.concurrent.CompletableFuture<T> dst;
        AsyncWhenComplete(T arg1, Throwable arg2,
                          BiConsumer<? super T,? super Throwable> fn,
                          java.util.concurrent.CompletableFuture<T> dst) {
            this.arg1 = arg1; this.arg2 = arg2; this.fn = fn; this.dst = dst;
        }
        public final boolean exec() {
            java.util.concurrent.CompletableFuture<T> d;
            if ((d = this.dst) != null && d.result == null) {
                Throwable ex = arg2;
                try {
                    fn.accept(arg1, ex);
    ...
    static final class ThenApply<T,U> extends Completion {
        final java.util.concurrent.CompletableFuture<? extends T> src;
        final Function<? super T,? extends U> fn;
        final java.util.concurrent.CompletableFuture<U> dst;
        final Executor executor;
        ThenApply(java.util.concurrent.CompletableFuture<? extends T> src,
        ...
        public final void run() {
            final java.util.concurrent.CompletableFuture<? extends T> a;
            final Function<? super T,? extends U> fn;
            final java.util.concurrent.CompletableFuture<U> dst;
    ...
    static final class ThenAccept<T> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<?> dst;
        final Executor executor;
        ThenAccept(java.util.concurrent.CompletableFuture<? extends T> src,
                   Consumer<? super T> fn,
                   java.util.concurrent.CompletableFuture<?> dst,
                   Executor executor) {
            this.src = src; this.fn = fn; this.dst = dst;
    ...
    static final class ThenRun extends Completion {
        final java.util.concurrent.CompletableFuture<?> src;
        final Runnable fn;
        final java.util.concurrent.CompletableFuture<Void> dst;
        final Executor executor;
        ThenRun(java.util.concurrent.CompletableFuture<?> src,
                Runnable fn,
                java.util.concurrent.CompletableFuture<Void> dst,
                Executor executor) {
            this.src = src; this.fn = fn; this.dst = dst;
            this.executor = executor;
        }
        public final void run() {
            final java.util.concurrent.CompletableFuture<?> a;
            final Runnable fn;
            final java.util.concurrent.CompletableFuture<Void> dst;
    ...
    static final class ThenCombine<T,U,V> extends Completion {
        final java.util.concurrent.CompletableFuture<? extends T> src;
        final java.util.concurrent.CompletableFuture<? extends U> snd;
        final BiFunction<? super T,? super U,? extends V> fn;
        final java.util.concurrent.CompletableFuture<V> dst;
        final Executor executor;
        ThenCombine(java.util.concurrent.CompletableFuture<? extends T> src,
                    java.util.concurrent.CompletableFuture<? extends U> snd,
                    BiFunction<? super T,? super U,? extends V> fn,
                    java.util.concurrent.CompletableFuture<V> dst,
                    Executor executor) {
        ...
        public final void run() {
            final java.util.concurrent.CompletableFuture<? extends T> a;
            final java.util.concurrent.CompletableFuture<? extends U> b;
            final BiFunction<? super T,? super U,? extends V> fn;
            final java.util.concurrent.CompletableFuture<V> dst;
    ...
    static final class ThenAcceptBoth<T,U> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<Void> dst;
        final Executor executor;
        ThenAcceptBoth(java.util.concurrent.CompletableFuture<? extends T> src,
                       java.util.concurrent.CompletableFuture<? extends U> snd,
                       BiConsumer<? super T,? super U> fn,
                       java.util.concurrent.CompletableFuture<Void> dst,
                       Executor executor) {
    ...
    static final class RunAfterBoth extends Completion {
        final java.util.concurrent.CompletableFuture<?> src;
        final java.util.concurrent.CompletableFuture<?> snd;
        final Runnable fn;
        final java.util.concurrent.CompletableFuture<Void> dst;
        final Executor executor;
        RunAfterBoth(java.util.concurrent.CompletableFuture<?> src,
        ...
        public final void run() {
            final java.util.concurrent.CompletableFuture<?> a;
            final java.util.concurrent.CompletableFuture<?> b;
            final Runnable fn;
            final java.util.concurrent.CompletableFuture<Void> dst;
    ...
    static final class AndCompletion extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<?> snd;
        final java.util.concurrent.CompletableFuture<Void> dst;
        AndCompletion(java.util.concurrent.CompletableFuture<?> src,
                      java.util.concurrent.CompletableFuture<?> snd,
                      java.util.concurrent.CompletableFuture<Void> dst) {
    ...
    static final class ApplyToEither<T,U> extends Completion {
        final java.util.concurrent.CompletableFuture<? extends T> src;
        final java.util.concurrent.CompletableFuture<? extends T> snd;
        final Function<? super T,? extends U> fn;
        final java.util.concurrent.CompletableFuture<U> dst;
        final Executor executor;
        ApplyToEither(java.util.concurrent.CompletableFuture<? extends T> src,
                      java.util.concurrent.CompletableFuture<? extends T> snd,
                      Function<? super T,? extends U> fn,
                      java.util.concurrent.CompletableFuture<U> dst,
                      Executor executor) {
            this.src = src; this.snd = snd;
        ...
        public final void run() {
            final java.util.concurrent.CompletableFuture<? extends T> a;
            final java.util.concurrent.CompletableFuture<? extends T> b;
            final Function<? super T,? extends U> fn;
            final java.util.concurrent.CompletableFuture<U> dst;
            Object r; T t; Throwable ex;
            if ((dst = this.dst) != null &&
    ...
    static final class AcceptEither<T> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<Void> dst;
        final Executor executor;
        AcceptEither(java.util.concurrent.CompletableFuture<? extends T> src,
                     java.util.concurrent.CompletableFuture<? extends T> snd,
                     Consumer<? super T> fn,
                     java.util.concurrent.CompletableFuture<Void> dst,
                     Executor executor) {
    ...
    static final class RunAfterEither extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<Void> dst;
        final Executor executor;
        RunAfterEither(java.util.concurrent.CompletableFuture<?> src,
                       java.util.concurrent.CompletableFuture<?> snd,
                       Runnable fn,
                       java.util.concurrent.CompletableFuture<Void> dst,
                       Executor executor) {
    ...
    static final class OrCompletion extends Completion {
        final java.util.concurrent.CompletableFuture<?> src;
        final java.util.concurrent.CompletableFuture<?> snd;
        final java.util.concurrent.CompletableFuture<Object> dst;
        OrCompletion(java.util.concurrent.CompletableFuture<?> src,
                     java.util.concurrent.CompletableFuture<?> snd,
                     java.util.concurrent.CompletableFuture<Object> dst) {
            this.src = src; this.snd = snd; this.dst = dst;
        }
        public final void run() {
            final java.util.concurrent.CompletableFuture<?> a;
    ...
    static final class ExceptionCompletion<T> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<T> dst;
        ExceptionCompletion(java.util.concurrent.CompletableFuture<? extends T> src,
    ...
    static final class WhenCompleteCompletion<T> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<T> dst;
        final Executor executor;
        WhenCompleteCompletion(java.util.concurrent.CompletableFuture<? extends T> src,
                               BiConsumer<? super T, ? super Throwable> fn,
                               java.util.concurrent.CompletableFuture<T> dst,
                               Executor executor) {
            this.src = src; this.fn = fn; this.dst = dst;
    ...
    static final class ThenCopy<T> extends Completion {
        final java.util.concurrent.CompletableFuture<?> src;
        final java.util.concurrent.CompletableFuture<T> dst;
        ThenCopy(java.util.concurrent.CompletableFuture<?> src,
                 java.util.concurrent.CompletableFuture<T> dst) {
    ...
    static final class ThenPropagate extends Completion {
        final java.util.concurrent.CompletableFuture<?> src;
        final java.util.concurrent.CompletableFuture<Void> dst;
        ThenPropagate(java.util.concurrent.CompletableFuture<?> src,
                      java.util.concurrent.CompletableFuture<Void> dst) {
            this.src = src; this.dst = dst;
        }
        public final void run() {
    ...
    static final class HandleCompletion<T,U> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<U> dst;
        final Executor executor;
        HandleCompletion(java.util.concurrent.CompletableFuture<? extends T> src,
    ...
    static final class ThenCompose<T,U> extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<U> dst;
        final Executor executor;
        ThenCompose(java.util.concurrent.CompletableFuture<? extends T> src,
                    Function<? super T, ? extends CompletionStage<U>> fn,
                    java.util.concurrent.CompletableFuture<U> dst,
                    Executor executor) {
            this.src = src; this.fn = fn; this.dst = dst;
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null &&
                ...
                java.util.concurrent.CompletableFuture<U> c = null;
                U u = null;
    ...
    private <U> java.util.concurrent.CompletableFuture<U> doThenApply
        (Function<? super T,? extends U> fn,
         Executor e) {
        if (fn == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<U> dst = new java.util.concurrent.CompletableFuture<U>();
    ...
    private java.util.concurrent.CompletableFuture<Void> doThenAccept(Consumer<? super T> fn,
                                                                      Executor e) {
        if (fn == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<Void> dst = new java.util.concurrent.CompletableFuture<Void>();
        ThenAccept<T> d = null;
        Object r;
        if ((r = result) == null) {
            CompletionNode p = new CompletionNode
    ...
    private java.util.concurrent.CompletableFuture<Void> doThenRun(Runnable action,
                                                                   Executor e) {
    ...
    private <U,V> java.util.concurrent.CompletableFuture<V> doThenCombine
        (java.util.concurrent.CompletableFuture<? extends U> other,
         BiFunction<? super T,? super U,? extends V> fn,
         Executor e) {
        if (other == null || fn == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<V> dst = new java.util.concurrent.CompletableFuture<V>();
    ...
    private <U> java.util.concurrent.CompletableFuture<Void> doThenAcceptBoth
        (java.util.concurrent.CompletableFuture<? extends U> other,
         BiConsumer<? super T,? super U> fn,
         Executor e) {
        if (other == null || fn == null) throw new NullPointerException();
    ...
    private java.util.concurrent.CompletableFuture<Void> doRunAfterBoth(java.util.concurrent.CompletableFuture<?> other,
                                                                        Runnable action,
                                                                        Executor e) {
    ...
    private <U> java.util.concurrent.CompletableFuture<U> doApplyToEither
        (java.util.concurrent.CompletableFuture<? extends T> other,
    ...
    private java.util.concurrent.CompletableFuture<Void> doAcceptEither
        (java.util.concurrent.CompletableFuture<? extends T> other,
         Consumer<? super T> fn,
         Executor e) {
        if (other == null || fn == null) throw new NullPointerException();
    ...
    private java.util.concurrent.CompletableFuture<Void> doRunAfterEither
    ...
    private <U> java.util.concurrent.CompletableFuture<U> doThenCompose
        (Function<? super T, ? extends CompletionStage<U>> fn,
         Executor e) {
        if (fn == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<U> dst = null;
        ThenCompose<T,U> d = null;
        Object r;
        if ((r = result) == null) {
            dst = new java.util.concurrent.CompletableFuture<U>();
            CompletionNode p = new CompletionNode
    ...
    private java.util.concurrent.CompletableFuture<T> doWhenComplete
        (BiConsumer<? super T, ? super Throwable> fn,
         Executor e) {
        if (fn == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<T> dst = new java.util.concurrent.CompletableFuture<T>();
    ...
    private <U> java.util.concurrent.CompletableFuture<U> doHandle
        (BiFunction<? super T, Throwable, ? extends U> fn,
         Executor e) {
        if (fn == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<U> dst = new java.util.concurrent.CompletableFuture<U>();
    ...
    public static <U> java.util.concurrent.CompletableFuture<U> supplyAsync(Supplier<U> supplier) {
        ...
        java.util.concurrent.CompletableFuture<U> f = new java.util.concurrent.CompletableFuture<U>();
    ...
    public static java.util.concurrent.CompletableFuture<Void> runAsync(Runnable runnable) {
        ...
        java.util.concurrent.CompletableFuture<Void> f = new java.util.concurrent.CompletableFuture<Void>();
    ...
    public java.util.concurrent.CompletableFuture<Void> thenAccept
    ...
    public java.util.concurrent.CompletableFuture<Void> thenRun
        (Runnable action) {
     ...
     */
    private static java.util.concurrent.CompletableFuture<Void> allTree(java.util.concurrent.CompletableFuture<?>[] cfs,
                                                                        int lo, int hi) {
        java.util.concurrent.CompletableFuture<?> fst, snd;
        int mid = (lo + hi) >>> 1;
    ...
    public static java.util.concurrent.CompletableFuture<Object> anyOf(java.util.concurrent.CompletableFuture<?>... cfs) {
        ...
        if (len > 1)
            ...
            java.util.concurrent.CompletableFuture<Object> dst = new java.util.concurrent.CompletableFuture<Object>();
            java.util.concurrent.CompletableFuture<?> f;
            if (len == 0)
                ; // skip
            else if ((f = cfs[0]) == null)
     ...
     */
    private static java.util.concurrent.CompletableFuture<Object> anyTree(java.util.concurrent.CompletableFuture<?>[] cfs,
                                                                          int lo, int hi) {
        java.util.concurrent.CompletableFuture<?> fst, snd;
        int mid = (lo + hi) >>> 1;
