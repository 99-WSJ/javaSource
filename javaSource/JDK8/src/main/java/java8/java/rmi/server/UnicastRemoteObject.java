...
public class UnicastRemoteObject extends RemoteServer {
    ...
    {
        try {
            java.rmi.server.UnicastRemoteObject cloned = (java.rmi.server.UnicastRemoteObject) super.clone();
            cloned.reexport();
            return cloned;
        ...
        throws RemoteException
    {
        ...
        if (obj instanceof java.rmi.server.UnicastRemoteObject) {
            ((java.rmi.server.UnicastRemoteObject) obj).ref = sref;
        }
