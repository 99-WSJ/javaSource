        ...
        implements ActivationInstantiator
{
     ...
     * @since 1.2
     */
    public static synchronized java.rmi.activation.ActivationGroup createGroup(ActivationGroupID id,
        ...
        throws ActivationException
    {
        ...
        try {
            ...
            Class<? extends java.rmi.activation.ActivationGroup> cl;
            Class<? extends java.rmi.activation.ActivationGroup> defaultGroupClass =
                ...
                groupClassName.equals(defaultGroupClass.getName()))
            {
                ...
                if (java.rmi.activation.ActivationGroup.class.isAssignableFrom(cl0)) {
                    cl = cl0.asSubclass(java.rmi.activation.ActivationGroup.class);
                } else {
            ...
            // create group
            Constructor<? extends java.rmi.activation.ActivationGroup> constructor =
                cl.getConstructor(ActivationGroupID.class,
                                  MarshalledObject.class);
            java.rmi.activation.ActivationGroup newGroup =
    ...
    private ActivationMonitor getMonitor() throws RemoteException {
        synchronized (java.rmi.activation.ActivationGroup.class) {
            if (monitor != null) {
                return monitor;
            }
        }
