...
public final class UID implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof java.rmi.server.UID) {
            java.rmi.server.UID uid = (java.rmi.server.UID) obj;
     ...
     * this operation
     */
    public static java.rmi.server.UID read(DataInput in) throws IOException {
        int unique = in.readInt();
        long time = in.readLong();
        short count = in.readShort();
        return new java.rmi.server.UID(unique, time, count);
    }
}
