...
public final class NetworkInterface {
    ...
    private java.net.NetworkInterface parent = null;
    ...
    static {
        ...
        init();
        defaultInterface = java.net.DefaultInterface.getDefault();
     ...
     * @since 1.6
     */
    public Enumeration<java.net.NetworkInterface> getSubInterfaces() {
        class subIFs implements Enumeration<java.net.NetworkInterface> {
     ...
     */
    public static java.net.NetworkInterface getByName(String name) throws SocketException {
        if (name == null)
     ...
     * @since 1.7
     */
    public static java.net.NetworkInterface getByIndex(int index) throws SocketException {
        if (index < 0)
     ...
     */
    public static java.net.NetworkInterface getByInetAddress(InetAddress addr) throws SocketException {
        if (addr == null) {
            throw new NullPointerException();
        }
    ...
    public static Enumeration<java.net.NetworkInterface> getNetworkInterfaces()
        throws SocketException {
        final java.net.NetworkInterface[] netifs = getAll();

        // specified to return null if no network interfaces
        if (netifs == null)
            return null;

        return new Enumeration<java.net.NetworkInterface>() {
            private int i = 0;
            public java.net.NetworkInterface nextElement() {
                if (netifs != null && i < netifs.length) {
                    java.net.NetworkInterface netif = netifs[i++];
                    return netif;
                } else {
                    throw new NoSuchElementException();
                }
    ...
    private native static java.net.NetworkInterface[] getAll()
        throws SocketException;

    private native static java.net.NetworkInterface getByName0(String name)
        throws SocketException;

    private native static java.net.NetworkInterface getByIndex0(int index)
        throws SocketException;

    private native static java.net.NetworkInterface getByInetAddress0(InetAddress addr)
        throws SocketException;
    ...
    public boolean equals(Object obj) {
        ...
        java.net.NetworkInterface that = (java.net.NetworkInterface)obj;
        if (this.name != null ) {
