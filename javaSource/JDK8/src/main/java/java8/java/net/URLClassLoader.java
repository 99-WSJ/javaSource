...
public class URLClassLoader extends SecureClassLoader implements Closeable {
    ...
    */
     ...
     */
    public static java.net.URLClassLoader newInstance(final URL[] urls,
                                                      final ClassLoader parent) {
        // Save the caller's context
        final AccessControlContext acc = AccessController.getContext();
        // Need a privileged block to create the class loader
        java.net.URLClassLoader ucl = AccessController.doPrivileged(
            new PrivilegedAction<java.net.URLClassLoader>() {
                public java.net.URLClassLoader run() {
                    return new java.net.FactoryURLClassLoader(urls, parent, acc);
                }
            });
        return ucl;
    }
    ...
    public static java.net.URLClassLoader newInstance(final URL[] urls) {
        ...
        java.net.URLClassLoader ucl = AccessController.doPrivileged(
            new PrivilegedAction<java.net.URLClassLoader>() {
                public java.net.URLClassLoader run() {
                    return new java.net.FactoryURLClassLoader(urls, acc);
                }
            });
        return ucl;
    }
    ...
    static {
        sun.misc.SharedSecrets.setJavaNetAccess (
            new sun.misc.JavaNetAccess() {
                public URLClassPath getURLClassPath (java.net.URLClassLoader u) {
                    return u.ucp;
                }
            }
        );
...
final class FactoryURLClassLoader extends java.net.URLClassLoader {
