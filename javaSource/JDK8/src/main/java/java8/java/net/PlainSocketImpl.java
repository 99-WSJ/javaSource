...
class PlainSocketImpl extends java.net.AbstractPlainSocketImpl
{
    ...
    PlainSocketImpl() {
        if (useDualStackImpl) {
            ...
            impl = new java.net.TwoStacksPlainSocketImpl(exclusiveBind);
        }
    }
    ...
    PlainSocketImpl(FileDescriptor fd) {
        if (useDualStackImpl) {
            ...
            impl = new java.net.TwoStacksPlainSocketImpl(fd, exclusiveBind);
        }
    }
    ...
    protected synchronized void accept(SocketImpl s) throws IOException {
        if (s instanceof java.net.PlainSocketImpl) {
            ...
            SocketImpl delegate = ((java.net.PlainSocketImpl)s).impl;
    ...
    void setInputStream(java.net.SocketInputStream in) {
