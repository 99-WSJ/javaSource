...
public final class URLPermission extends Permission {
    ...
    public boolean implies(Permission p) {
        if (! (p instanceof java.net.URLPermission)) {
            return false;
        }

        java.net.URLPermission that = (java.net.URLPermission)p;
    ...
    static class Authority {
        ...
        Authority(String scheme, String authority) {
            ...
            if (at == -1) {
                    p = new java.net.HostPortrange(scheme, authority);
            } else {
                    p = new java.net.HostPortrange(scheme, authority.substring(at+1));
            }
        }
