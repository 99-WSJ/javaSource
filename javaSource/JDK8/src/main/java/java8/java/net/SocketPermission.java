    ...
    implements Serializable
{
    ...
    public boolean implies(Permission p) {
        ...
        java.net.SocketPermission that = (java.net.SocketPermission) p;
     ...
     * false if not.
     */
    boolean impliesIgnoreMask(java.net.SocketPermission that) {
        int i,j;
    ...
    private boolean compareHostnames(java.net.SocketPermission that) {
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof java.net.SocketPermission))
            return false;

        java.net.SocketPermission that = (java.net.SocketPermission) obj;
    ...
    public PermissionCollection newPermissionCollection() {
        return new java.net.SocketPermissionCollection();
    }
    ...
    implements Serializable
{
    ...
    private transient List<java.net.SocketPermission> perms;
    ...
    public SocketPermissionCollection() {
        perms = new ArrayList<java.net.SocketPermission>();
    }
    ...
    public void add(Permission permission) {
        ...
        synchronized (this) {
            perms.add(0, (java.net.SocketPermission)permission);
        }
    }
    ...
    public boolean implies(Permission permission)
    {
        ...
        java.net.SocketPermission np = (java.net.SocketPermission) permission;
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < len; i++) {
                java.net.SocketPermission x = perms.get(i);
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        // Write out Vector
        Vector<java.net.SocketPermission> permissions = new Vector<>(perms.size());
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        // Get the one we want
        @SuppressWarnings("unchecked")
        Vector<java.net.SocketPermission> permissions = (Vector<java.net.SocketPermission>)gfields.get("permissions", null);
        perms = new ArrayList<java.net.SocketPermission>(permissions.size());
