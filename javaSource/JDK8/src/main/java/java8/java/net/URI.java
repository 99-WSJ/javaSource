...
public final class URI
    implements Comparable<java.net.URI>, Serializable
{
    ...
    public java.net.URI resolve(String str) {
        return resolve(java.net.URI.create(str));
    }
    ...
    public boolean equals(Object ob) {
        if (ob == this)
            return true;
        if (!(ob instanceof java.net.URI))
            return false;
        java.net.URI that = (java.net.URI)ob;
    ...
    private static java.net.URI resolve(java.net.URI base, java.net.URI child) {
        ...
        if ((child.scheme == null) && (child.authority == null)
            ...
            java.net.URI ru = new java.net.URI();
        ...
        java.net.URI ru = new java.net.URI();             // Resolved URI
        ru.scheme = base.scheme;
    ...
    private static java.net.URI normalize(java.net.URI u) {
        ...
        java.net.URI v = new java.net.URI();
        v.scheme = u.scheme;
