...
class Inet6Address extends InetAddress {
     ...
     * @since 1.5
     */
    public static java.net.Inet6Address getByAddress(String host, byte[] addr,
        ...
        throws UnknownHostException
    {
        ...
        if (addr != null) {
            if (addr.length == java.net.Inet6Address.INADDRSZ) {
                return new java.net.Inet6Address(host, addr, nif);
            }
        }
        ...
        throws UnknownHostException
    {
        ...
        if (addr != null) {
            if (addr.length == java.net.Inet6Address.INADDRSZ) {
                return new java.net.Inet6Address(host, addr, scope_id);
            }
        }
        throw new UnknownHostException("addr is of illegal length");
    }
    ...
    private static boolean isDifferentLocalAddressType(
        ...
        if (java.net.Inet6Address.isLinkLocalAddress(thisAddr) &&
                !java.net.Inet6Address.isLinkLocalAddress(otherAddr)) {
            return false;
        }
        if (java.net.Inet6Address.isSiteLocalAddress(thisAddr) &&
                !java.net.Inet6Address.isSiteLocalAddress(otherAddr)) {
            return false;
        }
        return true;
    }
    ...
    private static int deriveNumericScope (byte[] thisAddr, NetworkInterface ifc) throws UnknownHostException {
        ...
        while (addresses.hasMoreElements()) {
            ...
            java.net.Inet6Address ia6_addr = (java.net.Inet6Address)addr;
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof java.net.Inet6Address))
            return false;

        java.net.Inet6Address inetAddr = (java.net.Inet6Address)obj;
