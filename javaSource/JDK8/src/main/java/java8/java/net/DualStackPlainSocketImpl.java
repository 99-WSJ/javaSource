...
class DualStackPlainSocketImpl extends java.net.AbstractPlainSocketImpl
{
    ...
    int socketGetOption(int opt, Object iaContainerObj) throws SocketException {
        ...
        if (opt == SO_BINDADDR) {
            localAddress(nativefd, (java.net.InetAddressContainer)iaContainerObj);
    ...
    static native void localAddress(int fd, java.net.InetAddressContainer in) throws SocketException;
