...
public final class HttpCookie implements Cloneable {
     ...
     */
    public static List<java.net.HttpCookie> parse(String header) {
    ...
    // class.
    private static List<java.net.HttpCookie> parse(String header, boolean retainHeader) {
        ...
        List<java.net.HttpCookie> cookies = new java.util.ArrayList<>();
        ...
        if (version == 0) {
            ...
            java.net.HttpCookie cookie = parseInternal(header, retainHeader);
            cookie.setVersion(0);
            cookies.add(cookie);
        } else {
            // rfc2965/2109 cookie
            ...
            for (String cookieStr : cookieStrings) {
                java.net.HttpCookie cookie = parseInternal(cookieStr, retainHeader);
                cookie.setVersion(1);
                cookies.add(cookie);
            }
        }
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof java.net.HttpCookie))
            return false;
        java.net.HttpCookie other = (java.net.HttpCookie)obj;
     ...
     */
    private static java.net.HttpCookie parseInternal(String header,
                                                     boolean retainHeader)
    {
        java.net.HttpCookie cookie = null;
        ...
        try {
            ...
            if (index != -1) {
                ...
                if (retainHeader)
                    cookie = new java.net.HttpCookie(name,
    ...
    static interface CookieAttributeAssignor {
            public void assign(java.net.HttpCookie cookie,
                               String attrName,
                               String attrValue);
    }
    ...
    private static void assignAttribute(java.net.HttpCookie cookie,
                                        String attrName,
                                        String attrValue)
    {
    ...
    static {
        sun.misc.SharedSecrets.setJavaNetHttpCookieAccess(
            new sun.misc.JavaNetHttpCookieAccess() {
                public List<java.net.HttpCookie> parse(String header) {
                    return java.net.HttpCookie.parse(header, true);
                }

                public String header(java.net.HttpCookie cookie) {
