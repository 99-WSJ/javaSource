 ...
 * @since       1.5
 */
abstract class AbstractStringBuilder implements Appendable, java.lang.CharSequence {
    /**
    ...
    public int codePointAt(int index) {
        ...
        return java.lang.Character.codePointAtImpl(value, index, count);
    }
    ...
    public int offsetByCodePoints(int index, int codePointOffset) {
        ...
        return java.lang.Character.offsetByCodePointsImpl(value, 0, count,
    ...
    public java.lang.AbstractStringBuilder append(StringBuffer sb) {
        if (sb == null)
            return appendNull();
        int len = sb.length();
        ensureCapacityInternal(count + len);
    ...
    public java.lang.AbstractStringBuilder append(java.lang.CharSequence s) {
        ...
        if (s instanceof java.lang.AbstractStringBuilder)
            return this.append((java.lang.AbstractStringBuilder)s);
     ...
     * {@link java.lang.Character#charCount(int) Character.charCount(codePoint)}.
     *
     * <p> The overall effect is exactly as if the argument were
     * converted to a {@code char} array by the method
     * {@link java.lang.Character#toChars(int)} and the character in that array
    ...
    public java.lang.AbstractStringBuilder appendCodePoint(int codePoint) {
        ...
        if (java.lang.Character.isBmpCodePoint(codePoint)) {
            ...
            this.count = count + 1;
        } else if (java.lang.Character.isValidCodePoint(codePoint)) {
            ensureCapacityInternal(count + 2);
            java.lang.Character.toSurrogates(codePoint, value, count);
            this.count = count + 2;
        } else {
     ...
     * @return      This object.
     * @throws java.lang.StringIndexOutOfBoundsException  if the {@code index}
     ...
     *             greater than {@code end}.
     */
    public java.lang.AbstractStringBuilder replace(int start, int end, String str) {
        if (start < 0)
            throw new java.lang.StringIndexOutOfBoundsException(start);
        if (start > count)
     ...
     * implement the {@link java.lang.CharSequence} interface.
     *
     ...
     *             be inserted.
     * @return     This object
     * @throws java.lang.StringIndexOutOfBoundsException  if {@code index}
     *             is negative or greater than {@code length()}, or
     *             {@code offset} or {@code len} are negative, or
     *             {@code (offset+len)} is greater than
     *             {@code str.length}.
     */
    public java.lang.AbstractStringBuilder insert(int index, char[] str, int offset,
                                                  int len)
    {
     ...
     * @param      obj      an {@code Object}.
     * @return     a reference to this object.
     * @throws java.lang.StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public java.lang.AbstractStringBuilder insert(int offset, Object obj) {
     ...
     * @throws java.lang.StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public java.lang.AbstractStringBuilder insert(int offset, String str) {
     ...
     * {@link #insert(int, java.lang.CharSequence,int,int) insert}(dstOffset, s, 0, s.length())
     * method.
     *
     ...
     * @return     a reference to this object.
     * @throws java.lang.IndexOutOfBoundsException  if the offset is invalid.
     */
     ...
     * @return     a reference to this object.
     * @throws java.lang.IndexOutOfBoundsException  if {@code dstOffset}
     ...
     */
     public java.lang.AbstractStringBuilder insert(int dstOffset, java.lang.CharSequence s,
        ...
        if ((dstOffset < 0) || (dstOffset > this.length()))
            throw new java.lang.IndexOutOfBoundsException("dstOffset "+dstOffset);
    ...
    public java.lang.AbstractStringBuilder reverse() {
        ...
        for (int j = (n-1) >> 1; j >= 0; j--) {
            ...
            if (java.lang.Character.isSurrogate(cj) ||
                java.lang.Character.isSurrogate(ck)) {
                hasSurrogates = true;
            }
        }
        if (hasSurrogates) {
