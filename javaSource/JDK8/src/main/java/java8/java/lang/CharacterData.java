...
abstract class CharacterData {
    ...
    static final java.lang.CharacterData of(int ch) {
        if (ch >>> 8 == 0) {     // fast-path
            return java.lang.CharacterDataLatin1.instance;
        } else {
            switch(ch >>> 16) {  //plane 00-16
            case(0):
                return java.lang.CharacterData00.instance;
            case(1):
                return java.lang.CharacterData01.instance;
            case(2):
                return CharacterData02.instance;
            case(14):
                return java.lang.CharacterData0E.instance;
            case(15):   // Private Use
            case(16):   // Private Use
