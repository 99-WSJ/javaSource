...
public final class String
    ...
    */
    ...
    private static class CaseInsensitiveComparator
        ...
        private java.lang.Object readResolve() { return CASE_INSENSITIVE_ORDER; }
    }
    ...
    public int lastIndexOf(int ch, int fromIndex) {
        if (ch < java.lang.Character.MIN_SUPPLEMENTARY_CODE_POINT) {
            ...
            // negative value (invalid code point))
            final char[] value = this.value;
            int i = java.lang.Math.min(fromIndex, value.length - 1);
            for (; i >= 0; i--) {
                if (value[i] == ch) {
                    return i;
                }
    ...
    private int lastIndexOfSupplementary(int ch, int fromIndex) {
        if (java.lang.Character.isValidCodePoint(ch)) {
            ...
            int i = java.lang.Math.min(fromIndex, value.length - 2);
            for (; i >= 0; i--) {
                if (value[i] == hi && value[i + 1] == lo) {
                    return i;
                }
    ...
    public java.lang.String substring(int beginIndex) {
        if (beginIndex < 0) {
            throw new java.lang.StringIndexOutOfBoundsException(beginIndex);
        }
        int subLen = value.length - beginIndex;
        if (subLen < 0) {
            throw new java.lang.StringIndexOutOfBoundsException(subLen);
        }
     ...
     *
     * <blockquote>
     * {@link Pattern}.{@link Pattern#matches(java.lang.String, java.lang.CharSequence)
     ...
     * Pattern#matcher(java.lang.CharSequence) matcher}(<i>str</i>).{@link
     ...
     * {@link Pattern}.{@link
     * Pattern#compile compile}(<i>regex</i>).{@link
     * Pattern#split(java.lang.CharSequence,int) split}(<i>str</i>,&nbsp;<i>n</i>)
     * </code>
     * </blockquote>
     *
     *
    ...
    public java.lang.String[] split(java.lang.String regex, int limit) {
        ...
        if (((regex.value.length == 1 &&
             ...
             (regex.length() == 2 &&
              ...
              ((ch-'a')|('z'-ch)) < 0 &&
              ((ch-'A')|('Z'-ch)) < 0)) &&
            (ch < java.lang.Character.MIN_HIGH_SURROGATE ||
             ch > java.lang.Character.MAX_LOW_SURROGATE))
        {
            int off = 0;
            int next = 0;
     ...
     * @since 1.8
     */
    public static java.lang.String join(java.lang.CharSequence delimiter, java.lang.CharSequence... elements) {
    ...
    public java.lang.String toLowerCase(Locale locale) {
        ...
        java.lang.System.arraycopy(value, 0, result, 0, firstUpper);
        ...
        for (int i = firstUpper; i < len; i += srcCount) {
            ...
            if (localeDependent || srcChar == '\u03A3') { // GREEK CAPITAL LETTER SIGMA
                lowerChar = java.lang.ConditionalSpecialCasing.toLowerCaseEx(this, i, locale);
            } else {
                lowerChar = java.lang.Character.toLowerCase(srcChar);
            }
            if ((lowerChar == java.lang.Character.ERROR)
                    || (lowerChar >= java.lang.Character.MIN_SUPPLEMENTARY_CODE_POINT)) {
                if (lowerChar == java.lang.Character.ERROR) {
                    lowerCharArray =
                            java.lang.ConditionalSpecialCasing.toLowerCaseCharArray(this, i, locale);
                } else if (srcCount == 2) {
                ...
                if (mapLen > srcCount) {
                    ...
                    java.lang.System.arraycopy(result, 0, result2, 0, i + resultOffset);
                    result = result2;
                }
    ...
    public java.lang.String toUpperCase(Locale locale) {
        ...
        scan: {
            for (firstLower = 0 ; firstLower < len; ) {
                ...
                int upperCaseChar = java.lang.Character.toUpperCaseEx(c);
                if ((upperCaseChar == java.lang.Character.ERROR)
                        || (c != upperCaseChar)) {
                    break scan;
                }
                firstLower += srcCount;
        ...
        java.lang.System.arraycopy(value, 0, result, 0, firstLower);
        ...
        for (int i = firstLower; i < len; i += srcCount) {
            ...
            if (localeDependent) {
                upperChar = java.lang.ConditionalSpecialCasing.toUpperCaseEx(this, i, locale);
            } else {
                upperChar = java.lang.Character.toUpperCaseEx(srcChar);
            }
            if ((upperChar == java.lang.Character.ERROR)
                    || (upperChar >= java.lang.Character.MIN_SUPPLEMENTARY_CODE_POINT)) {
                if (upperChar == java.lang.Character.ERROR) {
                    if (localeDependent) {
                        upperCharArray =
                                java.lang.ConditionalSpecialCasing.toUpperCaseCharArray(this, i, locale);
                    } else {
    ...
    public char[] toCharArray() {
        ...
        java.lang.System.arraycopy(value, 0, result, 0, value.length);
        return result;
    }
     ...
     * @since  1.5
     */
    public static java.lang.String format(Locale l, java.lang.String format, java.lang.Object... args) {
