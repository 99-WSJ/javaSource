...
/* non-public */ abstract class BoundMethodHandle extends MethodHandle {
    ...
    static MethodHandle bindSingle(MethodType type, LambdaForm form, char xtype, Object x) {
        ...
        try {
            ...
            case 'L':
                ...
                return (java.lang.invoke.BoundMethodHandle) SpeciesData.EMPTY.extendWithType('L').constructor[0].invokeBasic(type, form, x);
            case 'I':
                return (java.lang.invoke.BoundMethodHandle) SpeciesData.EMPTY.extendWithType('I').constructor[0].invokeBasic(type, form, ValueConversions.widenSubword(x));
            case 'J':
                return (java.lang.invoke.BoundMethodHandle) SpeciesData.EMPTY.extendWithType('J').constructor[0].invokeBasic(type, form, (long) x);
            case 'F':
                return (java.lang.invoke.BoundMethodHandle) SpeciesData.EMPTY.extendWithType('F').constructor[0].invokeBasic(type, form, (float) x);
            case 'D':
                return (java.lang.invoke.BoundMethodHandle) SpeciesData.EMPTY.extendWithType('D').constructor[0].invokeBasic(type, form, (double) x);
    ...
    public abstract java.lang.invoke.BoundMethodHandle clone(MethodType mt, LambdaForm lf) throws Throwable;
    public abstract java.lang.invoke.BoundMethodHandle cloneExtendL(MethodType mt, LambdaForm lf, Object narg) throws Throwable;
    public abstract java.lang.invoke.BoundMethodHandle cloneExtendI(MethodType mt, LambdaForm lf, int    narg) throws Throwable;
    public abstract java.lang.invoke.BoundMethodHandle cloneExtendJ(MethodType mt, LambdaForm lf, long   narg) throws Throwable;
    public abstract java.lang.invoke.BoundMethodHandle cloneExtendF(MethodType mt, LambdaForm lf, float  narg) throws Throwable;
    public abstract java.lang.invoke.BoundMethodHandle cloneExtendD(MethodType mt, LambdaForm lf, double narg) throws Throwable;
    ...
    static final class Species_L extends java.lang.invoke.BoundMethodHandle {
        final Object argL0;
        ...
        @Override
        public java.lang.invoke.BoundMethodHandle.SpeciesData speciesData() {
            return SPECIES_DATA;
        }
        public static final java.lang.invoke.BoundMethodHandle.SpeciesData SPECIES_DATA = java.lang.invoke.BoundMethodHandle.SpeciesData.getForClass("L", Species_L.class);
        @Override
        public final java.lang.invoke.BoundMethodHandle clone(MethodType mt, LambdaForm lf) throws Throwable {
            return new Species_L(mt, lf, argL0);
        }
        @Override
        public final java.lang.invoke.BoundMethodHandle cloneExtendL(MethodType mt, LambdaForm lf, Object narg) throws Throwable {
            return (java.lang.invoke.BoundMethodHandle) SPECIES_DATA.extendWithIndex(INDEX_L).constructor[0].invokeBasic(mt, lf, argL0, narg);
        }
        @Override
        public final java.lang.invoke.BoundMethodHandle cloneExtendI(MethodType mt, LambdaForm lf, int narg) throws Throwable {
            return (java.lang.invoke.BoundMethodHandle) SPECIES_DATA.extendWithIndex(INDEX_I).constructor[0].invokeBasic(mt, lf, argL0, narg);
        }
        @Override
        public final java.lang.invoke.BoundMethodHandle cloneExtendJ(MethodType mt, LambdaForm lf, long narg) throws Throwable {
            return (java.lang.invoke.BoundMethodHandle) SPECIES_DATA.extendWithIndex(INDEX_J).constructor[0].invokeBasic(mt, lf, argL0, narg);
        }
        @Override
        public final java.lang.invoke.BoundMethodHandle cloneExtendF(MethodType mt, LambdaForm lf, float narg) throws Throwable {
            return (java.lang.invoke.BoundMethodHandle) SPECIES_DATA.extendWithIndex(INDEX_F).constructor[0].invokeBasic(mt, lf, argL0, narg);
        }
        @Override
        public final java.lang.invoke.BoundMethodHandle cloneExtendD(MethodType mt, LambdaForm lf, double narg) throws Throwable {
            return (java.lang.invoke.BoundMethodHandle) SPECIES_DATA.extendWithIndex(INDEX_D).constructor[0].invokeBasic(mt, lf, argL0, narg);
        }
    }
...
*/
    ...
    static class SpeciesData {
        final String                             types;
        final Class<? extends java.lang.invoke.BoundMethodHandle> clazz;
        ...
        static final SpeciesData EMPTY = new SpeciesData("", java.lang.invoke.BoundMethodHandle.class);

        private SpeciesData(String types, Class<? extends java.lang.invoke.BoundMethodHandle> clazz) {
            this.types = types;
            this.clazz = clazz;
            if (!INIT_DONE) {
        ...
        static SpeciesData getForClass(String types, Class<? extends java.lang.invoke.BoundMethodHandle> clazz) {
        ...
        static {
            ...
            final Class<java.lang.invoke.BoundMethodHandle> rootCls = java.lang.invoke.BoundMethodHandle.class;
            SpeciesData d0 = java.lang.invoke.BoundMethodHandle.SPECIES_DATA;  // trigger class init
            assert(d0 == null || d0 == lookupCache("")) : d0;
            try {
                for (Class<?> c : rootCls.getDeclaredClasses()) {
                    if (rootCls.isAssignableFrom(c)) {
                        final Class<? extends java.lang.invoke.BoundMethodHandle> cbmh = c.asSubclass(java.lang.invoke.BoundMethodHandle.class);
    ...
    static class Factory {
         ...
         */
        static Class<? extends java.lang.invoke.BoundMethodHandle> generateConcreteBMHClass(String types) {
            ...
            Class<? extends java.lang.invoke.BoundMethodHandle> bmhClass =
                //UNSAFE.defineAnonymousClass(BoundMethodHandle.class, classFile, null).asSubclass(BoundMethodHandle.class);
                UNSAFE.defineClass(className, classFile, 0, classFile.length,
                                   java.lang.invoke.BoundMethodHandle.class.getClassLoader(), null)
                    .asSubclass(java.lang.invoke.BoundMethodHandle.class);
        ...
        static MethodHandle[] makeCtors(Class<? extends java.lang.invoke.BoundMethodHandle> cbmh, String types, MethodHandle mhs[]) {
        ...
        static SpeciesData speciesDataFromConcreteBMHClass(Class<? extends java.lang.invoke.BoundMethodHandle> cbmh) {
            try {
        ...
        static MethodHandle makeCbmhCtor(Class<? extends java.lang.invoke.BoundMethodHandle> cbmh, String types) {
            try {
        ...
        private static MethodHandle linkConstructor(MethodHandle cmh) {
            ...
            final MethodType linkerMT = ctorMT.changeParameterType(0, java.lang.invoke.BoundMethodHandle.class).appendParameterTypes(MemberName.class);
