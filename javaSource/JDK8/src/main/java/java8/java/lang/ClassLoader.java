...
public abstract class ClassLoader {
    ...
    private static class ParallelLoaders {
        ...
        private static final Set<Class<? extends java.lang.ClassLoader>> loaderTypes =
            Collections.newSetFromMap(
                new WeakHashMap<Class<? extends java.lang.ClassLoader>, Boolean>());
        static {
            synchronized (loaderTypes) { loaderTypes.add(java.lang.ClassLoader.class); }
        }
         ...
         */
        static boolean register(Class<? extends java.lang.ClassLoader> c) {
         ...
         */
        static boolean isRegistered(Class<? extends java.lang.ClassLoader> c) {
            synchronized (loaderTypes) {
    ...
    private ClassLoader(Void unused, java.lang.ClassLoader parent) {
        this.parent = parent;
    ...
    */
     ...
     *          If the class could not be found
     *
     * @see  #ClassLoader(java.lang.ClassLoader)
     * @see  #getParent()
     */
    protected final Class<?> findSystemClass(String name)
        throws ClassNotFoundException
    {
        java.lang.ClassLoader system = getSystemClassLoader();
        if (system == null) {
            if (!checkName(name))
                throw new ClassNotFoundException(name);
    ...
    protected static boolean registerAsParallelCapable() {
        Class<? extends java.lang.ClassLoader> callerClass =
            Reflection.getCallerClass().asSubclass(java.lang.ClassLoader.class);
            ...
            if (l != null) {
                ...
                try {
                    scl = AccessController.doPrivileged(
                        new java.lang.SystemClassLoaderAction(scl));
    ...
    boolean isAncestor(java.lang.ClassLoader cl) {
        java.lang.ClassLoader acl = this;
        do {
            acl = acl.parent;
            if (cl == acl) {
                return true;
    ...
    // any class loader.
    private static boolean needsClassLoaderPermissionCheck(java.lang.ClassLoader from,
    ...
    static class NativeLibrary {
        ...
        protected void finalize() {
            synchronized (loadedLibraryNames) {
                if (fromClass.getClassLoader() != null && loaded) {
                    ...
                    /* unload the library. */
                    java.lang.ClassLoader.nativeLibraryContext.push(this);
                    try {
        ...
        static Class<?> getFromClass() {
            return java.lang.ClassLoader.nativeLibraryContext.peek().fromClass;
        }
    }
    ...
    "ClassLoader.findLibrary failed to return an absolute path: " + libfilename);
        ...
        for (int i = 0 ; i < sys_paths.length ; i++) {
            ...
            libfile = java.lang.ClassLoaderHelper.mapAlternativeName(libfile);
    ...
    static long findNative(java.lang.ClassLoader loader, String name) {
        Vector<NativeLibrary> libs =
            loader != null ? loader.nativeLibraries : systemNativeLibraries;
        synchronized (libs) {
            int size = libs.size();
