...
class InvokerBytecodeGenerator {
    ...
    private static final Class<?> HOST_CLASS = java.lang.invoke.LambdaForm.class;

    private InvokerBytecodeGenerator(java.lang.invoke.LambdaForm lambdaForm, int localsMapSize,
    ...
    private InvokerBytecodeGenerator(String className, java.lang.invoke.LambdaForm form, MethodType invokerType) {
     ...
     */
    static MemberName generateCustomizedCode(java.lang.invoke.LambdaForm form, MethodType invokerType) {
        java.lang.invoke.InvokerBytecodeGenerator g = new java.lang.invoke.InvokerBytecodeGenerator("MH", form, invokerType);
    ...
    private boolean isSelectAlternative(MemberName member) {
        return member != null &&
               member.getDeclaringClass() == java.lang.invoke.MethodHandleImpl.class &&
    ...
    private void emitReturn() {
        ...
        if (lambdaForm.result == -1) {
            ...
            java.lang.invoke.LambdaForm.Name rn = lambdaForm.names[lambdaForm.result];
    ...
    static MemberName generateLambdaFormInterpreterEntryPoint(String sig) {
        assert(java.lang.invoke.LambdaForm.isValidSignature(sig));
        //System.out.println("generateExactInvoker "+sig);
        // compute method type
        // first parameter and return type
        char tret = java.lang.invoke.LambdaForm.signatureReturn(sig);
        MethodType type = MethodType.methodType(java.lang.invoke.LambdaForm.typeClass(tret), MethodHandle.class);
        // other parameter types
        int arity = java.lang.invoke.LambdaForm.signatureArity(sig);
        for (int i = 1; i < arity; i++) {
            type = type.appendParameterTypes(java.lang.invoke.LambdaForm.typeClass(sig.charAt(i)));
        }
        java.lang.invoke.InvokerBytecodeGenerator g = new java.lang.invoke.InvokerBytecodeGenerator("LFI", "interpret_"+tret, type);
     ...
     */
    static MemberName generateNamedFunctionInvoker(java.lang.invoke.MethodTypeForm typeForm) {
        MethodType invokerType = java.lang.invoke.LambdaForm.NamedFunction.INVOKER_METHOD_TYPE;
        String invokerName = basicTypeCharSignature("invoke_", typeForm.erasedType());
        java.lang.invoke.InvokerBytecodeGenerator g = new java.lang.invoke.InvokerBytecodeGenerator("NFI", invokerName, invokerType);
        return g.loadMethod(g.generateNamedFunctionInvokerImpl(typeForm));
    }

    static int nfi = 0;

    private byte[] generateNamedFunctionInvokerImpl(java.lang.invoke.MethodTypeForm typeForm) {
