...
final class Finalizer extends FinalReference<Object> { /* Package-private; must be in
    ...
    private static java.lang.ref.Finalizer unfinalized = null;
    private static final Object lock = new Object();

    private java.lang.ref.Finalizer
        next = null,
        prev = null;
    ...
    static void register(Object finalizee) {
        new java.lang.ref.Finalizer(finalizee);
    }
    ...
    static void runFinalization() {
        ...
        forkSecondaryFinalizer(new Runnable() {
            ...
            public void run() {
                ...
                running = true;
                for (;;) {
                    java.lang.ref.Finalizer f = (java.lang.ref.Finalizer)queue.poll();
                    if (f == null) break;
                    f.runFinalizer(jla);
                }
            }
    ...
    private static class FinalizerThread extends Thread {
        ...
        public void run() {
            ...
            for (;;) {
                try {
                    java.lang.ref.Finalizer f = (java.lang.ref.Finalizer)queue.remove();
                    f.runFinalizer(jla);
                } catch (InterruptedException x) {
                    // ignore and continue
                }
