...
final class ProcessEnvironment extends HashMap<String,String>
{
    ...
    private static final java.lang.ProcessEnvironment theEnvironment;
    ...
    static {
        ...
        theEnvironment  = new java.lang.ProcessEnvironment();
    ...
    static Map<String,String> emptyEnvironment(int capacity) {
        return new java.lang.ProcessEnvironment(capacity);
    }
    ...
    static String toEnvironmentBlock(Map<String,String> map) {
        return map == null ? null :
            ((java.lang.ProcessEnvironment)map).toEnvironmentBlock();
    }
}
