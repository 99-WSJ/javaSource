// This file was generated AUTOMATICALLY from a template file Tue Mar 04 03:50:23 PST 2014
/*
...
class CharacterData02 extends java.lang.CharacterData {
    ...
    int digit(int ch, int radix) {
        ...
        if (radix >= java.lang.Character.MIN_RADIX && radix <= java.lang.Character.MAX_RADIX) {
            int val = getProperties(ch);
            int kind = val & 0x1F;
            if (kind == java.lang.Character.DECIMAL_DIGIT_NUMBER) {
    ...
    byte getDirectionality(int ch) {
        ...
        if (directionality == 0xF ) {
	        directionality = java.lang.Character.DIRECTIONALITY_UNDEFINED;
        }
    ...
    static final java.lang.CharacterData instance = new java.lang.CharacterData02();
    private CharacterData02() {};

    // The following tables and code generated using:
  // java GenerateCharacter -plane 2 -template d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/jdk/make/data/characterdata/CharacterData02.java.template -spec d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/jdk/make/data/unicodedata/UnicodeData.txt -specialcasing d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/jdk/make/data/unicodedata/SpecialCasing.txt -proplist d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/jdk/make/data/unicodedata/PropList.txt -o d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/build/windows-amd64/jdk/gensrc/java/lang/CharacterData02.java -string -usecharforbyte 11 4 1
