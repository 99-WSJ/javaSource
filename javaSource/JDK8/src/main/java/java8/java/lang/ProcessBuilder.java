 ...
 * {@link java.lang.Process} instance with those attributes.  The {@link
 ...
 * be accessed using the {@link java.lang.Process#getInputStream()} and {@link
 * java.lang.Process#getErrorStream()} methods.
 *
...
public final class ProcessBuilder
{
     ...
     * of type {@link String} will throw a {@link java.lang.ClassCastException}.
     *
    ...
    public Map<String,String> environment() {
        ...
        if (security != null)
            security.checkPermission(new java.lang.RuntimePermission("getenv.*"));

        if (environment == null)
            environment = java.lang.ProcessEnvironment.environment();
    ...
    java.lang.ProcessBuilder environment(String[] envp) {
        assert environment == null;
        if (envp != null) {
            environment = java.lang.ProcessEnvironment.emptyEnvironment(envp.length);
            assert environment != null;
            ...
            for (String envstring : envp) {
                ...
                int eqlsign =
                    envstring.indexOf('=', java.lang.ProcessEnvironment.MIN_NAME_LENGTH);
     ...
     * @since  1.7
     */
    public java.lang.ProcessBuilder redirectInput(Redirect source) {
     ...
     * @since  1.7
     */
    public java.lang.ProcessBuilder redirectOutput(Redirect destination) {
     ...
     * @since  1.7
     */
    public java.lang.ProcessBuilder redirectError(Redirect destination) {
        if (destination.type() == Redirect.Type.READ)
            throw new java.lang.IllegalArgumentException(
                "Redirect invalid for writing: " + destination);
     ...
     * @since  1.7
     */
    public java.lang.ProcessBuilder redirectInput(File file) {
     ...
     * @since  1.7
     */
    public java.lang.ProcessBuilder redirectOutput(File file) {
     ...
     * @since  1.7
     */
    public java.lang.ProcessBuilder redirectError(File file) {
    ...
    public java.lang.Process start() throws IOException {
        ...
        try {
            return java.lang.ProcessImpl.start(cmdarray,
                                     environment,
                                     dir,
                                     redirects,
                                     redirectErrorStream);
