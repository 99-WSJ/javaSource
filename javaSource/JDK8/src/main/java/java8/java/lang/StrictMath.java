...
public final class StrictMath {
    ...
    private static double floorOrCeil(double a,
                                      ...
                                      double sign) {
        int exponent = java.lang.Math.getExponent(a);
        ...
        long doppel = java.lang.Double.doubleToRawLongBits(a);
        long mask   = DoubleConsts.SIGNIF_BIT_MASK >> exponent;

        if ( (mask & doppel) == 0L )
            return a; // integral value
        else {
            double result = java.lang.Double.longBitsToDouble(doppel & (~mask));
            if (sign*a > 0.0)
                result = result + sign;
            return result;
        }
    ...
    public static double rint(double a) {
        ...
        double sign = java.lang.Math.copySign(1.0, a); // preserve sign info
     ...
     * @throws java.lang.ArithmeticException if the {@code argument} overflows an int
     ...
     * @see java.lang.StrictMath#floorDiv(int, int)
     * @since 1.8
     */
     ...
     * @see java.lang.StrictMath#floorDiv(long, long)
     * @since 1.8
     */
    ...
    public static double copySign(double magnitude, double sign) {
        return java.lang.Math.copySign(magnitude, (java.lang.Double.isNaN(sign)?1.0d:sign));
    }
    ...
    public static float copySign(float magnitude, float sign) {
        return java.lang.Math.copySign(magnitude, (java.lang.Float.isNaN(sign)?1.0f:sign));
    }
    /**
     ...
     * {@link java.lang.Float#MAX_EXPONENT} + 1.
     * <li>If the argument is zero or subnormal, then the result is
     * {@link java.lang.Float#MIN_EXPONENT} -1.
     * </ul>
     ...
     * <ul>
     * <li>If the argument is NaN or infinite, then the result is
     * {@link java.lang.Double#MAX_EXPONENT} + 1.
     * <li>If the argument is zero or subnormal, then the result is
     * {@link java.lang.Double#MIN_EXPONENT} -1.
     * </ul>
     ...
     *
     * <li> If {@code start} is
     * &plusmn;{@link java.lang.Double#MIN_VALUE} and {@code direction}
     ...
     * have a smaller magnitude, {@link java.lang.Double#MAX_VALUE} with the
     * same sign as {@code start} is returned.
     *
     * <li> If {@code start} is equal to &plusmn;
     * {@link java.lang.Double#MAX_VALUE} and {@code direction} has a
     ...
     *
     * <li> If {@code start} is
     * &plusmn;{@link java.lang.Float#MIN_VALUE} and {@code direction}
     * has a value such that the result should have a smaller
     * magnitude, then a zero with the same sign as {@code start}
     * is returned.
     *
     * <li> If {@code start} is infinite and
     * {@code direction} has a value such that the result should
     * have a smaller magnitude, {@link java.lang.Float#MAX_VALUE} with the
     * same sign as {@code start} is returned.
     *
     * <li> If {@code start} is equal to &plusmn;
     * {@link java.lang.Float#MAX_VALUE} and {@code direction} has a
     * value such that the result should have a larger magnitude, an
     * infinity with same sign as {@code start} is returned.
     * </ul>
     *
     ...
     * {@link java.lang.Double#MIN_VALUE}
     *
     * </ul>
     *
     ...
     *
     * <li> If the argument is zero, the result is
     * {@link java.lang.Float#MIN_VALUE}
     *
     * </ul>
     *
     ...
     * java.lang.Double#MIN_EXPONENT} and {@link java.lang.Double#MAX_EXPONENT}, the
     ...
     * Language Specification for a discussion of floating-point
     * value sets.  If the exponent of the result is between {@link
     * java.lang.Float#MIN_EXPONENT} and {@link java.lang.Float#MAX_EXPONENT}, the
     * answer is calculated exactly.  If the exponent of the result
