...
public class MethodHandles {
     ...
     * {@link java.lang.invoke.MethodHandles#lookup MethodHandles.lookup} to create a factory for itself.
     ...
     * For example, the {@link java.lang.invoke.MethodHandles#publicLookup publicLookup}
     * method produces a lookup object which is only allowed to access
     * public members in public classes.
     * The caller sensitive method {@link java.lang.invoke.MethodHandles#lookup lookup}
     ...
     * {@link java.lang.invoke.MethodHandles#publicLookup() publicLookup()},
...
return mh1;
        ...
        private MethodHandle unreflectForMH(Method m) {
            ...
            if (MemberName.isMethodHandleInvokeName(m.getName()))
                return java.lang.invoke.MethodHandleImpl.fakeMethodHandleInvoke(new MemberName(m));
            return null;
        }
        ...
        public MethodHandleInfo revealDirect(MethodHandle target) {
            ...
            return new java.lang.invoke.InfoFromMemberName(this, member, refKind);
        }
        ...
        private MethodHandle getDirectMethodCommon(byte refKind, Class<?> refc, MemberName method,
            ...
            MethodHandle mh = java.lang.invoke.DirectMethodHandle.make(refKind, refc, method);
        ...
        private MethodHandle maybeBindCaller(MemberName method, MethodHandle mh,
            ...
            MethodHandle cbmh = java.lang.invoke.MethodHandleImpl.bindCaller(mh, hostClass);
        ...
        private MethodHandle getDirectFieldCommon(byte refKind, Class<?> refc, MemberName field,
            ...
            MethodHandle mh = java.lang.invoke.DirectMethodHandle.make(refc, field);
        ...
        private MethodHandle getDirectConstructorCommon(Class<?> refc, MemberName ctor,
            ...
            return java.lang.invoke.DirectMethodHandle.make(ctor).setVarargs(ctor);
        }
        ...
        MethodHandle linkMethodHandleConstant(byte refKind, Class<?> defc, String name, Object type) throws ReflectiveOperationException {
            ...
            if (mh instanceof java.lang.invoke.DirectMethodHandle
                ...
                if (member.equals(key)) {  // better safe than sorry
                    LOOKASIDE_TABLE.put(key, (java.lang.invoke.DirectMethodHandle) mh);
                }
            }
            return mh;
        }
        ...
        static ConcurrentHashMap<MemberName, java.lang.invoke.DirectMethodHandle> LOOKASIDE_TABLE = new ConcurrentHashMap<>();
    }
    ...
    MethodHandle arrayElementGetter(Class<?> arrayClass) throws IllegalArgumentException {
        return java.lang.invoke.MethodHandleImpl.makeArrayElementAccessor(arrayClass, false);
    }
    ...
    MethodHandle arrayElementSetter(Class<?> arrayClass) throws IllegalArgumentException {
        return java.lang.invoke.MethodHandleImpl.makeArrayElementAccessor(arrayClass, true);
    }
...
return invoker;
    ...
    MethodHandle explicitCastArguments(MethodHandle target, MethodType newType) {
        ...
        return java.lang.invoke.MethodHandleImpl.makePairwiseConvert(target, newType, 2);
    }
...
assert((int)twice.invokeExact(21) == 42);
    ...
    MethodHandle identity(Class<?> type) {
        if (type == void.class)
            ...
            return java.lang.invoke.MethodHandleImpl.makeReferenceIdentity(type);
    }
...
assertEquals("XY", (String) f2.invokeExact("x", "y")); // XY
    ...
    MethodHandle filterArgument(MethodHandle target, int pos, MethodHandle filter) {
        ...
        return java.lang.invoke.MethodHandleImpl.makeCollectArguments(target, filter, pos, false);
    }
...
System.out.println((int) f0.invokeExact("x", "y")); // 2
    ...
    MethodHandle filterReturnValue(MethodHandle target, MethodHandle filter) {
        ...
        return java.lang.invoke.MethodHandleImpl.makeCollectArguments(filter, target, 0, false);
    }
...
assertEquals("boojum", (String) catTrace.invokeExact("boo", "jum"));
    ...
    MethodHandle foldArguments(MethodHandle target, MethodHandle combiner) {
        ...
        return java.lang.invoke.MethodHandleImpl.makeCollectArguments(target, combiner, foldPos, true);
    }
    ...
    MethodHandle guardWithTest(MethodHandle test,
        ...
        return java.lang.invoke.MethodHandleImpl.makeGuardWithTest(test, target, fallback);
    }
    ...
    MethodHandle catchException(MethodHandle target,
        ...
        return java.lang.invoke.MethodHandleImpl.makeGuardWithCatch(target, exType, handler);
    }
    ...
    MethodHandle throwException(Class<?> returnType, Class<? extends Throwable> exType) {
        ...
        return java.lang.invoke.MethodHandleImpl.throwException(MethodType.methodType(returnType, exType));
    }
}
