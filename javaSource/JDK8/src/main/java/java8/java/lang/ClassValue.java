...
public abstract class ClassValue<T> {
    ...
    /*public*/ void put(java.lang.Class<?> type, T value) {
        ClassValueMap map = getMap(type);
    ...
    private static Entry<?>[] getCacheCarefully(java.lang.Class<?> type) {
     ...
     */
    private T getFromBackup(Entry<?>[] cache, java.lang.Class<?> type) {
     ...
     */
    private T getFromHashMap(java.lang.Class<?> type) {
    ...
    static class Version<T> {
        private final java.lang.ClassValue<T> classValue;
        private final Entry<T> promise = new Entry<>(this);
        Version(java.lang.ClassValue<T> classValue) { this.classValue = classValue; }
        java.lang.ClassValue<T> classValue() { return classValue; }
    ...
    static class Entry<T> extends WeakReference<Version<T>> {
        ...
        java.lang.ClassValue<T> classValueOrNull() {
            Version<T> v = version();
    ...
    private static ClassValueMap getMap(java.lang.Class<?> type) {
    ...
    private static ClassValueMap initializeMap(java.lang.Class<?> type) {
        ClassValueMap map;
     ...
     */
    static class ClassValueMap extends WeakHashMap<java.lang.ClassValue.Identity, Entry<?>> {
         ...
         */
        ClassValueMap(java.lang.Class<?> type) {
            this.type = type;
        ...
        synchronized
        <T> Entry<T> startEntry(java.lang.ClassValue<T> classValue) {
        ...
        synchronized
        <T> Entry<T> finishEntry(java.lang.ClassValue<T> classValue, Entry<T> e) {
            @SuppressWarnings("unchecked")  // one map has entries for all value types <T>
        ...
        /** Remove an entry. */
        synchronized
        void removeEntry(java.lang.ClassValue<?> classValue) {
        ...
        synchronized
        <T> void changeEntry(java.lang.ClassValue<T> classValue, T value) {
            @SuppressWarnings("unchecked")  // one map has entries for all value types <T>
            Entry<T> e0 = (Entry<T>) get(classValue.identity);
        ...
        static <T> Entry<T> probeHomeLocation(Entry<?>[] cache, java.lang.ClassValue<T> classValue) {
        ...
        static <T> Entry<T> probeBackupLocations(Entry<?>[] cache, java.lang.ClassValue<T> classValue) {
        ...
        private static int entryDislocation(Entry<?>[] cache, int pos, Entry<?> e) {
            java.lang.ClassValue<?> cv = e.classValueOrNull();
        ...
        private void removeStaleEntries(Entry<?>[] cache, int begin, int count) {
            ...
            cacheLoad = java.lang.Math.max(0, cacheLoad - removed);
        }
        ...
        private void removeStaleEntries(java.lang.ClassValue<?> classValue) {
        ...
        private <T> void addToCache(Entry<T> e) {
            java.lang.ClassValue<T> classValue = e.classValueOrNull();
            if (classValue != null)
                addToCache(classValue, e);
        }

        /** Add the given entry to the cache, in its home location. */
        private <T> void addToCache(java.lang.ClassValue<T> classValue, Entry<T> e) {
