...
class MethodHandleNatives {
    ...
    static MemberName linkCallSite(Object callerObj,
        ...
        if (callSite instanceof ConstantCallSite) {
            ...
            return java.lang.invoke.Invokers.linkToTargetMethod(type);
        } else {
            appendixResult[0] = callSite;
            return java.lang.invoke.Invokers.linkToCallSiteMethod(type);
        }
    }
    ...
    static MemberName linkMethodImpl(Class<?> callerClass, int refKind,
        ...
        try {
            if (defc == MethodHandle.class && refKind == REF_invokeVirtual) {
                return java.lang.invoke.Invokers.methodHandleInvokeLinkerMethod(name, fixMethodType(callerClass, type), appendixResult);
            }
        } catch (Throwable ex) {
