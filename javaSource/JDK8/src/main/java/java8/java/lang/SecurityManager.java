 ...
 * <p>
 * The special method
 * {@link java.lang.SecurityManager#checkPermission(Permission)}
 ...
 * The {@link java.lang.SecurityManager#getSecurityContext getSecurityContext} method
 * and the {@link java.lang.SecurityManager#checkPermission(Permission,
 ...
 * @see     java.lang.SecurityManager#checkTopLevelWindow(Object)
 *  checkTopLevelWindow
 * @see     System#getSecurityManager() getSecurityManager
 * @see     System#setSecurityManager(java.lang.SecurityManager)
 *  setSecurityManager
...
class SecurityManager {
    ...
    public SecurityManager() {
        synchronized(java.lang.SecurityManager.class) {
    ...
    protected java.lang.Class<?> currentLoadedClass() {
        java.lang.Class<?> c = currentLoadedClass0();
    ...
    private static ThreadGroup getRootGroup() {
        ThreadGroup root =  java.lang.Thread.currentThread().getThreadGroup();
    ...
    public void checkMemberAccess(java.lang.Class<?> clazz, int which) {
        ...
        if (which != Member.PUBLIC) {
            java.lang.Class<?> stack[] = getClassContext();
            /*
