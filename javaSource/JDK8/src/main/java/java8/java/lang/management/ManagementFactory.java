...
public class ManagementFactory {
    ...
    public static <T extends PlatformManagedObject>
        ...
        java.lang.management.PlatformComponent pc = java.lang.management.PlatformComponent.getPlatformComponent(mxbeanInterface);
        if (pc == null)
           ...
           getPlatformManagementInterfaces()
    {
        Set<Class<? extends PlatformManagedObject>> result =
            new HashSet<>();
        for (java.lang.management.PlatformComponent component: java.lang.management.PlatformComponent.values()) {
