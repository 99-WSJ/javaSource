...
public final class Short extends Number implements Comparable<java.lang.Short> {
    ...
    public static final java.lang.Class<java.lang.Short> TYPE = (java.lang.Class<java.lang.Short>) java.lang.Class.getPrimitiveClass("short");
    ...
    private static class ShortCache {
        ...
        static final java.lang.Short cache[] = new java.lang.Short[-(-128) + 127 + 1];

        static {
            for(int i = 0; i < cache.length; i++)
                cache[i] = new java.lang.Short((short)(i - 128));
        }
    }
