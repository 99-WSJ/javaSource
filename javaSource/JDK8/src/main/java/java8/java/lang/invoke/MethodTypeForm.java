...
final class MethodTypeForm {
    ...
    final @java.lang.invoke.Stable
    java.lang.invoke.LambdaForm[] lambdaForms;
    ...
    public java.lang.invoke.LambdaForm cachedLambdaForm(int which) {
        return lambdaForms[which];
    }

    public java.lang.invoke.LambdaForm setCachedLambdaForm(int which, java.lang.invoke.LambdaForm form) {
    ...
    public MethodHandle basicInvoker() {
        ...
        invoker = java.lang.invoke.DirectMethodHandle.make(invokeBasicMethod(basicType));
    ...
    protected MethodTypeForm(MethodType erasedType) {
        ...
        if (basicType == erasedType) {
            lambdaForms = new java.lang.invoke.LambdaForm[LF_LIMIT];
        } else {
    ...
    static java.lang.invoke.MethodTypeForm findForm(MethodType mt) {
        MethodType erased = canonicalize(mt, ERASE, ERASE);
        if (erased == null) {
            // It is already erased.  Make a new MethodTypeForm.
            return new java.lang.invoke.MethodTypeForm(mt);
        } else {
    ...
    public static MethodType canonicalize(MethodType mt, int howRet, int howArgs) {
        ...
        Class<?>[] ptc = java.lang.invoke.MethodTypeForm.canonicalizes(ptypes, howArgs);
        Class<?> rtype = mt.returnType();
        Class<?> rtc = java.lang.invoke.MethodTypeForm.canonicalize(rtype, howRet);
