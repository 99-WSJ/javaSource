...
/*non-public*/ abstract class MethodHandleImpl {
    ...
    private static class Lazy {
        ...
        static {
            try {
                NF_checkSpreadArgument = new NamedFunction(java.lang.invoke.MethodHandleImpl.class
    ...
    static MethodHandle selectAlternative() {
        ...
        try {
            SELECT_ALTERNATIVE
            = IMPL_LOOKUP.findStatic(java.lang.invoke.MethodHandleImpl.class, "selectAlternative",
    ...
    MethodHandle makeGuardWithTest(MethodHandle test,
        ...
        names[arity + 2] = new Name(java.lang.invoke.MethodHandleImpl.selectAlternative(), selectArgs);
    ...
    static MethodHandle throwException() {
        ...
        try {
            mh
            = IMPL_LOOKUP.findStatic(java.lang.invoke.MethodHandleImpl.class, "throwException",
