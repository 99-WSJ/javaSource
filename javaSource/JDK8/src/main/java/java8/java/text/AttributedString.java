...
public class AttributedString {
    ...
    final private class AttributedStringIterator implements AttributedCharacterIterator {
        ...
        public boolean equals(Object obj) {
            ...
            if (java.text.AttributedString.this != that.getString())
                return false;
        ...
        public int getRunStart(Attribute attribute) {
            if (currentRunStart == beginIndex || currentRunIndex == -1) {
                ...
                while (runStart > beginIndex &&
                        valuesMatch(value, java.text.AttributedString.this.getAttribute(attribute, runIndex - 1))) {
                    runIndex--;
        ...
        public int getRunStart(Set<? extends Attribute> attributes) {
            if (currentRunStart == beginIndex || currentRunIndex == -1) {
                ...
                int runIndex = currentRunIndex;
                while (runStart > beginIndex &&
                        java.text.AttributedString.this.attributeValuesMatch(attributes, currentRunIndex, runIndex - 1)) {
                    runIndex--;
                    runStart = runStarts[runIndex];
                }
                if (runStart < beginIndex) {
        ...
        public Set<Attribute> getAllAttributeKeys() {
            ...
            synchronized (java.text.AttributedString.this) {
        ...
        public Object getAttribute(Attribute attribute) {
            ...
            return java.text.AttributedString.this.getAttributeCheckRange(attribute, runIndex, beginIndex, endIndex);
        }

        // internally used methods

        private java.text.AttributedString getString() {
            return java.text.AttributedString.this;
        }
    ...
    final private class AttributeMap extends AbstractMap<Attribute,Object> {
        ...
        public Set<Entry<Attribute, Object>> entrySet() {
            ...
            synchronized (java.text.AttributedString.this) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (value instanceof Annotation) {
                        value = java.text.AttributedString.this.getAttributeCheckRange(key,
                    ...
                    Entry<Attribute, Object> entry = new java.text.AttributeEntry(key, value);
                    set.add(entry);
                }
            }
            return set;
        ...
        public Object get(Object key) {
            return java.text.AttributedString.this.getAttributeCheckRange((Attribute) key, runIndex, beginIndex, endIndex);
        }
    }
}
...
class AttributeEntry implements Map.Entry<Attribute,Object> {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof java.text.AttributeEntry)) {
            return false;
        }
        java.text.AttributeEntry other = (java.text.AttributeEntry) o;
