...
public class MessageFormat extends Format {
    ...
    public static String format(String pattern, Object ... arguments) {
        java.text.MessageFormat temp = new java.text.MessageFormat(pattern);
     ...
     */
    public Object clone() {
        java.text.MessageFormat other = (java.text.MessageFormat) super.clone();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass())
            return false;
        java.text.MessageFormat other = (java.text.MessageFormat) obj;
            ...
            if (false) { // if (argRecursion == 3){
                ...
                if (obj == null) {
                    ...
                    if (subFormatter instanceof ChoiceFormat) {
                        ...
                        if (arg.indexOf('{') >= 0) {
                            subFormatter = new java.text.MessageFormat(arg, locale);
                            obj = arguments;
                            arg = null;
                        }
                    }
