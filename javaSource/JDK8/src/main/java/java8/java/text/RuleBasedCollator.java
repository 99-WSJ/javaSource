...
public class RuleBasedCollator extends Collator{
     ...
     */
    private RuleBasedCollator(java.text.RuleBasedCollator that) {
    ...
    public Object clone() {
        ...
        if (getClass() == java.text.RuleBasedCollator.class) {
            return new java.text.RuleBasedCollator(this);
        }
        else {
            java.text.RuleBasedCollator result = (java.text.RuleBasedCollator) super.clone();
    ...
    public boolean equals(Object obj) {
        ...
        java.text.RuleBasedCollator other = (java.text.RuleBasedCollator) obj;
