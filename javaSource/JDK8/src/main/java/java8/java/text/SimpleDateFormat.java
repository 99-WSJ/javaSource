...
public class SimpleDateFormat extends DateFormat {
     ...
     * @see java.text.SimpleDateFormat#checkNegativeNumberExpression
     */
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object obj) {
        ...
        java.text.CharacterIteratorFieldDelegate delegate = new
    ...
    private static final int[] PATTERN_INDEX_TO_CALENDAR_FIELD = {
        ...
        Calendar.ZONE_OFFSET,
        java.text.CalendarBuilder.WEEK_YEAR,         // Pseudo Calendar field
        java.text.CalendarBuilder.ISO_DAY_OF_WEEK,   // Pseudo Calendar field
        Calendar.ZONE_OFFSET,
        Calendar.MONTH
    };
                           ...
                           boolean useDateFormatSymbols)
    {
        ...
        int value;
        if (field == java.text.CalendarBuilder.WEEK_YEAR) {
        ...
        } else if (field == java.text.CalendarBuilder.ISO_DAY_OF_WEEK) {
            value = java.text.CalendarBuilder.toISODayOfWeek(calendar.get(Calendar.DAY_OF_WEEK));
        } else {
            value = calendar.get(field);
        }
    ...
    private void zeroPaddingNumber(int value, int minDigits, int maxDigits, StringBuffer buffer)
    {
        ...
        numberFormat.format((long)value, buffer, java.text.DontCareFieldPosition.INSTANCE);
    }
    ...
    public Date parse(String text, ParsePosition pos)
    {
        ...
        java.text.CalendarBuilder calb = new java.text.CalendarBuilder();
     ...
     */
    private int matchString(String text, int start, int field, String[] data, java.text.CalendarBuilder calb)
    {
        int i = 0;
    ...
    private int matchString(String text, int start, int field,
                            Map<String,Integer> data, java.text.CalendarBuilder calb) {
        if (data != null) {
     ...
     * calendar.
     */
    private int subParseZoneString(String text, int start, java.text.CalendarBuilder calb) {
    ...
    private int subParseNumericZone(String text, int start, int sign, int count,
                                    boolean colon, java.text.CalendarBuilder calb) {
        int index = start;
    ...
    private int subParse(String text, int start, int patternCharIndex, int count,
                         ...
                         boolean useFollowingMinusSignAsDelimiter, java.text.CalendarBuilder calb) {
        Number number;
        int value = 0;
    ...
    @Override
    public Object clone() {
        java.text.SimpleDateFormat other = (java.text.SimpleDateFormat) super.clone();
    ...
    public boolean equals(Object obj)
    {
        ...
        java.text.SimpleDateFormat that = (java.text.SimpleDateFormat) obj;
