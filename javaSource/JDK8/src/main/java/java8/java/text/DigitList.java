...
final class DigitList implements Cloneable {
    ...
    public boolean equals(Object obj) {
        if (this == obj)                      // quick check
            return true;
        if (!(obj instanceof java.text.DigitList))         // (1) same object?
            return false;
        java.text.DigitList other = (java.text.DigitList) obj;
    ...
    public Object clone() {
        try {
            java.text.DigitList other = (java.text.DigitList) super.clone();
