        ...
        try {
            ...
            if (target != null) {
                getter = Statement.getMethod(target.getClass(),
                                      "get" + java.beans.NameGenerator.capitalize(first),
                                      new Class<?>[]{});
                if (getter == null) {
                    getter = Statement.getMethod(target.getClass(),
                                   "is" + java.beans.NameGenerator.capitalize(first),
                                   new Class<?>[]{});
                }
                if (getter == null) {
            ...
            try {
                ...
                if (targetMethod == null) {
                    targetMethod = Statement.getMethod(target.getClass(),
                             "set" + java.beans.NameGenerator.capitalize(action), argTypes);
                }
                if (targetMethod == null) {
...
//Equivalent code using an inner class instead of EventHandler.
                               ...
                               String listenerMethodName)
    {
        ...
        final java.beans.EventHandler handler = new java.beans.EventHandler(target, action,
                                                     eventPropertyName,
                                                     listenerMethodName);
