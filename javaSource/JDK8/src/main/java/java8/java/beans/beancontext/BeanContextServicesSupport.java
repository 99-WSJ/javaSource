...
public class      BeanContextServicesSupport extends BeanContextSupport
    ...
    protected class BCSSChild extends BCSChild  {
        ...
        synchronized void releaseService(Object requestor, Object service) {
            ...
            bcsp.releaseService(java.beans.beancontext.BeanContextServicesSupport.this.getBeanContextServicesPeer(), requestor, service);
        ...
        synchronized void revokeService(Class serviceClass, boolean isDelegated, boolean revokeNow) {
            ...
            BeanContextServiceRevokedEvent bcsre       = new BeanContextServiceRevokedEvent(java.beans.beancontext.BeanContextServicesSupport.this.getBeanContextServicesPeer(), serviceClass, revokeNow);
        ...
        void revokeAllDelegatedServicesNow() {
            ...
            while (serviceClassRefs.hasNext()) {
                ...
                Iterator i = serviceClassRef.cloneOfEntries();
                BeanContextServiceRevokedEvent bcsre       = new BeanContextServiceRevokedEvent(java.beans.beancontext.BeanContextServicesSupport.this.getBeanContextServicesPeer(), serviceClassRef.getServiceClass(), true);
                boolean                        noMoreRefs  = false;
