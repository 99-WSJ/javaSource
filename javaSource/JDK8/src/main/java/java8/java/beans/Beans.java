...
public class Beans {
    ...
    public static Object instantiate(ClassLoader cls, String beanName) throws IOException, ClassNotFoundException {
        return java.beans.Beans.instantiate(cls, beanName, null, null);
    }
    ...
    public static Object instantiate(ClassLoader cls, String beanName, BeanContext beanContext) throws IOException, ClassNotFoundException {
        return java.beans.Beans.instantiate(cls, beanName, beanContext, null);
    }
        ...
        if (ins != null) {
            try {
                if (cls == null) {
                    ...
                    oins = new java.beans.ObjectInputStreamWithLoader(ins, cls);
                }
        ...
        if (result != null) {
            ...
            if (result instanceof Applet) {
                ...
                if (needDummies) {
                    ...
                    java.beans.BeansAppletContext context = new java.beans.BeansAppletContext(applet);

                    stub = (AppletStub)new java.beans.BeansAppletStub(applet, context, codeBase, docBase);
                    applet.setStub(stub);
                } else {
                ...
                if (needDummies) {
                  ((java.beans.BeansAppletStub)stub).active = true;
