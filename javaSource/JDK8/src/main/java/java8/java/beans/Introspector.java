...
public class Introspector {
        ...
        throws IntrospectionException
    {
        if (!ReflectUtil.isPackageAccessible(beanClass)) {
            return (new java.beans.Introspector(beanClass, null, USE_ALL_BEANINFO)).getBeanInfo();
        }
        ...
        if (beanInfo == null) {
            beanInfo = new java.beans.Introspector(beanClass, null, USE_ALL_BEANINFO).getBeanInfo();
            synchronized (declaredMethodCache) {
    ...
    public static BeanInfo getBeanInfo(Class<?> beanClass, Class<?> stopClass,
        ...
        if (stopClass == null && flags == USE_ALL_BEANINFO) {
            ...
            bi = (new java.beans.Introspector(beanClass, stopClass, flags)).getBeanInfo();
        }
        return bi;
    ...
    private BeanInfo getBeanInfo() throws IntrospectionException {
        ...
        return new java.beans.GenericBeanInfo(bd, esds, defaultEvent, pds,
                ...
                if (name.startsWith(ADD_PREFIX)) {
                    ...
                    if (returnType == void.class) {
                        ...
                        if (parameterTypes.length == 1) {
                            ...
                            if (java.beans.Introspector.isSubclass(type, eventListenerType)) {
...
class GenericBeanInfo extends SimpleBeanInfo {
     ...
     */
    GenericBeanInfo(java.beans.GenericBeanInfo old) {
