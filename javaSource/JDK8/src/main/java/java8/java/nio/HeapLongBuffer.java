    ...
    extends LongBuffer
{
    ...
    */
    ...
    public LongBuffer slice() {
        return new java.nio.HeapLongBuffer(hb,
                                        -1,
                                        0,
                                        this.remaining(),
                                        this.remaining(),
    ...
    public LongBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.HeapLongBufferR(hb,
                                     this.markValue(),
                                     this.position(),
                                     this.limit(),
                                     this.capacity(),
    ...
    public LongBuffer put(LongBuffer src) {
        ...
        if (src instanceof java.nio.HeapLongBuffer) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.HeapLongBuffer sb = (java.nio.HeapLongBuffer)src;
            int n = sb.remaining();
            if (n > remaining())
                throw new BufferOverflowException();
