...
public abstract class CharBuffer
    extends Buffer
    implements Comparable<java.nio.CharBuffer>, Appendable, CharSequence, Readable
{
     ...
     *          parameters do not hold
     */
    public static java.nio.CharBuffer wrap(CharSequence csq, int start, int end) {
        try {
            return new java.nio.StringCharBuffer(csq, start, end);
        } catch (IllegalArgumentException x) {
            throw new IndexOutOfBoundsException();
        }
    }
     ...
     * @return  The new character buffer
     */
    public static java.nio.CharBuffer wrap(CharSequence csq) {
     ...
     *          If this buffer is read-only
     */
    public final java.nio.CharBuffer put(String src) {
        return put(src, 0, src.length());
    }
    ...
    public boolean equals(Object ob) {
        if (this == ob)
            return true;
        if (!(ob instanceof java.nio.CharBuffer))
            return false;
        java.nio.CharBuffer that = (java.nio.CharBuffer)ob;
     ...
     * @since  1.5
     */
    public java.nio.CharBuffer append(CharSequence csq) {
        if (csq == null)
            return put("null");
        else
     ...
     * @since  1.5
     */
    public java.nio.CharBuffer append(CharSequence csq, int start, int end) {
    ...
    public IntStream chars() {
        return StreamSupport.intStream(() -> new java.nio.CharBufferSpliterator(this),
