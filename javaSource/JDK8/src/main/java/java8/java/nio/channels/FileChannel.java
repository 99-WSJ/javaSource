    ...
    implements SeekableByteChannel, GatheringByteChannel, ScatteringByteChannel
{
     ...
     * @since   1.7
     */
    public static java.nio.channels.FileChannel open(Path path,
     ...
     * @since   1.7
     */
    public static java.nio.channels.FileChannel open(Path path, OpenOption... options)
        throws IOException
    {
     ...
     *          If some other I/O error occurs
     */
    public abstract java.nio.channels.FileChannel position(long newPosition) throws IOException;
     ...
     *          If some other I/O error occurs
     */
    public abstract java.nio.channels.FileChannel truncate(long size) throws IOException;
