    ...
    extends DirectoryStream<T>
{
     ...
     */
    java.nio.file.SecureDirectoryStream<T> newDirectoryStream(T path, LinkOption... options)
        throws IOException;
     ...
     *          target file.
     */
    void move(T srcpath, java.nio.file.SecureDirectoryStream<T> targetdir, T targetpath)
        throws IOException;
