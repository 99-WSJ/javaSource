    ...
    extends ByteChannel
{
     ...
     *          If some other I/O error occurs
     */
    java.nio.channels.SeekableByteChannel position(long newPosition) throws IOException;
     ...
     *          If some other I/O error occurs
     */
    java.nio.channels.SeekableByteChannel truncate(long size) throws IOException;
}
