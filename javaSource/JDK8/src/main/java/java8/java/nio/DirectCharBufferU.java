    ...
    implements DirectBuffer
{
    ...
    public CharBuffer slice() {
        ...
        int off = (pos << 1);
        assert (off >= 0);
        return new java.nio.DirectCharBufferU(this, -1, 0, rem, rem, off);
    }

    public CharBuffer duplicate() {
        return new java.nio.DirectCharBufferU(this,
                                              this.markValue(),
                                              this.position(),
                                              this.limit(),
                                              this.capacity(),
    ...
    public CharBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.DirectCharBufferRU(this,
                                           this.markValue(),
                                           this.position(),
                                           this.limit(),
                                           this.capacity(),
    ...
    public CharBuffer put(CharBuffer src) {
        ...
        if (src instanceof java.nio.DirectCharBufferU) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.DirectCharBufferU sb = (java.nio.DirectCharBufferU)src;
