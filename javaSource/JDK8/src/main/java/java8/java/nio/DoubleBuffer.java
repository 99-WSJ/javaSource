...
public abstract class DoubleBuffer
    extends Buffer
    implements Comparable<java.nio.DoubleBuffer>
{
     ...
     *          parameters do not hold
     */
    public java.nio.DoubleBuffer get(double[] dst, int offset, int length) {
    ...
    public boolean equals(Object ob) {
        if (this == ob)
            return true;
        if (!(ob instanceof java.nio.DoubleBuffer))
            return false;
        java.nio.DoubleBuffer that = (java.nio.DoubleBuffer)ob;
