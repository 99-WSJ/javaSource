    ...
    implements DirectBuffer
{
    ...
    public FloatBuffer slice() {
        ...
        int off = (pos << 2);
        assert (off >= 0);
        return new java.nio.DirectFloatBufferU(this, -1, 0, rem, rem, off);
    }

    public FloatBuffer duplicate() {
        return new java.nio.DirectFloatBufferU(this,
                                              this.markValue(),
                                              this.position(),
                                              this.limit(),
                                              this.capacity(),
    ...
    public FloatBuffer put(FloatBuffer src) {
        ...
        if (src instanceof java.nio.DirectFloatBufferU) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.DirectFloatBufferU sb = (java.nio.DirectFloatBufferU)src;
