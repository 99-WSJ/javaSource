...
public final class AclEntry {
    ...
    /**
     * A builder of {@link java.nio.file.attribute.AclEntry} objects.
     *
     * <p> A {@code Builder} object is obtained by invoking one of the {@link
     * java.nio.file.attribute.AclEntry#newBuilder newBuilder} methods defined by the {@code AclEntry}
     * class.
     *
    ...
    public static final class Builder {
        ...
        /**
         * Constructs an {@link java.nio.file.attribute.AclEntry} from the components of this builder.
        ...
        public java.nio.file.attribute.AclEntry build() {
            ...
            return new java.nio.file.attribute.AclEntry(type, who, perms, flags);
        }
     ...
     * @return  a new builder
     */
    public static Builder newBuilder(java.nio.file.attribute.AclEntry entry) {
    ...
    public boolean equals(Object ob) {
        if (ob == this)
            return true;
        if (ob == null || !(ob instanceof java.nio.file.attribute.AclEntry))
            return false;
        java.nio.file.attribute.AclEntry other = (java.nio.file.attribute.AclEntry)ob;
