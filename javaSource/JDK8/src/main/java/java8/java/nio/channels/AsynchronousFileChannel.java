    ...
    implements AsynchronousChannel
{
     ...
     */
    public static java.nio.channels.AsynchronousFileChannel open(Path file,
     ...
     *          If some other I/O error occurs
     */
    public abstract java.nio.channels.AsynchronousFileChannel truncate(long size) throws IOException;
