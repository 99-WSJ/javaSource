    ...
    extends ShortBuffer
{
    ...
    */
    ...
    public ShortBuffer slice() {
        return new java.nio.HeapShortBuffer(hb,
                                        -1,
                                        0,
                                        this.remaining(),
                                        this.remaining(),
    ...
    public ShortBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.HeapShortBufferR(hb,
                                     this.markValue(),
                                     this.position(),
                                     this.limit(),
                                     this.capacity(),
    ...
    public ShortBuffer put(ShortBuffer src) {
        ...
        if (src instanceof java.nio.HeapShortBuffer) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.HeapShortBuffer sb = (java.nio.HeapShortBuffer)src;
            int n = sb.remaining();
            if (n > remaining())
                throw new BufferOverflowException();
