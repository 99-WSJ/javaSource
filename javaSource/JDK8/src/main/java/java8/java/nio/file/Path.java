...
public interface Path
    extends Comparable<java.nio.file.Path>, Iterable<java.nio.file.Path>, Watchable
{
    /**
     ...
     * @return  the resulting path
     *
     * @see #resolve(java.nio.file.Path)
     */
     ...
     * @see FileSystem#getPath
     */
    java.nio.file.Path resolveSibling(String other);
     ...
     *          system property {@code user.dir}
     */
    java.nio.file.Path toRealPath(LinkOption... options) throws IOException;
