...
public abstract class FloatBuffer
    extends Buffer
    implements Comparable<java.nio.FloatBuffer>
{
    ...
    public static java.nio.FloatBuffer allocate(int capacity) {
        ...
        return new java.nio.HeapFloatBuffer(capacity, capacity);
    }
    ...
    {
        try {
            return new java.nio.HeapFloatBuffer(array, offset, length);
     ...
     *          parameters do not hold
     */
    public java.nio.FloatBuffer get(float[] dst, int offset, int length) {
     ...
     *          If this buffer is read-only
     */
    public java.nio.FloatBuffer put(float[] src, int offset, int length) {
    ...
    public boolean equals(Object ob) {
        if (this == ob)
            return true;
        if (!(ob instanceof java.nio.FloatBuffer))
            return false;
        java.nio.FloatBuffer that = (java.nio.FloatBuffer)ob;
