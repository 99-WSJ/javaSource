    ...
    implements Comparable<java.nio.charset.Charset>
{
    ...
    private static void cache(String charsetName, java.nio.charset.Charset cs) {
        cache2 = cache1;
    ...
    private static java.nio.charset.Charset lookupViaProviders(final String charsetName) {
        ...
        try {
            ...
            return AccessController.doPrivileged(
                new PrivilegedAction<java.nio.charset.Charset>() {
                    public java.nio.charset.Charset run() {
                        for (Iterator<CharsetProvider> i = providers();
                             i.hasNext();) {
                            CharsetProvider cp = i.next();
                            java.nio.charset.Charset cs = cp.charsetForName(charsetName);
                            if (cs != null)
                                return cs;
                        }
                        return null;
    ...
    private static java.nio.charset.Charset lookupExtendedCharset(String charsetName) {
        CharsetProvider ecp = ExtendedProviderHolder.extendedProvider;
        return (ecp != null) ? ecp.charsetForName(charsetName) : null;
    }

    private static java.nio.charset.Charset lookup(String charsetName) {
        if (charsetName == null)
    ...
    private static java.nio.charset.Charset lookup2(String charsetName) {
        Object[] a;
    ...
    //
    private static void put(Iterator<java.nio.charset.Charset> i, Map<String, java.nio.charset.Charset> m) {
        while (i.hasNext()) {
            java.nio.charset.Charset cs = i.next();
    ...
    public static SortedMap<String, java.nio.charset.Charset> availableCharsets() {
        return AccessController.doPrivileged(
            new PrivilegedAction<SortedMap<String, java.nio.charset.Charset>>() {
                public SortedMap<String, java.nio.charset.Charset> run() {
                    TreeMap<String, java.nio.charset.Charset> m =
                        new TreeMap<String, java.nio.charset.Charset>(
    ...
    public static java.nio.charset.Charset defaultCharset() {
        if (defaultCharset == null) {
            synchronized (java.nio.charset.Charset.class) {
                String csn = AccessController.doPrivileged(
                    new GetPropertyAction("file.encoding"));
                java.nio.charset.Charset cs = lookup(csn);
                if (cs != null)
                    defaultCharset = cs;
                else
