...
public abstract class IntBuffer
    extends Buffer
    implements Comparable<java.nio.IntBuffer>
{
    ...
    public static java.nio.IntBuffer allocate(int capacity) {
        ...
        return new java.nio.HeapIntBuffer(capacity, capacity);
    }
    ...
    {
        try {
            return new java.nio.HeapIntBuffer(array, offset, length);
    ...
    public boolean equals(Object ob) {
        if (this == ob)
            return true;
        if (!(ob instanceof java.nio.IntBuffer))
            return false;
        java.nio.IntBuffer that = (java.nio.IntBuffer)ob;
