    ...
    extends CharBuffer
{
    ...
    public CharBuffer slice() {
        ...
        assert (off >= 0);
        return new java.nio.ByteBufferAsCharBufferL(bb, -1, 0, rem, rem, off);
    }

    public CharBuffer duplicate() {
        return new java.nio.ByteBufferAsCharBufferL(bb,
                                                    this.markValue(),
                                                    this.position(),
                                                    this.limit(),
                                                    this.capacity(),
    ...
    public CharBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.ByteBufferAsCharBufferRL(bb,
                                                 this.markValue(),
                                                 this.position(),
                                                 this.limit(),
                                                 this.capacity(),
