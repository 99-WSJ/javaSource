    ...
    implements DirectBuffer
{
    ...
    public IntBuffer slice() {
        ...
        int off = (pos << 2);
        assert (off >= 0);
        return new java.nio.DirectIntBufferU(this, -1, 0, rem, rem, off);
    }

    public IntBuffer duplicate() {
        return new java.nio.DirectIntBufferU(this,
                                              this.markValue(),
                                              this.position(),
                                              this.limit(),
                                              this.capacity(),
    ...
    public IntBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.DirectIntBufferRU(this,
                                           this.markValue(),
                                           this.position(),
                                           this.limit(),
                                           this.capacity(),
    ...
    public IntBuffer put(IntBuffer src) {
        ...
        if (src instanceof java.nio.DirectIntBufferU) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.DirectIntBufferU sb = (java.nio.DirectIntBufferU)src;
