...
public final class FileTime
    implements Comparable<java.nio.file.attribute.FileTime>
{
    /**
     ...
     */
    public static java.nio.file.attribute.FileTime from(long value, TimeUnit unit) {
        Objects.requireNonNull(unit, "unit");
        return new java.nio.file.attribute.FileTime(value, unit, null);
    }
    ...
    public static java.nio.file.attribute.FileTime fromMillis(long value) {
        return new java.nio.file.attribute.FileTime(value, TimeUnit.MILLISECONDS, null);
    }
     ...
     * @since 1.8
     */
    public static java.nio.file.attribute.FileTime from(Instant instant) {
        Objects.requireNonNull(instant, "instant");
        return new java.nio.file.attribute.FileTime(0, null, instant);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof java.nio.file.attribute.FileTime) ? compareTo((java.nio.file.attribute.FileTime)obj) == 0 : false;
    }
