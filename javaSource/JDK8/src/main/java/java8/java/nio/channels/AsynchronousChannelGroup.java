 ...
 * @since 1.7
 *
 * @see AsynchronousSocketChannel#open(java.nio.channels.AsynchronousChannelGroup)
 * @see AsynchronousServerSocketChannel#open(java.nio.channels.AsynchronousChannelGroup)
 */
...
public abstract class AsynchronousChannelGroup {
     ...
     */
    public static java.nio.channels.AsynchronousChannelGroup withFixedThreadPool(int nThreads,
     ...
     */
    public static java.nio.channels.AsynchronousChannelGroup withCachedThreadPool(ExecutorService executor,
                                                                                  int initialSize)
        throws IOException
    {
        return AsynchronousChannelProvider.provider()
     ...
     *          If an I/O error occurs
     */
    public static java.nio.channels.AsynchronousChannelGroup withThreadPool(ExecutorService executor)
        throws IOException
    {
        return AsynchronousChannelProvider.provider()
