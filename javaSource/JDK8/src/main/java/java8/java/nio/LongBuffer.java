...
public abstract class LongBuffer
    extends Buffer
    implements Comparable<java.nio.LongBuffer>
{
    ...
    public static java.nio.LongBuffer allocate(int capacity) {
        ...
        return new java.nio.HeapLongBuffer(capacity, capacity);
    }
    ...
    {
        try {
            return new java.nio.HeapLongBuffer(array, offset, length);
     ...
     *          parameters do not hold
     */
    public java.nio.LongBuffer get(long[] dst, int offset, int length) {
    ...
    public boolean equals(Object ob) {
        if (this == ob)
            return true;
        if (!(ob instanceof java.nio.LongBuffer))
            return false;
        java.nio.LongBuffer that = (java.nio.LongBuffer)ob;
