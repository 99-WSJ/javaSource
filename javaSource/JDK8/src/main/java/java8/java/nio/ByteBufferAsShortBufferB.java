    ...
    extends ShortBuffer
{
    ...
    public ShortBuffer slice() {
        ...
        assert (off >= 0);
        return new java.nio.ByteBufferAsShortBufferB(bb, -1, 0, rem, rem, off);
    }

    public ShortBuffer duplicate() {
        return new java.nio.ByteBufferAsShortBufferB(bb,
                                                    this.markValue(),
                                                    this.position(),
                                                    this.limit(),
                                                    this.capacity(),
    ...
    public ShortBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.ByteBufferAsShortBufferRB(bb,
                                                 this.markValue(),
                                                 this.position(),
                                                 this.limit(),
                                                 this.capacity(),
