 ...
 * channel via the channel's {@link SelectableChannel#register(java.nio.channels.Selector,int)
...
public abstract class Selector implements Closeable {
     ...
     */
    public static java.nio.channels.Selector open() throws IOException {
