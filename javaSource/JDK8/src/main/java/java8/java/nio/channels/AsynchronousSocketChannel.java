    ...
    implements AsynchronousByteChannel, NetworkChannel
{
     ...
     */
    public static java.nio.channels.AsynchronousSocketChannel open(AsynchronousChannelGroup group)
        throws IOException
    {
     ...
     */
    @Override
    public abstract java.nio.channels.AsynchronousSocketChannel bind(SocketAddress local)
        throws IOException;
     ...
     */
    @Override
    public abstract <T> java.nio.channels.AsynchronousSocketChannel setOption(SocketOption<T> name, T value)
        throws IOException;
     ...
     */
    public abstract java.nio.channels.AsynchronousSocketChannel shutdownInput() throws IOException;
     ...
     *          If some other I/O error occurs
     */
    public abstract java.nio.channels.AsynchronousSocketChannel shutdownOutput() throws IOException;
