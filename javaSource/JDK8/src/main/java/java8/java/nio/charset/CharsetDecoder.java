...
public abstract class CharsetDecoder {
     ...
     */
    public final java.nio.charset.CharsetDecoder replaceWith(String newReplacement) {
     ...
     */
    public final java.nio.charset.CharsetDecoder onMalformedInput(CodingErrorAction newAction) {
        if (newAction == null)
     ...
     *         If the precondition on the parameter does not hold
     */
    public final java.nio.charset.CharsetDecoder onUnmappableCharacter(CodingErrorAction
                                                      newAction)
    {
        if (newAction == null)
            throw new IllegalArgumentException("Null action");
