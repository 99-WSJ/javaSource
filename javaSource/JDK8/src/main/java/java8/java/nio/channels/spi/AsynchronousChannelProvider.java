...
public abstract class AsynchronousChannelProvider {
    ...
    private static class ProviderHolder {
        static final java.nio.channels.spi.AsynchronousChannelProvider provider = load();

        private static java.nio.channels.spi.AsynchronousChannelProvider load() {
            return AccessController
                .doPrivileged(new PrivilegedAction<java.nio.channels.spi.AsynchronousChannelProvider>() {
                    public java.nio.channels.spi.AsynchronousChannelProvider run() {
                        java.nio.channels.spi.AsynchronousChannelProvider p;
        ...
        private static java.nio.channels.spi.AsynchronousChannelProvider loadProviderFromProperty() {
            ...
            try {
                ...
                return (java.nio.channels.spi.AsynchronousChannelProvider)c.newInstance();
        ...
        private static java.nio.channels.spi.AsynchronousChannelProvider loadProviderAsService() {
            ServiceLoader<java.nio.channels.spi.AsynchronousChannelProvider> sl =
                ServiceLoader.load(java.nio.channels.spi.AsynchronousChannelProvider.class,
                                   ClassLoader.getSystemClassLoader());
            Iterator<java.nio.channels.spi.AsynchronousChannelProvider> i = sl.iterator();
            for (;;) {
                try {
