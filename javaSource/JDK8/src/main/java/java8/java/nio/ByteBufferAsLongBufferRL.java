...
class ByteBufferAsLongBufferRL                  // package-private
    extends java.nio.ByteBufferAsLongBufferL
{
    ...
    public LongBuffer slice() {
        ...
        assert (off >= 0);
        return new java.nio.ByteBufferAsLongBufferRL(bb, -1, 0, rem, rem, off);
    }

    public LongBuffer duplicate() {
        return new java.nio.ByteBufferAsLongBufferRL(bb,
                                                    this.markValue(),
                                                    this.position(),
                                                    this.limit(),
                                                    this.capacity(),
