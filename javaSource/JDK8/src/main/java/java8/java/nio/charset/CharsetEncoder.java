...
public abstract class CharsetEncoder {
     ...
     */
    public final java.nio.charset.CharsetEncoder onMalformedInput(CodingErrorAction newAction) {
        if (newAction == null)
     ...
     *         If the precondition on the parameter does not hold
     */
    public final java.nio.charset.CharsetEncoder onUnmappableCharacter(CodingErrorAction
                                                      newAction)
    {
        if (newAction == null)
            throw new IllegalArgumentException("Null action");
