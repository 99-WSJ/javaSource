    ...
    implements DirectBuffer
{
    ...
    public DoubleBuffer slice() {
        ...
        int off = (pos << 3);
        assert (off >= 0);
        return new java.nio.DirectDoubleBufferU(this, -1, 0, rem, rem, off);
    }

    public DoubleBuffer duplicate() {
        return new java.nio.DirectDoubleBufferU(this,
                                              this.markValue(),
                                              this.position(),
                                              this.limit(),
                                              this.capacity(),
    ...
    public DoubleBuffer put(DoubleBuffer src) {
        ...
        if (src instanceof java.nio.DirectDoubleBufferU) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.DirectDoubleBufferU sb = (java.nio.DirectDoubleBufferU)src;
