    ...
    implements DirectBuffer
{
    ...
    public ShortBuffer slice() {
        ...
        int off = (pos << 1);
        assert (off >= 0);
        return new java.nio.DirectShortBufferU(this, -1, 0, rem, rem, off);
    }

    public ShortBuffer duplicate() {
        return new java.nio.DirectShortBufferU(this,
                                              this.markValue(),
                                              this.position(),
                                              this.limit(),
                                              this.capacity(),
    ...
    public ShortBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.DirectShortBufferRU(this,
                                           this.markValue(),
                                           this.position(),
                                           this.limit(),
                                           this.capacity(),
    ...
    public ShortBuffer put(ShortBuffer src) {
        ...
        if (src instanceof java.nio.DirectShortBufferU) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.DirectShortBufferU sb = (java.nio.DirectShortBufferU)src;
