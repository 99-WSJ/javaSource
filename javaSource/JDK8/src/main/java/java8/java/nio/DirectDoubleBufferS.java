    ...
    implements DirectBuffer
{
    ...
    public DoubleBuffer slice() {
        ...
        int off = (pos << 3);
        assert (off >= 0);
        return new java.nio.DirectDoubleBufferS(this, -1, 0, rem, rem, off);
    }

    public DoubleBuffer duplicate() {
        return new java.nio.DirectDoubleBufferS(this,
                                              this.markValue(),
                                              this.position(),
                                              this.limit(),
                                              this.capacity(),
    ...
    public DoubleBuffer asReadOnlyBuffer() {
        ...
        return new java.nio.DirectDoubleBufferRS(this,
                                           this.markValue(),
                                           this.position(),
                                           this.limit(),
                                           this.capacity(),
    ...
    public double get() {
        return Double.longBitsToDouble(java.nio.Bits.swap(unsafe.getLong(ix(nextGetIndex()))));
    }

    public double get(int i) {
        return Double.longBitsToDouble(java.nio.Bits.swap(unsafe.getLong(ix(checkIndex(i)))));
    }
    ...
    public DoubleBuffer put(double x) {
        ...
        unsafe.putLong(ix(nextPutIndex()), java.nio.Bits.swap(Double.doubleToRawLongBits(x)));
        return this;
    ...
    public DoubleBuffer put(int i, double x) {
        ...
        unsafe.putLong(ix(checkIndex(i)), java.nio.Bits.swap(Double.doubleToRawLongBits(x)));
        return this;
    ...
    public DoubleBuffer put(DoubleBuffer src) {
        ...
        if (src instanceof java.nio.DirectDoubleBufferS) {
            if (src == this)
                throw new IllegalArgumentException();
            java.nio.DirectDoubleBufferS sb = (java.nio.DirectDoubleBufferS)src;
