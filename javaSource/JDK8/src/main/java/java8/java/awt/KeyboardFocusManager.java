    ...
    implements KeyEventDispatcher, KeyEventPostProcessor
{
    ...
    static {
        ...
        AWTAccessor.setKeyboardFocusManagerAccessor(
            new AWTAccessor.KeyboardFocusManagerAccessor() {
                ...
                {
                    return java.awt.KeyboardFocusManager.shouldNativelyFocusHeavyweight(
                ...
                public boolean processSynchronousLightweightTransfer(Component heavyweight,
                                                              ...
                                                              long time)
                {
                    return java.awt.KeyboardFocusManager.processSynchronousLightweightTransfer(
                ...
                public java.awt.KeyboardFocusManager getCurrentKeyboardFocusManager(AppContext ctx) {
    ...
    synchronized static java.awt.KeyboardFocusManager
        getCurrentKeyboardFocusManager(AppContext appcontext)
    {
        java.awt.KeyboardFocusManager manager = (java.awt.KeyboardFocusManager)
            appcontext.get(java.awt.KeyboardFocusManager.class);
        if (manager == null) {
    ...
    public static void setCurrentKeyboardFocusManager(
        java.awt.KeyboardFocusManager newManager) throws SecurityException
    {
     ...
     *
     * @see java.awt.KeyboardFocusManager#clearFocusOwner
     * @see Component#requestFocus()
     * @see FocusEvent#FOCUS_LOST
                                                  ...
                                                  long time)
    {
        ...
        java.awt.KeyboardFocusManager manager = getCurrentKeyboardFocusManager(SunToolkit.targetToAppContext(descendant));
         ...
         boolean focusedWindowChangeAllowed, long time, CausedFocusEvent.Cause cause)
    {
        ...
        java.awt.KeyboardFocusManager thisManager = getCurrentKeyboardFocusManager();
    ...
    static void processCurrentLightweightRequests() {
        java.awt.KeyboardFocusManager manager = getCurrentKeyboardFocusManager();
        ...
        try {
            if (localLightweightRequests != null) {
                ...
                for (Iterator<java.awt.KeyboardFocusManager.LightweightFocusRequest> iter = localLightweightRequests.iterator(); iter.hasNext(); ) {
        ...
        synchronized(heavyweightRequests) {
            ...
            if (hwFocusRequest != null) {
                ...
                if (hwFocusRequest.lightweightRequests != null) {
                    for (Iterator<java.awt.KeyboardFocusManager.LightweightFocusRequest> lwIter = hwFocusRequest.lightweightRequests.
                             iterator();
                         lwIter.hasNext(); )
                    {
