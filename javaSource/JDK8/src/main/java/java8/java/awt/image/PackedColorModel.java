...
public abstract class PackedColorModel extends ColorModel {
    ...
    public PackedColorModel (ColorSpace space, int bits,
        ...
        super(bits, java.awt.image.PackedColorModel.createBitsArray(colorMaskArray,
                                                     alphaMask),
    ...
    public PackedColorModel(ColorSpace space, int bits, int rmask, int gmask,
                            ...
                            boolean isAlphaPremultiplied,
                            int trans, int transferType) {
        super (bits, java.awt.image.PackedColorModel.createBitsArray(rmask, gmask, bmask,
                                                      amask),
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof java.awt.image.PackedColorModel)) {
            return false;
        }
        ...
        java.awt.image.PackedColorModel cm = (java.awt.image.PackedColorModel) obj;
