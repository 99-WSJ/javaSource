...
public class EventQueue {
     ...
     * across all Queues.
     */
    private java.awt.Queue[] queues = new java.awt.Queue[NUM_PRIORITIES];
    ...
    static {
        AWTAccessor.setEventQueueAccessor(
            new AWTAccessor.EventQueueAccessor() {
                public Thread getDispatchThread(java.awt.EventQueue eventQueue) {
                    return eventQueue.getDispatchThread();
                }
                public boolean isDispatchThreadImpl(java.awt.EventQueue eventQueue) {
                    return eventQueue.isDispatchThreadImpl();
                }
                public void removeSourceEvents(java.awt.EventQueue eventQueue,
                                               Object source,
                ...
                public void setFwDispatcher(java.awt.EventQueue eventQueue,
    ...
    public void push(java.awt.EventQueue newEventQueue) {
        ...
        pushPopLock.lock();
        try {
            java.awt.EventQueue topQueue = this;
    ...
    SecondaryLoop createSecondaryLoop(java.awt.Conditional cond, EventFilter filter, long interval) {
        pushPopLock.lock();
        try {
            if (nextQueue != null) {
    ...
    public static boolean isDispatchThread() {
        java.awt.EventQueue eq = Toolkit.getEventQueue();
        return eq.isDispatchThreadImpl();
    }

    final boolean isDispatchThreadImpl() {
        java.awt.EventQueue eq = this;
        pushPopLock.lock();
        try {
