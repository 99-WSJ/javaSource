...
public class ICC_Profile implements Serializable {
    ...
    java.awt.color.ICC_Profile thisProfile;
        ...
        try {
            if ((getColorSpaceType (p) == ColorSpace.TYPE_GRAY) &&
                ...
                thisProfile = new java.awt.color.ICC_Profile(p);
            }
        } catch (CMMException c) {
            thisProfile = new java.awt.color.ICC_Profile(p);
        }
    ...
    public static java.awt.color.ICC_Profile getInstance (int cspace) {
        java.awt.color.ICC_Profile thisProfile = null;
        String fileName;

        switch (cspace) {
        case ColorSpace.CS_sRGB:
            synchronized(java.awt.color.ICC_Profile.class) {
                if (sRGBprofile == null) {
                    /*
     ...
     * standard profiles.
     */
    private static java.awt.color.ICC_Profile getStandardProfile(final String name) {

        return AccessController.doPrivileged(
            new PrivilegedAction<java.awt.color.ICC_Profile>() {
                 public java.awt.color.ICC_Profile run() {
                     java.awt.color.ICC_Profile p = null;
                     try {
                         p = getInstance (name);
     ...
     */
    public static java.awt.color.ICC_Profile getInstance(String fileName) throws IOException {
        java.awt.color.ICC_Profile thisProfile;
     ...
     * contain valid ICC Profile data.
     */
    public static java.awt.color.ICC_Profile getInstance(InputStream s) throws IOException {
    byte profileData[];
     ...
     */
    static java.awt.color.ICC_Profile getDeferredInstance(ProfileDeferralInfo pdi) {
        if (!ProfileDeferralMgr.deferring) {
        ...
        if (pdi.colorSpaceType == ColorSpace.TYPE_RGB) {
            ...
            return new java.awt.color.ICC_Profile(pdi);
        }
    }
