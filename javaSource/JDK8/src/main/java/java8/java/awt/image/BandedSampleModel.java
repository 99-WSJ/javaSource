...
public final class BandedSampleModel extends ComponentSampleModel
{
    ...
    public BandedSampleModel(int dataType, int w, int h, int numBands) {
        super(dataType, w, h, 1, w,
              java.awt.image.BandedSampleModel.createIndicesArray(numBands),
              java.awt.image.BandedSampleModel.createOffsetArray(numBands));
    }
    ...
    public SampleModel createCompatibleSampleModel(int w, int h) {
        ...
        SampleModel sampleModel =
            new java.awt.image.BandedSampleModel(dataType, w, h, w, bankIndices, bandOffs);
        return sampleModel;
    }
    ...
    public SampleModel createSubsetSampleModel(int bands[]) {
        ...
        return new java.awt.image.BandedSampleModel(this.dataType, width, height,
                                     this.scanlineStride,
