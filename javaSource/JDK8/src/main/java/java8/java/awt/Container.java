...
public class Container extends Component {
    ...
    private static final ObjectStreamField[] serialPersistentFields = {
        ...
        new ObjectStreamField("dispatcher", java.awt.LightweightDispatcher.class),
    ...
    static {
        ...
        AWTAccessor.setContainerAccessor(new AWTAccessor.ContainerAccessor() {
            ...
            @Override
            public Component findComponentAt(java.awt.Container cont, int x, int y,
    ...
    private void checkAddToSelf(Component comp){
        if (comp instanceof java.awt.Container) {
            for (java.awt.Container cn = this; cn != null; cn=cn.parent) {
                if (cn == comp) {
     ...
     * @since: 1.5
     */
    private boolean removeDelicately(Component comp, java.awt.Container newParent, int newIndex) {
        checkTreeLock();
     ...
     * @since: 1.5
     */
    private static boolean isRemoveNotifyNeeded(Component comp, java.awt.Container oldContainer, java.awt.Container newContainer) {
     ...
     * @since 1.5
     */
    private void reparentTraverse(ContainerPeer parentPeer, java.awt.Container child) {
        checkTreeLock();
    ...
    private void reparentChild(Component comp) {
        ...
        if (comp.isLightweight()) {
            ...
            if (comp instanceof java.awt.Container) {
                ...
                reparentTraverse((ContainerPeer)getPeer(), (java.awt.Container)comp);
            }
        } else {
     ...
     * @since 1.5
     */
    private void addDelicately(Component comp, java.awt.Container curParent, int index) {
        checkTreeLock();
    ...
    final int createHierarchyEvents(int id, Component changed,
                                    java.awt.Container changedParent, long changeFlags, boolean enabledOnToolkit)
    {
        checkTreeLock();
     ...
     * the {@link LayoutManager2#invalidateLayout(java.awt.Container)} method is invoked
     ...
     * then {@link LayoutManager#preferredLayoutSize(java.awt.Container)}
     ...
     * @see       #getMaximumSize
     * @see       #getLayout
     * @see       LayoutManager#preferredLayoutSize(java.awt.Container)
     ...
     * and this {@code Container} has a {@code non-null} {@link LayoutManager},
     * then {@link LayoutManager#minimumLayoutSize(java.awt.Container)}
     ...
     * @see       #getMaximumSize
     * @see       #getLayout
     * @see       LayoutManager#minimumLayoutSize(java.awt.Container)
     ...
     * {@link LayoutManager2#maximumLayoutSize(java.awt.Container)}
     ...
     * @see       #getMinimumSize
     * @see       #getLayout
     * @see       LayoutManager2#maximumLayoutSize(java.awt.Container)
    ...
    final Component findComponentAtImpl(int x, int y, boolean ignoreEnabled){
        ...
        for (int i = 0; i < component.size(); i++) {
            ...
            if (comp != null &&
                !(comp.peer instanceof LightweightPeer)) {
                if (comp instanceof java.awt.Container) {
                    comp = ((java.awt.Container)comp).findComponentAtImpl(x - comp.x,
                                                                 y - comp.y,
                                                                 ignoreEnabled);
                } else {
    ...
    public void addNotify() {
        synchronized (getTreeLock()) {
            ...
            super.addNotify();
            if (! (peer instanceof LightweightPeer)) {
                dispatcher = new java.awt.LightweightDispatcher(this);
            }
    ...
    private java.awt.Container findTraversalRoot() {
        ...
        java.awt.Container currentFocusCycleRoot = KeyboardFocusManager.
    ...
    void preProcessKeyEvent(KeyEvent e) {
        java.awt.Container parent = this.parent;
        if (parent != null) {
     ...
     * @see java.awt.Container#containerListenerK
    ...
    final void increaseComponentCount(Component c) {
        synchronized (getTreeLock()) {
            ...
            for (java.awt.Container cont = this; cont != null; cont = cont.getContainer()) {
        ...
        for (int index = fromZorder; index <= toZorder; index++) {
            ...
            if (!comp.isLightweight()) {
                comp.subtractAndApplyShape(shape);
                    ...
                    ((java.awt.Container)comp).hasHeavyweightDescendants() && comp.isShowing()) {
    ...
    final void recursiveApplyCurrentShape(int fromZorder, int toZorder) {
        ...
        for (int index = fromZorder; index <= toZorder; index++) {
            ...
            if (comp instanceof java.awt.Container &&
                    ((java.awt.Container)comp).hasHeavyweightDescendants()) {
    ...
    final boolean isRecursivelyVisibleUpToHeavyweightContainer() {
        ...
        for (java.awt.Container cont = this;
    ...
    void mixOnReshaping() {
        synchronized (getTreeLock()) {
            ...
            if (isLightweight() && hasHeavyweightDescendants()) {
                ...
                for (java.awt.Container cont = getContainer();
                     cont != null && cont.isLightweight();
                     cont = cont.getContainer())
                {
    ...
    private boolean processMouseEvent(MouseEvent e) {
        ...
        Component mouseOver =   // sensitive to mouse events
            nativeContainer.getMouseEventTarget(e.getX(), e.getY(),
                                                java.awt.Container.INCLUDE_SELF);
            ...
            new java.security.PrivilegedAction<Object>() {
                public Object run() {
                    nativeContainer.getToolkit().addAWTEventListener(
                        java.awt.LightweightDispatcher.this,
