...
public final class SystemFlavorMap implements FlavorMap, FlavorTable {
    ...
    public static String encodeDataFlavor(DataFlavor flav) {
        return (flav != null)
            ? java.awt.datatransfer.SystemFlavorMap.encodeJavaMIMEType(flav.getMimeType())
            : null;
    }
    ...
    {
        String retval_str = java.awt.datatransfer.SystemFlavorMap.decodeJavaMIMEType(nat);
