 ...
 * with {@link #Window(java.awt.Window, GraphicsConfiguration)}.  The
...
public class Window extends Container implements Accessible {
     ...
     * @since 1.6
     */
    private static final IdentityArrayList<java.awt.Window> allWindows = new IdentityArrayList<java.awt.Window>();
     ...
     * @see #getOwnedWindows
     */
    transient Vector<WeakReference<java.awt.Window>> ownedWindowList =
                                            new Vector<WeakReference<java.awt.Window>>();
     ...
     * correctly.
     */
    private transient WeakReference<java.awt.Window> weakThis;
    ...
    static class WindowDisposerRecord implements sun.java2d.DisposerRecord {
        WeakReference<java.awt.Window> owner;
        final WeakReference<java.awt.Window> weakThis;
        final WeakReference<AppContext> context;

        WindowDisposerRecord(AppContext context, java.awt.Window victim) {
        ...
        public void updateOwner() {
            ...
            owner = (victim == null)
                    ? null
                    : new WeakReference<java.awt.Window>(victim.getOwner());
        }
    ...
    private void init(GraphicsConfiguration gc) {
        ...
        weakThis = new WeakReference<java.awt.Window>(this);
        addToWindowList();
     ...
     * @since     1.3
     */
    public Window(java.awt.Window owner, GraphicsConfiguration gc) {
        this(gc);
        ownedInit(owner);
    }
        ...
        public void run() {
            ...
            try {
                ...
                for (int i = 0; i < ownedWindowArray.length; i++) {
                    java.awt.Window child = (java.awt.Window) (((WeakReference)
     ...
     * @see #removeNotify
     */
    static IdentityArrayList<java.awt.Window> getAllWindows() {
        synchronized (allWindows) {
            IdentityArrayList<java.awt.Window> v = new IdentityArrayList<java.awt.Window>();
            v.addAll(allWindows);
            return v;
        }
    }

    static IdentityArrayList<java.awt.Window> getAllUnblockedWindows() {
        synchronized (allWindows) {
            IdentityArrayList<java.awt.Window> unblocked = new IdentityArrayList<java.awt.Window>();
            for (int i = 0; i < allWindows.size(); i++) {
                java.awt.Window w = allWindows.get(i);
                if (!w.isModalBlocked()) {
                    unblocked.add(w);
                }
            }
    ...
    private static java.awt.Window[] getWindows(AppContext appContext) {
        synchronized (java.awt.Window.class) {
            java.awt.Window realCopy[];
            @SuppressWarnings("unchecked")
            Vector<WeakReference<java.awt.Window>> windowList =
                (Vector<WeakReference<java.awt.Window>>)appContext.get(java.awt.Window.class);
            if (windowList != null) {
     ...
     *
     * @see Frame#getFrames
     * @see java.awt.Window#getOwnerlessWindows
     *
     * @since 1.6
     */
     ...
     *
     * @see Frame#getFrames
     * @see java.awt.Window#getWindows()
     *
     * @since 1.6
     */
 ...
 */
    ...
    void updateChildrenBlocking() {
        Vector<java.awt.Window> childHierarchy = new Vector<java.awt.Window>();
     ...
     * {@link java.awt.Window#isAlwaysOnTopSupported()}.  If always-on-top mode
    ...
    public final void setAlwaysOnTop(boolean alwaysOnTop) throws SecurityException {
        ...
        for (WeakReference<java.awt.Window> ref : ownedWindowList) {
    ...
    public final boolean isFocusableWindow() {
        ...
        // screen.
        for (java.awt.Window owner = getOwner(); owner != null;
    ...
    public void setFocusableWindowState(boolean focusableWindowState) {
        ...
        if (oldFocusableWindowState && !focusableWindowState && isFocused()) {
            for (java.awt.Window owner = getOwner();
                 owner != null;
                 owner = owner.getOwner())
                {
                    Component toFocus =
    ...
    */
    void addOwnedWindow(WeakReference<java.awt.Window> weakWindow) {
        if (weakWindow != null) {
            synchronized(ownedWindowList) {
    ...
    void removeOwnedWindow(WeakReference<java.awt.Window> weakWindow) {
        if (weakWindow != null) {
    ...
    private void addToWindowList() {
        synchronized (java.awt.Window.class) {
            @SuppressWarnings("unchecked")
            Vector<WeakReference<java.awt.Window>> windowList = (Vector<WeakReference<java.awt.Window>>)appContext.get(java.awt.Window.class);
            if (windowList == null) {
                windowList = new Vector<WeakReference<java.awt.Window>>();
    ...
    private static void removeFromWindowList(AppContext context, WeakReference<java.awt.Window> weakThis) {
        synchronized (java.awt.Window.class) {
            @SuppressWarnings("unchecked")
            Vector<WeakReference<java.awt.Window>> windowList = (Vector<WeakReference<java.awt.Window>>)context.get(java.awt.Window.class);
            if (windowList != null) {
    ...
    public void setLocationRelativeTo(Component c) {
        ...
        java.awt.Window componentWindow = SunToolkit.getContainingWindow(c);
     ...
     *
     * @see java.awt.Window#setOpacity(float)
     ...
     * alpha component of their color (see {@link java.awt.Window#setBackground(Color)}) and the
     ...
     *     {@code 1.0f}
     *
     * @see java.awt.Window#getOpacity
     * @see java.awt.Window#setBackground(Color)
     * @see java.awt.Window#setShape(Shape)
     ...
     *
     * @see java.awt.Window#getBackground
     * @see java.awt.Window#isOpaque
     * @see java.awt.Window#setOpacity(float)
     * @see java.awt.Window#setShape(Shape)
     * @see Frame#isUndecorated
            ...
            double w, double h)
    {
        ...
        wx = java.awt.Window.limit(wx,
                x - securityWarningWidth - 2,
                x + w + 2);
        wy = java.awt.Window.limit(wy,
    ...
    static {
        AWTAccessor.setWindowAccessor(new AWTAccessor.WindowAccessor() {
            public float getOpacity(java.awt.Window window) {
                return window.opacity;
            }
            public void setOpacity(java.awt.Window window, float opacity) {
                window.setOpacity(opacity);
            }
            public Shape getShape(java.awt.Window window) {
                return window.getShape();
            }
            public void setShape(java.awt.Window window, Shape shape) {
                window.setShape(shape);
            }
            public void setOpaque(java.awt.Window window, boolean opaque) {
            ...
            public void updateWindow(java.awt.Window window) {
                window.updateWindow();
            }

            public Dimension getSecurityWarningSize(java.awt.Window window) {
                return new Dimension(window.securityWarningWidth,
                        window.securityWarningHeight);
            }

            public void setSecurityWarningSize(java.awt.Window window, int width, int height)
            {
                window.securityWarningWidth = width;
                window.securityWarningHeight = height;
            }

            public void setSecurityWarningPosition(java.awt.Window window,
            ...
            public Point2D calculateSecurityWarningPosition(java.awt.Window window,
                                                            double x, double y, double w, double h)
            {
                return window.calculateSecurityWarningPosition(x, y, w, h);
            }

            public void setLWRequestStatus(java.awt.Window changed, boolean status) {
                changed.syncLWRequests = status;
            }

            public boolean isAutoRequestFocus(java.awt.Window w) {
                return w.autoRequestFocus;
            }

            public boolean isTrayIconWindow(java.awt.Window w) {
                return w.isTrayIconWindow;
            }

            public void setTrayIconWindow(java.awt.Window w, boolean isTrayIconWindow) {
