...
public class ComponentSampleModel extends SampleModel
{
    ...
    public SampleModel createCompatibleSampleModel(int w, int h) {
        ...
        for (int i=0; i<bands; i++)
            bandOff[i] += base;
        return new java.awt.image.ComponentSampleModel(dataType, w, h, pStride,
    ...
    public SampleModel createSubsetSampleModel(int bands[]) {
       if (bands.length > bankIndices.length)
        ...
        return new java.awt.image.ComponentSampleModel(this.dataType, width, height,
                                        this.pixelStride,
                                        this.scanlineStride,
    ...
    public boolean equals(Object o) {
        if ((o == null) || !(o instanceof java.awt.image.ComponentSampleModel)) {
            return false;
        }

        java.awt.image.ComponentSampleModel that = (java.awt.image.ComponentSampleModel)o;
