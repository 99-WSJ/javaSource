 ...
 * subtype, and representation class. Refer to {@link #equals(java.awt.datatransfer.DataFlavor)} for
...
public class DataFlavor implements Externalizable, Cloneable {
     ...
     * private initializer
     */
    static private java.awt.datatransfer.DataFlavor createConstant(Class<?> rc, String prn) {
        try {
     ...
     * private initializer
     */
    static private java.awt.datatransfer.DataFlavor createConstant(String mt, String prn) {
        try {
     ...
     * private initializer
     */
    static private java.awt.datatransfer.DataFlavor initHtmlDataFlavor(String htmlFlavorType) {
        try {
            return new java.awt.datatransfer.DataFlavor("text/html; class=java.lang.String;document=" +
     ...
     * </pre>
     */
    public static final java.awt.datatransfer.DataFlavor stringFlavor = createConstant(String.class, "Unicode String");
     ...
     * </pre>
     */
    public static final java.awt.datatransfer.DataFlavor imageFlavor = createConstant("image/x-java-image; class=java.awt.Image", "Image");
     ...
     */
    @Deprecated
    public static final java.awt.datatransfer.DataFlavor plainTextFlavor = createConstant("text/plain; charset=unicode; class=java.io.InputStream", "Plain Text");
     ...
     */
    public static final java.awt.datatransfer.DataFlavor javaFileListFlavor = createConstant("application/x-java-file-list;class=java.util.List", null);
     ...
     * </pre>
     */
    public static java.awt.datatransfer.DataFlavor selectionHtmlFlavor = initHtmlDataFlavor("selection");
     ...
     * </pre>
     */
    public static java.awt.datatransfer.DataFlavor fragmentHtmlFlavor = initHtmlDataFlavor("fragment");
     ...
     * </pre>
     */
    public static java.awt.datatransfer.DataFlavor allHtmlFlavor = initHtmlDataFlavor("all");
     ...
     */
    private DataFlavor(String primaryType, String subType, java.awt.datatransfer.MimeTypeParameterList params, Class<?> representationClass, String humanPresentableName) {
        super();
        if (primaryType == null) {
        ...
        try {
            mimeType = new java.awt.datatransfer.MimeType(primaryType, subType, params);
    ...
    */
    private void initialize(String mimeType, String humanPresentableName, ClassLoader classLoader) throws MimeTypeParseException, ClassNotFoundException {
        ...
        this.mimeType = new java.awt.datatransfer.MimeType(mimeType); // throws
        ...
        if (rcn == null) {
            ...
            representationClass = java.awt.datatransfer.DataFlavor.tryToLoadClass(rcn, classLoader);
        }
     ...
     * @since 1.3
     */
    public static final java.awt.datatransfer.DataFlavor selectBestTextFlavor(
                                       java.awt.datatransfer.DataFlavor[] availableFlavors) {
        ...
        java.awt.datatransfer.DataFlavor bestFlavor =
            (java.awt.datatransfer.DataFlavor)Collections.max(Arrays.asList(availableFlavors),
    ...
    private static Comparator<java.awt.datatransfer.DataFlavor> textFlavorComparator;
    ...
    static class TextFlavorComparator
        ...
        public int compare(Object obj1, Object obj2) {
            java.awt.datatransfer.DataFlavor flavor1 = (java.awt.datatransfer.DataFlavor)obj1;
            java.awt.datatransfer.DataFlavor flavor2 = (java.awt.datatransfer.DataFlavor)obj2;
    ...
    public boolean equals(Object o) {
        return ((o instanceof java.awt.datatransfer.DataFlavor) && equals((java.awt.datatransfer.DataFlavor)o));
    }
    ...
    /**
     * Identical to {@link #equals(java.awt.datatransfer.DataFlavor)}.
     *
     * @param that the <code>DataFlavor</code> to compare with
     *        <code>this</code>
     * @return <code>true</code> if <code>that</code> is equivalent to this
    ...
    private boolean isMimeTypeEqual(java.awt.datatransfer.MimeType mtype) {
        if (this.mimeType == null) {
            return (mtype == null);
        }
   ...
   public synchronized void readExternal(ObjectInput is) throws IOException , ClassNotFoundException {
       String rcn = null;
        mimeType = (java.awt.datatransfer.MimeType)is.readObject();
        ...
        try {
            ...
            if (rcn != null) {
                representationClass =
                    java.awt.datatransfer.DataFlavor.tryToLoadClass(rcn, getClass().getClassLoader());
            }
        }
   }
    ...
    */
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (mimeType != null) {
            ((java.awt.datatransfer.DataFlavor)newObj).mimeType = (java.awt.datatransfer.MimeType)mimeType.clone();
        }
        return newObj;
    } // clone()
