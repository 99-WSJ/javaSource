...
public class DragSource implements Serializable {
    ...
    private static final java.awt.dnd.DragSource dflt =
        (GraphicsEnvironment.isHeadless()) ? null : new java.awt.dnd.DragSource();
    ...
    public void addDragSourceListener(DragSourceListener dsl) {
        if (dsl != null) {
            synchronized (this) {
                listener = java.awt.dnd.DnDEventMulticaster.add(listener, dsl);
            }
        }
    }
    ...
    public void removeDragSourceListener(DragSourceListener dsl) {
        if (dsl != null) {
            synchronized (this) {
                listener = java.awt.dnd.DnDEventMulticaster.remove(listener, dsl);
            }
        }
    }
    ...
    public void addDragSourceMotionListener(DragSourceMotionListener dsml) {
        if (dsml != null) {
            synchronized (this) {
                motionListener = java.awt.dnd.DnDEventMulticaster.add(motionListener, dsml);
            }
        }
    }
    ...
    public void removeDragSourceMotionListener(DragSourceMotionListener dsml) {
        if (dsml != null) {
            synchronized (this) {
                motionListener = java.awt.dnd.DnDEventMulticaster.remove(motionListener, dsml);
            }
        }
    }
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        java.awt.dnd.DnDEventMulticaster.save(s, dragSourceListenerK, listener);
        java.awt.dnd.DnDEventMulticaster.save(s, dragSourceMotionListenerK, motionListener);
        s.writeObject(null);
    }
