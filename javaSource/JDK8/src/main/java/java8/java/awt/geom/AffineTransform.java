...
public class AffineTransform implements Cloneable, java.io.Serializable {
     ...
     * @since 1.2
     */
    public static java.awt.geom.AffineTransform getTranslateInstance(double tx, double ty) {
     ...
     * @since 1.6
     */
    public static java.awt.geom.AffineTransform getRotateInstance(double vecx, double vecy) {
        java.awt.geom.AffineTransform Tx = new java.awt.geom.AffineTransform();
     ...
     * @since 1.6
     */
    public static java.awt.geom.AffineTransform getRotateInstance(double vecx,
                                                                  double vecy,
                                                                  double anchorx,
                                                                  double anchory)
    {
     ...
     * @since 1.2
     */
    public static java.awt.geom.AffineTransform getScaleInstance(double sx, double sy) {
        java.awt.geom.AffineTransform Tx = new java.awt.geom.AffineTransform();
        Tx.setToScale(sx, sy);
        return Tx;
    }
     ...
     * @since 1.2
     */
    public static java.awt.geom.AffineTransform getShearInstance(double shx, double shy) {
        java.awt.geom.AffineTransform Tx = new java.awt.geom.AffineTransform();
        ...
        throws NoninvertibleTransformException
    {
        ...
        case (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE):
            ...
            return new java.awt.geom.AffineTransform( m11 / det, -m10 / det,
                                       -m01 / det,  m00 / det,
                                       (m01 * m12 - m11 * m02) / det,
                                       (m10 * m02 - m00 * m12) / det,
                                       (APPLY_SHEAR |
        ...
        case (APPLY_SHEAR | APPLY_TRANSLATE):
            ...
            return new java.awt.geom.AffineTransform( 0.0,        1.0 / m01,
                                        1.0 / m10,  0.0,
                                       -m12 / m10, -m02 / m01,
        ...
        case (APPLY_SCALE | APPLY_TRANSLATE):
            ...
            return new java.awt.geom.AffineTransform( 1.0 / m00,  0.0,
                                        0.0,        1.0 / m11,
                                       -m02 / m00, -m12 / m11,
        ...
        case (APPLY_SCALE):
            ...
            return new java.awt.geom.AffineTransform(1.0 / m00, 0.0,
                                       ...
                                       (APPLY_SCALE));
        case (APPLY_TRANSLATE):
            return new java.awt.geom.AffineTransform( 1.0,  0.0,
                                        0.0,  1.0,
                                       -m02, -m12,
                                       (APPLY_TRANSLATE));
        case (APPLY_IDENTITY):
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof java.awt.geom.AffineTransform)) {
            return false;
        }

        java.awt.geom.AffineTransform a = (java.awt.geom.AffineTransform)obj;
