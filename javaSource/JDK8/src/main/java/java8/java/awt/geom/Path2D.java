 ...
 * <p>
 * Use {@link java.awt.geom.Path2D.Float} when dealing with data that can be represented
 * and used with floating point precision.  Use {@link java.awt.geom.Path2D.Double}
...
public abstract class Path2D implements Shape, Cloneable {
     ...
     * @since 1.6
     */
    public static class Float extends java.awt.geom.Path2D implements Serializable {
        ...
        public Float(Shape s, AffineTransform at) {
            if (s instanceof java.awt.geom.Path2D) {
                java.awt.geom.Path2D p2d = (java.awt.geom.Path2D) s;
         ...
         * @see java.awt.geom.Path2D#moveTo
         * @since 1.6
         */
         ...
         * @param x the specified X coordinate
         * @param y the specified Y coordinate
         * @see java.awt.geom.Path2D#lineTo
         * @since 1.6
         */
         ...
         * @see java.awt.geom.Path2D#quadTo
         * @since 1.6
         */
         ...
         * @see java.awt.geom.Path2D#curveTo
         * @since 1.6
         */
        ...
        static class CopyIterator extends java.awt.geom.Path2D.Iterator {
            float floatCoords[];
        ...
        static class TxIterator extends java.awt.geom.Path2D.Iterator {
            float floatCoords[];
     ...
     * @since 1.6
     */
    public static class Double extends java.awt.geom.Path2D implements Serializable {
     ...
     * {@link java.awt.geom.Path2D.Float#Path2D.Float(Shape, AffineTransform) Path2D.Float}
     * and
     * {@link java.awt.geom.Path2D.Double#Path2D.Double(Shape, AffineTransform) Path2D.Double}
    ...
    public final synchronized Shape createTransformedShape(AffineTransform at) {
        java.awt.geom.Path2D p2d = (java.awt.geom.Path2D) clone();
        if (at != null) {
            p2d.transform(at);
        }
        return p2d;
        ...
        throws java.io.IOException
    {
        ...
        if (isdbl) {
            dCoords = ((java.awt.geom.Path2D.Double) this).doubleCoords;
            fCoords = null;
        } else {
            fCoords = ((java.awt.geom.Path2D.Float) this).floatCoords;
            dCoords = null;
        }
        ...
        throws ClassNotFoundException, java.io.IOException
    {
        ...
        if (storedbl) {
            ((java.awt.geom.Path2D.Double) this).doubleCoords = new double[nC];
        } else {
            ((java.awt.geom.Path2D.Float) this).floatCoords = new float[nC];
        }
    ...
    static abstract class Iterator implements PathIterator {
        ...
        Iterator(java.awt.geom.Path2D path) {
            this.path = path;
        }
