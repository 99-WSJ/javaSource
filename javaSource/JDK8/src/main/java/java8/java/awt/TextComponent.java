...
////////////////
        ...
        implements AccessibleText, TextListener
    {
        ...
        public AccessibleAWTTextComponent() {
            java.awt.TextComponent.this.addTextListener(this);
        }
        ...
        public void textValueChanged(TextEvent textEvent)  {
            Integer cpos = Integer.valueOf(java.awt.TextComponent.this.getCaretPosition());
        ...
        public String getSelectedText() {
            String selText = java.awt.TextComponent.this.getSelectedText();
            // Fix for 4256662
        ...
        public String getAtIndex(int part, int index) {
            ...
            case AccessibleText.WORD:  {
                    String s = java.awt.TextComponent.this.getText();
