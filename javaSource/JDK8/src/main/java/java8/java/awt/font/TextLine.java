...
final class TextLine {
    ...
    private abstract static class Function {
        ...
        abstract float computeFunction(java.awt.font.TextLine line,
                                       int componentIndex,
                                       int indexInArray);
    }

    private static Function fgPosAdvF = new Function() {
        float computeFunction(java.awt.font.TextLine line,
                              int componentIndex,
                              int indexInArray) {
     ...
     * attributes
     */
    public static java.awt.font.TextLine fastCreateTextLine(FontRenderContext frc,
                                                            char[] chars,
                                                            Font font,
                                                            CoreMetrics lm,
        ...
        return new java.awt.font.TextLine(frc, components, lm.baselineOffsets,
     ...
     * character array.
     */
    public static java.awt.font.TextLine createLineFromText(char[] chars,
        ...
        return new java.awt.font.TextLine(factory.getFontRenderContext(), components, baselineOffsets,
                            chars, 0, chars.length, charsLtoV, levels, isDirectionLTR);
    }
     ...
     */
    public static java.awt.font.TextLine standardCreateTextLine(FontRenderContext frc,
   ...
   */
    public java.awt.font.TextLine getJustifiedLine(float justificationWidth, float justifyRatio, int justStart, int justLimit) {
        ...
        do {
            ...
            java.awt.font.TextJustifier justifier = new java.awt.font.TextJustifier(infos, infoStart, infoLimit);
        ...
        return new java.awt.font.TextLine(frc, newComponents, fBaselineOffsets, fChars, fCharsStart,
