...
public class AWTKeyStroke implements Serializable {
     ...
     */
    private static Class<java.awt.AWTKeyStroke> getAWTKeyStrokeClass() {
        Class<java.awt.AWTKeyStroke> clazz = (Class)AppContext.getAppContext().get(java.awt.AWTKeyStroke.class);
        if (clazz == null) {
            clazz = java.awt.AWTKeyStroke.class;
            AppContext.getAppContext().put(java.awt.AWTKeyStroke.class, java.awt.AWTKeyStroke.class);
        }
        return clazz;
    }
    ...
    protected static void registerSubclass(Class<?> subclass) {
        ...
        synchronized (java.awt.AWTKeyStroke.class) {
            Class<java.awt.AWTKeyStroke> keyStrokeClass = (Class)AppContext.getAppContext().get(java.awt.AWTKeyStroke.class);
        ...
        try {
            java.awt.AWTKeyStroke stroke = (java.awt.AWTKeyStroke)ctor.newInstance((Object[]) null);
            if (stroke == null) {
                throw new IllegalArgumentException(couldNotInstantiate);
            }
        ...
        synchronized (java.awt.AWTKeyStroke.class) {
            AppContext.getAppContext().put(java.awt.AWTKeyStroke.class, subclass);
    ...
    private static synchronized java.awt.AWTKeyStroke getCachedStroke
        (char keyChar, int keyCode, int modifiers, boolean onKeyRelease)
    {
        Map<java.awt.AWTKeyStroke, java.awt.AWTKeyStroke> cache = (Map)AppContext.getAppContext().get(APP_CONTEXT_CACHE_KEY);
        java.awt.AWTKeyStroke cacheKey = (java.awt.AWTKeyStroke)AppContext.getAppContext().get(APP_CONTEXT_KEYSTROKE_KEY);
        ...
        if (cacheKey == null) {
            try {
                Class<java.awt.AWTKeyStroke> clazz = getAWTKeyStrokeClass();
                cacheKey = (java.awt.AWTKeyStroke)getCtor(clazz).newInstance((Object[]) null);
     ...
     * @see InputEvent
     */
    public static java.awt.AWTKeyStroke getAWTKeyStroke(Character keyChar, int modifiers)
    {
        if (keyChar == null) {
     ...
     */
    public static java.awt.AWTKeyStroke getAWTKeyStrokeForEvent(KeyEvent anEvent) {
     ...
     */
    public static java.awt.AWTKeyStroke getAWTKeyStroke(String s) {
        if (s == null) {
    ...
    private static int getVKValue(String key) {
        java.awt.VKCollection vkCollect = getVKCollection();
