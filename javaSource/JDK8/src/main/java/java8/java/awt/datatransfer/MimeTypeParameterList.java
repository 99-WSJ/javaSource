...
class MimeTypeParameterList implements Cloneable {
    ...
    public boolean equals(Object thatObject) {
        ...
        if (!(thatObject instanceof java.awt.datatransfer.MimeTypeParameterList)) {
            return false;
        }
        java.awt.datatransfer.MimeTypeParameterList that = (java.awt.datatransfer.MimeTypeParameterList)thatObject;
     ...
     */
     ...
     public Object clone() {
         java.awt.datatransfer.MimeTypeParameterList newObj = null;
         try {
             newObj = (java.awt.datatransfer.MimeTypeParameterList)super.clone();
