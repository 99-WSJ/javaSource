...
public class DefaultKeyboardFocusManager extends KeyboardFocusManager {
    ...
    static {
        AWTAccessor.setDefaultKeyboardFocusManagerAccessor(
            new AWTAccessor.DefaultKeyboardFocusManagerAccessor() {
                public void consumeNextKeyTyped(java.awt.DefaultKeyboardFocusManager dkfm, KeyEvent e) {
        ...
        extends SentEvent
    {
        ...
        public final void dispatch() {
            ...
            java.awt.DefaultKeyboardFocusManager defaultManager =
                (manager instanceof java.awt.DefaultKeyboardFocusManager)
                ? (java.awt.DefaultKeyboardFocusManager)manager
                : null;
    ...
    static boolean sendMessage(Component target, AWTEvent e) {
        ...
        if (myAppContext == targetAppContext) {
            ...
            if (EventQueue.isDispatchThread()) {
                ...
                edt.pumpEvents(SentEvent.ID, new java.awt.Conditional() {
