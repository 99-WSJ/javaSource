...
class SequencedEvent extends AWTEvent implements ActiveEvent {
    ...
    private static final LinkedList<java.awt.SequencedEvent> list = new LinkedList<>();
        ...
        try {
            ...
            if (getFirst() != this) {
                if (EventQueue.isDispatchThread()) {
                    java.awt.EventDispatchThread edt = (java.awt.EventDispatchThread)
     ...
     */
    private final static boolean isOwnerAppContextDisposed(java.awt.SequencedEvent se) {
        if (se != null) {
    ...
    private final synchronized static java.awt.SequencedEvent getFirst() {
     ...
     */
    private final static java.awt.SequencedEvent getFirstWithContext() {
        java.awt.SequencedEvent first = getFirst();
