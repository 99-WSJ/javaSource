...
public final class NumericShaper implements java.io.Serializable {
     ...
     * java.awt.font.NumericShaper.Range#THAI} range has the Thai digits, THAI DIGIT
     * ZERO (U+0E50) to THAI DIGIT NINE (U+0E59).
     *
     * <p>The <code>Range</code> enum replaces the traditional bit
     * mask-based values (e.g., {@link java.awt.font.NumericShaper#ARABIC}), and
    ...
    public static java.awt.font.NumericShaper getShaper(int singleRange) {
        ...
        return new java.awt.font.NumericShaper(key, singleRange);
    }
     ...
     *                    java.awt.font.NumericShaper.Range} constant.
     * @return a non-contextual {@code NumericShaper}.
     * @throws NullPointerException if {@code singleRange} is {@code null}
     * @since 1.7
     */
    public static java.awt.font.NumericShaper getShaper(Range singleRange) {
        return new java.awt.font.NumericShaper(singleRange, EnumSet.of(singleRange));
    }
    ...
    public static java.awt.font.NumericShaper getContextualShaper(int ranges) {
        ...
        return new java.awt.font.NumericShaper(EUROPEAN_KEY, ranges);
    }
     ...
     * @since 1.7
     */
    public static java.awt.font.NumericShaper getContextualShaper(Set<Range> ranges) {
        java.awt.font.NumericShaper shaper = new java.awt.font.NumericShaper(Range.EUROPEAN, ranges);
     ...
     */
    public static java.awt.font.NumericShaper getContextualShaper(int ranges, int defaultContext) {
        int key = getKeyFromMask(defaultContext);
        ranges |= CONTEXTUAL_MASK;
        return new java.awt.font.NumericShaper(key, ranges);
    }
    ...
    public static java.awt.font.NumericShaper getContextualShaper(Set<Range> ranges,
        ...
        java.awt.font.NumericShaper shaper = new java.awt.font.NumericShaper(defaultContext, ranges);
        shaper.mask = CONTEXTUAL_MASK;
        return shaper;
    }
    ...
    private synchronized void shapeContextually(char[] text, int start, int count, int ctxKey) {
        ...
        synchronized (java.awt.font.NumericShaper.class) {
            for (int i = start, e = start + count; i < e; ++i) {
                char c = text[i];
                if (c >= minDigit && c <= '\u0039') {
                    text[i] = (char)(c + base);
    ...
    public boolean equals(Object o) {
        if (o != null) {
            try {
                java.awt.font.NumericShaper rhs = (java.awt.font.NumericShaper)o;
                if (rangeSet != null) {
