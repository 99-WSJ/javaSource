...
public abstract class MenuComponent implements java.io.Serializable {
    ...
    static {
        AWTAccessor.setMenuComponentAccessor(
            new AWTAccessor.MenuComponentAccessor() {
                public AppContext getAppContext(java.awt.MenuComponent menuComp) {
                    return menuComp.appContext;
                }
                public void setAppContext(java.awt.MenuComponent menuComp,
                                          AppContext appContext) {
                    menuComp.appContext = appContext;
                }
                public MenuContainer getParent(java.awt.MenuComponent menuComp) {
                    return menuComp.parent;
                }
                public Font getFont_NoClientCode(java.awt.MenuComponent menuComp) {
     ...
     * @see           java.awt.MenuComponent#setName(String)
     * @since         JDK1.1
     */
    ...
    void dispatchEventImpl(AWTEvent e) {
        ...
        if (newEventsOnly ||
            (parent != null && parent instanceof java.awt.MenuComponent &&
             ((java.awt.MenuComponent)parent).newEventsOnly)) {
            if (eventEnabled(e)) {
                processEvent(e);
                   ...
                   AccessibleSelection
    {
        ...
        public Accessible getAccessibleParent() {
            if (accessibleParent != null) {
                ...
                MenuContainer parent = java.awt.MenuComponent.this.getParent();
