...
public class Font implements Serializable
{
    private static class FontAccessImpl extends FontAccess {
        public Font2D getFont2D(java.awt.Font font) {
            return font.getFont2D();
        }

        public void setFont2D(java.awt.Font font, Font2DHandle handle) {
    ...
    private Font(File fontFile, int fontFormat,
        ...
        this.style = java.awt.Font.PLAIN;
        this.size = 1;
        this.pointSize = 1f;
    }
     ...
     * @see TextAttribute
     */
    public static java.awt.Font getFont(Map<? extends Attribute, ?> attributes) {
        ...
        if (attributes instanceof AttributeMap &&
            ...
            if (values.isNonDefault(EFONT)) {
                ...
                return new java.awt.Font(values, font.name, font.style,
                                font.createdFont, font.font2DHandle);
            }
            return new java.awt.Font(attributes);
        }

        java.awt.Font font = (java.awt.Font)attributes.get(TextAttribute.FONT);
        if (font != null) {
     ...
     * {@link GraphicsEnvironment#registerFont(java.awt.Font) registerFont(Font)}.
     ...
     * @see GraphicsEnvironment#registerFont(java.awt.Font)
     * @since 1.3
     */
    public static java.awt.Font createFont(int fontFormat, InputStream fontStream)
    ...
    private static java.awt.Font createFont0(int fontFormat, InputStream fontStream,
                                             CreatedFontTracker tracker)
        throws FontFormatException, IOException {

        if (fontFormat != java.awt.Font.TRUETYPE_FONT &&
            fontFormat != java.awt.Font.TYPE1_FONT) {
     ...
     * @since 1.5
     */
    public static java.awt.Font createFont(int fontFormat, File fontFile)
        throws FontFormatException, IOException {
     ...
     * @see #decode(String)
     */
    public static java.awt.Font getFont(String nm, java.awt.Font font) {
        String str = null;
        try {
     ...
     * @since 1.2
     */
    public java.awt.Font deriveFont(int style, AffineTransform trans){
        AttributeValues newValues = getAttributeValues().clone();
        int oldStyle = (this.style != style) ? this.style : -1;
        applyStyle(style, newValues);
     ...
     * @since 1.2
     */
    public java.awt.Font deriveFont(AffineTransform trans){
        AttributeValues newValues = getAttributeValues().clone();
        applyTransform(trans, newValues);
        return new java.awt.Font(newValues, null, -1, createdFont, font2DHandle);
    }
     ...
     * @since 1.2
     */
    public java.awt.Font deriveFont(Map<? extends Attribute, ?> attributes) {
        if (attributes == null) {
            return this;
        }
        AttributeValues newValues = getAttributeValues().clone();
