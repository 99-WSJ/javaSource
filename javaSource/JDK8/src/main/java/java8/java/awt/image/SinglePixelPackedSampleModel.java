...
public class SinglePixelPackedSampleModel extends SampleModel
{
    ...
    public SampleModel createCompatibleSampleModel(int w, int h) {
      SampleModel sampleModel = new java.awt.image.SinglePixelPackedSampleModel(dataType, w, h,
                                                              bitMasks);
      return sampleModel;
    }
    ...
    public SampleModel createSubsetSampleModel(int bands[]) {
        ...
        return new java.awt.image.SinglePixelPackedSampleModel(this.dataType, width, height,
    ...
    public boolean equals(Object o) {
        if ((o == null) || !(o instanceof java.awt.image.SinglePixelPackedSampleModel)) {
            return false;
        }

        java.awt.image.SinglePixelPackedSampleModel that = (java.awt.image.SinglePixelPackedSampleModel)o;
