...
final class StyledParagraph {
     ...
     *     insertion
     */
    public static java.awt.font.StyledParagraph insertChar(AttributedCharacterIterator aci,
                                                           char[] chars,
                                                           int insertPos,
                                                           java.awt.font.StyledParagraph oldParagraph) {
        ...
        if (!oldParagraph.getDecorationAt(relativePos).equals(d)) {
            return new java.awt.font.StyledParagraph(aci, chars);
        }
        Object f = getGraphicOrFont(attributes);
        if (f == null) {
     ...
     *     insertion
     */
    public static java.awt.font.StyledParagraph deleteChar(AttributedCharacterIterator aci,
                                                           char[] chars,
                                                           int deletePos,
                                                           java.awt.font.StyledParagraph oldParagraph) {
