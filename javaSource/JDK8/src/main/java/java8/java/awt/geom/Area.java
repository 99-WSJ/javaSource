...
public class Area implements Shape, Cloneable {
     ...
     */
    public Area(Shape s) {
        if (s instanceof java.awt.geom.Area) {
            curves = ((java.awt.geom.Area) s).curves;
        } else {
     ...
     * @since 1.2
     */
    public java.awt.geom.Area createTransformedArea(AffineTransform t) {
        java.awt.geom.Area a = new java.awt.geom.Area(this);
        a.transform(t);
        return a;
    }
    ...
    public PathIterator getPathIterator(AffineTransform at) {
        return new java.awt.geom.AreaIterator(curves, at);
    }
