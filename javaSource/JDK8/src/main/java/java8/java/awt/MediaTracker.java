...
public class MediaTracker implements java.io.Serializable {
    ...
    public synchronized void addImage(Image image, int id, int w, int h) {
        head = java.awt.MediaEntry.insert(head,
                                 new java.awt.ImageMediaEntry(this, image, id, w, h));
    }
     ...
     * @see     java.awt.MediaTracker#removeImage(Image, int)
     * @see     java.awt.MediaTracker#removeImage(Image, int, int, int)
     * @since   JDK1.1
     */
     ...
     * @see        java.awt.MediaTracker#removeImage(Image)
     * @see        java.awt.MediaTracker#removeImage(Image, int, int, int)
     * @since      JDK1.1
     */
    ...
    public synchronized void removeImage(Image image, int id,
        ...
        while (cur != null) {
            java.awt.MediaEntry next = cur.next;
            if (cur.getID() == id && cur instanceof java.awt.ImageMediaEntry
                && ((java.awt.ImageMediaEntry) cur).matches(image, width, height))
            {
                if (prev == null) {
                    head = next;
                } else {
...
class ImageMediaEntry extends java.awt.MediaEntry implements ImageObserver,
java.io.Serializable {
    ...
    ImageMediaEntry(java.awt.MediaTracker mt, Image img, int c, int w, int h) {
        super(mt, c);
        image = img;
        width = w;
        height = h;
