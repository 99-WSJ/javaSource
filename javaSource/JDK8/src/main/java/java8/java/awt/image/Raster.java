...
public class Raster {
     ...
     *          null
     */
    public static java.awt.image.Raster createRaster(SampleModel sm,
                                                     DataBuffer db,
                                                     Point location) {
        if ((sm == null) || (db == null)) {
     ...
     *         overflow
     */
    public java.awt.image.Raster createTranslatedChild(int childMinX, int childMinY) {
     ...
     *         overflow
     */
    public java.awt.image.Raster createChild(int parentX, int parentY,
        ...
        return new java.awt.image.Raster(subSampleModel, getDataBuffer(),
