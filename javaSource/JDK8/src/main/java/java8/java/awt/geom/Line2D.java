...
public abstract class Line2D implements Shape, Cloneable {
     ...
     * @since 1.2
     */
    public static class Float extends java.awt.geom.Line2D implements Serializable {
        /**
     ...
     * @since 1.2
     */
    public static class Double extends java.awt.geom.Line2D implements Serializable {
        /**
         * The X coordinate of the start point of the line segment.
         * @since 1.2
         * @serial
