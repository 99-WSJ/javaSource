...
public abstract class ColorModel implements Transparency{
    ...
    public ColorModel(int bits) {
        ...
        transferType = java.awt.image.ColorModel.getDefaultTransferType(bits);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof java.awt.image.ColorModel)) {
            return false;
        }
        java.awt.image.ColorModel cm = (java.awt.image.ColorModel) obj;
     ...
     * coerced data.
     */
    public java.awt.image.ColorModel coerceData (WritableRaster raster,
                                                 boolean isAlphaPremultiplied) {
        throw new UnsupportedOperationException
            ("This method is not supported by this color model");
    }
