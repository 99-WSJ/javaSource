 ...
 * The button which has changed state is returned by {@link java.awt.event.MouseEvent#getButton}
 * <P>
...
public class MouseEvent extends InputEvent {
   ...
   */
     ...
     *                     the class description for {@link java.awt.event.MouseEvent}
                      ...
                      int clickCount, boolean popupTrigger, int button)
    {
        ...
        if (button > BUTTON3) {
            ...
            if (getModifiersEx() != 0) { //There is at least one more button in a pressed state.
                if (id == java.awt.event.MouseEvent.MOUSE_RELEASED || id == java.awt.event.MouseEvent.MOUSE_CLICKED){
