...
public class ParameterBlock implements Cloneable, Serializable {
     ...
     */
    public Object clone() {
        java.awt.image.renderable.ParameterBlock theClone;

        try {
            theClone = (java.awt.image.renderable.ParameterBlock) super.clone();
        } catch (Exception e) {
            // We can't be here since we implement Cloneable.
            return null;
        }
     ...
     *         <code>source</code>.
     */
    public java.awt.image.renderable.ParameterBlock addSource(Object source) {
     ...
     * @see #getSource(int)
     */
    public java.awt.image.renderable.ParameterBlock setSource(Object source, int index) {
     ...
     */
    public java.awt.image.renderable.ParameterBlock add(Object obj) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(Object obj, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(byte b, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(char c, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(short s, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(int i, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(long l, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(float f, int index) {
     ...
     *        the specified parameter.
     */
    public java.awt.image.renderable.ParameterBlock set(double d, int index) {
