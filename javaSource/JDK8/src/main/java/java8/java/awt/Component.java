                                           ...
                                           Serializable
{
    ...
    static {
        AWTAccessor.setComponentAccessor(new AWTAccessor.ComponentAccessor() {
            ...
            public Rectangle getBounds(java.awt.Component comp) {
                return new Rectangle(comp.x, comp.y, comp.width, comp.height);
            }
            public void setMixingCutoutShape(java.awt.Component comp, Shape shape) {
            ...
            public void setGraphicsConfiguration(java.awt.Component comp,
                                                 GraphicsConfiguration gc)
            {
                comp.setGraphicsConfiguration(gc);
            }
            public boolean requestFocus(java.awt.Component comp, CausedFocusEvent.Cause cause) {
            ...
            public AppContext getAppContext(java.awt.Component comp) {
                 return comp.appContext;
            }
            public void setAppContext(java.awt.Component comp, AppContext appContext) {
                 comp.appContext = appContext;
            }
            public Container getParent(java.awt.Component comp) {
                return comp.getParent_NoClientCode();
            }
            public void setParent(java.awt.Component comp, Container parent) {
                comp.parent = parent;
            }
            ...
            public Point getLocation(java.awt.Component comp) {
            ...
            public Cursor getCursor(java.awt.Component comp) {
                return comp.getCursor_NoClientCode();
            }
            public ComponentPeer getPeer(java.awt.Component comp) {
                return comp.peer;
            }
            public void setPeer(java.awt.Component comp, ComponentPeer peer) {
                comp.peer = peer;
            }
            ...
            public Color getForeground(java.awt.Component comp) {
                return comp.foreground;
            }
            public Color getBackground(java.awt.Component comp) {
                return comp.background;
            }
            public void setBackground(java.awt.Component comp, Color background) {
                comp.background = background;
            }
            public Font getFont(java.awt.Component comp) {
                return comp.getFont_NoClientCode();
            }
            public void processEvent(java.awt.Component comp, AWTEvent e) {
                comp.processEvent(e);
            }

            public AccessControlContext getAccessControlContext(java.awt.Component comp) {
     ...
     * @see Container#add(java.awt.Component)
     * @see Window#pack
     * @see Window#show
     ...
     */
    java.awt.Component findUnderMouseInWindow(PointerInfo pi) {
        if (!isShowing()) {
            return null;
        }
        ...
        java.awt.Component inTheSameWindow = win.findComponentAt(relativeToWindow.x,
                                                        relativeToWindow.y,
                                                        INCLUDE_DISABLED);
     ...
     */
    void clearLightweightDispatcherOnRemove(java.awt.Component removedComponent) {
        if (parent != null) {
    ...
    final Point getLocationOnScreen_NoTreeLock() {
        ...
        if (peer != null && isShowing()) {
            if (peer instanceof LightweightPeer) {
                ...
                for(java.awt.Component c = this; c != host; c = c.getParent()) {
                    pt.x += c.x;
                    pt.y += c.y;
                }
                return pt;
    ...
    private void reshapeNativePeer(int x, int y, int width, int height, int op) {
        ...
        int nativeX = x;
        int nativeY = y;
        for (java.awt.Component c = parent;
        ...
        if (isShowing()) {
            java.awt.GraphicsCallback.PeerPaintCallback.getInstance().
                runOneComponent(this, new Rectangle(0, 0, width, height),
                                g, g.getClip(),
                                java.awt.GraphicsCallback.LIGHTWEIGHTS |
                                java.awt.GraphicsCallback.HEAVYWEIGHTS);
        }
    }
    ...
    protected class FlipBufferStrategy extends BufferStrategy {
        ...
        protected FlipBufferStrategy(int numBuffers, BufferCapabilities caps)
            throws AWTException
        {
            if (!(java.awt.Component.this instanceof Window) &&
                !(java.awt.Component.this instanceof Canvas))
            {
         ...
         */
        public void dispose() {
            if (java.awt.Component.this.bufferStrategy == this) {
    ...
    public boolean postEvent(Event e) {
        ...
        java.awt.Component parent = this.parent;
        int eventx = e.x;
        int eventy = e.y;
        if (parent != null) {
            e.translate(x, y);
    ...
    // Should only be called while holding the tree lock
    int createHierarchyEvents(int id, java.awt.Component changed,
     ...
     */
     private boolean checkCoalescing() {
         ...
         final Class<? extends java.awt.Component> clazz = getClass();
                                     ...
                                     CausedFocusEvent.Cause cause)
    {
            ...
            SunToolkit.isSystemGenerated(currentEvent))
        {
            ...
            java.awt.Component source = ((MouseEvent)currentEvent).getComponent();
        ...
        java.awt.Component window = this;
        ...
        ComponentPeer peer = this.peer;
        java.awt.Component heavyweight = (peer instanceof LightweightPeer)
                                           ...
                                           CausedFocusEvent.Cause cause)
    {
        ...
        java.awt.Component focusOwner = KeyboardFocusManager.getMostRecentFocusOwner(window);
        if (focusOwner == null) {
        ...
        boolean ret = java.awt.Component.requestFocusController.acceptRequestFocus(focusOwner,
                                                                          this,
                                                                          temporary,
    ...
    private static class DummyRequestFocusController implements RequestFocusController {
        public boolean acceptRequestFocus(java.awt.Component from, java.awt.Component to,
    ...
    public void transferFocusUpCycle() {
        ...
        if (rootAncestor != null) {
            ...
            if (window != null) {
                java.awt.Component toFocus = window.getFocusTraversalPolicy().
    ...
    private void doSwingSerialization() {
        ...
        for (Class<?> klass = java.awt.Component.this.getClass(); klass != null;
    ...
    final void relocateComponent() {
        synchronized (getTreeLock()) {
            ...
            int nativeX = x;
            int nativeY = y;
            for (java.awt.Component cont = getContainer();
    ...
    AccessibleStateSet getAccessibleStateSet() {
        synchronized (getTreeLock()) {
            ...
            if (java.awt.Component.isInstanceOf(this, "javax.swing.JComponent")) {
