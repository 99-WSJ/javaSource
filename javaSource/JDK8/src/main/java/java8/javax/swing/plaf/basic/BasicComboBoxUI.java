...
public class BasicComboBoxUI extends ComboBoxUI {
    ...
    protected void installKeyboardActions() {
        ...
        LazyActionMap.installLazyActionMap(comboBox, javax.swing.plaf.basic.BasicComboBoxUI.class,
                                           "ComboBox.actionMap");
    }
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed( ActionEvent e ) {
            ...
            javax.swing.plaf.basic.BasicComboBoxUI ui = (javax.swing.plaf.basic.BasicComboBoxUI)BasicLookAndFeel.getUIOfType(
                                  comboBox.getUI(), javax.swing.plaf.basic.BasicComboBoxUI.class);
            if (key == HIDE) {
        ...
        private int getNextIndex(JComboBox comboBox, String key) {
            ...
            if (UIManager.getBoolean("ComboBox.noActionOnKeyNavigation")
                    && (comboBox.getUI() instanceof javax.swing.plaf.basic.BasicComboBoxUI)) {
                selectedIndex = ((javax.swing.plaf.basic.BasicComboBoxUI) comboBox.getUI()).listBox.getSelectedIndex();
            }
    ...
    private class Handler implements ActionListener, FocusListener,
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (e.getSource() == editor){
                ...
                else if ( propertyName == javax.swing.plaf.basic.BasicComboBoxUI.IS_TABLE_CELL_EDITOR ) {
