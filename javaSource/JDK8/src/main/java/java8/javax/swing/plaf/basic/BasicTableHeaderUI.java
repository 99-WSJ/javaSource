    ...
    private static FocusListener focusListener = new FocusListener() {
        ...
        private void repaintHeader(Object source) {
            if (source instanceof JTableHeader) {
                ...
                javax.swing.plaf.basic.BasicTableHeaderUI ui =
                   (javax.swing.plaf.basic.BasicTableHeaderUI)BasicLookAndFeel.
                                        getUIOfType(th.getUI(),
                                            javax.swing.plaf.basic.BasicTableHeaderUI.class);
                if (ui == null) {
                    return;
                }
...
//  Installation
    ...
    protected void installKeyboardActions() {
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(header, javax.swing.plaf.basic.BasicTableHeaderUI.class,
    ...
    private static class Actions extends UIAction {
        ...
        public boolean isEnabled(Object sender) {
            if (sender instanceof JTableHeader) {
                ...
                String key = getName();
                javax.swing.plaf.basic.BasicTableHeaderUI ui =
                    (javax.swing.plaf.basic.BasicTableHeaderUI)BasicLookAndFeel.getUIOfType(th.getUI(),
                                                      javax.swing.plaf.basic.BasicTableHeaderUI.class);
                if (ui != null) {
        ...
        private boolean maybeMoveColumn(boolean leftArrow, JTableHeader th,
                                        javax.swing.plaf.basic.BasicTableHeaderUI ui, boolean doIt) {
