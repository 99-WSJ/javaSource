    ...
    public JEditorPane() {
        ...
        setFocusTraversalPolicy(new LayoutFocusTraversalPolicy() {
                public Component getComponentAfter(Container focusCycleRoot,
                    ...
                    if (focusCycleRoot != javax.swing.JEditorPane.this ||
                ...
                {
                    return (focusCycleRoot != javax.swing.JEditorPane.this ||
                            (!isEditable() && getComponentCount() > 0))
                        ? super.getDefaultComponent(focusCycleRoot)
                        : null;
                }
                protected boolean accept(Component aComponent) {
                    return (aComponent != javax.swing.JEditorPane.this)
    ...
    class PageLoader extends SwingWorker<URL, Object> {
        ...
        protected URL doInBackground() {
            ...
            try {
                if (in == null) {
                    ...
                    if (kit == null) {
                        ...
                        UIManager.getLookAndFeel().
                                provideErrorFeedback(javax.swing.JEditorPane.this);
                        return old;
                    }
                }
                ...
                UIManager.getLookAndFeel().provideErrorFeedback(javax.swing.JEditorPane.this);
            } finally {
                if (pageLoaded) {
                    SwingUtilities.invokeLater(new Runnable() {
                        public void run() {
                            javax.swing.JEditorPane.this.firePropertyChange("page", old, page);
                        }
                    });
                }
...
////////////////
    ...
    protected class AccessibleJEditorPane extends AccessibleJTextComponent {
        ...
        public String getAccessibleDescription() {
            ...
            if (description == null) {
                description = javax.swing.JEditorPane.this.getContentType();
            }
            return description;
        }
    ...
    protected class AccessibleJEditorPaneHTML extends AccessibleJEditorPane {
        ...
        protected AccessibleJEditorPaneHTML () {
            HTMLEditorKit kit = (HTMLEditorKit) javax.swing.JEditorPane.this.getEditorKit();
    ...
    extends AccessibleJEditorPane implements AccessibleHypertext {
        ...
        public class HTMLLink extends AccessibleHyperlink {
                ...
                if (i == 0 && isValid() == true) {
                    ...
                    if (u != null) {
                        HyperlinkEvent linkEvent =
                            new HyperlinkEvent(javax.swing.JEditorPane.this, HyperlinkEvent.EventType.ACTIVATED, u);
                        javax.swing.JEditorPane.this.fireHyperlinkUpdate(linkEvent);
                        return true;
                    }
                }
            ...
            public String getAccessibleActionDescription(int i) {
                if (i == 0 && isValid() == true) {
                    Document d = javax.swing.JEditorPane.this.getDocument();
                    if (d != null) {
                        try {
            ...
            public Object getAccessibleActionObject(int i) {
                if (i == 0 && isValid() == true) {
                    ...
                    if (href != null) {
                        URL u;
                        try {
                            u = new URL(javax.swing.JEditorPane.this.getPage(), href);
        ...
        public int getLinkIndex(int charIndex) {
            ...
            Element e = null;
            Document doc = javax.swing.JEditorPane.this.getDocument();
            if (doc != null) {
