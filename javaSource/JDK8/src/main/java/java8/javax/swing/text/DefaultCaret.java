...
public class DefaultCaret extends Rectangle implements Caret, FocusListener, MouseListener, MouseMotionListener {
    ...
    class Handler implements PropertyChangeListener, DocumentListener, ActionListener, ClipboardOwner {
        ...
        public void insertUpdate(DocumentEvent e) {
            ...
            if (changed != 0) {
                Position.Bias dotBias = javax.swing.text.DefaultCaret.this.dotBias;
                if (dot == offset) {
                    Document doc = component.getDocument();
                    boolean isNewline;
                    try {
        ...
        public void removeUpdate(DocumentEvent e) {
            ...
            if (newMark == newDot) {
                ...
                Position.Bias dotBias = javax.swing.text.DefaultCaret.this.dotBias;
                Position.Bias markBias = javax.swing.text.DefaultCaret.this.markBias;
                if(adjustDotBias) {
    ...
    private class DefaultFilterBypass extends NavigationFilter.FilterBypass {
        public Caret getCaret() {
            return javax.swing.text.DefaultCaret.this;
        }
