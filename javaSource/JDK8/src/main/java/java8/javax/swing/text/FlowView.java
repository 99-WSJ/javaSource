...
public abstract class FlowView extends BoxView {
    ...
    public static class FlowStrategy {
        ...
        void addDamage(javax.swing.text.FlowView fv, int offset) {
         ...
         * @see View#insertUpdate
         */
        public void insertUpdate(javax.swing.text.FlowView fv, DocumentEvent e, Rectangle alloc) {
         ...
         * @see View#removeUpdate
         */
        public void removeUpdate(javax.swing.text.FlowView fv, DocumentEvent e, Rectangle alloc) {
            addDamage(fv, e.getOffset());
            if (alloc != null) {
                Component host = fv.getContainer();
                if (host != null) {
         ...
         * @see View#changedUpdate
         */
        public void changedUpdate(javax.swing.text.FlowView fv, DocumentEvent e, Rectangle alloc) {
            addDamage(fv, e.getOffset());
            if (alloc != null) {
                Component host = fv.getContainer();
                if (host != null) {
         ...
         */
        protected View getLogicalView(javax.swing.text.FlowView fv) {
