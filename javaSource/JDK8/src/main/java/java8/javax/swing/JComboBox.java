...
implements ItemSelectable,ListDataListener,ActionListener, Accessible {
    ...
    protected void installAncestorListener() {
        addAncestorListener(new AncestorListener(){
                                ...
                                public void ancestorMoved(AncestorEvent event){
                                    if (event.getSource() != javax.swing.JComboBox.this)
                                        hidePopup();
                                }});
    }
    ...
    private static class ComboBoxActionPropertyChangeListener
                 extends javax.swing.ActionPropertyChangeListener<javax.swing.JComboBox<?>> {
        ComboBoxActionPropertyChangeListener(javax.swing.JComboBox<?> b, Action a) {
            super(b, a);
        }
        protected void actionPropertyChanged(javax.swing.JComboBox<?> cb,
                                             Action action,
...
///////////////////
    ...
    implements AccessibleAction, AccessibleSelection {
        ...
        public AccessibleJComboBox() {
            ...
            javax.swing.JComboBox.this.addPropertyChangeListener(new AccessibleJComboBoxPropertyChangeListener());
            setEditorNameAndDescription();

            // Get the popup list
            Accessible a = getUI().getAccessibleChild(javax.swing.JComboBox.this, 0);
            ...
            javax.swing.JComboBox.this.addPopupMenuListener(
        ...
        private void setEditorNameAndDescription() {
            ComboBoxEditor editor = javax.swing.JComboBox.this.getEditor();
            if (editor != null) {
        ...
        public int getAccessibleChildrenCount() {
            ...
            if (ui != null) {
                return ui.getAccessibleChildrenCount(javax.swing.JComboBox.this);
            } else {
        ...
        public Accessible getAccessibleChild(int i) {
            // Always delegate to the UI if it exists
            if (ui != null) {
                return ui.getAccessibleChild(javax.swing.JComboBox.this, i);
            } else {
        ...
        public AccessibleStateSet getAccessibleStateSet() {
            ...
            if (javax.swing.JComboBox.this.isPopupVisible()) {
        ...
        public int getAccessibleSelectionCount() {
            Object o = javax.swing.JComboBox.this.getSelectedItem();
            if (o != null) {
                return 1;
            } else {
                return 0;
        ...
        public Accessible getAccessibleSelection(int i) {
            // Get the popup
            Accessible a =
                javax.swing.JComboBox.this.getUI().getAccessibleChild(javax.swing.JComboBox.this, 0);
            if (a != null &&
        ...
        public boolean isAccessibleChildSelected(int i) {
            return javax.swing.JComboBox.this.getSelectedIndex() == i;
        }
        ...
        public void addAccessibleSelection(int i) {
            ...
            javax.swing.JComboBox.this.setSelectedIndex(i);
        }
        ...
        public void removeAccessibleSelection(int i) {
            if (javax.swing.JComboBox.this.getSelectedIndex() == i) {
                clearAccessibleSelection();
            }
        }
        ...
        public void clearAccessibleSelection() {
            javax.swing.JComboBox.this.setSelectedIndex(-1);
        }
...
//        }
        ...
        private class AccessibleEditor implements Accessible {
            public AccessibleContext getAccessibleContext() {
                if (editorAccessibleContext == null) {
                    Component c = javax.swing.JComboBox.this.getEditor().getEditorComponent();
        ...
        private class EditorAccessibleContext extends AccessibleContext {
            ...
            public int getAccessibleIndexInParent() {
                return javax.swing.JComboBox.this.getSelectedIndex();
            }
