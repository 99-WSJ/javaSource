...
public abstract class AbstractButton extends JComponent implements ItemSelectable, SwingConstants {
    ...
    private static class ButtonActionPropertyChangeListener
                 extends javax.swing.ActionPropertyChangeListener<javax.swing.AbstractButton> {
        ButtonActionPropertyChangeListener(javax.swing.AbstractButton b, Action a) {
            super(b, a);
        }
        protected void actionPropertyChanged(javax.swing.AbstractButton button,
                                             Action action,
        ...
        for (int i = listeners.length-2; i>=0; i-=2) {
            if (listeners[i]==ActionListener.class) {
                ...
                if (e == null) {
                      ...
                      e = new ActionEvent(javax.swing.AbstractButton.this,
    ...
    protected void fireItemStateChanged(ItemEvent event) {
        ...
        for (int i = listeners.length-2; i>=0; i-=2) {
            if (listeners[i]==ItemListener.class) {
                // Lazily create the event:
                if (e == null) {
                    e = new ItemEvent(javax.swing.AbstractButton.this,
...
///////////////////
    ...
    protected abstract class AccessibleAbstractButton
        ...
        public String getAccessibleName() {
            ...
            if (name == null) {
                name = javax.swing.AbstractButton.this.getText();
            }
            if (name == null) {
            ...
            if (!relationSet.contains(AccessibleRelation.MEMBER_OF)) {
                ...
                if (model != null && model instanceof DefaultButtonModel) {
                    ...
                    if (group != null) {
                        ...
                        Enumeration<javax.swing.AbstractButton> elem = group.getElements();
                        for (int i = 0; i < len; i++) {
        ...
        public AccessibleText getAccessibleText() {
            View view = (View) javax.swing.AbstractButton.this.getClientProperty("html");
            if (view != null) {
                return this;
            } else {
                return null;
        ...
        private Rectangle getTextRectangle() {
            ...
            String text = javax.swing.AbstractButton.this.getText();
            Icon icon = (javax.swing.AbstractButton.this.isEnabled()) ? javax.swing.AbstractButton.this.getIcon() : javax.swing.AbstractButton.this.getDisabledIcon();
            ...
            paintViewInsets = javax.swing.AbstractButton.this.getInsets(paintViewInsets);
            paintViewR.x = paintViewInsets.left;
            paintViewR.y = paintViewInsets.top;
            paintViewR.width = javax.swing.AbstractButton.this.getWidth() - (paintViewInsets.left + paintViewInsets.right);
            paintViewR.height = javax.swing.AbstractButton.this.getHeight() - (paintViewInsets.top + paintViewInsets.bottom);
            ...
            String clippedText = SwingUtilities.layoutCompoundLabel(
                ...
                text,
                icon,
                javax.swing.AbstractButton.this.getVerticalAlignment(),
                javax.swing.AbstractButton.this.getHorizontalAlignment(),
                javax.swing.AbstractButton.this.getVerticalTextPosition(),
                javax.swing.AbstractButton.this.getHorizontalTextPosition(),
                paintViewR,
                paintIconR,
                paintTextR,
                0);
        ...
        public String getToolTipText() {
            return javax.swing.AbstractButton.this.getToolTipText();
        }
        ...
        public AccessibleKeyBinding getAccessibleKeyBinding() {
            int mnemonic = javax.swing.AbstractButton.this.getMnemonic();
            if (mnemonic == 0) {
                return null;
            }
