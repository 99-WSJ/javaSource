...
public abstract class View implements SwingConstants {
    ...
    public void preferenceChanged(javax.swing.text.View child, boolean width, boolean height) {
        javax.swing.text.View parent = getParent();
        if (parent != null) {
     ...
     * @since 1.3
     */
    public void insert(int offs, javax.swing.text.View v) {
        javax.swing.text.View[] one = new javax.swing.text.View[1];
        one[0] = v;
        replace(offs, 0, one);
    }
     ...
     * @see LabelView
     */
    public javax.swing.text.View createFragment(int p0, int p1) {
        return this;
    }
    ...
    public Container getContainer() {
        javax.swing.text.View v = getParent();
    ...
    protected boolean updateChildren(DocumentEvent.ElementChange ec,
        ...
        javax.swing.text.View[] added = null;
        if (addedElems != null) {
            added = new javax.swing.text.View[addedElems.length];
    ...
    protected void forwardUpdate(DocumentEvent.ElementChange ec,
        ...
        for (int i = firstUpdateIndex; i <= lastUpdateIndex; i++) {
            if (! ((i >= hole0) && (i <= hole1))) {
                javax.swing.text.View v = getView(i);
                if (v != null) {
    ...
    void calculateUpdateIndexes(DocumentEvent e) {
        ...
        javax.swing.text.View v = (firstUpdateIndex >= 0) ? getView(firstUpdateIndex) : null;
        if (v != null) {
     ...
     * @since 1.3
     */
    protected void forwardUpdateToView(javax.swing.text.View v, DocumentEvent e,
