...
public class DefaultFormatter extends JFormattedTextField.AbstractFormatter
    ...
    public Object clone() throws CloneNotSupportedException {
        javax.swing.text.DefaultFormatter formatter = (javax.swing.text.DefaultFormatter)super.clone();
    ...
    private class DefaultNavigationFilter extends NavigationFilter
        ...
        public void setDot(FilterBypass fb, int dot, Position.Bias bias) {
            JTextComponent tc = javax.swing.text.DefaultFormatter.this.getFormattedTextField();
            if (tc.composedTextExists()) {
                // bypass the filter
                fb.setDot(dot, bias);
            } else {
                javax.swing.text.DefaultFormatter.this.setDot(fb, dot, bias);
            }
        }
        ...
        public void moveDot(FilterBypass fb, int dot, Position.Bias bias) {
            ...
            if (tc.composedTextExists()) {
                ...
                javax.swing.text.DefaultFormatter.this.moveDot(fb, dot, bias);
            }
        }
        ...
        public int getNextVisualPositionFrom(JTextComponent text, int pos,
            ...
            if (text.composedTextExists()) {
                ...
                return javax.swing.text.DefaultFormatter.this.getNextVisualPositionFrom(
                        text, pos, bias, direction, biasRet);
            }
        }
    }
    ...
    private class DefaultDocumentFilter extends DocumentFilter implements
        ...
        public void remove(FilterBypass fb, int offset, int length) throws
            ...
            if (tc.composedTextExists()) {
                ...
                javax.swing.text.DefaultFormatter.this.replace(fb, offset, length, null, null);
            }
        }
        ...
        public void insertString(FilterBypass fb, int offset,
            ...
            if (tc.composedTextExists() ||
                ...
                javax.swing.text.DefaultFormatter.this.replace(fb, offset, 0, string, attr);
            }
        }
        ...
        public void replace(FilterBypass fb, int offset, int length,
            ...
            if (tc.composedTextExists() ||
                ...
                javax.swing.text.DefaultFormatter.this.replace(fb, offset, length, text, attr);
            }
        }
    }
}
