...
public class JTextField extends JTextComponent implements SwingConstants {
    ...
    private static class TextFieldActionPropertyChangeListener extends
                         ActionPropertyChangeListener<javax.swing.JTextField> {
        TextFieldActionPropertyChangeListener(javax.swing.JTextField tf, Action a) {
            super(tf, a);
        }

        protected void actionPropertyChanged(javax.swing.JTextField textField,
                                             Action action,
    ...
    static class NotifyAction extends TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target instanceof javax.swing.JTextField) {
                javax.swing.JTextField field = (javax.swing.JTextField) target;
        ...
        public boolean isEnabled() {
            JTextComponent target = getFocusedComponent();
            if (target instanceof javax.swing.JTextField) {
                return ((javax.swing.JTextField)target).hasActionListener();
            }
            return false;
        }
    }
