...
public class KeyStroke extends AWTKeyStroke {
    ...
    public static javax.swing.KeyStroke getKeyStroke(char keyChar) {
        synchronized (AWTKeyStroke.class) {
            registerSubclass(javax.swing.KeyStroke.class);
            return (javax.swing.KeyStroke)getAWTKeyStroke(keyChar);
        }
    }
     ...
     */
    @Deprecated
    public static javax.swing.KeyStroke getKeyStroke(char keyChar, boolean onKeyRelease) {
        return new javax.swing.KeyStroke(keyChar, KeyEvent.VK_UNDEFINED, 0, onKeyRelease);
    }
     ...
     * @since 1.3
     */
    public static javax.swing.KeyStroke getKeyStroke(Character keyChar, int modifiers) {
        synchronized (AWTKeyStroke.class) {
            registerSubclass(javax.swing.KeyStroke.class);
            return (javax.swing.KeyStroke)getAWTKeyStroke(keyChar, modifiers);
        }
    }
    ...
    public static javax.swing.KeyStroke getKeyStroke(int keyCode, int modifiers,
        ...
        synchronized (AWTKeyStroke.class) {
            registerSubclass(javax.swing.KeyStroke.class);
            return (javax.swing.KeyStroke)getAWTKeyStroke(keyCode, modifiers,
                                              onKeyRelease);
        }
    }
     ...
     */
    public static javax.swing.KeyStroke getKeyStrokeForEvent(KeyEvent anEvent) {
        synchronized (AWTKeyStroke.class) {
            registerSubclass(javax.swing.KeyStroke.class);
            return (javax.swing.KeyStroke)getAWTKeyStrokeForEvent(anEvent);
        }
    }
     ...
     * @see KeyEvent
     */
    public static javax.swing.KeyStroke getKeyStroke(String s) {
        ...
        synchronized (AWTKeyStroke.class) {
            registerSubclass(javax.swing.KeyStroke.class);
            try {
                return (javax.swing.KeyStroke)getAWTKeyStroke(s);
