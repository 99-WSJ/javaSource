...
////////////////
    ...
    protected class AccessibleJTableHeader extends AccessibleJComponent {
        ...
        public Accessible getAccessibleAt(Point p) {
            ...
            if ((column = javax.swing.table.JTableHeader.this.columnAtPoint(p)) != -1) {
                TableColumn aColumn = javax.swing.table.JTableHeader.this.columnModel.getColumn(column);
                TableCellRenderer renderer = aColumn.getHeaderRenderer();
                if (renderer == null) {
                ...
                Component component = renderer.getTableCellRendererComponent(
                                  javax.swing.table.JTableHeader.this.getTable(),
                                  aColumn.getHeaderValue(), false, false,
                                  -1, column);

                return new AccessibleJTableHeaderEntry(column, javax.swing.table.JTableHeader.this, javax.swing.table.JTableHeader.this.table);
            } else {
                return null;
            }
        }
        ...
        public int getAccessibleChildrenCount() {
            return javax.swing.table.JTableHeader.this.columnModel.getColumnCount();
        }
        ...
        public Accessible getAccessibleChild(int i) {
            if (i < 0 || i >= getAccessibleChildrenCount()) {
                ...
                TableColumn aColumn = javax.swing.table.JTableHeader.this.columnModel.getColumn(i)
;
                TableCellRenderer renderer = aColumn.getHeaderRenderer();
                if (renderer == null) {
                    if (defaultRenderer != null) {
                ...
                return new AccessibleJTableHeaderEntry(i, javax.swing.table.JTableHeader.this, javax.swing.table.JTableHeader.this.table);
            }
        }
       ...
       */
        protected class AccessibleJTableHeaderEntry extends AccessibleContext
            ...
            private javax.swing.table.JTableHeader parent;
            private int column;
             ...
             * @since 1.4
             */
            public AccessibleJTableHeaderEntry(int c, javax.swing.table.JTableHeader p, JTable t) {
                parent = p;
                column = c;
                table = t;
        ...
        // AccessibleComponent methods
            ...
            public boolean isShowing() {
                if (isVisible() && javax.swing.table.JTableHeader.this.isShowing()) {
                    return true;
                } else {
                    return false;
                }
