...
public class JLabel extends JComponent implements SwingConstants, Accessible
{
    ...
    protected class AccessibleJLabel extends AccessibleJComponent
        ...
        public String getAccessibleName() {
            ...
            if (name == null) {
                name = javax.swing.JLabel.this.getText();
            }
            if (name == null) {
        ...
        public AccessibleRelationSet getAccessibleRelationSet() {
            ...
            if (!relationSet.contains(AccessibleRelation.LABEL_FOR)) {
                Component c = javax.swing.JLabel.this.getLabelFor();
                if (c != null) {
        ...
        public AccessibleText getAccessibleText() {
            View view = (View) javax.swing.JLabel.this.getClientProperty("html");
            if (view != null) {
                return this;
            } else {
                return null;
        ...
        private Rectangle getTextRectangle() {
            ...
            String text = javax.swing.JLabel.this.getText();
            Icon icon = (javax.swing.JLabel.this.isEnabled()) ? javax.swing.JLabel.this.getIcon() : javax.swing.JLabel.this.getDisabledIcon();
            ...
            paintViewInsets = javax.swing.JLabel.this.getInsets(paintViewInsets);
            paintViewR.x = paintViewInsets.left;
            paintViewR.y = paintViewInsets.top;
            paintViewR.width = javax.swing.JLabel.this.getWidth() - (paintViewInsets.left + paintViewInsets.right);
            paintViewR.height = javax.swing.JLabel.this.getHeight() - (paintViewInsets.top + paintViewInsets.bottom);

            String clippedText = SwingUtilities.layoutCompoundLabel(
                (JComponent) javax.swing.JLabel.this,
                getFontMetrics(getFont()),
                text,
                icon,
                javax.swing.JLabel.this.getVerticalAlignment(),
                javax.swing.JLabel.this.getHorizontalAlignment(),
                javax.swing.JLabel.this.getVerticalTextPosition(),
                javax.swing.JLabel.this.getHorizontalTextPosition(),
                paintViewR,
                paintIconR,
                paintTextR,
                javax.swing.JLabel.this.getIconTextGap());
        ...
        public String getToolTipText() {
            return javax.swing.JLabel.this.getToolTipText();
        }
        ...
        public AccessibleKeyBinding getAccessibleKeyBinding() {
            int mnemonic = javax.swing.JLabel.this.getDisplayedMnemonic();
            if (mnemonic == 0) {
                return null;
            }
