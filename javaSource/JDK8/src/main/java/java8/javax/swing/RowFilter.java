...
public abstract class RowFilter<M,I> {
     ...
     * @see Pattern
     */
    public static <M,I> javax.swing.RowFilter<M,I> regexFilter(String regex,
                                                               int... indices) {
        return (javax.swing.RowFilter<M,I>)new RegexFilter(Pattern.compile(regex),
                                               indices);
    }
     ...
     * @see Date
     */
    public static <M,I> javax.swing.RowFilter<M,I> dateFilter(ComparisonType type,
                                                              Date date, int... indices) {
        return (javax.swing.RowFilter<M,I>)new DateFilter(type, date.getTime(), indices);
    }
     ...
     */
    public static <M,I> javax.swing.RowFilter<M,I> numberFilter(ComparisonType type,
                                                                Number number, int... indices) {
        return (javax.swing.RowFilter<M,I>)new NumberFilter(type, number, indices);
    }
     ...
     */
    public static <M,I> javax.swing.RowFilter<M,I> orFilter(
            Iterable<? extends javax.swing.RowFilter<? super M, ? super I>> filters) {
     ...
     * @see java.util.Arrays#asList
     */
    public static <M,I> javax.swing.RowFilter<M,I> andFilter(
            Iterable<? extends javax.swing.RowFilter<? super M, ? super I>> filters) {
     ...
     *         <code>null</code>
     */
    public static <M,I> javax.swing.RowFilter<M,I> notFilter(javax.swing.RowFilter<M,I> filter) {
    ...
    private static abstract class GeneralFilter extends javax.swing.RowFilter<Object,Object> {
        private int[] columns;
    ...
    private static class OrFilter<M,I> extends javax.swing.RowFilter<M,I> {
        List<javax.swing.RowFilter<? super M,? super I>> filters;

        OrFilter(Iterable<? extends javax.swing.RowFilter<? super M, ? super I>> filters) {
            this.filters = new ArrayList<javax.swing.RowFilter<? super M,? super I>>();
            for (javax.swing.RowFilter<? super M, ? super I> filter : filters) {
                if (filter == null) {
                    throw new IllegalArgumentException(
    ...
    private static class AndFilter<M,I> extends OrFilter<M,I> {
        AndFilter(Iterable<? extends javax.swing.RowFilter<? super M,? super I>> filters) {
            super(filters);
        }
    ...
    private static class NotFilter<M,I> extends javax.swing.RowFilter<M,I> {
        private javax.swing.RowFilter<M,I> filter;

        NotFilter(javax.swing.RowFilter<M,I> filter) {
            if (filter == null) {
                throw new IllegalArgumentException(
                    "filter must be non-null");
            }
