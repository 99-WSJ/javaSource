...
class DefaultSwatchChooserPanel extends AbstractColorChooserPanel {
    ...
    protected void buildChooser() {
        ...
        swatchPanel =  new javax.swing.colorchooser.MainSwatchPanel();
        swatchPanel.putClientProperty(AccessibleContext.ACCESSIBLE_NAME_PROPERTY,
                                      getDisplayName());
        swatchPanel.setInheritsPopupMenu(true);

        recentSwatchPanel = new javax.swing.colorchooser.RecentSwatchPanel();
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (typed) {
                    ...
                    case KeyEvent.VK_LEFT:
                        if (selCol > 0 && javax.swing.colorchooser.SwatchPanel.this.getComponentOrientation().isLeftToRight()) {
                            selCol--;
                            repaint();
                        } else if (selCol < numSwatches.width - 1
                                && !javax.swing.colorchooser.SwatchPanel.this.getComponentOrientation().isLeftToRight()) {
                            selCol++;
                            repaint();
                        }
                        break;
                    case KeyEvent.VK_RIGHT:
                        if (selCol < numSwatches.width - 1
                            ...
                            selCol++;
                            repaint();
                        } else if (selCol > 0 && !javax.swing.colorchooser.SwatchPanel.this.getComponentOrientation().isLeftToRight()) {
                            selCol--;
                            repaint();
                        }
                        break;
...
class MainSwatchPanel extends javax.swing.colorchooser.SwatchPanel {
