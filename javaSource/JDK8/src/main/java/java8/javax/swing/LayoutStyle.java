...
public abstract class LayoutStyle {
    ...
    public static void setInstance(javax.swing.LayoutStyle style) {
        synchronized(javax.swing.LayoutStyle.class) {
            if (style == null) {
                AppContext.getAppContext().remove(javax.swing.LayoutStyle.class);
            }
            else {
                AppContext.getAppContext().put(javax.swing.LayoutStyle.class, style);
            }
        }
    }
    ...
    public static javax.swing.LayoutStyle getInstance() {
        ...
        synchronized(javax.swing.LayoutStyle.class) {
            style = (javax.swing.LayoutStyle)AppContext.getAppContext().
                    get(javax.swing.LayoutStyle.class);
        }
        if (style == null) {
     ...
     *
     * @see javax.swing.LayoutStyle#getPreferredGap(JComponent,JComponent,
