...
public class JFormattedTextField extends JTextField {
    ...
    protected void invalidEdit() {
        UIManager.getLookAndFeel().provideErrorFeedback(javax.swing.JFormattedTextField.this);
    }
    ...
    private class FocusLostHandler implements Runnable, Serializable {
        public void run() {
            int fb = javax.swing.JFormattedTextField.this.getFocusLostBehavior();
            if (fb == javax.swing.JFormattedTextField.COMMIT ||
                fb == javax.swing.JFormattedTextField.COMMIT_OR_REVERT) {
                try {
                    javax.swing.JFormattedTextField.this.commitEdit();
                    // Give it a chance to reformat.
                    javax.swing.JFormattedTextField.this.setValue(
                        javax.swing.JFormattedTextField.this.getValue(), true, true);
                } catch (ParseException pe) {
                    if (fb == javax.swing.JFormattedTextField.this.COMMIT_OR_REVERT) {
                        javax.swing.JFormattedTextField.this.setValue(
                            javax.swing.JFormattedTextField.this.getValue(), true, true);
                    }
                }
            }
            else if (fb == javax.swing.JFormattedTextField.REVERT) {
                javax.swing.JFormattedTextField.this.setValue(
                    javax.swing.JFormattedTextField.this.getValue(), true, true);
            }
        }
    ...
    public static abstract class AbstractFormatterFactory {
         ...
         */
        public abstract AbstractFormatter getFormatter(javax.swing.JFormattedTextField tf);
    }
    ...
    static class CommitAction extends JTextField.NotifyAction {
        public void actionPerformed(ActionEvent e) {
            ...
            if (target instanceof javax.swing.JFormattedTextField) {
                // Attempt to commit the value
                try {
                    ((javax.swing.JFormattedTextField)target).commitEdit();
                } catch (ParseException pe) {
                    ((javax.swing.JFormattedTextField)target).invalidEdit();
        ...
        public boolean isEnabled() {
            JTextComponent target = getFocusedComponent();
            if (target instanceof javax.swing.JFormattedTextField) {
                javax.swing.JFormattedTextField ftf = (javax.swing.JFormattedTextField)target;
                if (!ftf.isEdited()) {
                    return false;
                }
                return true;
