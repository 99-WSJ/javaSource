...
public class JPopupMenu extends JComponent implements Accessible,MenuElement {
    ...
    Point adjustPopupLocationToFitScreen(int xPosition, int yPosition) {
        ...
        Dimension popupSize = javax.swing.JPopupMenu.this.getPreferredSize();
    ...
    javax.swing.JPopupMenu getRootPopupMenu() {
        javax.swing.JPopupMenu mp = this;
        while((mp!=null) && (mp.isPopupMenu()!=true) &&
              (mp.getInvoker() != null) &&
              (mp.getInvoker().getParent() != null) &&
              (mp.getInvoker().getParent() instanceof javax.swing.JPopupMenu)
              ) {
            mp = (javax.swing.JPopupMenu) mp.getInvoker().getParent();
        }
        return mp;
    }
     ...
     */
    boolean isSubPopupMenu(javax.swing.JPopupMenu popup) {
        int ncomponents = this.getComponentCount();
        Component[] component = this.getComponents();
        for (int i = 0 ; i < ncomponents ; i++) {
            Component comp = component[i];
            if (comp instanceof JMenu) {
                ...
                javax.swing.JPopupMenu subPopup = menu.getPopupMenu();
                if (subPopup == popup)
                    return true;
...
////////////////
    ...
    protected class AccessibleJPopupMenu extends AccessibleJComponent
        ...
        protected AccessibleJPopupMenu() {
            javax.swing.JPopupMenu.this.addPropertyChangeListener(this);
        }
        ...
        private void fireActiveDescendant() {
            if (javax.swing.JPopupMenu.this instanceof BasicComboPopup) {
                // get the popup list
                JList<?> popupList = ((BasicComboPopup) javax.swing.JPopupMenu.this).getList();
                if (popupList == null) {
                    return;
                }
