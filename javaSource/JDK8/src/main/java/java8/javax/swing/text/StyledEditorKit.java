...
public class StyledEditorKit extends DefaultEditorKit {
   ...
   /**
     ...
     */
    public Object clone() {
        javax.swing.text.StyledEditorKit o = (javax.swing.text.StyledEditorKit)super.clone();
    ...
    public abstract static class StyledTextAction extends TextAction {
         ...
         * @exception IllegalArgumentException for the wrong document type
         */
        protected final javax.swing.text.StyledEditorKit getStyledEditorKit(JEditorPane e) {
            EditorKit k = e.getEditorKit();
            if (k instanceof javax.swing.text.StyledEditorKit) {
                return (javax.swing.text.StyledEditorKit) k;
            }
        ...
        protected final void setCharacterAttributes(JEditorPane editor,
            ...
            javax.swing.text.StyledEditorKit k = getStyledEditorKit(editor);
    ...
    public static class BoldAction extends StyledTextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            JEditorPane editor = getEditor(e);
            if (editor != null) {
                javax.swing.text.StyledEditorKit kit = getStyledEditorKit(editor);
    ...
    static class StyledInsertBreakAction extends StyledTextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                ...
                javax.swing.text.StyledEditorKit sek = getStyledEditorKit(target);
