        ...
        if(prop == JFileChooser.DIRECTORY_CHANGED_PROPERTY ||
           ...
           prop == JFileChooser.FILE_SELECTION_MODE_CHANGED_PROPERTY) {
            ...
            if (old instanceof BasicFileChooserUI) {
                ...
                javax.swing.plaf.basic.BasicDirectoryModel model = ui.getModel();
                if (model != null) {
        ...
        public synchronized void run() {
            if (fetchID == fid && doFire) {
                ...
                if (remSize > 0 && addSize == 0) {
                    fireIntervalRemoved(javax.swing.plaf.basic.BasicDirectoryModel.this, remStart, remStart + remSize - 1);
                } else if (addSize > 0 && remSize == 0 && addStart + addSize <= fileCache.size()) {
                    fireIntervalAdded(javax.swing.plaf.basic.BasicDirectoryModel.this, addStart, addStart + addSize - 1);
                } else {
                    fireContentsChanged();
                }
            }
