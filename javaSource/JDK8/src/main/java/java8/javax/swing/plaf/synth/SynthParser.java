...
class SynthParser extends DefaultHandler {
     ...
     */
    private List<javax.swing.plaf.synth.ParsedSynthStyle.StateInfo> _stateInfos;
     ...
     */
    private List<javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo> _stylePainters;

    /**
     * List of SynthStyle.Painters that will be applied to the current state.
     */
    private List<javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo> _statePainters;

    SynthParser() {
        _mapping = new HashMap<String,Object>();
        _stateInfos = new ArrayList<javax.swing.plaf.synth.ParsedSynthStyle.StateInfo>();
        _colorTypes = new ArrayList<ColorType>();
        _inputMapBindings = new ArrayList<String>();
        _stylePainters = new ArrayList<javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo>();
        _statePainters = new ArrayList<javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo>();
    }
    ...
    public void parse(InputStream inputStream,
                      javax.swing.plaf.synth.DefaultSynthStyleFactory factory,
    ...
    private void startStyle(Attributes attributes) throws SAXException {
        ...
        for(int i = attributes.getLength() - 1; i >= 0; i--) {
            ...
            if (key.equals(ATTRIBUTE_CLONE)) {
                _style = (javax.swing.plaf.synth.ParsedSynthStyle)((javax.swing.plaf.synth.ParsedSynthStyle)lookup(
                         attributes.getValue(i), javax.swing.plaf.synth.ParsedSynthStyle.class)).
                         clone();
            }
        ...
        if (_style == null) {
            _style = new javax.swing.plaf.synth.ParsedSynthStyle();
        }
        register(id, _style);
    }
    ...
    private void endStyle() {
        ...
        if (size > 0) {
            _style.setPainters(_stylePainters.toArray(new javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo[size]));
            _stylePainters.clear();
        }
        size = _stateInfos.size();
        if (size > 0) {
            _style.setStateInfo(_stateInfos.toArray(new javax.swing.plaf.synth.ParsedSynthStyle.StateInfo[size]));
            _stateInfos.clear();
        }
        _style = null;
    }
    ...
    private void startState(Attributes attributes) throws SAXException {
        javax.swing.plaf.synth.ParsedSynthStyle.StateInfo stateInfo = null;
        int state = 0;
        String id = null;
        ...
        for(int i = attributes.getLength() - 1; i >= 0; i--) {
            ...
            if (key.equals(ATTRIBUTE_ID)) {
                ...
                _stateInfo = (javax.swing.plaf.synth.ParsedSynthStyle.StateInfo)lookup(
                   attributes.getValue(i), javax.swing.plaf.synth.ParsedSynthStyle.StateInfo.class);
            }
            else if (key.equals(ATTRIBUTE_CLONE)) {
                _stateInfo = (javax.swing.plaf.synth.ParsedSynthStyle.StateInfo)((javax.swing.plaf.synth.ParsedSynthStyle.
                             StateInfo)lookup(attributes.getValue(i),
                             javax.swing.plaf.synth.ParsedSynthStyle.StateInfo.class)).clone();
            }
        ...
        if (_stateInfo == null) {
            _stateInfo = new javax.swing.plaf.synth.ParsedSynthStyle.StateInfo();
        }
    ...
    private void endState() {
        ...
        if (size > 0) {
            _stateInfo.setPainters(_statePainters.toArray(new javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo[size]));
            _statePainters.clear();
        }
        _stateInfo = null;
    }
    ...
    private void startBind(Attributes attributes) throws SAXException {
        javax.swing.plaf.synth.ParsedSynthStyle style = null;
        String path = null;
        int type = -1;
        ...
        for(int i = attributes.getLength() - 1; i >= 0; i--) {
            ...
            if (key.equals(ATTRIBUTE_STYLE)) {
                style = (javax.swing.plaf.synth.ParsedSynthStyle)lookup(attributes.getValue(i),
                                                  javax.swing.plaf.synth.ParsedSynthStyle.class);
            }
            else if (key.equals(ATTRIBUTE_TYPE)) {
                String typeS = attributes.getValue(i).toUpperCase();

                if (typeS.equals("NAME")) {
                    type = javax.swing.plaf.synth.DefaultSynthStyleFactory.NAME;
                }
                else if (typeS.equals("REGION")) {
                    type = javax.swing.plaf.synth.DefaultSynthStyleFactory.REGION;
                }
                else {
    ...
    private void startPainter(Attributes attributes, String type) throws SAXException {
        ...
        if (painter == null) {
            ...
            painter = new javax.swing.plaf.synth.ImagePainter(!stretch, paintCenter,
    ...
    private void addPainterOrMerge(List<javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo> painters, String method,
                                   SynthPainter painter, int direction) {
        javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo painterInfo;
        painterInfo = new javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo(method,
                                                       painter,
                                                       direction);

        for (Object infoObject: painters) {
            javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo info;
            info = (javax.swing.plaf.synth.ParsedSynthStyle.PainterInfo) infoObject;
