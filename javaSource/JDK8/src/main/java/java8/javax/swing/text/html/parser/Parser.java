...
class Parser implements DTDConstants {
    ...
    protected void startTag(TagElement tag) throws ChangedCharSetException {
        ...
        if (elem.isEmpty()) {
            ...
            */
            ...
            recent = elem;
            stack = new javax.swing.text.html.parser.TagStack(tag, stack);
            handleStartTag(tag);
        }
    }
    ...
    boolean ignoreElement(Element elem) {
        ...
        if (elemName.equals("dt") || elemName.equals("dd")) {
            javax.swing.text.html.parser.TagStack s = stack;
    ...
    boolean legalElementContext(Element elem) throws ChangedCharSetException {
        ...
        if (!insertTag && stack.terminate() && (!strict || stack.elem.omitEnd())) {
            for (javax.swing.text.html.parser.TagStack s = stack.next; s != null ; s = s.next) {
                if (s.advance(elem)) {
                    while (stack != s) {
                        endTag(true);
                    }
    ...
    void legalTagContext(TagElement tag) throws ChangedCharSetException {
        ...
        for (javax.swing.text.html.parser.TagStack s = stack; s != null ; s = s.next) {
        ...
        switch (ch = readCh()) {
          ...
          case '/':
            ...
            */
            ...
            javax.swing.text.html.parser.TagStack sp = stack;
