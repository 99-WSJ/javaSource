...
public class TreePath extends Object implements Serializable {
    ...
    public TreePath(Object[] path) {
        ...
        if(path.length > 1)
            parentPath = new javax.swing.tree.TreePath(path, path.length - 1);
    }
     ...
     *         {@code null}
     */
    protected TreePath(javax.swing.tree.TreePath parent, Object lastPathComponent) {
        if(lastPathComponent == null)
            throw new IllegalArgumentException("path in TreePath must be non null.");
        parentPath = parent;
        this.lastPathComponent = lastPathComponent;
    ...
    protected TreePath(Object[] path, int length) {
        ...
        if(length > 1)
            parentPath = new javax.swing.tree.TreePath(path, length - 1);
    }
    ...
    public Object[] getPath() {
        ...
        for(javax.swing.tree.TreePath path = this; path != null; path = path.getParentPath()) {
    ...
    public Object getPathComponent(int index) {
        ...
        javax.swing.tree.TreePath path = this;
    ...
    public boolean equals(Object o) {
        if(o == this)
            return true;
        if(o instanceof javax.swing.tree.TreePath) {
            javax.swing.tree.TreePath oTreePath = (javax.swing.tree.TreePath)o;

            if(getPathCount() != oTreePath.getPathCount())
                return false;
            for(javax.swing.tree.TreePath path = this; path != null;
                path = path.getParentPath()) {
     ...
     */
    public javax.swing.tree.TreePath pathByAddingChild(Object child) {
        if(child == null)
