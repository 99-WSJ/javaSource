...
public class MetalTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected void paintTopTabBorder( int tabIndex, Graphics g,
        ...
        boolean leftToRight = javax.swing.plaf.metal.MetalUtils.isLeftToRight(tabPane);
    ...
    protected boolean shouldFillGap( int currentRun, int tabIndex, int x, int y ) {
        ...
        if ( currentRun == runCount - 2 ) {  // If it's the second to last row.
            ...
            if (javax.swing.plaf.metal.MetalUtils.isLeftToRight(tabPane)) {
    ...
    public class TabbedPaneLayout extends BasicTabbedPaneUI.TabbedPaneLayout {
        ...
        public TabbedPaneLayout() {
            javax.swing.plaf.metal.MetalTabbedPaneUI.this.super();
        }
