...
public class JSpinner extends JComponent implements Accessible
{
        ...
        implements ChangeListener, PropertyChangeListener, LayoutManager
    {
         ...
         * @see #getTextField
         * @see javax.swing.JSpinner#addChangeListener
         */
        public DefaultEditor(javax.swing.JSpinner spinner) {
            super(null);
    ...
    public static class DateEditor extends DefaultEditor
    {
         ...
         */
        public DateEditor(javax.swing.JSpinner spinner, String dateFormatPattern) {
         ...
         * @see SimpleDateFormat
         */
        private DateEditor(javax.swing.JSpinner spinner, DateFormat format) {
            super(spinner);
    ...
    public static class NumberEditor extends DefaultEditor
    {
         ...
         * @see SpinnerNumberModel
         */
        public NumberEditor(javax.swing.JSpinner spinner) {
            this(spinner, getDefaultPattern(spinner.getLocale()));
        }
         ...
         * @see DecimalFormat
         */
        public NumberEditor(javax.swing.JSpinner spinner, String decimalFormatPattern) {
         ...
         * @see DecimalFormat
         */
        private NumberEditor(javax.swing.JSpinner spinner, DecimalFormat format) {
            super(spinner);
    ...
    public static class ListEditor extends DefaultEditor
    {
         ...
         * @see SpinnerListModel
         */
        public ListEditor(javax.swing.JSpinner spinner) {
            super(spinner);
    ...
    protected class AccessibleJSpinner extends AccessibleJComponent
        ...
        protected AccessibleJSpinner() {
            ...
            javax.swing.JSpinner.this.addChangeListener(this);
        }
        ...
        public int getIndexAtPoint(Point p) {
            AccessibleText at = getEditorAccessibleText();
            if (at != null && sameWindowAncestor(javax.swing.JSpinner.this, editor)) {
                // convert point from the JSpinner bounds (source) to
                // editor bounds (destination)
                Point editorPoint = SwingUtilities.convertPoint(javax.swing.JSpinner.this,
                                                                p,
                                                                editor);
                if (editorPoint != null) {
        ...
        public Rectangle getCharacterBounds(int i) {
            ...
            if (at != null ) {
                ...
                if (editorRect != null &&
                    sameWindowAncestor(javax.swing.JSpinner.this, editor)) {
