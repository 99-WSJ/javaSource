...
public class DefaultStyledDocument extends AbstractDocument implements StyledDocument {
    ...
    abstract static class AbstractChangeHandler implements ChangeListener {
        ...
        private class DocReference extends WeakReference<javax.swing.text.DefaultStyledDocument> {

            DocReference(javax.swing.text.DefaultStyledDocument d, ReferenceQueue<javax.swing.text.DefaultStyledDocument> q) {
                super(d, q);
            }
        ...
        private final static Map<Class, ReferenceQueue<javax.swing.text.DefaultStyledDocument>> queueMap
                = new HashMap<Class, ReferenceQueue<javax.swing.text.DefaultStyledDocument>>();

        /** A weak reference to the document object.  */
        private DocReference doc;

        AbstractChangeHandler(javax.swing.text.DefaultStyledDocument d) {
            Class c = getClass();
            ReferenceQueue<javax.swing.text.DefaultStyledDocument> q;
            synchronized (queueMap) {
                q = queueMap.get(c);
                if (q == null) {
                    q = new ReferenceQueue<javax.swing.text.DefaultStyledDocument>();
                    queueMap.put(c, q);
                }
            }
        ...
        static List<ChangeListener> getStaleListeners(ChangeListener l) {
            ...
            ReferenceQueue<javax.swing.text.DefaultStyledDocument> q = queueMap.get(l.getClass());
        ...
        public void stateChanged(ChangeEvent e) {
            javax.swing.text.DefaultStyledDocument d = doc.get();
            if (d != null) {
        ...
        abstract void fireStateChanged(javax.swing.text.DefaultStyledDocument d, ChangeEvent e);
    }
    ...
    static class StyleChangeHandler extends AbstractChangeHandler {
        ...
        StyleChangeHandler(javax.swing.text.DefaultStyledDocument d) {
            super(d);
        }

        void fireStateChanged(javax.swing.text.DefaultStyledDocument d, ChangeEvent e) {
    ...
    static class StyleContextChangeHandler extends AbstractChangeHandler {
        ...
        StyleContextChangeHandler(javax.swing.text.DefaultStyledDocument d) {
            super(d);
        }
