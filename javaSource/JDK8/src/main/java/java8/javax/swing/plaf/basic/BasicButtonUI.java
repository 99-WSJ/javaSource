...
public class BasicButtonUI extends ButtonUI{
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        javax.swing.plaf.basic.BasicButtonUI buttonUI =
                (javax.swing.plaf.basic.BasicButtonUI) appContext.get(BASIC_BUTTON_UI_KEY);
        if (buttonUI == null) {
            buttonUI = new javax.swing.plaf.basic.BasicButtonUI();
