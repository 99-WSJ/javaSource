       ...
       MutableTreeNode, Serializable
{
    ...
    public int getDepth() {
        ...
        return ((javax.swing.tree.DefaultMutableTreeNode)last).getLevel() - getLevel();
    }
    ...
    public Object[] getUserObjectPath() {
        ...
        for(int counter = 0; counter < realPath.length; counter++)
            retPath[counter] = ((javax.swing.tree.DefaultMutableTreeNode)realPath[counter])
                               .getUserObject();
        return retPath;
    }
    ...
    public javax.swing.tree.DefaultMutableTreeNode getNextNode() {
        if (getChildCount() == 0) {
            ...
            javax.swing.tree.DefaultMutableTreeNode nextSibling = getNextSibling();

            if (nextSibling == null) {
                javax.swing.tree.DefaultMutableTreeNode aNode = (javax.swing.tree.DefaultMutableTreeNode)getParent();
                ...
                do {
                    ...
                    aNode = (javax.swing.tree.DefaultMutableTreeNode)aNode.getParent();
                } while(true);
            } else {
                return nextSibling;
            }
        } else {
            return (javax.swing.tree.DefaultMutableTreeNode)getChildAt(0);
        }
    }
    ...
    public javax.swing.tree.DefaultMutableTreeNode getPreviousNode() {
        javax.swing.tree.DefaultMutableTreeNode previousSibling;
        javax.swing.tree.DefaultMutableTreeNode myParent = (javax.swing.tree.DefaultMutableTreeNode)getParent();
    ...
    public boolean isNodeSibling(TreeNode anotherNode) {
        ...
        if (anotherNode == null) {
            ...
            if (retval && !((javax.swing.tree.DefaultMutableTreeNode)getParent())
    ...
    public javax.swing.tree.DefaultMutableTreeNode getNextSibling() {
        javax.swing.tree.DefaultMutableTreeNode retval;
        ...
        if (myParent == null) {
            ...
            retval = (javax.swing.tree.DefaultMutableTreeNode)myParent.getChildAfter(this);      // linear search
        }
    ...
    public javax.swing.tree.DefaultMutableTreeNode getPreviousSibling() {
        ...
        if (myParent == null) {
            ...
            retval = (javax.swing.tree.DefaultMutableTreeNode)myParent.getChildBefore(this);     // linear search
        }
    ...
    public javax.swing.tree.DefaultMutableTreeNode getFirstLeaf() {
        javax.swing.tree.DefaultMutableTreeNode node = this;

        while (!node.isLeaf()) {
            node = (javax.swing.tree.DefaultMutableTreeNode)node.getFirstChild();
        }
    ...
    public javax.swing.tree.DefaultMutableTreeNode getLastLeaf() {
        ...
        while (!node.isLeaf()) {
            node = (javax.swing.tree.DefaultMutableTreeNode)node.getLastChild();
        }
    ...
    public javax.swing.tree.DefaultMutableTreeNode getNextLeaf() {
        javax.swing.tree.DefaultMutableTreeNode nextSibling;
        javax.swing.tree.DefaultMutableTreeNode myParent = (javax.swing.tree.DefaultMutableTreeNode)getParent();
     ...
     */
    public Object clone() {
        javax.swing.tree.DefaultMutableTreeNode newNode;

        try {
            newNode = (javax.swing.tree.DefaultMutableTreeNode)super.clone();
