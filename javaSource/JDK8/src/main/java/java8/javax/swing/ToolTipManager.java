...
;
    ...
    public static javax.swing.ToolTipManager sharedInstance() {
        ...
        if (value instanceof javax.swing.ToolTipManager) {
            return (javax.swing.ToolTipManager) value;
        }
        javax.swing.ToolTipManager manager = new javax.swing.ToolTipManager();
        ...
        public void keyPressed(KeyEvent e) {
            if (!e.isConsumed()) {
                ...
                if (hideTip.equals(keyStrokeForEvent)) {
                    ...
                    javax.swing.ToolTipManager.this.show(source);
                    e.consume();
                }
            }
        }
