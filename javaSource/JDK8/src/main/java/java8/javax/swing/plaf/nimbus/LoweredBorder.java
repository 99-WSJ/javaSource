...
class LoweredBorder extends AbstractRegionPainter implements Border {
    ...
    protected void doPaint(Graphics2D g, JComponent c, int width, int height,
        ...
        g2.dispose();
        // draw shadow
        javax.swing.plaf.nimbus.InnerShadowEffect effect = new javax.swing.plaf.nimbus.InnerShadowEffect();
        ...
        if (width != IMG_SIZE || height != IMG_SIZE){
            javax.swing.plaf.nimbus.ImageScalingHelper.paint(g,0,0,width,height,img2, INSETS, INSETS,
                    javax.swing.plaf.nimbus.ImageScalingHelper.PaintType.PAINT9_STRETCH,
                    javax.swing.plaf.nimbus.ImageScalingHelper.PAINT_ALL);
        } else {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width,
        ...
        if (g instanceof Graphics2D){
            ...
            paint(g2,comp, width, height);
            g2.dispose();
            javax.swing.plaf.nimbus.ImageScalingHelper.paint(g,x,y,width,height,img,INSETS, INSETS,
                    javax.swing.plaf.nimbus.ImageScalingHelper.PaintType.PAINT9_STRETCH,
                    javax.swing.plaf.nimbus.ImageScalingHelper.PAINT_ALL);
        }
    }
