...
public class DefaultTreeSelectionModel implements Cloneable, Serializable, TreeSelectionModel
{
    ...
    public void setSelectionPaths(TreePath[] pPaths) {
        ...
        if((newCount + oldCount) != 0) {
            ...
            Vector<javax.swing.tree.PathPlaceHolder> cPaths = new Vector<javax.swing.tree.PathPlaceHolder>(newCount + oldCount);
            ...
            for(newCounter = 0; newCounter < newCount; newCounter++) {
                ...
                if (path != null && lastPaths.get(path) == null) {
                    ...
                    if (uniquePaths.get(path) == null) {
                        cPaths.addElement(new javax.swing.tree.PathPlaceHolder(path, true));
                    }
                    leadPath = path;
            ...
            for(oldCounter = 0; oldCounter < oldCount; oldCounter++)
                if(selection[oldCounter] != null &&
                    ...
                    cPaths.addElement(new javax.swing.tree.PathPlaceHolder
    ...
    public void addSelectionPaths(TreePath[] paths) {
        ...
        if(newPathLength > 0) {
            if(selectionMode == TreeSelectionModel.SINGLE_TREE_SELECTION) {
                ...
                int               oldCount;
                TreePath          beginLeadPath = leadPath;
                Vector<javax.swing.tree.PathPlaceHolder>  cPaths = null;
                ...
                for(counter = 0, validCount = 0; counter < newPathLength;
                    ...
                    if(paths[counter] != null) {
                        if (uniquePaths.get(paths[counter]) == null) {
                            validCount++;
                            if(cPaths == null)
                                cPaths = new Vector<javax.swing.tree.PathPlaceHolder>();
                            cPaths.addElement(new javax.swing.tree.PathPlaceHolder
                                              (paths[counter], true));
    ...
    public void removeSelectionPaths(TreePath[] paths) {
        if (paths != null && selection != null && paths.length > 0) {
            if(!canPathsBeRemoved(paths)) {
                ...
                Vector<javax.swing.tree.PathPlaceHolder> pathsToRemove = null;
                    ...
                    if(paths[removeCounter] != null) {
                        if (uniquePaths.get(paths[removeCounter]) != null) {
                            if(pathsToRemove == null)
                                pathsToRemove = new Vector<javax.swing.tree.PathPlaceHolder>(paths.length);
                            uniquePaths.remove(paths[removeCounter]);
                            pathsToRemove.addElement(new javax.swing.tree.PathPlaceHolder
    ...
    protected void notifyPathChange(Vector<?> changedPaths,
        ...
        javax.swing.tree.PathPlaceHolder placeholder;

        for(int counter = 0; counter < cPathCount; counter++) {
            placeholder = (javax.swing.tree.PathPlaceHolder) changedPaths.elementAt(counter);
    ...
    public Object clone() throws CloneNotSupportedException {
        javax.swing.tree.DefaultTreeSelectionModel clone = (javax.swing.tree.DefaultTreeSelectionModel)
                            super.clone();
