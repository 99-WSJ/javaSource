...
public class BasicToggleButtonUI extends BasicButtonUI {
    ...
    public static ComponentUI createUI(JComponent b) {
        ...
        javax.swing.plaf.basic.BasicToggleButtonUI toggleButtonUI =
                (javax.swing.plaf.basic.BasicToggleButtonUI) appContext.get(BASIC_TOGGLE_BUTTON_UI_KEY);
        if (toggleButtonUI == null) {
            toggleButtonUI = new javax.swing.plaf.basic.BasicToggleButtonUI();
