...
class ParsedSynthStyle extends DefaultSynthStyle {
    ...
    public ParsedSynthStyle(DefaultSynthStyle style) {
        super(style);
        if (style instanceof javax.swing.plaf.synth.ParsedSynthStyle) {
            javax.swing.plaf.synth.ParsedSynthStyle pStyle = (javax.swing.plaf.synth.ParsedSynthStyle)style;
    ...
    public DefaultSynthStyle addTo(DefaultSynthStyle style) {
        if (!(style instanceof javax.swing.plaf.synth.ParsedSynthStyle)) {
            style = new javax.swing.plaf.synth.ParsedSynthStyle(style);
        }
        javax.swing.plaf.synth.ParsedSynthStyle pStyle = (javax.swing.plaf.synth.ParsedSynthStyle)super.addTo(style);
    ...
    private static class DelegatingPainter extends SynthPainter {
        private static SynthPainter getPainter(SynthContext context,
            ...
            return ((javax.swing.plaf.synth.ParsedSynthStyle)context.getStyle()).getBestPainter(
