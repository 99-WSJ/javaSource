...
public class Timer implements Serializable
{
    ...
    transient javax.swing.TimerQueue.DelayedTimer delayedTimer = null;
     ...
     * @see javax.swing.Timer#post
     */
    class DoPostEvent implements Runnable
    {
        public void run() {
            if (logTimers) {
                System.out.println("Timer ringing: " + javax.swing.Timer.this);
            }
            if(notify.get()) {
                fireActionPerformed(new ActionEvent(javax.swing.Timer.this, 0, getActionCommand(),
    ...
    private javax.swing.TimerQueue timerQueue() {
        return javax.swing.TimerQueue.sharedInstance();
    }
    ...
    void post() {
         if (notify.compareAndSet(false, true) || !coalesce) {
             AccessController.doPrivileged(new PrivilegedAction<Void>() {
                 public Void run() {
                     javax.swing.SwingUtilities.invokeLater(doPostEvent);
                     return null;
                }
    ...
    private Object readResolve() {
        javax.swing.Timer timer = new javax.swing.Timer(getDelay(), null);
