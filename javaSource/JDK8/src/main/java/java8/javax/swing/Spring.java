...
public abstract class Spring {
    ...
    /*pp*/ static abstract class AbstractSpring extends javax.swing.Spring {
    ...
    private static class NegativeSpring extends javax.swing.Spring {
        private javax.swing.Spring s;

        public NegativeSpring(javax.swing.Spring s) {
            this.s = s;
        }
...
// See the opening preamble on arithmetic with springs.
    ...
    private static class ScaleSpring extends javax.swing.Spring {
        ...
        private ScaleSpring(javax.swing.Spring s, float factor) {
            this.s = s;
            this.factor = factor;
        }
   ...
   /*pp*/ static abstract class SpringMap extends javax.swing.Spring {
       private javax.swing.Spring s;

       public SpringMap(javax.swing.Spring s) {
           this.s = s;
       }
...
// cache values that have already been calculated.
    /*pp*/ static abstract class CompoundSpring extends StaticSpring {
        ...
        public CompoundSpring(javax.swing.Spring s1, javax.swing.Spring s2) {
            super(UNSET);
            this.s1 = s1;
            this.s2 = s2;
        }
     ...
     private static class SumSpring extends CompoundSpring {
         public SumSpring(javax.swing.Spring s1, javax.swing.Spring s2) {
             super(s1, s2);
         }
    ...
    private static class MaxSpring extends CompoundSpring {
        ...
        public MaxSpring(javax.swing.Spring s1, javax.swing.Spring s2) {
            super(s1, s2);
        }
     ...
     * @see javax.swing.Spring
     */
     public static javax.swing.Spring constant(int min, int pref, int max) {
     ...
     * @see javax.swing.Spring
     */
     public static javax.swing.Spring sum(javax.swing.Spring s1, javax.swing.Spring s2) {
     ...
     * @see javax.swing.Spring
     */
    public static javax.swing.Spring max(javax.swing.Spring s1, javax.swing.Spring s2) {
    ...
    /*pp*/ static javax.swing.Spring difference(javax.swing.Spring s1, javax.swing.Spring s2) {
    ...
    */
     ...
     * @since 1.5
     */
    public static javax.swing.Spring scale(javax.swing.Spring s, float factor) {
        checkArg(s);
     ...
     * @since 1.5
     */
    public static javax.swing.Spring width(Component c) {
        checkArg(c);
     ...
     * @since 1.5
     */
    public static javax.swing.Spring height(Component c) {
        checkArg(c);
