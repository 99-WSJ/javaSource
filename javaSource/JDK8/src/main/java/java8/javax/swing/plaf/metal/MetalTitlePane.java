...
class MetalTitlePane extends JComponent {
    ...
    // Bumps
    private javax.swing.plaf.metal.MetalBumps activeBumps
        = new javax.swing.plaf.metal.MetalBumps( 0, 0,
                          activeBumpsHighlight,
                          activeBumpsShadow,
                          MetalLookAndFeel.getPrimaryControl() );
    private javax.swing.plaf.metal.MetalBumps inactiveBumps
        = new javax.swing.plaf.metal.MetalBumps( 0, 0,
    ...
    private void addMenuItems(JMenu menu) {
        ...
        int mnemonic = javax.swing.plaf.metal.MetalUtils.getInt("MetalTitlePane.restoreMnemonic", -1);
        ...
        mnemonic = javax.swing.plaf.metal.MetalUtils.getInt("MetalTitlePane.iconifyMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
        ...
        if (Toolkit.getDefaultToolkit().isFrameStateSupported(
            ...
            mnemonic =
                javax.swing.plaf.metal.MetalUtils.getInt("MetalTitlePane.maximizeMnemonic", -1);
            if (mnemonic != -1) {
                mi.setMnemonic(mnemonic);
            }
        }
        ...
        mnemonic = javax.swing.plaf.metal.MetalUtils.getInt("MetalTitlePane.closeMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
    }
