...
public class DebugGraphics extends Graphics {
    ...
    public Graphics create() {
        ...
        debugGraphics = new javax.swing.DebugGraphics();
        ...
        if (isDrawingBuffer()) {
            ...
            ImageProducer newProducer
                = new FilteredImageSource(oldProducer,
                                new javax.swing.DebugGraphicsFilter(info.flashColor));
            Image newImage
    ...
    private Graphics debugGraphics() {
        ...
        debugFrame.show();
        debugGraphics = new javax.swing.DebugGraphics(debugFrame.getGraphics());
