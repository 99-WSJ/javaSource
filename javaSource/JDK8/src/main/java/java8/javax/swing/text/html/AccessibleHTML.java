                ...
                for (int i = 0; i < elementInfo.getChildCount(); i++)
{
    ...
    private class TableElementInfo extends ElementInfo
        ...
        public class TableAccessibleContext extends HTMLAccessibleContext
             ...
             */
            public int getAccessibleChildrenCount() {
                return ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getRowCount() *
                    ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getColumnCount();
            }
             ...
             */
            public Accessible getAccessibleChild(int i) {
                int rowCount = ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getRowCount();
                int columnCount = ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getColumnCount();
                int r = i / rowCount;
                int c = i % columnCount;
            ...
            public int getAccessibleColumnCount() {
                return ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getColumnCount();
            }
            ...
            public int getAccessibleRowExtentAt(int r, int c) {
                return ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getRowExtentAt(r, c);
            }
            ...
            public int getAccessibleColumnExtentAt(int r, int c) {
                return ((javax.swing.text.html.AccessibleHTML.TableElementInfo)elementInfo).getColumnExtentAt(r, c);
            }
        ...
        private class TableRowElementInfo extends ElementInfo {
            ...
            TableRowElementInfo(Element e, javax.swing.text.html.AccessibleHTML.TableElementInfo parent, int rowNumber) {
                super(e, parent);
                this.parent = parent;
