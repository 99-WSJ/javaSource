...
/////////////////////////////////////////////////////////////////////////////
    public static ComponentUI createUI(JComponent b)    {
        return new javax.swing.plaf.basic.BasicInternalFrameUI((JInternalFrame)b);
    }
    ...
    protected void installKeyboardActions(){
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(frame, javax.swing.plaf.basic.BasicInternalFrameUI.class,
    ...
    static void loadActionMap(javax.swing.plaf.basic.LazyActionMap map) {
        map.put(new UIAction("showSystemMenu") {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (iFrame.getUI() instanceof javax.swing.plaf.basic.BasicInternalFrameUI) {
                    JComponent comp = ((javax.swing.plaf.basic.BasicInternalFrameUI)
            ...
            public boolean isEnabled(Object sender){
                if (sender instanceof JInternalFrame) {
                    ...
                    if (iFrame.getUI() instanceof javax.swing.plaf.basic.BasicInternalFrameUI) {
                        return ((javax.swing.plaf.basic.BasicInternalFrameUI)iFrame.getUI()).
                            isKeyBindingActive();
                    }
                }
                return false;
    ...
    private class Handler implements ComponentListener, InternalFrameListener,
        ...
        public void layoutContainer(Container c) {
            ...
            if(getNorthPane() != null) {
                ...
                if (DefaultLookup.getBoolean(frame, javax.swing.plaf.basic.BasicInternalFrameUI.this,
