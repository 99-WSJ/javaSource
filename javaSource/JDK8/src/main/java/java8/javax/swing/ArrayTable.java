...
class ArrayTable implements Cloneable {
     ...
     */
    static void writeArrayTable(ObjectOutputStream s, javax.swing.ArrayTable table) throws IOException {
        Object keys[];
     ...
     */
    public Object clone() {
        javax.swing.ArrayTable newArrayTable = new javax.swing.ArrayTable();
        if (isArray()) {
            Object[] array = (Object[])table;
            for (int i = 0 ;i < array.length-1 ; i+=2) {
