...
public class JMenu extends JMenuItem implements Accessible,MenuElement
{
    ...
    private void ensurePopupMenuCreated() {
        if (popupMenu == null) {
            final javax.swing.JMenu thisMenu = this;
    ...
    public boolean isMenuComponent(Component c) {
        ...
        for (int i = 0 ; i < ncomponents ; i++) {
            ...
            if (comp instanceof javax.swing.JMenu) {
                javax.swing.JMenu subMenu = (javax.swing.JMenu) comp;
     ...
     */
    private MenuElement[] buildMenuElementArray(javax.swing.JMenu leaf) {
        ...
        while (true) {
            ...
            } else if (current instanceof javax.swing.JMenu) {
                menu = (javax.swing.JMenu) current;
    ...
    protected class AccessibleJMenu extends AccessibleJMenuItem
                ...
                if (child instanceof Accessible) {
                    if (count == i) {
                        if (child instanceof JComponent) {
                            ...
                            ac.setAccessibleParent(javax.swing.JMenu.this);
                        }
        ...
        public int getAccessibleSelectionCount() {
            ...
            if (me != null) {
                for (int i = 0; i < me.length; i++) {
                    if (me[i] == javax.swing.JMenu.this) {   // this menu is selected
                        if (i+1 < me.length) {
                            return 1;
                        }
                    }
        ...
        public Accessible getAccessibleSelection(int i) {
            ...
            if (me != null) {
                for (int j = 0; j < me.length; j++) {
                    if (me[j] == javax.swing.JMenu.this) {   // this menu is selected
        ...
        public boolean isAccessibleChildSelected(int i) {
            ...
            MenuElement me[] =
                MenuSelectionManager.defaultManager().getSelectedPath();
            if (me != null) {
                JMenuItem mi = javax.swing.JMenu.this.getItem(i);
                for (int j = 0; j < me.length; j++) {
                    if (me[j] == mi) {
                        return true;
                    }
        ...
        public void addAccessibleSelection(int i) {
            ...
            if (mi != null) {
                if (mi instanceof javax.swing.JMenu) {
                    MenuElement me[] = buildMenuElementArray((javax.swing.JMenu) mi);
                    MenuSelectionManager.defaultManager().setSelectedPath(me);
                } else {
        ...
        public void removeAccessibleSelection(int i) {
            ...
            JMenuItem mi = getItem(i);
            if (mi != null && mi instanceof javax.swing.JMenu) {
                if (mi.isSelected()) {
                    MenuElement old[] =
                        MenuSelectionManager.defaultManager().getSelectedPath();
        ...
        public void clearAccessibleSelection() {
            ...
            if (old != null) {
                for (int j = 0; j < old.length; j++) {
                    if (old[j] == javax.swing.JMenu.this) {  // menu is in the selection!
                        MenuElement me[] = new MenuElement[j+1];
                        System.arraycopy(old, 0, me, 0, j);
                        me[j] = javax.swing.JMenu.this.getPopupMenu();
                        MenuSelectionManager.defaultManager().setSelectedPath(me);
                    }
                }
            }
