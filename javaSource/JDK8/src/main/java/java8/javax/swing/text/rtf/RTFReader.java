...
class RTFReader extends javax.swing.text.rtf.RTFParser
{
  ...
  static private Dictionary<String, javax.swing.text.rtf.RTFAttribute> straightforwardAttributes;
  static {
      straightforwardAttributes = RTFAttributes.attributesByKeyword();
  }

  private javax.swing.text.rtf.MockAttributeSet mockery;
...
public RTFReader(StyledDocument destination)
{
    ...
    mockery = new javax.swing.text.rtf.MockAttributeSet();
...
public void setCharacterSet(String name)
{
    ...
    setTargetAttribute(javax.swing.text.rtf.Constants.RTFCharacterSet, name);
}
    ...
    if (set == null) {
      ...
      charsetStream = java.security.AccessController.
          ...
          public InputStream run() {
              return javax.swing.text.rtf.RTFReader.class.getResourceAsStream
                                     ("charsets/" + name + ".txt");
          }
      });
 ...
 *
 *  @see javax.swing.text.rtf.RTFReader
 */
    ...
    implements Destination
{
    ...
    public void close()
    {
        ...
        while(styles.hasMoreElements()) {
            ...
            String stype = (String)defined.getAttribute(javax.swing.text.rtf.Constants.StyleType);
            Vector<Style> toSet;
            if (stype.equals(javax.swing.text.rtf.Constants.STSection)) {
                toSet = secStyles;
            } else if (stype.equals(javax.swing.text.rtf.Constants.STCharacter)) {
                toSet = chrStyles;
            } else {
                toSet = pgfStyles;
            }
...
*/
        ...
        implements Destination
    {
        ...
        public Style realize()
        {
            ...
            if (next != null)
                realizedStyle.addAttribute(javax.swing.text.rtf.Constants.StyleNext, next);
            realizedStyle.addAttribute(javax.swing.text.rtf.Constants.StyleAdditive,
                                       Boolean.valueOf(additive));
            realizedStyle.addAttribute(javax.swing.text.rtf.Constants.StyleHidden,
...
abstract class AttributeTrackingDestination implements Destination
{
    ...
    public boolean handleKeyword(String keyword)
    {
        ...
        {
            javax.swing.text.rtf.RTFAttribute attr = straightforwardAttributes.get(keyword);
            if (attr != null) {
                boolean ok;

                switch(attr.domain()) {
                  case javax.swing.text.rtf.RTFAttribute.D_CHARACTER:
                    ok = attr.set(characterAttributes);
                    break;
                  case javax.swing.text.rtf.RTFAttribute.D_PARAGRAPH:
                    ok = attr.set(paragraphAttributes);
                    break;
                  case javax.swing.text.rtf.RTFAttribute.D_SECTION:
                    ok = attr.set(sectionAttributes);
                    break;
                  case javax.swing.text.rtf.RTFAttribute.D_META:
                    mockery.backing = parserState;
                    ok = attr.set(mockery);
                    mockery.backing = null;
                    break;
                  case javax.swing.text.rtf.RTFAttribute.D_DOCUMENT:
    ...
    MutableAttributeSet currentParagraphAttributes()
    {
        ...
        if (tabs != null)
            bld.addAttribute(javax.swing.text.rtf.Constants.Tabs, tabs);
    ...
    protected void resetCharacterAttributes()
    {
        ...
        Enumeration<javax.swing.text.rtf.RTFAttribute> attributes = straightforwardAttributes.elements();
        while(attributes.hasMoreElements()) {
            javax.swing.text.rtf.RTFAttribute attr = attributes.nextElement();
