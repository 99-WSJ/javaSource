...
class FrameView extends ComponentView implements HyperlinkListener {
    ...
    JEditorPane getOutermostJEditorPane() {
        ...
        javax.swing.text.html.FrameSetView frameSetView = null;
        while (parent != null) {
            if (parent instanceof javax.swing.text.html.FrameSetView) {
                frameSetView = (javax.swing.text.html.FrameSetView)parent;
            }
    ...
    private boolean inNestedFrameSet() {
        javax.swing.text.html.FrameSetView parent = (javax.swing.text.html.FrameSetView)getParent();
        return (parent.getParent() instanceof javax.swing.text.html.FrameSetView);
    }
    ...
    class FrameEditorPane extends JEditorPane implements FrameEditorPaneTag {
        ...
        javax.swing.text.html.FrameView getFrameView() {
            return javax.swing.text.html.FrameView.this;
        }
    }
}
