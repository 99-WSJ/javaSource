...
static public void writeDocument(Document d, OutputStream to)
    throws IOException
{
    javax.swing.text.rtf.RTFGenerator gen = new javax.swing.text.rtf.RTFGenerator(to);
...
private Integer findStyleNumber(AttributeSet a, String domain)
{
    while(a != null) {
        if (a instanceof Style) {
            ...
            if (aNum != null) {
                if (domain == null ||
                    domain.equals(a.getAttribute(javax.swing.text.rtf.Constants.StyleType)))
                    return aNum;
            }
    ...
    throws IOException
{
    ...
    if (styleCount > 1) {
        ...
        while(styles.hasMoreElements()) {
            ...
            writeBegingroup();
            String styleType = (String)style.getAttribute(javax.swing.text.rtf.Constants.StyleType);
            if (styleType == null)
                styleType = javax.swing.text.rtf.Constants.STParagraph;
            if (styleType.equals(javax.swing.text.rtf.Constants.STCharacter)) {
                writeControlWord("*");
                writeControlWord("cs", styleNumber);
            } else if(styleType.equals(javax.swing.text.rtf.Constants.STSection)) {
                writeControlWord("*");
            ...
            Style nextStyle = (Style)style.getAttribute(javax.swing.text.rtf.Constants.StyleNext);
            if (nextStyle != null) {
            ...
            Boolean hidden = (Boolean)style.getAttribute(javax.swing.text.rtf.Constants.StyleHidden);
            if (hidden != null && hidden.booleanValue())
                writeControlWord("shidden");

            Boolean additive = (Boolean)style.getAttribute(javax.swing.text.rtf.Constants.StyleAdditive);
    ...
    throws IOException
{
    ...
    for(i = 0; i < RTFAttributes.attributes.length; i++) {
        javax.swing.text.rtf.RTFAttribute attr = RTFAttributes.attributes[i];
        if (attr.domain() != javax.swing.text.rtf.RTFAttribute.D_DOCUMENT)
            continue;
...
protected void checkControlWord(MutableAttributeSet currentAttributes,
                                AttributeSet newAttributes,
                                javax.swing.text.rtf.RTFAttribute word)
    throws IOException
{
    Object parm;
...
protected void checkControlWords(MutableAttributeSet currentAttributes,
                                 AttributeSet newAttributes,
                                 javax.swing.text.rtf.RTFAttribute words[],
                                 int domain)
    throws IOException
{
    int wordIndex;
    ...
    for(wordIndex = 0; wordIndex < wordCount; wordIndex++) {
        javax.swing.text.rtf.RTFAttribute attr = words[wordIndex];
    ...
    throws IOException
{
    if (emitStyleChanges) {
        ...
        Object newStyle = findStyleNumber(newAttributes, javax.swing.text.rtf.Constants.STSection);
    ...
    checkControlWords(current, newAttributes,
                      RTFAttributes.attributes, javax.swing.text.rtf.RTFAttribute.D_SECTION);
}
    ...
    throws IOException
{
    ...
    for(wordIndex = 0; wordIndex < wordCount; wordIndex++) {
        javax.swing.text.rtf.RTFAttribute attr = RTFAttributes.attributes[wordIndex];
        if (attr.domain() == javax.swing.text.rtf.RTFAttribute.D_SECTION)
    ...
    throws IOException
{
    ...
    if (emitStyleChanges) {
        ...
        newStyle = findStyleNumber(newAttributes, javax.swing.text.rtf.Constants.STParagraph);
        if (oldStyle != newStyle) {
            if (oldStyle != null) {
    ...
    Object oldTabs = current.getAttribute(javax.swing.text.rtf.Constants.Tabs);
    Object newTabs = newAttributes.getAttribute(javax.swing.text.rtf.Constants.Tabs);
    if (oldTabs != newTabs) {
        if (oldTabs != null) {
            resetParagraphAttributes(current);
            oldTabs = null;
    ...
    checkControlWords(current, newAttributes,
                      RTFAttributes.attributes, javax.swing.text.rtf.RTFAttribute.D_PARAGRAPH);
    ...
    if (oldTabs != newTabs && newTabs != null) {
        ...
        current.addAttribute(javax.swing.text.rtf.Constants.Tabs, tabs);
    }
}
    ...
    throws IOException
{
    ...
    for(wordIndex = 0; wordIndex < wordCount; wordIndex++) {
        javax.swing.text.rtf.RTFAttribute attr = RTFAttributes.attributes[wordIndex];
        if (attr.domain() == javax.swing.text.rtf.RTFAttribute.D_PARAGRAPH)
            attr.setDefault(currentAttributes);
    }

    currentAttributes.removeAttribute("paragraphStyle");
    currentAttributes.removeAttribute(javax.swing.text.rtf.Constants.Tabs);
}
    ...
    throws IOException
{
    ...
    if (updateStyleChanges) {
        ...
        Object newStyle = findStyleNumber(newAttributes,
                                          javax.swing.text.rtf.Constants.STCharacter);
        if (oldStyle != newStyle) {
            if (oldStyle != null) {
    ...
    checkControlWords(current, newAttributes,
                      RTFAttributes.attributes, javax.swing.text.rtf.RTFAttribute.D_CHARACTER);
    ...
    throws IOException
{
    ...
    for(wordIndex = 0; wordIndex < wordCount; wordIndex++) {
        javax.swing.text.rtf.RTFAttribute attr = RTFAttributes.attributes[wordIndex];
        if (attr.domain() == javax.swing.text.rtf.RTFAttribute.D_CHARACTER)
            attr.setDefault(currentAttributes);
    }
