...
public abstract class SwingWorker<T, V> implements RunnableFuture<T> {
    ...
    private static synchronized ExecutorService getWorkersExecutorService() {
        ...
        ExecutorService executorService =
            (ExecutorService) appContext.get(javax.swing.SwingWorker.class);
        if (executorService == null) {
            ...
            executorService =
                new ThreadPoolExecutor(MAX_WORKER_THREADS, MAX_WORKER_THREADS,
                                       ...
                                       threadFactory);
            appContext.put(javax.swing.SwingWorker.class, executorService);
        ...
        public void firePropertyChange(final PropertyChangeEvent evt) {
            if (SwingUtilities.isEventDispatchThread()) {
                ...
                doSubmit.add(
                    new Runnable() {
                        public void run() {
                            javax.swing.SwingWorker.SwingWorkerPropertyChangeSupport.this
