...
public class MetalLookAndFeel extends BasicLookAndFeel
{
  ...
  "inactiveCaptionBorder", theme.getControlShadow(), /* Border color for inactive caption (title bar) window borders. */
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
           ...
           "shift ctrl F12", "navigatePrevious"
            ...
            "Table.ascendingSortIcon",
                SwingUtilities2.makeIcon(getClass(), javax.swing.plaf.metal.MetalLookAndFeel.class,
                "icons/sortUp.png"),
        ...
        if (isWindows() && useSystemFonts() && theme.isSystemTheme()) {
            Object messageFont = new javax.swing.plaf.metal.MetalFontDesktopProperty(
    ...
    public static MetalTheme getCurrentTheme() {
        ...
        if (currentTheme == null) {
            ...
            if (useHighContrastTheme()) {
                currentTheme = new javax.swing.plaf.metal.MetalHighContrastTheme();
            }
            else {
    ...
    public Icon getDisabledIcon(JComponent component, Icon icon) {
        if ((icon instanceof ImageIcon) && javax.swing.plaf.metal.MetalLookAndFeel.usingOcean()) {
            return javax.swing.plaf.metal.MetalUtils.getOceanDisabledButtonIcon(
