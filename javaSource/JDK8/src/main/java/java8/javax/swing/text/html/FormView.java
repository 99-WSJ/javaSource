...
public class FormView extends ComponentView implements ActionListener {
    ...
    protected Component createComponent() {
        ...
        if (t == HTML.Tag.INPUT) {
            ...
            if (model instanceof javax.swing.text.html.OptionListModel) {
    ...
    protected void submitData(String data) {
        ...
        if (!kit.isAutoFormSubmission() || doc.isFrameDocument()) {
            ...
            formEvent = new FormSubmitEvent(
                    javax.swing.text.html.FormView.this, HyperlinkEvent.EventType.ACTIVATED,
    ...
    private void loadSelectData(AttributeSet attr, StringBuilder buffer) {
        ...
        if (m instanceof javax.swing.text.html.OptionListModel) {
            javax.swing.text.html.OptionListModel<Option> model = (javax.swing.text.html.OptionListModel<Option>) m;
        ...
        if (parent != null) {
            ...
            while((next = it.next()) != null) {
                if (isControl(next)) {
                    ...
                    } else if (m instanceof javax.swing.text.html.OptionListModel) {
                        javax.swing.text.html.OptionListModel model = (javax.swing.text.html.OptionListModel) m;
