...
public class SizeRequirements implements Serializable {
    ...
    public static javax.swing.SizeRequirements getTiledSizeRequirements(javax.swing.SizeRequirements[]
                                                            children) {
        javax.swing.SizeRequirements total = new javax.swing.SizeRequirements();
        for (int i = 0; i < children.length; i++) {
            javax.swing.SizeRequirements req = children[i];
    ...
    public static javax.swing.SizeRequirements getAlignedSizeRequirements(javax.swing.SizeRequirements[]
                                                              children) {
        javax.swing.SizeRequirements totalAscent = new javax.swing.SizeRequirements();
        javax.swing.SizeRequirements totalDescent = new javax.swing.SizeRequirements();
        for (int i = 0; i < children.length; i++) {
            javax.swing.SizeRequirements req = children[i];
    ...
    private static void compressedTile(int allocated, long min, long pref, long max,
                                       javax.swing.SizeRequirements[] request,
        ...
        if( forward ) {
            ...
            for (int i = 0; i < spans.length; i++) {
                ...
                javax.swing.SizeRequirements req = request[i];
     ...
     */
    public static int[] adjustSizes(int delta, javax.swing.SizeRequirements[] children) {
      return new int[0];
    }
}
