...
/*public*/ class TableView extends BoxView implements ViewFactory {
    ...
    class RowIterator implements CSS.LayoutIterator {
        ...
        public float getPreferredSpan(float parentSpan) {
            ...
            if (rv != null) {
                ...
                return rv.getPreferredSpan(javax.swing.text.html.TableView.this.getAxis()) + adjust;
            }
            return 0;
        }
    ...
    public class RowView extends BoxView {
        ...
        public void preferenceChanged(View child, boolean width, boolean height) {
            ...
            if (javax.swing.text.html.TableView.this.multiRowCells && height) {
                for (int i = rowIndex  - 1; i >= 0; i--) {
                    RowView rv = javax.swing.text.html.TableView.this.getRow(i);
                    if (rv.multiRowCells) {
