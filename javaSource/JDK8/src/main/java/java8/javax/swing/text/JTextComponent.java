...
public abstract class JTextComponent extends JComponent implements Scrollable, Accessible
{
    ...
    static {
        SwingAccessor.setJTextComponentAccessor(
            new SwingAccessor.JTextComponentAccessor() {
                public TransferHandler.DropLocation dropLocationForPoint(javax.swing.text.JTextComponent textComp,
                                                                         Point p)
                {
                    return textComp.dropLocationForPoint(p);
                }
                public Object setDropLocation(javax.swing.text.JTextComponent textComp,
    ...
    private static Boolean isProcessInputMethodEventOverridden(Class<?> klass) {
        if (klass == javax.swing.text.JTextComponent.class) {
    ...
    public void replaceSelection(String content) {
        ...
        if (doc != null) {
            try {
                ...
                UIManager.getLookAndFeel().provideErrorFeedback(javax.swing.text.JTextComponent.this);
            }
        }
    }
...
////////////////
    ...
    implements AccessibleText, CaretListener, DocumentListener,
        ...
        public AccessibleJTextComponent() {
            Document doc = javax.swing.text.JTextComponent.this.getDocument();
            if (doc != null) {
                doc.addDocumentListener(this);
            }
            javax.swing.text.JTextComponent.this.addCaretListener(this);
            ...
            javax.swing.text.JTextComponent.this.addComponentListener(new ComponentAdapter() {
        ...
        public AccessibleStateSet getAccessibleStateSet() {
            ...
            if (javax.swing.text.JTextComponent.this.isEditable()) {
        ...
        public int getIndexAtPoint(Point p) {
            ...
            return javax.swing.text.JTextComponent.this.viewToModel(p);
        }
            ...
            Rectangle getRootEditorRect() {
                Rectangle alloc = javax.swing.text.JTextComponent.this.getBounds();
                if ((alloc.width > 0) && (alloc.height > 0)) {
                        alloc.x = alloc.y = 0;
                        Insets insets = javax.swing.text.JTextComponent.this.getInsets();
                        alloc.x += insets.left;
                        alloc.y += insets.top;
        ...
        public Rectangle getCharacterBounds(int i) {
            ...
            try {
                View rootView = ui.getRootView(javax.swing.text.JTextComponent.this);
                if (rootView != null) {
         ...
         */
        public int getCaretPosition() {
            return javax.swing.text.JTextComponent.this.getCaretPosition();
        }
         ...
         */
        public int getSelectionStart() {
            return javax.swing.text.JTextComponent.this.getSelectionStart();
        }
         ...
         */
        public int getSelectionEnd() {
            return javax.swing.text.JTextComponent.this.getSelectionEnd();
        }
         ...
         */
        public String getSelectedText() {
            return javax.swing.text.JTextComponent.this.getSelectedText();
        }
       ...
       /**
        ...
        public void setTextContents(String s) {
            javax.swing.text.JTextComponent.this.setText(s);
        }
        ...
        public void cut(int startIndex, int endIndex) {
            ...
            javax.swing.text.JTextComponent.this.cut();
        }
        ...
        public void paste(int startIndex) {
            ...
            javax.swing.text.JTextComponent.this.paste();
        }
        ...
        public void replaceText(int startIndex, int endIndex, String s) {
            selectText(startIndex, endIndex);
            javax.swing.text.JTextComponent.this.replaceSelection(s);
        }
        ...
        public void selectText(int startIndex, int endIndex) {
            javax.swing.text.JTextComponent.this.select(startIndex, endIndex);
        }
...
// call this new method instead and return only the string portion
        ...
        private AccessibleTextSequence getSequenceAtIndex(int part,
            ...
            case AccessibleExtendedText.LINE:
                ...
                try {
                    int startIndex =
                        Utilities.getRowStart(javax.swing.text.JTextComponent.this, index);
                    int endIndex =
                        Utilities.getRowEnd(javax.swing.text.JTextComponent.this, index);
                    if (startIndex >= 0 && endIndex >= startIndex) {
                        if (direction == 0) {
                            ...
                            endIndex =
                                Utilities.getRowEnd(javax.swing.text.JTextComponent.this,
                                    startIndex - 1);
                            startIndex =
                                Utilities.getRowStart(javax.swing.text.JTextComponent.this,
                                    startIndex - 1);
                            if (startIndex >= 0 && endIndex >= startIndex) {
                                lineSequence =
        ...
        public int getAccessibleActionCount() {
            Action [] actions = javax.swing.text.JTextComponent.this.getActions();
        ...
        public boolean doAccessibleAction(int i) {
            ...
            ActionEvent ae =
                new ActionEvent(javax.swing.text.JTextComponent.this,
    ...
    static class DefaultTransferHandler extends TransferHandler implements
        ...
        public void exportToClipboard(JComponent comp, Clipboard clipboard,
            ...
            if (comp instanceof javax.swing.text.JTextComponent) {
                javax.swing.text.JTextComponent text = (javax.swing.text.JTextComponent)comp;
            ...
            if (comp instanceof javax.swing.text.JTextComponent) {
                ...
                if (flavor != null) {
                    ...
                    try {
                        ...
                        ((javax.swing.text.JTextComponent)comp).replaceSelection(data);
                        return true;
        ...
        public boolean canImport(JComponent comp,
            ...
            javax.swing.text.JTextComponent c = (javax.swing.text.JTextComponent)comp;
    ...
    static final javax.swing.text.JTextComponent getFocusedComponent() {
        return (javax.swing.text.JTextComponent)AppContext.getAppContext().
    ...
    static class MutableCaretEvent extends CaretEvent implements ChangeListener, FocusListener, MouseListener {
        ...
        MutableCaretEvent(javax.swing.text.JTextComponent c) {
            super(c);
        }

        final void fire() {
            javax.swing.text.JTextComponent c = (javax.swing.text.JTextComponent) getSource();
            if (c != null) {
    ...
    class InputMethodRequestsHandler implements InputMethodRequests, DocumentListener {
        ...
        public AttributedCharacterIterator getSelectedText(
                                                Attribute[] attributes) {
            String selection = javax.swing.text.JTextComponent.this.getSelectedText();
            if (selection != null) {
        ...
        Boolean ret = AccessController.doPrivileged(new
            ...
            public Boolean run() {
                return isProcessInputMethodEventOverridden(
                                javax.swing.text.JTextComponent.this.getClass());
            }
        });
    ...
    class ComposedTextCaret extends DefaultCaret implements Serializable {
        ...
        protected void positionCaret(MouseEvent me) {
            javax.swing.text.JTextComponent host = component;
    ...
    private class DoSetCaretPosition implements Runnable {
        javax.swing.text.JTextComponent host;
        Position newPos;

        DoSetCaretPosition(javax.swing.text.JTextComponent host, Position newPos) {
            this.host = host;
            this.newPos = newPos;
        }
