...
public class JTree extends JComponent implements Scrollable, Accessible
{
    ...
    private class TreeTimer extends Timer {
        ...
        public void fireActionPerformed(ActionEvent ae) {
            javax.swing.JTree.this.expandRow(expandRow);
        }
    }
    ...
    */
                    ...
                    TreeSelectionListener
    {
        ...
        public void valueChanged(TreeSelectionEvent e) {
            ...
            newE = (TreeSelectionEvent)e.cloneWithSource(javax.swing.JTree.this);
    ...
    public static class DynamicUtilTreeNode extends DefaultMutableTreeNode {
         ...
         * @see javax.swing.JTree.DynamicUtilTreeNode
         */
...
////////////////
    ...
    protected class AccessibleJTree extends AccessibleJComponent
        ...
        public AccessibleJTree() {
            ...
            TreeModel model = javax.swing.JTree.this.getModel();
            if (model != null) {
                model.addTreeModelListener(this);
            }
            javax.swing.JTree.this.addTreeExpansionListener(this);
            javax.swing.JTree.this.addTreeSelectionListener(this);
            leadSelectionPath = javax.swing.JTree.this.getLeadSelectionPath();
            leadSelectionAccessible = (leadSelectionPath != null)
                    ? new AccessibleJTreeNode(javax.swing.JTree.this,
                                              leadSelectionPath,
        ...
        public  void treeCollapsed(TreeExpansionEvent e) {
            ...
            if (path != null) {
                // Set parent to null so AccessibleJTreeNode computes
                // its parent.
                AccessibleJTreeNode node = new AccessibleJTreeNode(javax.swing.JTree.this,
                                                                   path,
                                                                   null);
        ...
        private Component getCurrentComponent() {
            ...
            if (javax.swing.JTree.this.isVisible(path)) {
                TreeCellRenderer r = javax.swing.JTree.this.getCellRenderer();
                TreeUI ui = javax.swing.JTree.this.getUI();
                if (ui != null) {
                    int row = ui.getRowForPath(javax.swing.JTree.this, path);
                    int lsr = javax.swing.JTree.this.getLeadSelectionRow();
                    boolean hasFocus = javax.swing.JTree.this.isFocusOwner()
                                       && (lsr == row);
                    boolean selected = javax.swing.JTree.this.isPathSelected(path);
                    boolean expanded = javax.swing.JTree.this.isExpanded(path);

                    return r.getTreeCellRendererComponent(javax.swing.JTree.this,
        ...
        public Accessible getAccessibleAt(Point p) {
            ...
            if (path != null) {
                ...
                return new AccessibleJTreeNode(javax.swing.JTree.this, path, null);
            } else {
                return null;
            }
        }
        ...
        public Accessible getAccessibleChild(int i) {
            ...
            if (isRootVisible()) {
                if (i == 0) {    // return the root node Accessible
                    ...
                    return new AccessibleJTreeNode(javax.swing.JTree.this, path, javax.swing.JTree.this);
                } else {
                    return null;
                }
            }
        ...
        public int getAccessibleSelectionCount() {
            ...
            if (javax.swing.JTree.this.isPathSelected(childPath)) {
                return 1;
            } else {
                return 0;
            }
        ...
        public Accessible getAccessibleSelection(int i) {
            ...
            if (i == 0) {
                ...
                TreePath childPath = new TreePath(rootPath);
                if (javax.swing.JTree.this.isPathSelected(childPath)) {
                    return new AccessibleJTreeNode(javax.swing.JTree.this, childPath, javax.swing.JTree.this);
                }
            }
            return null;
        }
        ...
        public boolean isAccessibleChildSelected(int i) {
            ...
            if (i == 0) {
                ...
                rootPath[0] = treeModel.getRoot();
                TreePath childPath = new TreePath(rootPath);
                return javax.swing.JTree.this.isPathSelected(childPath);
            } else {
                return false;
            }
        }
        ...
        public void addAccessibleSelection(int i) {
           ...
           if (model != null) {
               if (i == 0) {
                   Object[] objPath = {model.getRoot()};
                   TreePath path = new TreePath(objPath);
                   javax.swing.JTree.this.addSelectionPath(path);
                }
            }
        }
        ...
        public void removeAccessibleSelection(int i) {
            ...
            if (model != null) {
                if (i == 0) {
                    Object[] objPath = {model.getRoot()};
                    TreePath path = new TreePath(objPath);
                    javax.swing.JTree.this.removeSelectionPath(path);
                }
            }
        }
        ...
        protected class AccessibleJTreeNode extends AccessibleContext
             ...
             * @since 1.4
             */
            public AccessibleJTreeNode(javax.swing.JTree t, TreePath p, Accessible ap) {
                tree = t;
                path = p;
                accessibleParent = ap;
        ...
        // AccessibleContext methods
            ...
            public Accessible getAccessibleChild(int i) {
                ...
                if (i < 0 || i >= getAccessibleChildrenCount()) {
                    ...
                    return new AccessibleJTreeNode(javax.swing.JTree.this, childPath, this);
                }
            }
        ...
        // AccessibleAction methods
            ...
            public boolean doAccessibleAction(int i) {
                ...
                AccessibleContext ac = getCurrentAccessibleContext();
                if (i == 0) {
                    if (javax.swing.JTree.this.isExpanded(path)) {
                        javax.swing.JTree.this.collapsePath(path);
                    } else {
                        javax.swing.JTree.this.expandPath(path);
                    }
                    return true;
                } else if (ac != null) {
                    AccessibleAction aa = ac.getAccessibleAction();
