...
public class JFileChooser extends JComponent implements Accessible {
        ...
        addHierarchyListener(new HierarchyListener() {
            ...
            public void hierarchyChanged(HierarchyEvent e) {
                if ((e.getChangeFlags() & HierarchyEvent.PARENT_CHANGED)
                    ...
                    javax.swing.JFileChooser fc = javax.swing.JFileChooser.this;
    ...
    public int showDialog(Component parent, String approveButtonText)
        ...
        if (dialog != null) {
            ...
            return javax.swing.JFileChooser.ERROR_OPTION;
        }
    ...
    */
    ...
    private static class WeakPCL implements PropertyChangeListener {
        WeakReference<javax.swing.JFileChooser> jfcRef;

        public WeakPCL(javax.swing.JFileChooser jfc) {
            jfcRef = new WeakReference<javax.swing.JFileChooser>(jfc);
        }
        public void propertyChange(PropertyChangeEvent ev) {
            assert ev.getPropertyName().equals(SHOW_HIDDEN_PROP);
            javax.swing.JFileChooser jfc = jfcRef.get();
            if (jfc == null) {
