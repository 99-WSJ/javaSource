...
public class SynthLookAndFeel extends BasicLookAndFeel {
    ...
    public static void setStyleFactory(SynthStyleFactory cache) {
        ...
        synchronized(javax.swing.plaf.synth.SynthLookAndFeel.class) {
            AppContext context = AppContext.getAppContext();
            lastFactory = cache;
            lastContext = context;
    ...
    static boolean shouldUpdateStyle(PropertyChangeEvent event) {
        ...
        return (laf instanceof javax.swing.plaf.synth.SynthLookAndFeel &&
                ((javax.swing.plaf.synth.SynthLookAndFeel) laf).shouldUpdateStyleOnEvent(event));
    }
    ...
    public SynthLookAndFeel() {
        factory = new javax.swing.plaf.synth.DefaultSynthStyleFactory();
    ...
    public void load(InputStream input, Class<?> resourceBase) throws
        ...
        new javax.swing.plaf.synth.SynthParser().parse(input, (javax.swing.plaf.synth.DefaultSynthStyleFactory) factory,
    ...
    public void initialize() {
        super.initialize();
        DefaultLookup.setDefaultLookup(new javax.swing.plaf.synth.SynthDefaultLookup());
