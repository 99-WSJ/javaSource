...
public class MetalFileChooserUI extends BasicFileChooserUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new javax.swing.plaf.metal.MetalFileChooserUI((JFileChooser) c);
    }
    ...
    private class MetalFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
        public JFileChooser getFileChooser() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.getFileChooser();
        }

        public BasicDirectoryModel getModel() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.isDirectorySelected();
        }

        public File getDirectory() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.getDirectory();
        }

        public Action getChangeToParentDirectoryAction() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.getChangeToParentDirectoryAction();
        }

        public Action getApproveSelectionAction() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.getNewFolderAction();
        }

        public MouseListener createDoubleClickListener(JList list) {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.createDoubleClickListener(getFileChooser(),
                                                                     list);
        }

        public ListSelectionListener createListSelectionListener() {
            return javax.swing.plaf.metal.MetalFileChooserUI.this.createListSelectionListener(getFileChooser());
        }
    }
