...
////////////////
    ...
    protected class AccessibleJTabbedPane extends AccessibleJComponent
        ...
        public AccessibleJTabbedPane() {
            super();
            javax.swing.JTabbedPane.this.model.addChangeListener(this);
        }
        ...
        public Accessible getAccessibleAt(Point p) {
            int tab = ((TabbedPaneUI) ui).tabForCoordinate(javax.swing.JTabbedPane.this,
                                                           p.x, p.y);
            if (tab == -1) {
    ...
    private class Page extends AccessibleContext
        ...
        Page(javax.swing.JTabbedPane parent,
        ...
        void initAccessibleContext() {
            if (javax.swing.JTabbedPane.this.accessibleContext != null &&
        ...
        void setDisplayedMnemonicIndex(int mnemonicIndex) {
            if (this.mnemonicIndex != mnemonicIndex) {
                ...
                javax.swing.JTabbedPane.this.firePropertyChange("displayedMnemonicIndexAt",
                                                    null, null);
            }
        }
