...
public class RepaintManager
{
    ...
    private static final Object repaintManagerKey = javax.swing.RepaintManager.class;
     ...
     */
    public static javax.swing.RepaintManager currentManager(Component c) {
     ...
     */
    static javax.swing.RepaintManager currentManager(AppContext appContext) {
        javax.swing.RepaintManager rm = (javax.swing.RepaintManager)appContext.get(repaintManagerKey);
        if (rm == null) {
            rm = new javax.swing.RepaintManager(BUFFER_STRATEGY_TYPE);
    ...
    * Note: This method exists for backward binary compatibility with earlier
     ...
     * @return the RepaintManager object
     */
    public static javax.swing.RepaintManager currentManager(JComponent c) {
    ...
    {
        javax.swing.RepaintManager delegate = getDelegate(invalidComponent);
        if (delegate != null) {
    ...
    public synchronized void removeInvalidComponent(JComponent component) {
        javax.swing.RepaintManager delegate = getDelegate(component);
        if (delegate != null) {
    ...
    {
        javax.swing.RepaintManager delegate = getDelegate(c);
        if (delegate != null) {
    ...
    public Rectangle getDirtyRegion(JComponent aComponent) {
        javax.swing.RepaintManager delegate = getDelegate(aComponent);
        if (delegate != null) {
   ...
   */
        ...
        public boolean paint(JComponent paintingComponent,
            ...
            if (repaintManager.useVolatileDoubleBuffer() &&
                ...
                for (int i = 0; !paintCompleted &&
                         i < javax.swing.RepaintManager.VOLATILE_LOOP_MAX; i++) {
    ...
    private static final class DisplayChangedRunnable implements Runnable {
        public void run() {
            javax.swing.RepaintManager.currentManager((JComponent)null).displayChanged();
        }
    }
    ...
    private javax.swing.RepaintManager getDelegate(Component c) {
        javax.swing.RepaintManager delegate = SwingUtilities3.getDelegateRepaintManager(c);
        if (this == delegate) {
            delegate = null;
        }
        return delegate;
