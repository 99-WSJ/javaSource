...
public class AsyncBoxView extends View {
    ...
    public class ChildState implements Runnable {
        ...
        public ChildState(View v) {
            ...
            child.setParent(javax.swing.text.AsyncBoxView.this);
        }
        ...
        public void run () {
            ...
            try {
                ...
                if (child.getParent() == javax.swing.text.AsyncBoxView.this) {
                    ...
                    // overwrite.
                    synchronized(javax.swing.text.AsyncBoxView.this) {
                        changing = this;
                    }
                    updateChild();
                    synchronized(javax.swing.text.AsyncBoxView.this) {
