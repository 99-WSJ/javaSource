    ...
    extends ScrollBarUI implements LayoutManager, SwingConstants
{
    ...
    protected void installKeyboardActions(){
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(scrollbar, javax.swing.plaf.basic.BasicScrollBarUI.class,
                                           "ScrollBar.actionMap");
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (key == POSITIVE_UNIT_INCREMENT) {
                ...
                scroll(scrollBar, javax.swing.plaf.basic.BasicScrollBarUI.MIN_SCROLL, true);
            }
            else if (key == MAX_SCROLL) {
                scroll(scrollBar, javax.swing.plaf.basic.BasicScrollBarUI.MAX_SCROLL, true);
            }
        }
        private void scroll(JScrollBar scrollBar, int dir, boolean block) {
            ...
            else if (dir == javax.swing.plaf.basic.BasicScrollBarUI.MIN_SCROLL) {
                scrollBar.setValue(scrollBar.getMinimum());
            }
            else if (dir == javax.swing.plaf.basic.BasicScrollBarUI.MAX_SCROLL) {
