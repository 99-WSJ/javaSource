...
{
    private javax.swing.ProgressMonitor root;
    ...
    private ProgressMonitor(Component parentComponent,
                            ...
                            int min,
                            int max,
                            javax.swing.ProgressMonitor group) {
        this.min = min;
        this.max = max;
    ...
    private class ProgressOptionPane extends JOptionPane
    {
        ProgressOptionPane(Object messageList) {
            super(messageList,
                  ...
                  null,
                  javax.swing.ProgressMonitor.this.cancelOption,
                  null);
        }
        ...
        public JDialog createDialog(Component parentComponent, String title) {
            ...
            addPropertyChangeListener(new PropertyChangeListener() {
                public void propertyChange(PropertyChangeEvent event) {
                    if(dialog.isVisible() &&
                       event.getSource() == javax.swing.ProgressMonitor.ProgressOptionPane.this &&
        ...
        public AccessibleContext getAccessibleContext() {
            return javax.swing.ProgressMonitor.this.getAccessibleContext();
        }
