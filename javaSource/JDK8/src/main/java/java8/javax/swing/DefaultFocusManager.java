...
public class DefaultFocusManager extends FocusManager {
    ...
    final FocusTraversalPolicy gluePolicy =
        new javax.swing.LegacyGlueFocusTraversalPolicy(this);
    private final FocusTraversalPolicy layoutPolicy =
        new javax.swing.LegacyLayoutFocusTraversalPolicy(this);
...
{
    LegacyLayoutFocusTraversalPolicy(javax.swing.DefaultFocusManager defaultFocusManager) {
        super(new javax.swing.CompareTabOrderComparator(defaultFocusManager));
    }
}

final class CompareTabOrderComparator implements Comparator<Component> {
    private final javax.swing.DefaultFocusManager defaultFocusManager;

    CompareTabOrderComparator(javax.swing.DefaultFocusManager defaultFocusManager) {
