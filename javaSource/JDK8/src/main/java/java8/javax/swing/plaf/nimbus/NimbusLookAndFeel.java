...
public class NimbusLookAndFeel extends SynthLookAndFeel {
    ...
    public NimbusLookAndFeel() {
        super();
        defaults = new javax.swing.plaf.nimbus.NimbusDefaults();
    }
    ...
    @Override public void uninitialize() {
        ...
        javax.swing.plaf.nimbus.ImageCache.getInstance().flush();
    ...
    @Override public UIDefaults getDefaults() {
        if (uiDefaults == null){
            ...
            uiDefaults.put("TitledBorder.font",
                    new javax.swing.plaf.nimbus.NimbusDefaults.DerivedFont("defaultFont",
                            1f, true, null));
            ...
            uiDefaults.put("Table.scrollPaneCornerComponent",
                    new UIDefaults.ActiveValue() {
                        ...
                        public Object createValue(UIDefaults table) {
                            return new javax.swing.plaf.nimbus.TableScrollPaneCorner();
                        }
                    });
    ...
    public Icon getDisabledIcon(JComponent component, Icon icon) {
        if (icon instanceof SynthIcon) {
            ...
            BufferedImage img = javax.swing.plaf.nimbus.EffectUtils.createCompatibleTranslucentImage(
