...
public class GlyphView extends View implements TabableView, Cloneable {
    ...
    public View breakView(int axis, int p0, float pos, float len) {
        if (axis == View.X_AXIS) {
            ...
            javax.swing.text.GlyphView v = (javax.swing.text.GlyphView) createFragment(p0, p1);
            v.x = (int) pos;
            return v;
        }
        return this;
    ...
    private BreakIterator getBreaker() {
        ...
        if ((doc != null) && Boolean.TRUE.equals(
            ...
            return new javax.swing.text.WhitespaceBasedBreakIterator();
        }
    }
    ...
    public View createFragment(int p0, int p1) {
        ...
        javax.swing.text.GlyphView v = (javax.swing.text.GlyphView) clone();
    ...
    */
    ...
    public static abstract class GlyphPainter {
         ...
         * (for tab expansion).
         */
        public abstract float getSpan(javax.swing.text.GlyphView v, int p0, int p1, TabExpander e, float x);
         ...
         */
        public abstract void paint(javax.swing.text.GlyphView v, Graphics g, Shape a, int p0, int p1);
         ...
         * @see View#modelToView
         */
        public abstract Shape modelToView(javax.swing.text.GlyphView v,
         ...
         * @see View#viewToModel
         */
        public abstract int viewToModel(javax.swing.text.GlyphView v,
         ...
         * @see View#breakView
         */
        public abstract int getBoundedPosition(javax.swing.text.GlyphView v, int p0, float x, float len);
         ...
         * @param p1 the ending document offset &gt;= p0
         */
        public GlyphPainter getPainter(javax.swing.text.GlyphView v, int p0, int p1) {
            return this;
        }
         ...
         * @exception IllegalArgumentException for an invalid direction
         */
        public int getNextVisualPositionFrom(javax.swing.text.GlyphView v, int pos, Position.Bias b, Shape a,
                                             int direction,
                                             Position.Bias[] biasRet)
            throws BadLocationException {
