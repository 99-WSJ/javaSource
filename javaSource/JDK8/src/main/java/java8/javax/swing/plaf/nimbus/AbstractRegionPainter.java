    ...
    private void paintWith9SquareCaching(Graphics2D g, PaintContext ctx,
        ...
        if (w <= (canvas.width * ctx.maxHorizontalScaleFactor) && h <= (canvas.height * ctx.maxVerticalScaleFactor)) {
            ...
            if (img != null) {
                ...
                javax.swing.plaf.nimbus.ImageScalingHelper.paint(g, 0, 0, w, h, img, insets, dstInsets,
                        javax.swing.plaf.nimbus.ImageScalingHelper.PaintType.PAINT9_STRETCH, javax.swing.plaf.nimbus.ImageScalingHelper.PAINT_ALL);
