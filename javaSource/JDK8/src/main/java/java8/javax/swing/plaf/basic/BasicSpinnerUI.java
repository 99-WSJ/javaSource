...
public class BasicSpinnerUI extends SpinnerUI
{
    ...
    public static ComponentUI createUI(JComponent c) {
        return new javax.swing.plaf.basic.BasicSpinnerUI();
    }
    ...
    protected void installKeyboardActions() {
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(spinner, javax.swing.plaf.basic.BasicSpinnerUI.class,
                "Spinner.actionMap");
    }
    ...
    private static class Handler implements LayoutManager,
        ...
        public void propertyChange(PropertyChangeEvent e)
        {
            ...
            if (e.getSource() instanceof JSpinner) {
                ...
                if (spinnerUI instanceof javax.swing.plaf.basic.BasicSpinnerUI) {
                    javax.swing.plaf.basic.BasicSpinnerUI ui = (javax.swing.plaf.basic.BasicSpinnerUI)spinnerUI;
        ...
        public void stateChanged(ChangeEvent e) {
            if (e.getSource() instanceof JSpinner) {
                ...
                if (DefaultLookup.getBoolean(spinner, spinnerUI,
                    "Spinner.disableOnBoundaryValues", false) &&
                    spinnerUI instanceof javax.swing.plaf.basic.BasicSpinnerUI) {
                    javax.swing.plaf.basic.BasicSpinnerUI ui = (javax.swing.plaf.basic.BasicSpinnerUI)spinnerUI;
                    ui.updateEnabledState();
                }
            }
