...
public class MetalCheckBoxUI extends MetalRadioButtonUI {
    ...
    public static ComponentUI createUI(JComponent b) {
        ...
        javax.swing.plaf.metal.MetalCheckBoxUI checkboxUI =
                (javax.swing.plaf.metal.MetalCheckBoxUI) appContext.get(METAL_CHECK_BOX_UI_KEY);
        if (checkboxUI == null) {
            checkboxUI = new javax.swing.plaf.metal.MetalCheckBoxUI();
