    ...
    protected void dispose() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                synchronized(javax.swing.BufferStrategyPaintManager.this) {
                    while (showing) {
                        try {
                            javax.swing.BufferStrategyPaintManager.this.wait();
                        } catch (InterruptedException ie) {
                        }
                    }
                    bufferInfos = javax.swing.BufferStrategyPaintManager.this.bufferInfos;
                    javax.swing.BufferStrategyPaintManager.this.bufferInfos = null;
                }
                dispose(bufferInfos);
            }
        });
