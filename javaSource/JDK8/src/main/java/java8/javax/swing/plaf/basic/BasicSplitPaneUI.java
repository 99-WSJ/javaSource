...
public class BasicSplitPaneUI extends SplitPaneUI
{
    ...
    public static ComponentUI createUI(JComponent x) {
        return new javax.swing.plaf.basic.BasicSplitPaneUI();
    }
    ...
    protected void installKeyboardActions() {
        ...
        SwingUtilities.replaceUIInputMap(splitPane, JComponent.
                                       WHEN_ANCESTOR_OF_FOCUSED_COMPONENT,
                                       km);
        LazyActionMap.installLazyActionMap(splitPane, javax.swing.plaf.basic.BasicSplitPaneUI.class,
                                           "SplitPane.actionMap");
    }
    ...
    private void addHeavyweightDivider() {
        if(nonContinuousLayoutDivider != null && splitPane != null) {
            ...
            splitPane.remove(divider);
            splitPane.add(nonContinuousLayoutDivider, javax.swing.plaf.basic.BasicSplitPaneUI.
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent ev) {
            ...
            javax.swing.plaf.basic.BasicSplitPaneUI ui = (javax.swing.plaf.basic.BasicSplitPaneUI)BasicLookAndFeel.
                      getUIOfType(splitPane.getUI(), javax.swing.plaf.basic.BasicSplitPaneUI.class);
