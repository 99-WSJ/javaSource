...
public class BasicLabelUI extends LabelUI implements  PropertyChangeListener
{
    ...
    */
    protected static javax.swing.plaf.basic.BasicLabelUI labelUI = new javax.swing.plaf.basic.BasicLabelUI();
    ...
    protected void installKeyboardActions(JLabel l) {
        ...
        if ((dka != 0) && (lf != null)) {
            javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(l, javax.swing.plaf.basic.BasicLabelUI.class,
                                               "Label.actionMap");
    ...
    public static ComponentUI createUI(JComponent c) {
        if (System.getSecurityManager() != null) {
            ...
            javax.swing.plaf.basic.BasicLabelUI safeBasicLabelUI =
                    (javax.swing.plaf.basic.BasicLabelUI) appContext.get(BASIC_LABEL_UI_KEY);
            if (safeBasicLabelUI == null) {
                safeBasicLabelUI = new javax.swing.plaf.basic.BasicLabelUI();
