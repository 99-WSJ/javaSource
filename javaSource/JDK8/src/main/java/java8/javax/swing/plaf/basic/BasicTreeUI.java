...
public class BasicTreeUI extends TreeUI
{
    ...
    public static ComponentUI createUI(JComponent x) {
        return new javax.swing.plaf.basic.BasicTreeUI();
    }
    ...
    protected void installKeyboardActions() {
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(tree, javax.swing.plaf.basic.BasicTreeUI.class,
                                           "Tree.actionMap");
    }
    ...
    public class NodeDimensionsHandler extends
         ...
         */
        protected int getRowX(int row, int depth) {
            return javax.swing.plaf.basic.BasicTreeUI.this.getRowX(row, depth);
        }
    ...
    public class MouseHandler extends MouseAdapter implements MouseMotionListener
 {
    ...
    public class TreeTraverseAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if (tree != null) {
                SHARED_ACTION.traverse(tree, javax.swing.plaf.basic.BasicTreeUI.this, direction,
                                       changeSelection);
            }
        }
    ...
    public class TreePageAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if (tree != null) {
                SHARED_ACTION.page(tree, javax.swing.plaf.basic.BasicTreeUI.this, direction,
    ...
    public class TreeIncrementAction extends AbstractAction  {
        ...
        public void actionPerformed(ActionEvent e) {
            if (tree != null) {
                SHARED_ACTION.increment(tree, javax.swing.plaf.basic.BasicTreeUI.this, direction,
                                        addToSelection, changeSelection);
            }
        }
    ...
    public class TreeHomeAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if (tree != null) {
                SHARED_ACTION.home(tree, javax.swing.plaf.basic.BasicTreeUI.this, direction,
                                   addToSelection, changeSelection);
            }
        }
    ...
    public class TreeToggleAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if(tree != null) {
                SHARED_ACTION.toggle(tree, javax.swing.plaf.basic.BasicTreeUI.this);
            }
        }
    ...
    public class TreeCancelEditingAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if(tree != null) {
                SHARED_ACTION.cancelEditing(tree, javax.swing.plaf.basic.BasicTreeUI.this);
            }
        }
    ...
    static class TreeTransferHandler extends TransferHandler implements UIResource, Comparator<TreePath> {
        ...
        protected Transferable createTransferable(JComponent c) {
            if (c instanceof JTree) {
                ...
                return new javax.swing.plaf.basic.BasicTransferable(plainBuf.toString(), htmlBuf.toString());
            }
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            javax.swing.plaf.basic.BasicTreeUI ui = (javax.swing.plaf.basic.BasicTreeUI)BasicLookAndFeel.getUIOfType(
                             tree.getUI(), javax.swing.plaf.basic.BasicTreeUI.class);
            if (ui == null) {
                return;
            }
            String key = getName();
        ...
        private void scrollChangeSelection(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui,
        ...
        private void scroll(JTree component, javax.swing.plaf.basic.BasicTreeUI ui, int direction,
                            int amount) {
        ...
        private void extendSelection(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
            if (ui.getRowCount(tree) > 0) {
                int       lead = ui.getLeadSelectionRow();
        ...
        private void selectAll(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui, boolean selectAll) {
        ...
        private void startEditing(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
        ...
        private void cancelEditing(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
            tree.cancelEditing();
        }

        private void toggle(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
        ...
        private void expand(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
            int selRow = ui.getLeadSelectionRow();
            tree.expandRow(selRow);
        }

        private void collapse(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
            int selRow = ui.getLeadSelectionRow();
            tree.collapseRow(selRow);
        }

        private void increment(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui, int direction,
                               boolean addToSelection,
                               boolean changeSelection) {
        ...
        private void traverse(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui, int direction,
                              boolean changeSelection) {
        ...
        private void moveSelectionToParent(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui) {
            int selRow = ui.getLeadSelectionRow();
        ...
        private void page(JTree tree, javax.swing.plaf.basic.BasicTreeUI ui, int direction,
        ...
        private void home(JTree tree, final javax.swing.plaf.basic.BasicTreeUI ui, int direction,
                          boolean addToSelection, boolean changeSelection) {
