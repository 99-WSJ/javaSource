...
public class StyleContext implements Serializable, AbstractDocument.AttributeContext {
    ...
    public static final javax.swing.text.StyleContext getDefaultStyleContext() {
        if (defaultContext == null) {
            defaultContext = new javax.swing.text.StyleContext();
        }
        return defaultContext;
    }

    private static javax.swing.text.StyleContext defaultContext;
    ...
    public class NamedStyle implements Style, Serializable {
        ...
        public void addAttribute(Object name, Object value) {
            javax.swing.text.StyleContext context = javax.swing.text.StyleContext.this;
    ...
    static {
        ...
        try {
            ...
            for (int i = 0; i < n; i++) {
                javax.swing.text.StyleContext.registerStaticAttributeKey(StyleConstants.keys[i]);
            }
        } catch (Throwable e) {
            e.printStackTrace();
        }
