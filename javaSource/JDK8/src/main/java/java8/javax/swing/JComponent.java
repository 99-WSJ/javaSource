                                              ...
                                              TransferHandler.HasGetTransferHandler
{
    ...
    static Set<KeyStroke> getManagingFocusForwardTraversalKeys() {
        synchronized(javax.swing.JComponent.class) {
        ...
        if(popupMenu == null) {
            ...
            while (parent != null) {
                if(parent instanceof javax.swing.JComponent) {
                    return ((javax.swing.JComponent)parent).getComponentPopupMenu();
                }
    ...
    public JComponent() {
        ...
        super.setLocale( javax.swing.JComponent.getDefaultLocale() );
    }
    ...
    protected void paintChildren(Graphics g) {
        ...
        synchronized(getTreeLock()) {
            ...
            if (paintingChild != null &&
                (paintingChild instanceof javax.swing.JComponent) &&
            ...
            for (; i >= 0 ; i--) {
                ...
                final boolean isJComponent = comp instanceof javax.swing.JComponent;
                        ...
                        try {
                            if(isJComponent) {
                                if(getFlag(ANCESTOR_USING_BUFFER)) {
                                    ((javax.swing.JComponent)comp).setFlag(
    ...
    public void paint(Graphics g) {
        ...
        try {
            ...
            if(getParent() != null && !(getParent() instanceof javax.swing.JComponent)) {
                adjustPaintFlags();
    ...
    boolean isPainting() {
        ...
        while (component != null) {
            if (component instanceof javax.swing.JComponent &&
                   ((javax.swing.JComponent)component).getFlag(ANCESTOR_USING_BUFFER)) {
                return true;
            }
    ...
    private void adjustPaintFlags() {
        javax.swing.JComponent jparent;
        Container parent;
        for(parent = getParent() ; parent != null ; parent =
            parent.getParent()) {
            if(parent instanceof javax.swing.JComponent) {
                jparent = (javax.swing.JComponent) parent;
    ...
    private void unregisterWithKeyboardManager(KeyStroke aKeyStroke) {
        javax.swing.KeyboardManager.getCurrentManager().unregisterKeyStroke(aKeyStroke,
                                                                this);
    }
    ...
    boolean processKeyBindings(KeyEvent e, boolean pressed) {
      ...
      while (parent != null && !(parent instanceof Window) &&
             !(parent instanceof Applet)) {
          if(parent instanceof javax.swing.JComponent) {
              if(ksE != null && ((javax.swing.JComponent)parent).processKeyBinding(ksE, e,
                               WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, pressed))
                  return true;
              if(((javax.swing.JComponent)parent).processKeyBinding(ks, e,
                               WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, pressed))
                  return true;
          }
          ...
          if ((parent instanceof JInternalFrame) &&
              javax.swing.JComponent.processKeyBindingsForAllComponents(e,parent,pressed)){
              return true;
          }
          parent = parent.getParent();
      }
    ...
    static boolean processKeyBindingsForAllComponents(KeyEvent e,
        ...
        while (true) {
            if (javax.swing.KeyboardManager.getCurrentManager().fireKeyboardAction(
                                e, pressed, container)) {
                return true;
            }
    ...
    public void scrollRectToVisible(Rectangle aRect) {
        ...
        for (parent = getParent();
                 !(parent == null) &&
                 !(parent instanceof javax.swing.JComponent) &&
        ...
        if (!(parent == null) && !(parent instanceof CellRendererPane)) {
            ...
            ((javax.swing.JComponent)parent).scrollRectToVisible(aRect);
            aRect.x -= dx;
            aRect.y -= dy;
        }
    }
    ...
    public void setAutoscrolls(boolean autoscrolls) {
        ...
        if (this.autoscrolls != autoscrolls) {
            ...
            if (autoscrolls) {
                ...
                javax.swing.Autoscroller.stop(this);
            }
        }
    }
    ...
    protected void processMouseMotionEvent(MouseEvent e) {
        ...
        if (autoscrolls && e.getID() == MouseEvent.MOUSE_DRAGGED) {
            ...
            dispatch = !javax.swing.Autoscroller.isRunning(this);
            javax.swing.Autoscroller.processMouseDragged(e);
        }
        if (dispatch) {
    ...
    static final sun.awt.RequestFocusController focusController =
        new sun.awt.RequestFocusController() {
            ...
            {
                if ((to == null) || !(to instanceof javax.swing.JComponent)) {
                    return true;
                }

                if ((from == null) || !(from instanceof javax.swing.JComponent)) {
                    return true;
                }

                javax.swing.JComponent target = (javax.swing.JComponent) to;
                if (!target.getVerifyInputWhenFocusTarget()) {
                    return true;
                }

                javax.swing.JComponent jFocusOwner = (javax.swing.JComponent)from;
       ...
       implements AccessibleExtendedComponent
    {
        ...
        public void addPropertyChangeListener(PropertyChangeListener listener) {
            ...
            if (propertyListenersCount++ == 0) {
                javax.swing.JComponent.this.addFocusListener(accessibleFocusHandler);
                javax.swing.JComponent.this.addContainerListener(accessibleContainerHandler);
            }
        ...
        public void removePropertyChangeListener(PropertyChangeListener listener) {
            if (--propertyListenersCount == 0) {
                javax.swing.JComponent.this.removeFocusListener(accessibleFocusHandler);
                javax.swing.JComponent.this.removeContainerListener(accessibleContainerHandler);
            }
         ...
         */
        public String getToolTipText() {
            return javax.swing.JComponent.this.getToolTipText();
        }
        ...
        public String getTitledBorderText() {
            Border border = javax.swing.JComponent.this.getBorder();
    ...
    private javax.swing.ArrayTable getClientProperties() {
        if (clientProperties == null) {
            clientProperties = new javax.swing.ArrayTable();
        }
    ...
    public final void putClientProperty(Object key, Object value) {
        ...
        javax.swing.ArrayTable clientProperties = getClientProperties();
        Object oldValue;
        synchronized(clientProperties) {
...
//                  Thread.dumpStack();
    ...
    private javax.swing.AncestorNotifier getAncestorNotifier() {
        return (javax.swing.AncestorNotifier)
    ...
    public void addAncestorListener(AncestorListener listener) {
        javax.swing.AncestorNotifier ancestorNotifier = getAncestorNotifier();
    ...
    public void revalidate() {
        ...
        if (SwingUtilities.isEventDispatchThread()) {
            ...
            Runnable callRevalidate = new Runnable() {
                public void run() {
                    synchronized(javax.swing.JComponent.this) {
     ...
     * the {@link javax.swing.JComponent#paintImmediately(int, int, int, int)} method of
    ...
    public void paintImmediately(int x,int y,int w, int h) {
        ...
        javax.swing.JComponent paintingOigin = SwingUtilities.getPaintingOrigin(this);
        ...
        if(c instanceof javax.swing.JComponent) {
            ((javax.swing.JComponent)c)._paintImmediately(x,y,w,h);
        } else {
            c.repaint(x,y,w,h);
        }
    }
    ...
    void _paintImmediately(int x, int y, int w, int h) {
        ...
        javax.swing.JComponent bufferedComponent = null;
        javax.swing.JComponent paintingComponent = this;
        ...
        for (c = this, child = null;
             ...
             child = c, c = c.getParent()) {
                javax.swing.JComponent jc = (c instanceof javax.swing.JComponent) ? (javax.swing.JComponent)c :
                                null;
                path.add(c);
        ...
        if(paintingComponent != this) {
            ...
            for(; i > 0 ; i--) {
                ...
                if(comp instanceof javax.swing.JComponent) {
                    ((javax.swing.JComponent)comp).setPaintingChild(path.get(i-1));
                }
            }
        }
        try {
            ...
            if(paintingComponent != this) {
                ...
                for(; i > 0 ; i--) {
                    comp = path.get(i);
                    if(comp instanceof javax.swing.JComponent) {
                        ((javax.swing.JComponent)comp).setPaintingChild(null);
                    }
                }
            }
    ...
    private int getObscuredState(int compIndex, int x, int y, int width,
        ...
        for (int i = compIndex - 1 ; i >= 0 ; i--) {
            ...
            boolean opaque;
            if (sibling instanceof javax.swing.JComponent) {
    ...
    void compWriteObjectNotify() {
        byte count = javax.swing.JComponent.getWriteObjCounter(this);
        javax.swing.JComponent.setWriteObjCounter(this, (byte)(count + 1));
        if (count != 0) {
            return;
        }
        ...
        if (getToolTipText() != null ||
            ...
            ToolTipManager.sharedInstance().unregisterComponent(javax.swing.JComponent.this);
        }
    }
    ...
    {
        private final Vector<javax.swing.JComponent> roots = new Vector<javax.swing.JComponent>(1);
        ...
        public void validateObject() throws InvalidObjectException {
            try {
                for (javax.swing.JComponent root : roots) {
         ...
         */
        private void registerComponent(javax.swing.JComponent c)
        {
            ...
            for(int i = 0; i < roots.size(); i++) {
                javax.swing.JComponent root = roots.elementAt(i);
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        if (getUIClassID().equals(uiClassID)) {
            byte count = javax.swing.JComponent.getWriteObjCounter(this);
            javax.swing.JComponent.setWriteObjCounter(this, --count);
            if (count == 0 && ui != null) {
                ui.installUI(this);
            }
        }
        javax.swing.ArrayTable.writeArrayTable(s, clientProperties);
    }
