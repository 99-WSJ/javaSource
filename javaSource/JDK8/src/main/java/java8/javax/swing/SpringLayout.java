 ...
 *
 * @see Spring
 * @see javax.swing.SpringLayout.Constraints
 *
 * @author      Philip Milne
 * @author      Scott Violet
...
*/
   ...
   private static class SpringProxy extends Spring {
       ...
       private Component c;
       private javax.swing.SpringLayout l;

       public SpringProxy(String edgeName, Component c, javax.swing.SpringLayout l) {
       ...
       /*pp*/ boolean isCyclic(javax.swing.SpringLayout l) {
    ...
    public Constraints getConstraints(Component c) {
       ...
       if (result == null) {
           if (c instanceof JComponent) {
                Object cp = ((JComponent)c).getClientProperty(javax.swing.SpringLayout.class);
