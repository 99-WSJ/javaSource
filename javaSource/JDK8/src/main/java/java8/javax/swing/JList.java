...
public class JList<E> extends JComponent implements Scrollable, Accessible
{
                ...
                /* Scroll Up */
                     ...
                     */
                        ...
                        return visibleRect.y - r.y;
                           ...
                           getLayoutOrientation() != javax.swing.JList.VERTICAL) {
    ...
    protected class AccessibleJList extends AccessibleJComponent
        ...
        public AccessibleJList() {
            super();
            javax.swing.JList.this.addPropertyChangeListener(this);
            javax.swing.JList.this.getSelectionModel().addListSelectionListener(this);
            javax.swing.JList.this.getModel().addListDataListener(this);
            leadSelectionIndex = javax.swing.JList.this.getLeadSelectionIndex();
        }
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            ListSelectionModel lsm = javax.swing.JList.this.getSelectionModel();
    ...
    // AccessibleContext methods
        ...
        public Accessible getAccessibleAt(Point p) {
            ...
            if (i >= 0) {
                return new AccessibleJListChild(javax.swing.JList.this, i);
            } else {
                return null;
            }
        }
    ...
    // AccessibleSelection methods
         ...
         */
         public int getAccessibleSelectionCount() {
             return javax.swing.JList.this.getSelectedIndices().length;
         }
         ...
         */
         public Accessible getAccessibleSelection(int i) {
             ...
             if (i < 0 || i >= len) {
                 ...
                 return getAccessibleChild(javax.swing.JList.this.getSelectedIndices()[i]);
             }
         }
         ...
         */
         public void addAccessibleSelection(int i) {
             javax.swing.JList.this.addSelectionInterval(i, i);
         }
         ...
         */
         public void removeAccessibleSelection(int i) {
             javax.swing.JList.this.removeSelectionInterval(i, i);
         }
         ...
         */
         public void clearAccessibleSelection() {
             javax.swing.JList.this.clearSelection();
         }
         ...
         */
         public void selectAllAccessibleSelection() {
             javax.swing.JList.this.addSelectionInterval(0, getAccessibleChildrenCount() -1);
         }
        ...
        protected class AccessibleJListChild extends AccessibleContext
            ...
            private javax.swing.JList<E> parent = null;
            ...
            public AccessibleJListChild(javax.swing.JList<E> parent, int indexInParent) {
                this.parent = parent;
