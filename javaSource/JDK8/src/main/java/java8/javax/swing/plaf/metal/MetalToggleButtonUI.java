...
public class MetalToggleButtonUI extends BasicToggleButtonUI {
    ...
    public static ComponentUI createUI(JComponent b) {
        ...
        javax.swing.plaf.metal.MetalToggleButtonUI metalToggleButtonUI =
                (javax.swing.plaf.metal.MetalToggleButtonUI) appContext.get(METAL_TOGGLE_BUTTON_UI_KEY);
        if (metalToggleButtonUI == null) {
            metalToggleButtonUI = new javax.swing.plaf.metal.MetalToggleButtonUI();
