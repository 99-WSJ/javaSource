...
public class UIManager implements Serializable
{
    ...
    private static class LAFState
    {
        ...
        javax.swing.MultiUIDefaults multiUIDefaults = new javax.swing.MultiUIDefaults(tables);
     ...
     *
     * @see javax.swing.UIManager#getInstalledLookAndFeels
     * @see LookAndFeel
     */
    ...
    private static Properties loadSwingProperties()
    {
         ...
         */
        if (javax.swing.UIManager.class.getClassLoader() != null) {
    ...
    private static void initializeDefaultLAF(Properties swingProps)
    {
        ...
        if (lafData != null) {
            for (Object key: lafData.keySet()) {
                javax.swing.UIManager.put(key, lafData.get(key));
            }
        }
    }
