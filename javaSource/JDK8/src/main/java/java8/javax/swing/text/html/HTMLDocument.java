...
public class HTMLDocument extends DefaultStyledDocument {
     ...
     */
    void addMap(javax.swing.text.html.Map map) {
     ...
     */
    void removeMap(javax.swing.text.html.Map map) {
        String     name = map.getName();
     ...
     */
    javax.swing.text.html.Map getMap(String name) {
        if (name != null) {
            Object     maps = getProperty(MAP_PROPERTY);

            if (maps != null && (maps instanceof Hashtable)) {
                return (javax.swing.text.html.Map)((Hashtable)maps).get(name);
            }
        }
        return null;
    }
    ...
    public class HTMLReader extends HTMLEditorKit.ParserCallback {
        ...
        HTMLReader(int offset, int popDepth, int pushDepth,
            ...
            this.offset = offset;
            threshold = javax.swing.text.html.HTMLDocument.this.getTokenThreshold();
            ...
            if (!emptyDocument && !midInsert) {
                ...
                Element elem =
                        javax.swing.text.html.HTMLDocument.this.getCharacterElement(targetOffset);
        ...
        public void flush() throws BadLocationException {
            if (emptyDocument && !insertAfterImplied) {
                if (javax.swing.text.html.HTMLDocument.this.getLength() > 0 ||
                                      parseBuffer.size() > 0) {
                    flushBuffer(true);
                    adjustEndElement();
                }
        ...
        public void handleText(char[] data, int pos) {
            ...
            if(javax.swing.text.html.HTMLDocument.this.getProperty(I18NProperty).equals( Boolean.FALSE ) ) {
                // if a default direction of right-to-left has been specified,
                // we want complex layout even if the text is all left to right.
                Object d = getProperty(TextAttribute.RUN_DIRECTION);
                if ((d != null) && (d.equals(TextAttribute.RUN_DIRECTION_RTL))) {
                    javax.swing.text.html.HTMLDocument.this.putProperty( I18NProperty, Boolean.TRUE);
                } else {
        ...
        class MapAction extends TagAction {
            ...
            public void start(HTML.Tag t, MutableAttributeSet a) {
                lastMap = new javax.swing.text.html.Map((String)a.getAttribute(HTML.Attribute.NAME));
                addMap(lastMap);
            }
        ...
        public class FormAction extends SpecialAction {
            ...
            public void start(HTML.Tag t, MutableAttributeSet attr) {
                if (t == HTML.Tag.INPUT) {
                    ...
                    if ((size > 1) || multiple) {
                        javax.swing.text.html.OptionListModel<Option> m = new javax.swing.text.html.OptionListModel<Option>();
                        if (multiple) {
                ...
                if (t == HTML.Tag.OPTION) {
                    ...
                    if (selectModel instanceof javax.swing.text.html.OptionListModel) {
                        javax.swing.text.html.OptionListModel<Option> m = (javax.swing.text.html.OptionListModel<Option>) selectModel;
                        m.addElement(option);
        ...
        void flushBuffer(boolean endOfStream) throws BadLocationException {
            int oldLength = javax.swing.text.html.HTMLDocument.this.getLength();
            ...
            offset += javax.swing.text.html.HTMLDocument.this.getLength() - oldLength;
            flushCount++;
        }
