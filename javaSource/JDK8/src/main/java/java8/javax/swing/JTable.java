...
//
     ...
     *
     * @see #print(javax.swing.JTable.PrintMode, MessageFormat, MessageFormat,
...
//
     ...
     */
    @Deprecated
    static public JScrollPane createScrollPaneForTable(javax.swing.JTable aTable) {
...
//
    ...
    private final class SortManager {
        ...
        SortManager(RowSorter<? extends TableModel> sorter) {
            this.sorter = sorter;
            sorter.addRowSorterListener(javax.swing.JTable.this);
        }
        ...
        public void dispose() {
            if (sorter != null) {
                sorter.removeRowSorterListener(javax.swing.JTable.this);
            }
        }
...
//
    ...
    class CellEditorRemover implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent ev) {
            ...
            while (c != null) {
                if (c == javax.swing.JTable.this) {
                    // focus remains inside the table
                    return;
                } else if ((c instanceof Window) ||
                           (c instanceof Applet && c.getParent() == null)) {
                    if (c == SwingUtilities.getRoot(javax.swing.JTable.this)) {
...
/////////////////
     ...
     * {@link #print(javax.swing.JTable.PrintMode, MessageFormat, MessageFormat,
...
////////////////
    ...
    AccessibleExtendedTable {
        ...
        protected AccessibleJTable() {
            super();
            javax.swing.JTable.this.addPropertyChangeListener(this);
            javax.swing.JTable.this.getSelectionModel().addListSelectionListener(this);
            TableColumnModel tcm = javax.swing.JTable.this.getColumnModel();
            tcm.addColumnModelListener(this);
            tcm.getSelectionModel().addListSelectionListener(this);
            javax.swing.JTable.this.getModel().addTableModelListener(this);
            lastSelectedRow = javax.swing.JTable.this.getSelectedRow();
            lastSelectedCol = javax.swing.JTable.this.getSelectedColumn();
        }
    ...
    // listeners
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (name.compareTo("model") == 0) {
                ...
                if (source == javax.swing.JTable.this) {    // row selection model
                ...
                } else if (source == javax.swing.JTable.this.getColumnModel()) {
    ...
    // Listeners to echo changes to the AccessiblePropertyChange mechanism
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            int selectedRow = javax.swing.JTable.this.getSelectedRow();
            int selectedCol = javax.swing.JTable.this.getSelectedColumn();
    ...
    // AccessibleContext support
        ...
        public Accessible getAccessibleAt(Point p) {
            ...
            if ((column != -1) && (row != -1)) {
                ...
                Component component = renderer.getTableCellRendererComponent(
                                  javax.swing.JTable.this, null, false, false,
                                  row, column);
                return new AccessibleJTableCell(javax.swing.JTable.this, row, column,
        ...
        public int getAccessibleChildrenCount() {
            return (javax.swing.JTable.this.getColumnCount() * javax.swing.JTable.this.getRowCount());
        }
    ...
    // AccessibleSelection support
        ...
        public int getAccessibleSelectionCount() {
            int rowsSel = javax.swing.JTable.this.getSelectedRowCount();
            int colsSel = javax.swing.JTable.this.getSelectedColumnCount();

            if (javax.swing.JTable.this.cellSelectionEnabled) { // a contiguous block
                return rowsSel * colsSel;

            } else {
                // a column swath and a row swath, with a shared block
                if (javax.swing.JTable.this.getRowSelectionAllowed() &&
                    javax.swing.JTable.this.getColumnSelectionAllowed()) {
                    return rowsSel * javax.swing.JTable.this.getColumnCount() +
                           colsSel * javax.swing.JTable.this.getRowCount() -
                           rowsSel * colsSel;

                // just one or more rows in selection
                } else if (javax.swing.JTable.this.getRowSelectionAllowed()) {
                    return rowsSel * javax.swing.JTable.this.getColumnCount();

                // just one or more rows in selection
                } else if (javax.swing.JTable.this.getColumnSelectionAllowed()) {
                    return colsSel * javax.swing.JTable.this.getRowCount();
        ...
        public Accessible getAccessibleSelection(int i) {
            ...
            int ttlCols = javax.swing.JTable.this.getColumnCount();
            int ttlRows = javax.swing.JTable.this.getRowCount();
            int r;
            int c;
...
//                      System.out.println("Bug in AccessibleJTable.getAccessibleSelection()");
        ...
        public boolean isAccessibleChildSelected(int i) {
            int column = getAccessibleColumnAtIndex(i);
            int row = getAccessibleRowAtIndex(i);
            return javax.swing.JTable.this.isCellSelected(row, column);
        }
        ...
        public void addAccessibleSelection(int i) {
            ...
            int column = getAccessibleColumnAtIndex(i);
            int row = getAccessibleRowAtIndex(i);
            javax.swing.JTable.this.changeSelection(row, column, true, false);
        }
        ...
        public void removeAccessibleSelection(int i) {
            if (javax.swing.JTable.this.cellSelectionEnabled) {
                int column = getAccessibleColumnAtIndex(i);
                int row = getAccessibleRowAtIndex(i);
                javax.swing.JTable.this.removeRowSelectionInterval(row, row);
                javax.swing.JTable.this.removeColumnSelectionInterval(column, column);
            }
        }
        ...
        public void clearAccessibleSelection() {
            javax.swing.JTable.this.clearSelection();
        }
        ...
        public void selectAllAccessibleSelection() {
            if (javax.swing.JTable.this.cellSelectionEnabled) {
                javax.swing.JTable.this.selectAll();
            }
        }
        ...
        public int getAccessibleRowCount() {
            return javax.swing.JTable.this.getRowCount();
        }
        ...
        public int getAccessibleColumnCount() {
            return javax.swing.JTable.this.getColumnCount();
        }
        ...
        public AccessibleTable getAccessibleColumnHeader() {
            JTableHeader header = javax.swing.JTable.this.getTableHeader();
        ...
        private class AccessibleTableHeader implements AccessibleTable {
            ...
            public Accessible getAccessibleAt(int row, int column) {
                ...
                return new AccessibleJTableHeaderCell(row, column,
                                                      javax.swing.JTable.this.getTableHeader(),
                                                      component);
            }
        ...
        public boolean isAccessibleSelected(int r, int c) {
            return javax.swing.JTable.this.isCellSelected(r, c);
        }
        ...
        public boolean isAccessibleRowSelected(int r) {
            return javax.swing.JTable.this.isRowSelected(r);
        }
        ...
        public boolean isAccessibleColumnSelected(int c) {
            return javax.swing.JTable.this.isColumnSelected(c);
        }
        ...
        public int [] getSelectedAccessibleRows() {
            return javax.swing.JTable.this.getSelectedRows();
        }
        ...
        public int [] getSelectedAccessibleColumns() {
            return javax.swing.JTable.this.getSelectedColumns();
        }
        ...
        protected class AccessibleJTableCell extends AccessibleContext
             ...
             * @since 1.4
             */
            public AccessibleJTableCell(javax.swing.JTable t, int r, int c, int i) {
                parent = t;
                row = r;
                column = c;
                index = i;
            ...
            protected AccessibleContext getCurrentAccessibleContext() {
                ...
                Component component = renderer.getTableCellRendererComponent(
                                  javax.swing.JTable.this, getValueAt(row, column),
        ...
        // AccessibleContext methods
            ...
            public AccessibleStateSet getAccessibleStateSet() {
                ...
                Rectangle rjt = javax.swing.JTable.this.getVisibleRect();
                Rectangle rcell = javax.swing.JTable.this.getCellRect(row, column, false);
...
//              }
        ...
        private class AccessibleJTableHeaderCell extends AccessibleContext
            ...
            public AccessibleStateSet getAccessibleStateSet() {
                ...
                if (javax.swing.JTable.this.isCellSelected(row, column)) {
                    as.add(AccessibleState.SELECTED);
                } else if (as.contains(AccessibleState.SELECTED)) {
                    as.remove(AccessibleState.SELECTED);
                }
