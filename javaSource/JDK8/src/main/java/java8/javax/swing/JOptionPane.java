...
public class JOptionPane extends JComponent implements Accessible
{
    ...
    private JDialog createDialog(Component parentComponent, String title,
        ...
        Window window = javax.swing.JOptionPane.getWindowForComponent(parentComponent);
    ...
    private void initDialog(final JDialog dialog, int style, Component parentComponent) {
        ...
        final PropertyChangeListener listener = new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                ...
                if (dialog.isVisible() && event.getSource() == javax.swing.JOptionPane.this &&
                        (event.getPropertyName().equals(VALUE_PROPERTY)) &&
                        event.getNewValue() != null &&
                        event.getNewValue() != javax.swing.JOptionPane.UNINITIALIZED_VALUE) {
        ...
        dialog.addComponentListener(new ComponentAdapter() {
            public void componentShown(ComponentEvent ce) {
                ...
                setValue(javax.swing.JOptionPane.UNINITIALIZED_VALUE);
            }
        });
    ...
    public JInternalFrame createInternalFrame(Component parentComponent,
                                 String title) {
        Container parent =
                javax.swing.JOptionPane.getDesktopPaneForComponent(parentComponent);
        ...
        addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                ...
                // (newValue = null in that case).  Otherwise, close the dialog.
                if (iFrame.isVisible() &&
                        event.getSource() == javax.swing.JOptionPane.this &&
                        event.getPropertyName().equals(VALUE_PROPERTY)) {
    ...
    private static final Object sharedFrameKey = javax.swing.JOptionPane.class;
