...
public class StyleSheet extends StyleContext {
    ...
    public void addStyleSheet(javax.swing.text.html.StyleSheet ss) {
        synchronized(this) {
            if (linkedStyleSheets == null) {
                linkedStyleSheets = new Vector<javax.swing.text.html.StyleSheet>();
            }
    ...
    public javax.swing.text.html.StyleSheet[] getStyleSheets() {
        javax.swing.text.html.StyleSheet[] retValue;

        synchronized(this) {
            if (linkedStyleSheets != null) {
                retValue = new javax.swing.text.html.StyleSheet[linkedStyleSheets.size()];
     ...
     */
    private synchronized void linkStyleSheetAt(javax.swing.text.html.StyleSheet ss, int index) {
        if (resolvedStyles.size() > 0) {
            Enumeration<ResolvedStyle> values = resolvedStyles.elements();
            while (values.hasMoreElements()) {
     ...
     */
    private synchronized void unlinkStyleSheet(javax.swing.text.html.StyleSheet ss, int index) {
        if (resolvedStyles.size() > 0) {
            Enumeration<ResolvedStyle> values = resolvedStyles.elements();
            while (values.hasMoreElements()) {
                ResolvedStyle rule = values.nextElement();
    ...
    public static class BoxPainter implements Serializable {
        ...
        BoxPainter(AttributeSet a, CSS css, javax.swing.text.html.StyleSheet ss) {
            this.ss = ss;
            this.css = css;
            border = getBorder(a);
    ...
    public static class ListPainter implements Serializable {
        ...
        ListPainter(AttributeSet attr, javax.swing.text.html.StyleSheet ss) {
            this.ss = ss;
        ...
        URL imageurl;
        private javax.swing.text.html.StyleSheet ss = null;
        Icon img = null;
    ...
    static class BackgroundImagePainter implements Serializable {
        ...
        BackgroundImagePainter(AttributeSet a, CSS css, javax.swing.text.html.StyleSheet ss) {
     ...
     */
    class ViewAttributeSet extends javax.swing.text.html.MuxingAttributeSet {
        ViewAttributeSet(View v) {
            ...
            try {
                if (doc instanceof HTMLDocument) {
                    javax.swing.text.html.StyleSheet styles = javax.swing.text.html.StyleSheet.this;
    ...
    // implement Style.
    static class ResolvedStyle extends javax.swing.text.html.MuxingAttributeSet implements
                  Serializable, Style {
     ...
     */
    private Vector<javax.swing.text.html.StyleSheet> linkedStyleSheets;
        ...
        public void endRule() {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (selector.length > 0) {
                    javax.swing.text.html.StyleSheet.this.addRule(selector, declaration, isLink);
                }
            }
            declaration.removeAttributes(declaration);
            selectors.removeAllElements();
