...
import javax.swing.plaf.metal.MetalTitlePane;
import java.awt.*;
import java.io.*;
...
public class MetalRootPaneUI extends BasicRootPaneUI
{
    ...
    public static ComponentUI createUI(JComponent c) {
        return new javax.swing.plaf.metal.MetalRootPaneUI();
    }
    ...
    private static class MetalRootLayout implements LayoutManager2 {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            ...
            if (root.getWindowDecorationStyle() != JRootPane.NONE &&
                     (root.getUI() instanceof javax.swing.plaf.metal.MetalRootPaneUI)) {
                JComponent titlePane = ((javax.swing.plaf.metal.MetalRootPaneUI)root.getUI()).
                                       getTitlePane();
                if (titlePane != null) {
