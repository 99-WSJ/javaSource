...
public abstract class AbstractAction implements Action, Cloneable, Serializable
{
    ...
    static boolean shouldReconfigure(PropertyChangeEvent e) {
        if (e.getPropertyName() == null) {
            synchronized(javax.swing.AbstractAction.class) {
    ...
    protected Object clone() throws CloneNotSupportedException {
        javax.swing.AbstractAction newAction = (javax.swing.AbstractAction)super.clone();
        synchronized(this) {
            if (arrayTable != null) {
                newAction.arrayTable = (javax.swing.ArrayTable)arrayTable.clone();
            }
        }
        return newAction;
    }
