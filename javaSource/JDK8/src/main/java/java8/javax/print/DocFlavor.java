 ...
 * from {@link javax.print.DocFlavor#hostEncoding DocFlavor.hostEncoding}
...
public class DocFlavor implements Serializable, Cloneable {
     ...
     * MIME type.
     */
    private transient javax.print.MimeType myMimeType;
    ...
    public DocFlavor(String mimeType, String className) {
        ...
        myMimeType = new javax.print.MimeType(mimeType);
    ...
    public boolean equals(Object obj) {
        return
            obj != null &&
            obj instanceof javax.print.DocFlavor &&
            getStringValue().equals (((javax.print.DocFlavor) obj).getStringValue());
    }
    ...
    private void readObject(ObjectInputStream s)
        ...
        s.defaultReadObject();
        myMimeType = new javax.print.MimeType((String)s.readObject());
    }
    ...
    public static class BYTE_ARRAY extends javax.print.DocFlavor {
         ...
         * See {@link javax.print.DocFlavor#hostEncoding hostEncoding}
