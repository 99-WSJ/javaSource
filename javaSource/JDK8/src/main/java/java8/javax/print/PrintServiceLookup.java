...
public abstract class PrintServiceLookup {
    ...
    public static final PrintService lookupDefaultPrintService() {
        ...
        while (psIterator.hasNext()) {
            try {
                javax.print.PrintServiceLookup lus = (javax.print.PrintServiceLookup)psIterator.next();
    ...
    public static boolean registerServiceProvider(javax.print.PrintServiceLookup sp) {
        synchronized (javax.print.PrintServiceLookup.class) {
            Iterator psIterator = getAllLookupServices().iterator();
            while (psIterator.hasNext()) {
                try {
            ...
            try {
                java.security.AccessController.doPrivileged(
                     new java.security.PrivilegedExceptionAction() {
                        public Object run() {
                            Iterator<javax.print.PrintServiceLookup> iterator =
                                ServiceLoader.load(javax.print.PrintServiceLookup.class).
                                iterator();
