...
public class SerialBlob implements Blob, Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof javax.sql.rowset.serial.SerialBlob) {
            javax.sql.rowset.serial.SerialBlob sb = (javax.sql.rowset.serial.SerialBlob)obj;
            if (this.len == sb.len) {
    ...
    public Object clone() {
        try {
            javax.sql.rowset.serial.SerialBlob sb = (javax.sql.rowset.serial.SerialBlob) super.clone();
