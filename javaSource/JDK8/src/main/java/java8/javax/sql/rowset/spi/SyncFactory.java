...
public class SyncFactory {
    ...
    public static synchronized void registerProvider(String providerID)
        ...
        javax.sql.rowset.spi.ProviderImpl impl = new javax.sql.rowset.spi.ProviderImpl();
    ...
    private static void parseProperties(Properties p) {
        ...
        javax.sql.rowset.spi.ProviderImpl impl = null;
        String key = null;
        ...
        for (Enumeration<?> e = p.propertyNames(); e.hasMoreElements();) {
            ...
            if (str.startsWith(javax.sql.rowset.spi.SyncFactory.ROWSET_SYNC_PROVIDER)) {

                impl = new javax.sql.rowset.spi.ProviderImpl();
                impl.setIndex(providerImplIndex++);

                if (w == (javax.sql.rowset.spi.SyncFactory.ROWSET_SYNC_PROVIDER).length()) {
    ...
    private static String[] getPropertyNames(boolean append,
        ...
        String[] propertyNames =
                new String[]{javax.sql.rowset.spi.SyncFactory.ROWSET_SYNC_PROVIDER,
            javax.sql.rowset.spi.SyncFactory.ROWSET_SYNC_VENDOR,
            javax.sql.rowset.spi.SyncFactory.ROWSET_SYNC_PROVIDER_VERSION};
        if (append) {
     ...
     */
    private static void showImpl(javax.sql.rowset.spi.ProviderImpl impl) {
    ...
    public static SyncProvider getInstance(String providerID)
        ...
        javax.sql.rowset.spi.ProviderImpl impl = (javax.sql.rowset.spi.ProviderImpl) implementations.get(providerID);
        ...
        try {
            ...
            while (bindings.hasMore()) {
                ...
                if (syncProviderObj) {
                    ...
                    properties.put(javax.sql.rowset.spi.SyncFactory.ROWSET_SYNC_PROVIDER,
                            sync.getProviderID());
    ...
    private static class SyncFactoryHolder {
        static final javax.sql.rowset.spi.SyncFactory factory = new javax.sql.rowset.spi.SyncFactory();
    }
}
...
class ProviderImpl extends SyncProvider {
    ...
    public int getDataSourceLock() throws SyncProviderException {
        ...
        int dsLock = 0;
        try {
            dsLock = javax.sql.rowset.spi.SyncFactory.getInstance(className).getDataSourceLock();
    ...
    public int getProviderGrade() {
        ...
        try {
            grade = javax.sql.rowset.spi.SyncFactory.getInstance(className).getProviderGrade();
        } catch (SyncFactoryException sfEx) {
            //
        }
    ...
    public RowSetReader getRowSetReader() {
        ...
        try {
            rsReader = javax.sql.rowset.spi.SyncFactory.getInstance(className).getRowSetReader();
        } catch (SyncFactoryException sfEx) {
            //
        }
    ...
    public RowSetWriter getRowSetWriter() {
        ...
        try {
            rsWriter = javax.sql.rowset.spi.SyncFactory.getInstance(className).getRowSetWriter();
        } catch (SyncFactoryException sfEx) {
            //
        }
    ...
    public void setDataSourceLock(int param)
        ...
        try {
            javax.sql.rowset.spi.SyncFactory.getInstance(className).setDataSourceLock(param);
        } catch (SyncFactoryException sfEx) {
    ...
    public int supportsUpdatableView() {
        ...
        try {
            view = javax.sql.rowset.spi.SyncFactory.getInstance(className).supportsUpdatableView();
        } catch (SyncFactoryException sfEx) {
            //
        }
