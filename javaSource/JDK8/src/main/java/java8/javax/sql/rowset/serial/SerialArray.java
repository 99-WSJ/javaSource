...
public class SerialArray implements Array, Serializable, Cloneable {
     ...
     */
         ...
         throws SerialException, SQLException
     {
        ...
        switch (baseType) {
            ...
            case Types.ARRAY:
                for (int i = 0; i < len; i++) {
                    elements[i] = new javax.sql.rowset.serial.SerialArray((Array)elements[i], map);
                }
            break;
 ...
 //[if an error occurstype map used??]
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof javax.sql.rowset.serial.SerialArray) {
            javax.sql.rowset.serial.SerialArray sa = (javax.sql.rowset.serial.SerialArray)obj;
    ...
    public Object clone() {
        try {
            javax.sql.rowset.serial.SerialArray sa = (javax.sql.rowset.serial.SerialArray) super.clone();
