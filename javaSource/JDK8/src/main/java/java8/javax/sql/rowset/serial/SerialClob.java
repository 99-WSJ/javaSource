...
public class SerialClob implements Clob, Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof javax.sql.rowset.serial.SerialClob) {
            javax.sql.rowset.serial.SerialClob sc = (javax.sql.rowset.serial.SerialClob)obj;
            if (this.len == sc.len) {
    ...
    public Object clone() {
        try {
            javax.sql.rowset.serial.SerialClob sc = (javax.sql.rowset.serial.SerialClob) super.clone();
