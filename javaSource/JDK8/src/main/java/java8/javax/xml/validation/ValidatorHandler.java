 ...
 *
 * <p>
 * A {@link javax.xml.validation.ValidatorHandler} object is not thread-safe and not reentrant.
...
public abstract class ValidatorHandler implements ContentHandler {
     ...
     *
     * <p>Derived classes must create {@link javax.xml.validation.ValidatorHandler} objects that have
    ...
    /**
     * Gets the current {@link ErrorHandler} set to this {@link javax.xml.validation.ValidatorHandler}.
     *
     * @return
     *      This method returns the object that was last set through
    ...
    /**
     * Gets the current {@link LSResourceResolver} set to this {@link javax.xml.validation.ValidatorHandler}.
     *
     * @return
     *      This method returns the object that was last set through
     ...
     * {@link javax.xml.validation.ValidatorHandler} parses schemas. The feature name is
