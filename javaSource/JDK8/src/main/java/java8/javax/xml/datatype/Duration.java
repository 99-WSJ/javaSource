 ...
 * The {@link #compare(javax.xml.datatype.Duration duration)} method implements this
 * relationship.</p>
 *
 ...
 * @see XMLGregorianCalendar#add(javax.xml.datatype.Duration)
 * @since 1.5
 */
public abstract class Duration {
     ...
     */
    public abstract javax.xml.datatype.Duration add(final javax.xml.datatype.Duration rhs);
     ...
     * {@link XMLGregorianCalendar#add(javax.xml.datatype.Duration)} provides the same
     ...
     */
    public javax.xml.datatype.Duration subtract(final javax.xml.datatype.Duration rhs) {
     ...
     *
     */
    public abstract javax.xml.datatype.Duration multiply(final BigDecimal factor);
     ...
     */
    public abstract javax.xml.datatype.Duration normalizeWith(final Calendar startTimeInstant);
     ...
     */
    public abstract int compare(final javax.xml.datatype.Duration duration);
     ...
     *
     * @see #isShorterThan(javax.xml.datatype.Duration)
     * @see #compare(javax.xml.datatype.Duration duration)
     */
    public boolean isLongerThan(final javax.xml.datatype.Duration duration) {
     ...
     * @throws NullPointerException if <code>duration</code> is null.
     *
     * @see #isLongerThan(javax.xml.datatype.Duration duration)
     * @see #compare(javax.xml.datatype.Duration duration)
     */
    public boolean isShorterThan(final javax.xml.datatype.Duration duration) {
    ...
    public boolean equals(final Object duration) {
        ...
        if (duration == null || !(duration instanceof javax.xml.datatype.Duration)) {
            return false;
        }

        return compare((javax.xml.datatype.Duration) duration) == DatatypeConstants.EQUAL;
    }
