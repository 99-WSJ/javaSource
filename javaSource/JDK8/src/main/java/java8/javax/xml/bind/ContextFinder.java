...
class ContextFinder {
    ...
    static {
        ...
        try {
            if (AccessController.doPrivileged(new javax.xml.bind.GetPropertyAction("jaxb.debug")) != null) {
    ...
    private static JAXBException handleClassCastException(Class originalType, Class targetType) {
        ...
        return new JAXBException(javax.xml.bind.Messages.format(javax.xml.bind.Messages.ILLEGAL_CAST,
    ...
    static JAXBContext newInstance( String contextPath,
        ...
        try {
            ...
            throw new JAXBException(
                javax.xml.bind.Messages.format( javax.xml.bind.Messages.PROVIDER_NOT_FOUND, className ),
                x);
            ...
            throw new JAXBException(
                javax.xml.bind.Messages.format( javax.xml.bind.Messages.COULD_NOT_INSTANTIATE, className, x ),
                x);
        }
    }
        ...
        throws JAXBException
    {
        try {
            ...
            throw new JAXBException( javax.xml.bind.Messages.format( javax.xml.bind.Messages.COULD_NOT_INSTANTIATE, spFactory, e ), e );
        } catch (RuntimeException x) {
            // avoid wrapping RuntimeException to JAXBException,
            // because it indicates a bug in this code.
            throw x;
            ...
            // some other type of exception - just wrap it
            throw new JAXBException(
                javax.xml.bind.Messages.format( javax.xml.bind.Messages.COULD_NOT_INSTANTIATE, spFactory, x ),
                x);
        }
    }
    ...
    static JAXBContext find(String factoryId, String contextPath, ClassLoader classLoader, Map properties ) throws JAXBException {
        ...
        if(!packages.hasMoreTokens())
            ...
            throw new JAXBException(javax.xml.bind.Messages.format(javax.xml.bind.Messages.NO_PACKAGE_IN_CONTEXTPATH));
        ...
        while( packages.hasMoreTokens() ) {
            ...
            if (props != null) {
                if (props.containsKey(factoryId)) {
                    ...
                    throw new JAXBException(javax.xml.bind.Messages.format(javax.xml.bind.Messages.MISSING_PROPERTY, packageName, factoryId));
                }
            }
        }
        ...
        factoryClassName = AccessController.doPrivileged(new javax.xml.bind.GetPropertyAction(JAXBContext.JAXB_CONTEXT_FACTORY));
        if(  factoryClassName != null ) {
            return newInstance( contextPath, factoryClassName, classLoader, properties );
        } else { // leave this here to assure compatibility
            factoryClassName = AccessController.doPrivileged(new javax.xml.bind.GetPropertyAction(jaxbContextFQCN));
            if(  factoryClassName != null ) {
                return newInstance( contextPath, factoryClassName, classLoader, properties );
            }
        }
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(javax.xml.bind.ContextFinder.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        for (final Class c : classes) {
            ...
            if (props == null) {
                ...
                if (props.containsKey(JAXB_CONTEXT_FACTORY)) {
                    ...
                    throw new JAXBException(javax.xml.bind.Messages.format(javax.xml.bind.Messages.MISSING_PROPERTY, packageName, JAXB_CONTEXT_FACTORY));
                }
            }
        }
