...
public abstract class SAXParserFactory {
     ...
     * @since 1.6
     */
    public static javax.xml.parsers.SAXParserFactory newInstance(String factoryClassName, ClassLoader classLoader){
            //do not fallback if given classloader can't find the class, throw exception
            return FactoryFinder.newInstance(javax.xml.parsers.SAXParserFactory.class,
