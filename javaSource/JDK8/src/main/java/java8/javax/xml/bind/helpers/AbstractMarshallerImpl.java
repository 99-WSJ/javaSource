...
public abstract class AbstractMarshallerImpl implements Marshaller
{
    ...
    private void checkBoolean( String name, Object value ) throws PropertyException {
        if(!(value instanceof Boolean))
            throw new PropertyException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_BE_BOOLEAN, name ) );
    }
    ...
    private void checkString( String name, Object value ) throws PropertyException {
        if(!(value instanceof String))
            throw new PropertyException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_BE_STRING, name ) );
    }
    ...
    private void checkNotNull( Object o1, String o1Name,
        ...
        if( o1 == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, o1Name ) );
        }
        if( o2 == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, o2Name ) );
        }
    }
