...
public abstract class AbstractUnmarshallerImpl implements Unmarshaller
{
    ...
    public Object unmarshal( Source source ) throws JAXBException {
        if( source == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, "source" ) );
        }
    ...
    public final Object unmarshal( URL url ) throws JAXBException {
        if( url == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, "url" ) );
        }
    ...
    public final Object unmarshal( File f ) throws JAXBException {
        if( f == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, "file" ) );
        }
    ...
    public final Object unmarshal( java.io.InputStream is )
        ...
        if( is == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, "is" ) );
        }
    ...
    public final Object unmarshal( Reader reader ) throws JAXBException {
        if( reader == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, "reader" ) );
        }
    ...
    public void setProperty( String name, Object value )
        ...
        if( name == null ) {
            throw new IllegalArgumentException(
                javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.MUST_NOT_BE_NULL, "name" ) );
        }
