...
public abstract class XMLEventFactory {
  ...
  {
    return FactoryFinder.find(javax.xml.stream.XMLEventFactory.class, DEFAULIMPL);
  }
   ...
   */
  public static javax.xml.stream.XMLEventFactory newInstance(String factoryId,
                                                             ClassLoader classLoader)
          throws FactoryConfigurationError {
      //do not fallback if given classloader can't find the class, throw exception
      return FactoryFinder.find(javax.xml.stream.XMLEventFactory.class, factoryId, classLoader, null);
  }
   ...
   *   the implementation is not available or cannot be instantiated.
   */
  public static javax.xml.stream.XMLEventFactory newFactory(String factoryId,
                                                            ClassLoader classLoader)
          throws FactoryConfigurationError {
      //do not fallback if given classloader can't find the class, throw exception
      return FactoryFinder.find(javax.xml.stream.XMLEventFactory.class, factoryId, classLoader, null);
