 ...
 *
 * <p>The {@link javax.xml.xpath.XPathFactory} class is not thread-safe. In other words,
 * it is the application's responsibility to ensure that at most
 * one thread is using a {@link javax.xml.xpath.XPathFactory} object at any
 * given moment. Implementations are encouraged to mark methods
 * as <code>synchronized</code> to protect themselves from broken clients.
 *
 * <p>{@link javax.xml.xpath.XPathFactory} is not re-entrant. While one of the
    ...
    */
    public static javax.xml.xpath.XPathFactory newInstance(final String uri)
        ...
        if (classLoader == null) {
            ...
            classLoader = javax.xml.xpath.XPathFactory.class.getClassLoader();
        }

        javax.xml.xpath.XPathFactory xpathFactory = new javax.xml.xpath.XPathFactoryFinder(classLoader).newFactory(uri);
    ...
    public static javax.xml.xpath.XPathFactory newInstance(String uri, String factoryClassName, ClassLoader classLoader)
        ...
        javax.xml.xpath.XPathFactory f = new javax.xml.xpath.XPathFactoryFinder(cl).createInstance(factoryClassName);
