...
public interface SOAPElement extends Node, org.w3c.dom.Element {
     ...
     *                          <code>SOAPElement</code> object
     * @see javax.xml.soap.SOAPElement#addChildElement(QName)
     */
    public javax.xml.soap.SOAPElement addChildElement(Name name) throws SOAPException;
     ...
     * @exception SOAPException if there is an error in creating the
     *                          <code>SOAPElement</code> object
     * @see javax.xml.soap.SOAPElement#addChildElement(Name)
     * @since SAAJ 1.3
     */
     ...
     *                          <code>SOAPElement</code> object
     */
    public javax.xml.soap.SOAPElement addChildElement(String localName) throws SOAPException;
     ...
     *                          <code>SOAPElement</code> object
     */
    public javax.xml.soap.SOAPElement addChildElement(String localName, String prefix)
     ...
     * @see javax.xml.soap.SOAPElement#addAttribute(QName, String)
     */
    public javax.xml.soap.SOAPElement addAttribute(Name name, String value)
        throws SOAPException;
     ...
     * @see javax.xml.soap.SOAPElement#addAttribute(Name, String)
     * @since SAAJ 1.3
     */
    public javax.xml.soap.SOAPElement addAttribute(QName qname, String value)
        throws SOAPException;
     ...
     *                          namespace
     */
    public javax.xml.soap.SOAPElement addNamespaceDeclaration(String prefix, String uri)
        throws SOAPException;
     ...
     * @see javax.xml.soap.SOAPElement#getAttributeValue(QName)
     */
     ...
     * @return a <code>String</code> giving the value of the specified
     *         attribute, Null if there is no such attribute
     * @see javax.xml.soap.SOAPElement#getAttributeValue(Name)
     * @since SAAJ 1.3
     */
     ...
     * attribute.
     *
     * @see javax.xml.soap.SOAPElement#getAllAttributesAsQNames()
    ...
    * @since SAAJ 1.3
    */
   public javax.xml.soap.SOAPElement setElementQName(QName newName) throws SOAPException;
   ...
   /**
     ...
     * @see javax.xml.soap.SOAPElement#removeAttribute(QName)
     */
     ...
     * @return <code>true</code> if the attribute was
     *         removed successfully; <code>false</code> if it was not
     * @see javax.xml.soap.SOAPElement#removeAttribute(Name)
     * @since SAAJ 1.3
     */
     ...
     *         specified name
     * @see javax.xml.soap.SOAPElement#getChildElements(QName)
     */
     ...
     *         in this <code>SOAPElement</code> object with the
     *         specified qname
     * @see javax.xml.soap.SOAPElement#getChildElements(Name)
     * @since SAAJ 1.3
     */
