 ...
 * to create a {@link javax.xml.bind.JAXBContext}.
 *
...
public abstract class JAXBContext {
     ...
     * </ol>
     */
    public static javax.xml.bind.JAXBContext newInstance(String contextPath )
     ...
     * </ol>
     */
    public static javax.xml.bind.JAXBContext newInstance(String contextPath, ClassLoader classLoader ) throws JAXBException {
     ...
     *
     * <p>
     * This is mostly the same as {@link javax.xml.bind.JAXBContext#newInstance(String, ClassLoader)},
     * but this version allows you to pass in provider-specific properties to configure
     * the instantiation of {@link javax.xml.bind.JAXBContext}.
     *
     * <p>
     ...
     * @since JAXB2.0
     */
    public static javax.xml.bind.JAXBContext newInstance(String contextPath, ClassLoader classLoader, Map<String,?>  properties  )
        throws JAXBException {

        return javax.xml.bind.ContextFinder.find(
...
//    }
     ...
     *
     * For example, in the following Java code, if you do
     * <tt>newInstance(Foo.class)</tt>, the newly created {@link javax.xml.bind.JAXBContext}
     ...
     *
     * @param classesToBeBound
     *      list of java classes to be recognized by the new {@link javax.xml.bind.JAXBContext}.
     *      Can be empty, in which case a {@link javax.xml.bind.JAXBContext} that only knows about
     *      spec-defined classes will be returned.
     *
     * @return
     *      A new instance of a <tt>JAXBContext</tt>. Always non-null valid object.
     ...
     * @since JAXB2.0
     */
    public static javax.xml.bind.JAXBContext newInstance(Class... classesToBeBound )
        throws JAXBException {
     ...
     *
     * <p>
     * An overloading of {@link javax.xml.bind.JAXBContext#newInstance(Class...)}
     * to configure 'properties' for this instantiation of {@link javax.xml.bind.JAXBContext}.
     *
     * <p>
     * The interpretation of properties is up to implementations. Implementations should
     * throw <tt>JAXBException</tt> if it finds properties that it doesn't understand.
     ...
     * @since JAXB2.0
     */
    public static javax.xml.bind.JAXBContext newInstance(Class[] classesToBeBound, Map<String,?> properties )
        throws JAXBException {
        ...
        return javax.xml.bind.ContextFinder.find(classesToBeBound,properties);
    }
