...
public class DefaultValidationEventHandler implements ValidationEventHandler {
    ...
    public boolean handleEvent( ValidationEvent event ) {
        ...
        switch ( event.getSeverity() ) {
            case ValidationEvent.WARNING:
                severity = javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.WARNING );
                retVal = true; // continue after warnings
                break;
            case ValidationEvent.ERROR:
                severity = javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.ERROR );
                retVal = false; // terminate after errors
                break;
            case ValidationEvent.FATAL_ERROR:
                severity = javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.FATAL_ERROR );
                retVal = false; // terminate after fatal errors
                break;
            default:
                assert false :
                    javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.UNRECOGNIZED_SEVERITY,
                            event.getSeverity() );
        }
        ...
        System.out.println(
            javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.SEVERITY_MESSAGE,
                             severity,
                             event.getMessage(),
                             location ) );
    ...
    private String getLocation(ValidationEvent event) {
        ...
        if( locator != null ) {
            ...
            msg.append( javax.xml.bind.helpers.Messages.format( javax.xml.bind.helpers.Messages.LOCATION_UNAVAILABLE ) );
        }
