...
public abstract class SchemaFactory {
     ...
     private static javax.xml.validation.SecuritySupport ss = new javax.xml.validation.SecuritySupport();
     ...
     *
     * <p>Derived classes must create {@link javax.xml.validation.SchemaFactory} objects that have
    ...
    public static javax.xml.validation.SchemaFactory newInstance(String schemaLanguage) {
        ...
        if (cl == null) {
            ...
            cl = javax.xml.validation.SchemaFactory.class.getClassLoader();
        }

        javax.xml.validation.SchemaFactory f = new SchemaFactoryFinder(cl).newFactory(schemaLanguage);
        if (f == null) {
     ...
     * @since 1.6
     */
    public static javax.xml.validation.SchemaFactory newInstance(String schemaLanguage, String factoryClassName, ClassLoader classLoader){
        ...
        javax.xml.validation.SchemaFactory f = new SchemaFactoryFinder(cl).createInstance(factoryClassName);
        if (f == null) {
            throw new IllegalArgumentException(
     ...
     *   {@link javax.xml.validation.SchemaFactory} recognizes the feature name but
     ...
     *   value can't be assigned or retrieved.
     * @throws SAXNotSupportedException When the
     *   {@link javax.xml.validation.SchemaFactory} recognizes the property name but
     *   cannot set the requested value.
     * @throws NullPointerException If <code>name</code> is <code>null</code>.
     */
     ...
     * {@link ValidatorHandler}s that are created from this {@link javax.xml.validation.SchemaFactory}.
     *
    ...
    /**
     * Gets the current {@link ErrorHandler} set to this {@link javax.xml.validation.SchemaFactory}.
     *
     * @return
     *      This method returns the object that was last set through
     *      the {@link #setErrorHandler(ErrorHandler)} method, or null
     *      if that method has never been called since this {@link javax.xml.validation.SchemaFactory}
     *      has created.
     *
    ...
    /**
     * Gets the current {@link LSResourceResolver} set to this {@link javax.xml.validation.SchemaFactory}.
     *
     * @return
     *      This method returns the object that was last set through
     ...
     *
     * @param schemas
     *      inputs to be parsed. {@link javax.xml.validation.SchemaFactory} is required
     ...
     * depend on the schema language for which this {@link javax.xml.validation.SchemaFactory}
     * is created.
     *
     ...
     *
     * <p>Implementors and developers should pay particular attention
     * to how the features set on this {@link javax.xml.validation.SchemaFactory} are
     * processed by this special {@link Schema}.
     * In some cases, for example, when the
     * {@link javax.xml.validation.SchemaFactory} and the class actually loading the
     * schema come from different implementations, it may not be possible
     * for {@link javax.xml.validation.SchemaFactory} features to be inherited automatically.
     * Developers should
     * make sure that features, such as secure processing, are explicitly
     * set in both places.</p>
     *
