...
final class DatatypeConverterImpl implements DatatypeConverterInterface {
     ...
     */
    public static final DatatypeConverterInterface theInstance = new javax.xml.bind.DatatypeConverterImpl();
    ...
    public static BigInteger _parseInteger(CharSequence s) {
        return new BigInteger(removeOptionalPlus(javax.xml.bind.WhiteSpaceProcessor.trim(s)).toString());
    }
    ...
    public static int _parseInt(CharSequence s) {
        ...
        for (int i = 0; i < len; i++) {
            char ch = s.charAt(i);
            if (javax.xml.bind.WhiteSpaceProcessor.isWhiteSpace(ch)) {
                // skip whitespace
            } else if ('0' <= ch && ch <= '9') {
                r = r * 10 + (ch - '0');
            } else if (ch == '-') {
    ...
    public static long _parseLong(CharSequence s) {
        return Long.valueOf(removeOptionalPlus(javax.xml.bind.WhiteSpaceProcessor.trim(s)).toString());
    }
    ...
    public static BigDecimal _parseDecimal(CharSequence content) {
        content = javax.xml.bind.WhiteSpaceProcessor.trim(content);
    ...
    public static float _parseFloat(CharSequence _val) {
        String s = javax.xml.bind.WhiteSpaceProcessor.trim(_val).toString();
    ...
    public static double _parseDouble(CharSequence _val) {
        String val = javax.xml.bind.WhiteSpaceProcessor.trim(_val).toString();
    ...
    public static Boolean _parseBoolean(CharSequence literal) {
        ...
        do {
            ch = literal.charAt(i++);
        } while (javax.xml.bind.WhiteSpaceProcessor.isWhiteSpace(ch) && i < len);
...
//            throw new IllegalArgumentException("String \"" + literal + "\" is not valid boolean value.");
    ...
    public static QName _parseQName(CharSequence text, NamespaceContext nsc) {
        ...
        // trim whitespace
        int start = 0;
        while (start < length && javax.xml.bind.WhiteSpaceProcessor.isWhiteSpace(text.charAt(start))) {
            start++;
        }

        int end = length;
        while (end > start && javax.xml.bind.WhiteSpaceProcessor.isWhiteSpace(text.charAt(end - 1))) {
            end--;
        }
    ...
    public static GregorianCalendar _parseDateTime(CharSequence s) {
        String val = javax.xml.bind.WhiteSpaceProcessor.trim(s).toString();
