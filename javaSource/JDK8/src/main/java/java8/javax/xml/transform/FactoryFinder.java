...
class FactoryFinder {
     ...
     */
    private final static javax.xml.transform.SecuritySupport ss = new javax.xml.transform.SecuritySupport();
            ...
            boolean doFallback, boolean useBSClsLoader) throws ClassNotFoundException
    {
        try {
            if (cl == null) {
                if (useBSClsLoader) {
                    return Class.forName(className, false, javax.xml.transform.FactoryFinder.class.getClassLoader());
                } else {
