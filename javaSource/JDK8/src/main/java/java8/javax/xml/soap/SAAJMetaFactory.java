...
public abstract class SAAJMetaFactory {
     ...
     */
    static javax.xml.soap.SAAJMetaFactory getInstance() throws SOAPException {
            try {
                javax.xml.soap.SAAJMetaFactory instance =
                    (javax.xml.soap.SAAJMetaFactory) FactoryFinder.find(
