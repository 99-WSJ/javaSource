...
public abstract class SOAPFactory {
     ...
     * @exception SOAPException if there is an error in creating the
     *            <code>SOAPElement</code> object
     * @see javax.xml.soap.SOAPFactory#createElement(QName)
     */
     ...
     * @exception SOAPException if there is an error in creating the
     *            <code>SOAPElement</code> object
     * @see javax.xml.soap.SOAPFactory#createElement(Name)
     * @since SAAJ 1.3
     */
    ...
    {
        try {
            javax.xml.soap.SOAPFactory factory = (javax.xml.soap.SOAPFactory) javax.xml.soap.FactoryFinder.find(
     ...
     * @since SAAJ 1.3
     */
    public static javax.xml.soap.SOAPFactory newInstance(String protocol)
        throws SOAPException {
