...
public abstract class XMLInputFactory {
  ...
  {
    return FactoryFinder.find(javax.xml.stream.XMLInputFactory.class, DEFAULIMPL);
  }
   ...
   */
  public static javax.xml.stream.XMLInputFactory newInstance(String factoryId,
                                                             ClassLoader classLoader)
          throws FactoryConfigurationError {
      //do not fallback if given classloader can't find the class, throw exception
      return FactoryFinder.find(javax.xml.stream.XMLInputFactory.class, factoryId, classLoader, null);
  }
   ...
   * @throws FactoryConfigurationError if an instance of this factory cannot be loaded
   */
  public static javax.xml.stream.XMLInputFactory newFactory(String factoryId,
                                                            ClassLoader classLoader)
          throws FactoryConfigurationError {
      //do not fallback if given classloader can't find the class, throw exception
      return FactoryFinder.find(javax.xml.stream.XMLInputFactory.class, factoryId, classLoader, null);
