...
public abstract class XMLOutputFactory {
  ...
  {
    return FactoryFinder.find(javax.xml.stream.XMLOutputFactory.class, DEFAULIMPL);
  }
   ...
   *   the implementation is not available or cannot be instantiated.
   */
  public static javax.xml.stream.XMLOutputFactory newFactory(String factoryId,
                                                             ClassLoader classLoader)
          throws FactoryConfigurationError {
      //do not fallback if given classloader can't find the class, throw exception
      return FactoryFinder.find(javax.xml.stream.XMLOutputFactory.class, factoryId, classLoader, null);
  }
