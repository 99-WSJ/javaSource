 ...
 *     {@link #toGregorianCalendar(TimeZone timezone, java.util.Locale aLocale, javax.xml.datatype.XMLGregorianCalendar defaults)},
 *     {@link DatatypeFactory}</li>
 *   <li>partial order relation comparator method, {@link #compare(javax.xml.datatype.XMLGregorianCalendar xmlGregorianCalendar)}</li>
 *   <li>{@link #equals(Object)} defined relative to {@link #compare(javax.xml.datatype.XMLGregorianCalendar xmlGregorianCalendar)}.</li>
...
public abstract class XMLGregorianCalendar
     ...
     * {@link #compare(javax.xml.datatype.XMLGregorianCalendar obj)}
     * returns {@link DatatypeConstants#EQUAL},
     * otherwise <code>false</code>.
     */
    public boolean equals(Object obj) {

        if (obj == null || !(obj instanceof javax.xml.datatype.XMLGregorianCalendar)) {
               return false;
        }
        return compare((javax.xml.datatype.XMLGregorianCalendar) obj) == DatatypeConstants.EQUAL;
    }
    ...
    public int hashCode() {
        ...
        javax.xml.datatype.XMLGregorianCalendar gc = this;
        if (timezone != 0) {
            gc = this.normalize();
        }
        return gc.getYear()
     ...
     * instance, see
     * {@link #toGregorianCalendar(TimeZone, Locale, javax.xml.datatype.XMLGregorianCalendar)}.</p>
     *
     * <table border="2" rules="all" cellpadding="2">
     *   <thead>
     *     <tr>
     ...
     * </p>
     *
     * @see #toGregorianCalendar(TimeZone, java.util.Locale, javax.xml.datatype.XMLGregorianCalendar)
     */
