...
public abstract class DocumentBuilderFactory {
     ...
     * @since 1.6
     */
    public static javax.xml.parsers.DocumentBuilderFactory newInstance(String factoryClassName, ClassLoader classLoader){
            //do not fallback if given classloader can't find the class, throw exception
            return FactoryFinder.newInstance(javax.xml.parsers.DocumentBuilderFactory.class,
     ...
     *      if the method was not invoked since a {@link javax.xml.parsers.DocumentBuilderFactory}
     *      is created.
     *
