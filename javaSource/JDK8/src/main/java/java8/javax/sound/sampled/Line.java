...
public interface Line extends AutoCloseable {
     ...
     * @see Mixer#getSourceLineInfo(javax.sound.sampled.Line.Info) <code>Mixer.getSourceLineInfo(Line.Info)</code>
     * @see Mixer#getSourceLineInfo(javax.sound.sampled.Line.Info) <code>Mixer.getTargetLineInfo(Line.Info)</code>
    ...
    public static class Info {
        ...
        public Info(Class<?> lineClass) {
            ...
            if (lineClass == null) {
                this.lineClass = javax.sound.sampled.Line.class;
            } else {
