...
public class AudioSystem {
     ...
     * For details, refer to the {@link javax.sound.sampled.AudioSystem class description}.
     *
    ...
    public static Clip getClip() throws LineUnavailableException{
        AudioFormat format = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED,
                                             ...
                                             16, 2, 4,
                                             javax.sound.sampled.AudioSystem.NOT_SPECIFIED, true);
    ...
    public static SourceDataLine getSourceDataLine(AudioFormat format)
        ...
        return (SourceDataLine) javax.sound.sampled.AudioSystem.getLine(info);
    }
    ...
    public static TargetDataLine getTargetDataLine(AudioFormat format)
        ...
        return (TargetDataLine) javax.sound.sampled.AudioSystem.getLine(info);
    }
