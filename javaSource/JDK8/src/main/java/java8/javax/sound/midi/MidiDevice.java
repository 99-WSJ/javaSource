...
*
* <p>
* A <code>MidiDevice</code> includes a <code>{@link javax.sound.midi.MidiDevice.Info}</code> object
...
public interface MidiDevice extends AutoCloseable {
    ...
    * data about a <code>{@link javax.sound.midi.MidiDevice}</code>, including its
