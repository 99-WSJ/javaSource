...
*/
    ...
    public boolean equals(Object obj) {
        if ((obj != null) && (obj instanceof javax.naming.NameImpl)) {
            javax.naming.NameImpl target = (javax.naming.NameImpl)obj;
    ...
    /**
      ...
      */
    public int compareTo(javax.naming.NameImpl obj) {
        if (this == obj) {
            return 0;
        }
    ...
    public Enumeration<String> getPrefix(int posn) {
        ...
        return new javax.naming.NameImplEnumerator(components, 0, posn);
    }
    ...
    public Enumeration<String> getSuffix(int posn) {
        ...
        return new javax.naming.NameImplEnumerator(components, posn, cnt);
    }
