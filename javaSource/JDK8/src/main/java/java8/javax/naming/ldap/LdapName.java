...
public class LdapName implements Name {
    ...
    public Name getPrefix(int posn) {
        try {
            return new javax.naming.ldap.LdapName(null, rdns, 0, posn);
    ...
    public Name getSuffix(int posn) {
        try {
            return new javax.naming.ldap.LdapName(null, rdns, posn, rdns.size());
        } catch (IllegalArgumentException e) {
            throw new IndexOutOfBoundsException(
                "Posn: " + posn + ", Size: "+ rdns.size());
        }
    ...
    private boolean matches(int beg, int end, Name n) {
        if (n instanceof javax.naming.ldap.LdapName) {
            javax.naming.ldap.LdapName ln = (javax.naming.ldap.LdapName) n;
            ...
            for (int i = beg; i < end; i++) {
                ...
                try {
                    rdn = (new javax.naming.ldap.Rfc2253Parser(rdnString)).parseRdn();
    ...
    public Name addAll(int posn, Name suffix)
        ...
        if (suffix instanceof javax.naming.ldap.LdapName) {
            javax.naming.ldap.LdapName s = (javax.naming.ldap.LdapName) suffix;
            rdns.addAll(posn, s.rdns);
        } else {
            Enumeration<String> comps = suffix.getAll();
            while (comps.hasMoreElements()) {
                rdns.add(posn++,
                    (new javax.naming.ldap.Rfc2253Parser(comps.nextElement()).
                    parseRdn()));
            }
        }
        return this;
    ...
    public Name add(int posn, String comp) throws InvalidNameException {
        Rdn rdn = (new javax.naming.ldap.Rfc2253Parser(comp)).parseRdn();
        rdns.add(posn, rdn);
        unparsed = null;        // no longer valid
        return this;
    }
     ...
     */
    public Object clone() {
        return new javax.naming.ldap.LdapName(unparsed, rdns, 0, rdns.size());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof javax.naming.ldap.LdapName)) {
            return false;
        }
        javax.naming.ldap.LdapName that = (javax.naming.ldap.LdapName) obj;
    ...
    private void parse() throws InvalidNameException {
        ...
        rdns = new javax.naming.ldap.Rfc2253Parser(unparsed).parseDn();
    }
}
