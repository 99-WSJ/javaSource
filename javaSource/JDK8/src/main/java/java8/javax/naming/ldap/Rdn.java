...
public class Rdn implements Serializable, Comparable<Object> {
    ...
    public Rdn(String rdnString) throws InvalidNameException {
        ...
        (new javax.naming.ldap.Rfc2253Parser(rdnString)).parseRdn(this);
    }
     ...
     * @see #toString()
     */
    javax.naming.ldap.Rdn put(String type, Object value) {
    ...
    public int compareTo(Object obj) {
        if (!(obj instanceof javax.naming.ldap.Rdn)) {
            throw new ClassCastException("The obj is not a Rdn");
        }
        if (obj == this) {
            return 0;
        }
        javax.naming.ldap.Rdn that = (javax.naming.ldap.Rdn) obj;
    ...
    private void readObject(ObjectInputStream s)
        ...
        try {
            (new javax.naming.ldap.Rfc2253Parser(unparsed)).parseRdn(this);
