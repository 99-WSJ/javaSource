...
package java8.javax.imageio.metadata;
...
class IIOAttr extends javax.imageio.metadata.IIOMetadataNode implements Attr {
...
public class IIOMetadataNode implements Element, NodeList {
     ...
     */
    private javax.imageio.metadata.IIOMetadataNode parent = null;
     ...
     */
    private javax.imageio.metadata.IIOMetadataNode firstChild = null;

    /**
     * The last (rightmost) child node of this node, or
     * <code>null</code> if this node is a leaf node.
     */
    private javax.imageio.metadata.IIOMetadataNode lastChild = null;

    /**
     * The next (right) sibling node of this node, or
     * <code>null</code> if this node is its parent's last child node.
     */
    private javax.imageio.metadata.IIOMetadataNode nextSibling = null;

    /**
     * The previous (left) sibling node of this node, or
     * <code>null</code> if this node is its parent's first child node.
     */
    private javax.imageio.metadata.IIOMetadataNode previousSibling = null;
    ...
    private void checkNode(Node node) throws DOMException {
        ...
        if (!(node instanceof javax.imageio.metadata.IIOMetadataNode)) {
            throw new javax.imageio.metadata.IIODOMException(DOMException.WRONG_DOCUMENT_ERR,
    ...
    public NamedNodeMap getAttributes() {
        return new javax.imageio.metadata.IIONamedNodeMap(attributes);
    }
    ...
    public Node insertBefore(Node newChild,
        ...
        javax.imageio.metadata.IIOMetadataNode newChildNode = (javax.imageio.metadata.IIOMetadataNode)newChild;
        javax.imageio.metadata.IIOMetadataNode refChildNode = (javax.imageio.metadata.IIOMetadataNode)refChild;

        // Siblings, can be null.
        javax.imageio.metadata.IIOMetadataNode previous = null;
        javax.imageio.metadata.IIOMetadataNode next = null;
    ...
    public Node replaceChild(Node newChild,
        ...
        javax.imageio.metadata.IIOMetadataNode newChildNode = (javax.imageio.metadata.IIOMetadataNode)newChild;
        javax.imageio.metadata.IIOMetadataNode oldChildNode = (javax.imageio.metadata.IIOMetadataNode)oldChild;

        javax.imageio.metadata.IIOMetadataNode previous = oldChildNode.previousSibling;
        javax.imageio.metadata.IIOMetadataNode next = oldChildNode.nextSibling;
    ...
    public Node cloneNode(boolean deep) {
        javax.imageio.metadata.IIOMetadataNode newNode = new javax.imageio.metadata.IIOMetadataNode(this.nodeName);
        newNode.setUserObject(getUserObject());
        // Attributes

        if (deep) {
            for (javax.imageio.metadata.IIOMetadataNode child = firstChild;
                 child != null;
    ...
    public void setAttribute(String name, String value) {
        ...
        if (!valid) {
            throw new javax.imageio.metadata.IIODOMException(DOMException.INVALID_CHARACTER_ERR,
                                      "Attribute name is illegal!");
        }
        removeAttribute(name, false);
        attributes.add(new javax.imageio.metadata.IIOAttr(this, name, value));
    }
    ...
    private void removeAttribute(String name, boolean checkPresent) {
        ...
        for (int i = 0; i < numAttributes; i++) {
            javax.imageio.metadata.IIOAttr attr = (javax.imageio.metadata.IIOAttr)attributes.get(i);
        ...
        if (checkPresent) {
            throw new javax.imageio.metadata.IIODOMException(DOMException.NOT_FOUND_ERR,
                                      "No such attribute!");
        }
    }
   ...
   public Attr getAttributeNodeNS(String namespaceURI,
    ...
    public Attr setAttributeNode(Attr newAttr) throws DOMException {
        ...
        javax.imageio.metadata.IIOAttr attr;
        if (newAttr instanceof javax.imageio.metadata.IIOAttr) {
            attr = (javax.imageio.metadata.IIOAttr)newAttr;
            attr.setOwnerElement(this);
        } else {
            attr = new javax.imageio.metadata.IIOAttr(this,
                               newAttr.getName(),
                               newAttr.getValue());
        }
    ...
    public NodeList getElementsByTagName(String name) {
        ...
        return new javax.imageio.metadata.IIONodeList(l);
    }
    ...
    private void getElementsByTagName(String name, List l) {
        ...
        while (child != null) {
            ((javax.imageio.metadata.IIOMetadataNode)child).getElementsByTagName(name, l);
