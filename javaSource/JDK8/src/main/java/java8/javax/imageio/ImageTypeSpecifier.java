...
public class ImageTypeSpecifier {
    ...
    static {
        ...
        BISpecifier =
            new javax.imageio.ImageTypeSpecifier[BufferedImage.TYPE_BYTE_INDEXED + 1];
    }
    ...
    static class Packed extends javax.imageio.ImageTypeSpecifier {
    ...
    public static javax.imageio.ImageTypeSpecifier
        createPacked(ColorSpace colorSpace,
                     ...
                     int transferType,
                     boolean isAlphaPremultiplied) {
        return new javax.imageio.ImageTypeSpecifier.Packed(colorSpace,
                                             redMask,
                                             greenMask,
                                             blueMask,
    ...
    static class Interleaved extends javax.imageio.ImageTypeSpecifier {
        ColorSpace colorSpace;
        int[] bandOffsets;
        int dataType;
        boolean hasAlpha;
        ...
        public Interleaved(ColorSpace colorSpace,
            ...
            this.colorModel =
                javax.imageio.ImageTypeSpecifier.createComponentCM(colorSpace,
                                                     bandOffsets.length,
                                                     dataType,
                                                     hasAlpha,
                                                     isAlphaPremultiplied);
        ...
        public boolean equals(Object o) {
            if ((o == null) ||
                !(o instanceof javax.imageio.ImageTypeSpecifier.Interleaved)) {
                return false;
            }

            javax.imageio.ImageTypeSpecifier.Interleaved that =
                (javax.imageio.ImageTypeSpecifier.Interleaved)o;
    ...
    public static javax.imageio.ImageTypeSpecifier
        createInterleaved(ColorSpace colorSpace,
                          ...
                          boolean hasAlpha,
                          boolean isAlphaPremultiplied) {
        return new javax.imageio.ImageTypeSpecifier.Interleaved(colorSpace,
                                                  bandOffsets,
                                                  dataType,
                                                  hasAlpha,
                                                  isAlphaPremultiplied);
    ...
    static class Banded extends javax.imageio.ImageTypeSpecifier {
        ColorSpace colorSpace;
        int[] bankIndices;
        int[] bandOffsets;
        int dataType;
        ...
        public boolean equals(Object o) {
            if ((o == null) ||
                !(o instanceof javax.imageio.ImageTypeSpecifier.Banded)) {
                return false;
            }

            javax.imageio.ImageTypeSpecifier.Banded that =
                (javax.imageio.ImageTypeSpecifier.Banded)o;
    ...
    public static javax.imageio.ImageTypeSpecifier
        createBanded(ColorSpace colorSpace,
                     ...
                     boolean hasAlpha,
                     boolean isAlphaPremultiplied) {
        return new javax.imageio.ImageTypeSpecifier.Banded(colorSpace,
                                             bankIndices,
                                             bandOffsets,
                                             dataType,
                                             hasAlpha,
    ...
    static class Grayscale extends javax.imageio.ImageTypeSpecifier {
        int bits;
        int dataType;
        boolean isSigned;
        boolean hasAlpha;
    ...
    public static javax.imageio.ImageTypeSpecifier
        createGrayscale(int bits,
                        int dataType,
                        boolean isSigned) {
        return new javax.imageio.ImageTypeSpecifier.Grayscale(bits,
                                                dataType,
                                                isSigned,
                                                false,
                                                false);
    ...
    static class Indexed extends javax.imageio.ImageTypeSpecifier {
        byte[] redLUT;
        byte[] greenLUT;
        byte[] blueLUT;
        byte[] alphaLUT = null;
    ...
    public static javax.imageio.ImageTypeSpecifier
        createIndexed(byte[] redLUT,
                      ...
                      int bits,
                      int dataType) {
        return new javax.imageio.ImageTypeSpecifier.Indexed(redLUT,
                                              greenLUT,
                                              blueLUT,
                                              alphaLUT,
                                              bits,
     ...
     * <code>null</code>.
     */
    public static javax.imageio.ImageTypeSpecifier createFromRenderedImage(RenderedImage image) {
        if (image == null) {
            throw new IllegalArgumentException("image == null!");
        }
        ...
        return new javax.imageio.ImageTypeSpecifier(image);
    }
     ...
     */
    public boolean equals(Object o) {
        if ((o == null) || !(o instanceof javax.imageio.ImageTypeSpecifier)) {
            return false;
        }

        javax.imageio.ImageTypeSpecifier that = (javax.imageio.ImageTypeSpecifier)o;
    ...
    private static javax.imageio.ImageTypeSpecifier getSpecifier(int type) {
    ...
    private static javax.imageio.ImageTypeSpecifier createSpecifier(int type) {
        switch(type) {
