...
public class ServiceRegistry {
    ...
    public ServiceRegistry(Iterator<Class<?>> categories) {
        ...
        while (categories.hasNext()) {
            ...
            javax.imageio.spi.SubRegistry reg = new javax.imageio.spi.SubRegistry(this, category);
    ...
    private Iterator getSubRegistries(Object provider) {
        ...
        while (iter.hasNext()) {
            ...
            if (c.isAssignableFrom(provider.getClass())) {
                l.add((javax.imageio.spi.SubRegistry)categoryMap.get(c));
            }
        }
        return l.iterator();
    }
    ...
    public <T> boolean registerServiceProvider(T provider,
        ...
        javax.imageio.spi.SubRegistry reg = (javax.imageio.spi.SubRegistry)categoryMap.get(category);
        if (reg == null) {
    ...
    public void registerServiceProvider(Object provider) {
        ...
        while (regs.hasNext()) {
            javax.imageio.spi.SubRegistry reg = (javax.imageio.spi.SubRegistry)regs.next();
     ...
     *
     * @see javax.imageio.spi.ServiceRegistry#getServiceProviders(Class, javax.imageio.spi.ServiceRegistry.Filter, boolean)
     */
    ...
    public <T> Iterator<T> getServiceProviders(Class<T> category,
        ...
        return new javax.imageio.spi.FilterIterator(iter, filter);
    }
    ...
    public <T> T getServiceProviderByClass(Class<T> providerClass) {
        ...
        while (iter.hasNext()) {
            ...
            if (c.isAssignableFrom(providerClass)) {
                javax.imageio.spi.SubRegistry reg = (javax.imageio.spi.SubRegistry)categoryMap.get(c);
    ...
    public void deregisterAll() {
        ...
        while (iter.hasNext()) {
            javax.imageio.spi.SubRegistry reg = (javax.imageio.spi.SubRegistry)iter.next();
            reg.clear();
        }
    }
...
class SubRegistry {
    ...
    public SubRegistry(javax.imageio.spi.ServiceRegistry registry, Class category) {
...
class FilterIterator<T> implements Iterator<T> {
    ...
    private javax.imageio.spi.ServiceRegistry.Filter filter;
