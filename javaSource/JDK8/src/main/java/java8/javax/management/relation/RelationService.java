...
public class RelationService extends NotificationBroadcasterSupport
    ...
    public RelationService(boolean immediatePurgeFlag) {
        ...
        RELATION_LOGGER.entering(javax.management.relation.RelationService.class.getName(),
                "RelationService");

        setPurgeFlag(immediatePurgeFlag);

        RELATION_LOGGER.exiting(javax.management.relation.RelationService.class.getName(),
                "RelationService");
        return;
    }
    ...
    public List<ObjectName> getRole(String relationId,
        ...
        RELATION_LOGGER.exiting(javax.management.relation.RelationService.class.getName(), "getRole");
        return result;
    }
    ...
    public RoleResult getRoles(String relationId,
        ...
        RELATION_LOGGER.exiting(javax.management.relation.RelationService.class.getName(), "getRoles");
        return result;
    }
    ...
    public void setRole(String relationId,
        ...
        RELATION_LOGGER.exiting(javax.management.relation.RelationService.class.getName(), "setRole");
        return;
    }
    ...
    public RoleResult setRoles(String relationId,
        ...
        RELATION_LOGGER.exiting(javax.management.relation.RelationService.class.getName(), "setRoles");
        return result;
    }
