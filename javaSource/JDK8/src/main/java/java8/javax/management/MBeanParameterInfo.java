...
public class MBeanParameterInfo extends MBeanFeatureInfo implements Cloneable {
    ...
    static final javax.management.MBeanParameterInfo[] NO_PARAMS = new javax.management.MBeanParameterInfo[0];
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof javax.management.MBeanParameterInfo))
            return false;
        javax.management.MBeanParameterInfo p = (javax.management.MBeanParameterInfo) o;
