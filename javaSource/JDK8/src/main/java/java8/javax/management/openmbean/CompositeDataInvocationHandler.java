...
public class CompositeDataInvocationHandler implements InvocationHandler {
    ...
    */
    ...
    private boolean equals(Object proxy, Object other) {
        ...
        if (!(otherih instanceof javax.management.openmbean.CompositeDataInvocationHandler))
            return false;
        javax.management.openmbean.CompositeDataInvocationHandler othercdih =
            (javax.management.openmbean.CompositeDataInvocationHandler) otherih;
