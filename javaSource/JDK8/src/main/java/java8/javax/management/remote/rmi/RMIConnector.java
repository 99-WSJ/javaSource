...
public class RMIConnector implements JMXConnector, Serializable, JMXAddressable {
    ...
    static Object resolveOrb(Map<String, ?> environment)
        ...
        final Object orb =
                (javax.management.remote.rmi.RMIConnector.orb==null)?null: javax.management.remote.rmi.RMIConnector.orb.get();
        if (orb != null) return orb;

        final Object newOrb =
                IIOPHelper.createOrb((String[])null, (Properties)null);
        javax.management.remote.rmi.RMIConnector.orb = new WeakReference<Object>(newOrb);
        return newOrb;
    }
    ...
    static {
        ...
        final byte[] pRefByteCode =
                javax.management.remote.rmi.NoCallStackClassLoader.stringToBytes(pRefByteCodeString);
        PrivilegedExceptionAction<Constructor<?>> action =
                new PrivilegedExceptionAction<Constructor<?>>() {
            public Constructor<?> run() throws Exception {
                Class thisClass = javax.management.remote.rmi.RMIConnector.class;
                ClassLoader thisLoader = thisClass.getClassLoader();
                ProtectionDomain thisProtectionDomain =
                        thisClass.getProtectionDomain();
                String[] otherClassNames = {ProxyRef.class.getName()};
                ClassLoader cl =
                        new javax.management.remote.rmi.NoCallStackClassLoader(pRefClassName,
                        pRefByteCode,
                        otherClassNames,
                        thisLoader,
    ...
    static {
        ...
        final byte[] proxyStubByteCode =
                javax.management.remote.rmi.NoCallStackClassLoader.stringToBytes(proxyStubByteCodeString);
        final byte[] pInputStreamByteCode =
                javax.management.remote.rmi.NoCallStackClassLoader.stringToBytes(pInputStreamByteCodeString);
            ...
            PrivilegedExceptionAction<Class<?>> action =
              ...
              public Class<?> run() throws Exception {
                ...
                ProtectionDomain thisProtectionDomain =
                        thisClass.getProtectionDomain();
                ClassLoader cl =
                        new javax.management.remote.rmi.NoCallStackClassLoader(classNames,
                        byteCodes,
                        otherClassNames,
                        thisLoader,
                        thisProtectionDomain);
