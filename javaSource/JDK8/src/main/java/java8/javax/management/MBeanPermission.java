...
public class MBeanPermission extends Permission {
    ...
    public boolean implies(Permission p) {
        if (!(p instanceof javax.management.MBeanPermission))
            return false;

        javax.management.MBeanPermission that = (javax.management.MBeanPermission) p;
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof javax.management.MBeanPermission))
            return false;

        javax.management.MBeanPermission that = (javax.management.MBeanPermission) obj;
