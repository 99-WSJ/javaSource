...
public class TabularType extends OpenType<TabularData> {
    ...
    public boolean isValue(Object obj) {
        ...
        javax.management.openmbean.TabularType valueType = value.getTabularType();
        return isAssignableFrom(valueType);
    }

    @Override
    boolean isAssignableFrom(OpenType<?> ot) {
        if (!(ot instanceof javax.management.openmbean.TabularType))
            return false;
        javax.management.openmbean.TabularType tt = (javax.management.openmbean.TabularType) ot;
    ...
    public boolean equals(Object obj) {
        ...
        //
        javax.management.openmbean.TabularType other;
        try {
            other = (javax.management.openmbean.TabularType) obj;
