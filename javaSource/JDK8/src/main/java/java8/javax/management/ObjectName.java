...
public class ObjectName implements Comparable<javax.management.ObjectName>, QueryExp {
    ...
    /**
     * Initializes this {@link javax.management.ObjectName} from the given string
     * representation.
     *
     * @param name A string representation of the {@link javax.management.ObjectName}
     *
    ...
    /**
     * Deserializes an {@link javax.management.ObjectName} from an {@link ObjectInputStream}.
     * @serialData <ul>
     ...
     *                                of the {@link javax.management.ObjectName}</li>
     ...
     *                   produce an equivalent {@link javax.management.ObjectName}.
     *               </li>
     ...
     *                                {@link javax.management.ObjectName}</li>
     ...
     *                                {@link javax.management.ObjectName}'s canonical name</li>
     *                            <li>&lt;pattern&gt; is a boolean which is
     *                                <code>true</code> if this
     *                                {@link javax.management.ObjectName} contains a pattern</li>
     *                            <li>&lt;propertyPattern&gt; is a boolean which
     *                                is <code>true</code> if this
     *                                {@link javax.management.ObjectName} contains a pattern in
    ...
    /**
     * Serializes an {@link javax.management.ObjectName} to an {@link ObjectOutputStream}.
     * @serialData <ul>
     *               <li>In the current serial form (value of property
     *                   <code>jmx.serial.form</code> differs from
     *                   <code>1.0</code>): the string
     ...
     *
     */
    public static javax.management.ObjectName getInstance(String name)
     ...
     *
     */
    public static javax.management.ObjectName getInstance(String domain, String key,
                                                          String value)
            throws MalformedObjectNameException {
        return new javax.management.ObjectName(domain, key, value);
    }
     ...
     *
     */
    public static javax.management.ObjectName getInstance(String domain,
                                                          Hashtable<String,String> table)
        throws MalformedObjectNameException {
        return new javax.management.ObjectName(domain, table);
    }
    ...
    public static javax.management.ObjectName getInstance(javax.management.ObjectName name) {
        if (name.getClass().equals(javax.management.ObjectName.class))
            return name;
    ...
    public boolean equals(Object object)  {
        ...
        if (!(object instanceof javax.management.ObjectName)) return false;

        // equality when canonical names are the same
        // (because usage of intern())
        javax.management.ObjectName on = (javax.management.ObjectName) object;
     ...
     * @since 1.6
     */
    public static final javax.management.ObjectName WILDCARD = Util.newObjectName("*:*");
