...
public class MBeanFeatureInfo implements Serializable, DescriptorRead {
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof javax.management.MBeanFeatureInfo))
            return false;
        javax.management.MBeanFeatureInfo p = (javax.management.MBeanFeatureInfo) o;
    ...
    /**
     * Serializes an {@link javax.management.MBeanFeatureInfo} to an {@link ObjectOutputStream}.
     * @serialData
    ...
    /**
     * Deserializes an {@link javax.management.MBeanFeatureInfo} from an {@link ObjectInputStream}.
     * @serialData
