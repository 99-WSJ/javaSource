...
class BinaryRelQueryExp extends QueryEval implements QueryExp {
    ...
    public boolean apply(ObjectName name) throws BadStringOperationException, BadBinaryOpValueExpException,
        ...
        boolean bool = val1 instanceof javax.management.BooleanValueExp;
        if (numeric) {
            if (((javax.management.NumericValueExp)val1).isLong()) {
                long lval1 = ((javax.management.NumericValueExp)val1).longValue();
                long lval2 = ((javax.management.NumericValueExp)val2).longValue();
                ...
                double dval1 = ((javax.management.NumericValueExp)val1).doubleValue();
                double dval2 = ((javax.management.NumericValueExp)val2).doubleValue();
            ...
            boolean bval1 = ((javax.management.BooleanValueExp)val1).getValue().booleanValue();
            boolean bval2 = ((javax.management.BooleanValueExp)val2).getValue().booleanValue();
