...
public class StandardMBean implements DynamicMBean, MBeanRegistration {
     ...
     * methods.
     */
    static boolean immutableInfo(Class<? extends javax.management.StandardMBean> subclass) {
        if (subclass == javax.management.StandardMBean.class ||
    ...
    private static class MBeanInfoSafeAction
        ...
        public Boolean run() {
            ...
            //
            if (overrides(subclass, javax.management.StandardMBean.class,
