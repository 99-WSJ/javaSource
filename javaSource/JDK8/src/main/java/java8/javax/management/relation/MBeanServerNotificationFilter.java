...
public class MBeanServerNotificationFilter extends NotificationFilterSupport {
    ...
    public MBeanServerNotificationFilter() {
        ...
        super();
        RELATION_LOGGER.entering(javax.management.relation.MBeanServerNotificationFilter.class.getName(),
        ...
        RELATION_LOGGER.exiting(javax.management.relation.MBeanServerNotificationFilter.class.getName(),
                "MBeanServerNotificationFilter");
        return;
    }
    ...
    public synchronized boolean isNotificationEnabled(Notification notif)
        ...
        if (!(enabledTypes.contains(ntfType))) {
            RELATION_LOGGER.logp(Level.FINER,
                    javax.management.relation.MBeanServerNotificationFilter.class.getName(),
    ...
    /**
     * Deserializes an {@link javax.management.relation.MBeanServerNotificationFilter} from an {@link ObjectInputStream}.
     */
    ...
    /**
     * Serializes an {@link javax.management.relation.MBeanServerNotificationFilter} to an {@link ObjectOutputStream}.
     */
