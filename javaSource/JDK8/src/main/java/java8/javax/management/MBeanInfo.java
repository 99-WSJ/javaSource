...
public class MBeanInfo implements Cloneable, Serializable, DescriptorRead {
    ...
    public MBeanInfo(String className,
        ...
        this.arrayGettersSafe =
                arrayGettersSafe(this.getClass(), javax.management.MBeanInfo.class);
    }
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof javax.management.MBeanInfo))
            return false;
        javax.management.MBeanInfo p = (javax.management.MBeanInfo) o;
    ...
    */
    ...
    /**
     * Serializes an {@link javax.management.MBeanInfo} to an {@link ObjectOutputStream}.
     * @serialData
    ...
    /**
     * Deserializes an {@link javax.management.MBeanInfo} from an {@link ObjectInputStream}.
     * @serialData
