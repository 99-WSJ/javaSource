...
public class RequiredModelMBean
    ...
    public RequiredModelMBean()
        ...
        if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
            MODELMBEAN_LOGGER.logp(Level.FINER,
                    javax.management.modelmbean.RequiredModelMBean.class.getName(),
    ...
    private Object resolveForCacheValue(Descriptor descr)
        ...
        if (tracing) {
            MODELMBEAN_LOGGER.logp(Level.FINER,
                    javax.management.modelmbean.RequiredModelMBean.class.getName(),mth,"Entry");
        }
        ...
        if (descr == null) {
            if (tracing) {
                MODELMBEAN_LOGGER.logp(Level.FINER,
                        javax.management.modelmbean.RequiredModelMBean.class.getName(),mth,
        ...
        if (tracing) {
            MODELMBEAN_LOGGER.logp(Level.FINER,
                    javax.management.modelmbean.RequiredModelMBean.class.getName(),mth,"Exit");
        }
    ...
    private Method resolveMethod(Class<?> targetClass,
        ...
        if (tracing) {
            MODELMBEAN_LOGGER.logp(Level.FINER,
                javax.management.modelmbean.RequiredModelMBean.class.getName(),"resolveMethod",
    ...
    private Method findRMMBMethod(String opMethodName,
        ...
        if (targetObjectField != null)
            return null;
        final Class<javax.management.modelmbean.RequiredModelMBean> rmmbClass = javax.management.modelmbean.RequiredModelMBean.class;
        final Class<?> targetClass;
        if (opClassName == null)
    ...
    private static synchronized boolean isRMMBMethodName(String name) {
        if (rmmbMethodNames == null) {
            try {
                ...
                Method[] methods = javax.management.modelmbean.RequiredModelMBean.class.getMethods();
