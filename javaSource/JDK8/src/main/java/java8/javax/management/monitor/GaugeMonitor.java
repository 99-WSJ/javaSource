...
public class GaugeMonitor extends Monitor implements GaugeMonitorMBean {
    ...
    public synchronized void start() {
        if (isActive()) {
            MONITOR_LOGGER.logp(Level.FINER, javax.management.monitor.GaugeMonitor.class.getName(),
   ...
   /**
    ...
    private synchronized void setDerivedGaugeWithDifference(
        ...
        default:
            // Should never occur...
            MONITOR_LOGGER.logp(Level.FINEST, javax.management.monitor.GaugeMonitor.class.getName(),
