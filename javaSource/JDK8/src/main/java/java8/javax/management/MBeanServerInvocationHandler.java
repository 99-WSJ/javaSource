...
public class MBeanServerInvocationHandler implements InvocationHandler {
    ...
    private Object doLocally(Object proxy, Method method, Object[] args) {
        ...
        if (methodName.equals("equals")) {
            ...
            if (ihandler == null ||
                !(ihandler instanceof javax.management.MBeanServerInvocationHandler)) {
                return false;
            }

            final javax.management.MBeanServerInvocationHandler handler =
                (javax.management.MBeanServerInvocationHandler)ihandler;
