...
public class RelationNotification extends Notification {
    ...
    private boolean isValidCreate(String notifType) {
        String[] validTypes= {javax.management.relation.RelationNotification.RELATION_BASIC_CREATION,
                              javax.management.relation.RelationNotification.RELATION_MBEAN_CREATION,
                              javax.management.relation.RelationNotification.RELATION_BASIC_REMOVAL,
                              javax.management.relation.RelationNotification.RELATION_MBEAN_REMOVAL};
    ...
    private boolean isValidUpdate(String notifType, String name,
        ...
        if (!(notifType.equals(javax.management.relation.RelationNotification.RELATION_BASIC_UPDATE)) &&
            !(notifType.equals(javax.management.relation.RelationNotification.RELATION_MBEAN_UPDATE))) {
            return false;
        }
    ...
    /**
     * Deserializes a {@link javax.management.relation.RelationNotification} from an {@link ObjectInputStream}.
     */
    ...
    /**
     * Serializes a {@link javax.management.relation.RelationNotification} to an {@link ObjectOutputStream}.
     */
