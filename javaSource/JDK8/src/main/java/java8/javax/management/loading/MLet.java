...
public class MLet extends java.net.URLClassLoader
     ...
     */
     ...
     public void addURL(String url) throws ServiceNotFoundException {
         try {
             ...
             if (MLET_LOGGER.isLoggable(Level.FINEST)) {
                 MLET_LOGGER.logp(Level.FINEST, javax.management.loading.MLet.class.getName(),
     ...
     public Set<Object> getMBeansFromURL(String url)
         ...
         // Parse arguments
         if (url == null) {
             MLET_LOGGER.logp(Level.FINER, javax.management.loading.MLet.class.getName(),
                     mth, "URL is null");
             throw new ServiceNotFoundException("The specified URL is null");
         } else {
         ...
         // Parse URL
         try {
             javax.management.loading.MLetParser parser = new javax.management.loading.MLetParser();
             mletList = parser.parseURL(url);
         } catch (Exception e) {
             final String msg =
                 "Problems while parsing URL [" + url +
                 "], got exception [" + e.toString() + "]";
             MLET_LOGGER.logp(Level.FINER, javax.management.loading.MLet.class.getName(), mth, msg);
         ...
         for (MLetContent elmt : mletList) {
             ...
             while (st.hasMoreTokens()) {
                 ...
                 if (MLET_LOGGER.isLoggable(Level.FINER)) {
                     MLET_LOGGER.logp(Level.FINER, javax.management.loading.MLet.class.getName(), mth,
                     ...
                     if (signat.isEmpty()) {
                         ...
                         if (MLET_LOGGER.isLoggable(Level.FINEST)) {
                             ...
                             MLET_LOGGER.logp(Level.FINEST,
                                     javax.management.loading.MLet.class.getName(),
                                     mth, strb.toString());
                         }
                         if (name == null) {
                             objInst =
     ...
     /**
      * Called by {@link javax.management.loading.MLet#findClass(String)}.
      *
     ...
     Class<?> findClass(String name, ClassLoaderRepository clr)
         throws ClassNotFoundException {
         Class<?> c = null;
         MLET_LOGGER.logp(Level.FINER, javax.management.loading.MLet.class.getName(), "findClass", name);
    ...
    */
     ...
     */
     private Object loadSerializedObject(URL codebase, String filename)
        ...
        if (is != null) {
            try {
                ObjectInputStream ois = new javax.management.loading.MLetObjectInputStream(is, this);
