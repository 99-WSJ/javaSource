...
public class RoleUnresolved implements Serializable {
    ...
    public Object clone() {
        try {
            return new javax.management.relation.RoleUnresolved(roleName, roleValue, problemType);
    ...
    /**
     * Deserializes a {@link javax.management.relation.RoleUnresolved} from an {@link ObjectInputStream}.
     */
    ...
    /**
     * Serializes a {@link javax.management.relation.RoleUnresolved} to an {@link ObjectOutputStream}.
     */
