...
public class ArrayType<T> extends OpenType<T> {
    ...
    /**
     * @serial The dimension of arrays described by this {@link javax.management.openmbean.ArrayType}
     *         instance.
     */
     ...
     *         described by this {@link javax.management.openmbean.ArrayType} instance.
     */
    private OpenType<?> elementType;

    /**
     * @serial This flag indicates whether this {@link javax.management.openmbean.ArrayType}
    ...
    public ArrayType(int dimension,
        ...
        if (elementType.isArray()) {
            javax.management.openmbean.ArrayType<?> at = (javax.management.openmbean.ArrayType<?>) elementType;
    ...
    private static String buildArrayClassName(int dimension,
        ...
        if (elementType.isArray()) {
            isPrimitiveArray = ((javax.management.openmbean.ArrayType<?>) elementType).isPrimitiveArray();
        }
    ...
    boolean isAssignableFrom(OpenType<?> ot) {
        if (!(ot instanceof javax.management.openmbean.ArrayType<?>))
            return false;
        javax.management.openmbean.ArrayType<?> at = (javax.management.openmbean.ArrayType<?>) ot;
    ...
    public boolean equals(Object obj) {
        ...
        //
        if (!(obj instanceof javax.management.openmbean.ArrayType<?>))
            return false;
        javax.management.openmbean.ArrayType<?> other = (javax.management.openmbean.ArrayType<?>) obj;
     ...
     * @since 1.6
     */
    public static <E> javax.management.openmbean.ArrayType<E[]> getArrayType(OpenType<E> elementType)
        throws OpenDataException {
        return new javax.management.openmbean.ArrayType<E[]>(1, elementType);
    }
    ...
    public static <T> javax.management.openmbean.ArrayType<T> getPrimitiveArrayType(Class<T> arrayClass) {
        ...
        try {
            ...
            javax.management.openmbean.ArrayType at = new javax.management.openmbean.ArrayType(simpleType, true);
            if (n > 1)
                at = new javax.management.openmbean.ArrayType<T>(n - 1, at);
            return at;
    ...
    private <T> javax.management.openmbean.ArrayType<T> convertFromWrapperToPrimitiveTypes() {
        ...
        return new javax.management.openmbean.ArrayType<T>(cn, tn, d,
