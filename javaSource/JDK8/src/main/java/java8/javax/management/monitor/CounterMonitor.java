...
public class CounterMonitor extends Monitor implements CounterMonitorMBean {
    ...
    public synchronized void start() {
        if (isActive()) {
            MONITOR_LOGGER.logp(Level.FINER, javax.management.monitor.CounterMonitor.class.getName(),
                ...
                switch (o.getType()) {
                    ...
                    default:
                        ...
                        MONITOR_LOGGER.logp(Level.FINEST,
                                javax.management.monitor.CounterMonitor.class.getName(),
                                "updateThreshold",
    ...
    private synchronized void setDerivedGaugeWithDifference(
        ...
        default:
            // Should never occur...
            MONITOR_LOGGER.logp(Level.FINEST, javax.management.monitor.CounterMonitor.class.getName(),
