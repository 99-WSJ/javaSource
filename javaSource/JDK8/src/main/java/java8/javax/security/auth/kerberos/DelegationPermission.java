...
public final class DelegationPermission extends BasicPermission
    ...
    public boolean implies(Permission p) {
        if (!(p instanceof javax.security.auth.kerberos.DelegationPermission))
            return false;

        javax.security.auth.kerberos.DelegationPermission that = (javax.security.auth.kerberos.DelegationPermission) p;
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof javax.security.auth.kerberos.DelegationPermission))
            return false;

        javax.security.auth.kerberos.DelegationPermission that = (javax.security.auth.kerberos.DelegationPermission) obj;
        return implies(that);
    }
    ...
    public PermissionCollection newPermissionCollection() {
        return new javax.security.auth.kerberos.KrbDelegationPermissionCollection();
    }
...
final class KrbDelegationPermissionCollection extends PermissionCollection
    ...
    public boolean implies(Permission permission) {
        if (! (permission instanceof javax.security.auth.kerberos.DelegationPermission))
                return false;
