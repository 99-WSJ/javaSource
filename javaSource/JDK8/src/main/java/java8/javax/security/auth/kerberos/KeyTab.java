...
public final class KeyTab {
     ...
     */
    public static javax.security.auth.kerberos.KeyTab getInstance(File file) {
        if (file == null) {
            throw new NullPointerException("file must be non null");
        }
        return new javax.security.auth.kerberos.KeyTab(null, file, true);
    }
     ...
     * @since 1.8
     */
    public static javax.security.auth.kerberos.KeyTab getUnboundInstance(File file) {
        if (file == null) {
            throw new NullPointerException("file must be non null");
        }
        return new javax.security.auth.kerberos.KeyTab(null, file, false);
    }
     ...
     * @since 1.8
     */
    public static javax.security.auth.kerberos.KeyTab getInstance(KerberosPrincipal princ, File file) {
        if (princ == null) {
        ...
        return new javax.security.auth.kerberos.KeyTab(princ, file, true);
    }
    ...
    public static javax.security.auth.kerberos.KeyTab getInstance() {
        return new javax.security.auth.kerberos.KeyTab(null, null, true);
    }
    ...
    public static javax.security.auth.kerberos.KeyTab getUnboundInstance() {
        return new javax.security.auth.kerberos.KeyTab(null, null, false);
    }
     ...
     * @since 1.8
     */
    public static javax.security.auth.kerberos.KeyTab getInstance(KerberosPrincipal princ) {
        if (princ == null) {
            throw new NullPointerException("princ must be non null");
        }
        return new javax.security.auth.kerberos.KeyTab(princ, null, true);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (! (other instanceof javax.security.auth.kerberos.KeyTab)) {
            return false;
        }

        javax.security.auth.kerberos.KeyTab otherKtab = (javax.security.auth.kerberos.KeyTab) other;
