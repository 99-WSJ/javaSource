...
package java8.javax.security.auth;
...
public final class Subject implements Serializable {
     ...
     */
    public static javax.security.auth.Subject getSubject(final AccessControlContext acc) {
        ...
        return AccessController.doPrivileged
            (new PrivilegedAction<javax.security.auth.Subject>() {
     ...
     */
    public static <T> T doAs(final javax.security.auth.Subject subject,
     ...
     *                  to invoke this method.
     */
    public static <T> T doAsPrivileged(final javax.security.auth.Subject subject,
                        final PrivilegedAction<T> action,
    ...
    private static AccessControlContext createContext(final javax.security.auth.Subject subject,
                                        final AccessControlContext acc) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof javax.security.auth.Subject) {
            ...
            final javax.security.auth.Subject that = (javax.security.auth.Subject)o;
    ...
    private static class SecureSet<E>
        ...
        private static final ObjectStreamField[] serialPersistentFields = {
            new ObjectStreamField("this$0", javax.security.auth.Subject.class),
        ...
        SecureSet(javax.security.auth.Subject subject, int which) {
            this.subject = subject;
            this.which = which;
            this.elements = new LinkedList<E>();
        }

        SecureSet(javax.security.auth.Subject subject, int which, Set<? extends E> set) {
            this.subject = subject;
            this.which = which;
        ...
        public Iterator<E> iterator() {
            ...
            return new Iterator<E>() {
                ...
                public E next() {
                    if (which != javax.security.auth.Subject.PRIV_CREDENTIAL_SET) {
                        return i.next();
                    }
                ...
                public void remove() {
                    ...
                    if (sm != null) {
                        switch (which) {
                        case javax.security.auth.Subject.PRINCIPAL_SET:
                            sm.checkPermission(AuthPermissionHolder.MODIFY_PRINCIPALS_PERMISSION);
                            break;
                        case javax.security.auth.Subject.PUB_CREDENTIAL_SET:
            ...
            throws IOException, ClassNotFoundException
        {
            ...
            subject = (javax.security.auth.Subject) fields.get("this$0", null);
    ...
    private class ClassSet<T> extends AbstractSet<T> {
        ...
        private void populateSet() {
            ...
            switch(which) {
            case javax.security.auth.Subject.PRINCIPAL_SET:
                iterator = javax.security.auth.Subject.this.principals.iterator();
                break;
            case javax.security.auth.Subject.PUB_CREDENTIAL_SET:
                iterator = javax.security.auth.Subject.this.pubCredentials.iterator();
                break;
            default:
                iterator = javax.security.auth.Subject.this.privCredentials.iterator();
                break;
            }
                    ...
                    if (which != javax.security.auth.Subject.PRIV_CREDENTIAL_SET) {
                        ...
                        if (sm != null) {
                            sm.checkPermission(new PrivateCredentialPermission
                                                ...
                                                javax.security.auth.Subject.this.getPrincipals()));
                        }
                        set.add((T)next);
                    }
                }
