...
public abstract class Policy {
    ...
    static javax.security.auth.Policy getPolicyNoCheck() {
        if (policy == null) {
            ...
            synchronized(javax.security.auth.Policy.class) {
                ...
                if (policy == null) {
                    ...
                    try {
                        ...
                        javax.security.auth.Policy untrustedImpl = AccessController.doPrivileged(
                                new PrivilegedExceptionAction<javax.security.auth.Policy>() {
                                    public javax.security.auth.Policy run() throws ClassNotFoundException,
                                            InstantiationException,
                                            IllegalAccessException {
                                        Class<? extends javax.security.auth.Policy> implClass = Class.forName(
                                                finalClass, false,
                                                Thread.currentThread().getContextClassLoader()
                                        ).asSubclass(javax.security.auth.Policy.class);
    ...
    public static void setPolicy(javax.security.auth.Policy policy) {
        ...
        javax.security.auth.Policy.policy = policy;
