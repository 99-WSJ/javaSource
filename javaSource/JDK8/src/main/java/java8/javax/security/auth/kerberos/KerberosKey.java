...
public class KerberosKey implements SecretKey, Destroyable {
    ...
    */
    ...
    public boolean equals(Object other) {
        ...
        if (! (other instanceof javax.security.auth.kerberos.KerberosKey)) {
            return false;
        }

        javax.security.auth.kerberos.KerberosKey otherKey = ((javax.security.auth.kerberos.KerberosKey) other);
