...
public final class PrivateCredentialPermission extends Permission {
    ...
    public boolean implies(Permission p) {
        ...
        if (p == null || !(p instanceof javax.security.auth.PrivateCredentialPermission))
            return false;

        javax.security.auth.PrivateCredentialPermission that = (javax.security.auth.PrivateCredentialPermission)p;
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof javax.security.auth.PrivateCredentialPermission))
            return false;

        javax.security.auth.PrivateCredentialPermission that = (javax.security.auth.PrivateCredentialPermission)obj;
