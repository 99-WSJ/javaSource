...
public class SslRMIServerSocketFactory implements RMIServerSocketFactory {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof javax.rmi.ssl.SslRMIServerSocketFactory))
            return false;
        javax.rmi.ssl.SslRMIServerSocketFactory that = (javax.rmi.ssl.SslRMIServerSocketFactory) obj;
