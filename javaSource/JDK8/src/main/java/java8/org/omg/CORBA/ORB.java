...
abstract public class ORB {
    ...
    private static ORB create_impl(String className) {
        ...
        try {
            ...
            org.omg.CORBA.SystemException systemException = new org.omg.CORBA.INITIALIZE(
     ...
     */
    abstract public org.omg.CORBA.NVList create_list(int count);
     ...
     */
    abstract public org.omg.CORBA.NamedValue create_named_value(String s, org.omg.CORBA.Any any, int flags);
     ...
     */
    abstract public void send_multiple_requests_oneway(org.omg.CORBA.Request[] req);
     ...
     */
    abstract public void send_multiple_requests_deferred(org.omg.CORBA.Request[] req);
     ...
     * @exception org.omg.CORBA.WrongTransaction if the method <code>get_next_response</code>
     ...
     */
    abstract public org.omg.CORBA.Request get_next_response() throws org.omg.CORBA.WrongTransaction;
     ...
     */
    abstract public org.omg.CORBA.TypeCode get_primitive_tc(org.omg.CORBA.TCKind tcKind);
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_struct_tc(String id, String name,
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_union_tc(String id, String name,
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_enum_tc(String id, String name, String[] members);
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_alias_tc(String id, String name,
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_exception_tc(String id, String name,
                                                               org.omg.CORBA.StructMember[] members);
    ...
    abstract public org.omg.CORBA.TypeCode create_interface_tc(String id, String name);
     ...
     * @exception org.omg.CORBA.BAD_PARAM if bound is a negative value
     */

    abstract public org.omg.CORBA.TypeCode create_string_tc(int bound);
     ...
     * @exception org.omg.CORBA.BAD_PARAM if bound is a negative value
     */
    abstract public org.omg.CORBA.TypeCode create_wstring_tc(int bound);
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_sequence_tc(int bound, org.omg.CORBA.TypeCode element_type);
     ...
     * @see #create_sequence_tc(int, org.omg.CORBA.TypeCode) create_sequence_tc
     */
    @Deprecated
    abstract public org.omg.CORBA.TypeCode create_recursive_sequence_tc(int bound, int offset);
     ...
     */
    abstract public org.omg.CORBA.TypeCode create_array_tc(int length, org.omg.CORBA.TypeCode element_type);
