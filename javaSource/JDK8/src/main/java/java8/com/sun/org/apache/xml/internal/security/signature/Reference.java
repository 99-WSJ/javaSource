...
public class Reference extends SignatureElementProxy {
    ...
    private static final java.util.logging.Logger log =
        java.util.logging.Logger.getLogger(com.sun.org.apache.xml.internal.security.signature.Reference.class.getName());
    ...
    /**
     * Build a {@link com.sun.org.apache.xml.internal.security.signature.Reference} from an {@link Element}
     *
    ...
    public boolean typeIsReferenceToObject() {
        if (com.sun.org.apache.xml.internal.security.signature.Reference.OBJECT_URI.equals(this.getType())) {
            return true;
        }
    ...
    public boolean typeIsReferenceToManifest() {
        if (com.sun.org.apache.xml.internal.security.signature.Reference.MANIFEST_URI.equals(this.getType())) {
            return true;
        }
    ...
    private byte[] calculateDigest(boolean validating)
        ...
        try {
            ...
            if (com.sun.org.apache.xml.internal.security.signature.Reference.useC14N11 && !validating && !output.isOutputStreamSet()
