...
import java8.com.sun.corba.se.impl.io.ValueHandlerImpl;
    ...
    extends InputStreamHook
{
    ...
    private java8.com.sun.corba.se.impl.io.ObjectStreamClass currentClassDesc = null;
    ...
    java8.com.sun.corba.se.impl.io.ObjectStreamClass[] classdesc;
    Class[] classes;
    int spClass;
                                         ...
                                         /* throws OptionalDataException, ClassNotFoundException, IOException */
    {
        ...
        java8.com.sun.corba.se.impl.io.ObjectStreamClass prevClassDesc = currentClassDesc;
    ...
    /* throws IOException, ClassNotFoundException, NotActiveException */
    {
        try {
            ...
            if (defaultReadObjectFVDMembers != null &&
                ...
                java8.com.sun.corba.se.impl.io.ObjectStreamField[] fields =
...
// d11623 : implement readFully, required for serializing some core classes
    ...
    protected final Class resolveClass(java8.com.sun.corba.se.impl.io.ObjectStreamClass v)
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        currentClassDesc = java8.com.sun.corba.se.impl.io.ObjectStreamClass.lookup(clz);
        ...
        try {
            ...
            java8.com.sun.corba.se.impl.io.ObjectStreamClass currdesc = currentClassDesc;
            ...
            for (currdesc = currentClassDesc, currclass = currentClass;
                ...
                if (spClass >= classes.length) {
                    ...
                    java8.com.sun.corba.se.impl.io.ObjectStreamClass[] newclassdesc = new java8.com.sun.corba.se.impl.io.ObjectStreamClass[newlen];
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        try{
            ...
            java8.com.sun.corba.se.impl.io.ObjectStreamClass currdesc = currentClassDesc = java8.com.sun.corba.se.impl.io.ObjectStreamClass.lookup(clz);
            ...
            if (currentClassDesc.isExternalizable()) {
                ...
                while((fvdsList.hasMoreElements()) && (spClass > spBase)) {
                    ...
                    currdesc = currentClassDesc = java8.com.sun.corba.se.impl.io.ObjectStreamClass.lookup(currentClass);
     ...
     * removed.
     */
    private boolean invokeObjectReader(java8.com.sun.corba.se.impl.io.ObjectStreamClass osc, Object obj, Class aclass)
    ...
    private void resetStream() throws IOException {
        ...
        if (classdesc == null)
            classdesc = new java8.com.sun.corba.se.impl.io.ObjectStreamClass[20];
        else {
     ...
     * to set final fields.
     */
    private void inputPrimitiveField(Object o, Class cl, java8.com.sun.corba.se.impl.io.ObjectStreamField field)
     ...
     */
    private Object inputObjectField(java8.com.sun.corba.se.impl.io.ObjectStreamField field)
        throws InvalidClassException, StreamCorruptedException,
    ...
    private final void inputCurrentClassFieldsForReadFields(Map fieldToValueMap)
        ...
        java8.com.sun.corba.se.impl.io.ObjectStreamField[] fields = currentClassDesc.getFieldsNoCopy();
     ...
     */
    private void inputClassFields(Object o, Class cl,
                                  java8.com.sun.corba.se.impl.io.ObjectStreamClass osc,
                                  ValueMember[] fields,
                                  CodeBase sender)
        throws InvalidClassException, StreamCorruptedException,
               ClassNotFoundException, IOException
