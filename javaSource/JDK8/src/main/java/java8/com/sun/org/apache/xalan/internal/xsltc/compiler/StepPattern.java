...
class StepPattern extends com.sun.org.apache.xalan.internal.xsltc.compiler.RelativePathPattern {
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.StepPattern setPredicates(Vector predicates) {
        _predicates = predicates;
        return(this);
    }
    ...
    public Type typeCheck(SymbolTable stable) throws TypeCheckError {
        if (hasPredicates()) {
            ...
            if (_contextCase == SIMPLE_CONTEXT) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate pred = (com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate)_predicates.elementAt(0);
                if (pred.isNthPositionFilter()) {
                ...
                for (int i = 0; i < len; i++) {
                    ((com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate)_predicates.elementAt(i)).dontOptimize();
                }
