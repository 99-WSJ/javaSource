    ...
    */
            ...
            if (thread == null) {
                thread = new Thread() {
                    ...
                    public void run() {
                        while (true) {
                            Runnable r;
                            synchronized (com.sun.jmx.remote.internal.ClientNotifForwarder.LinearExecutor.this) {
                                if (com.sun.jmx.remote.internal.ClientNotifForwarder.LinearExecutor.this.command == null) {
                                    thread = null;
                                    return;
                                } else {
                                    r = com.sun.jmx.remote.internal.ClientNotifForwarder.LinearExecutor.this.command;
                                    com.sun.jmx.remote.internal.ClientNotifForwarder.LinearExecutor.this.command = null;
                                }
                            }
                            r.run();
                        }
    ...
    private class NotifFetcher implements Runnable {
        ...
        private final ClassLoader setContextClassLoader(final ClassLoader loader) {
            final AccessControlContext ctxt = com.sun.jmx.remote.internal.ClientNotifForwarder.this.acc;
        ...
        private void doRun() {
            synchronized (com.sun.jmx.remote.internal.ClientNotifForwarder.this) {
        ...
        private NotificationResult fetchNotifs() {
            try {
                NotificationResult nr = com.sun.jmx.remote.internal.ClientNotifForwarder.this.
        ...
        */
        private NotificationResult fetchOneNotif() {
            com.sun.jmx.remote.internal.ClientNotifForwarder cnf = com.sun.jmx.remote.internal.ClientNotifForwarder.this;
