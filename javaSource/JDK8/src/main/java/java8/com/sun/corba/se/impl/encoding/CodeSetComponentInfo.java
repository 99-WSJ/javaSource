...
public final class CodeSetComponentInfo {
    ...
    public boolean equals( Object obj )
    {
        ...
        if (!(obj instanceof com.sun.corba.se.impl.encoding.CodeSetComponentInfo))
            return false ;

        com.sun.corba.se.impl.encoding.CodeSetComponentInfo other = (com.sun.corba.se.impl.encoding.CodeSetComponentInfo)obj ;
    ...
    public CodeSetComponentInfo() {
        forCharData = com.sun.corba.se.impl.encoding.CodeSetComponentInfo.JAVASOFT_DEFAULT_CODESETS.forCharData;
        forWCharData = com.sun.corba.se.impl.encoding.CodeSetComponentInfo.JAVASOFT_DEFAULT_CODESETS.forWCharData;
    }
     ...
     *
     */
    public static final com.sun.corba.se.impl.encoding.CodeSetComponentInfo JAVASOFT_DEFAULT_CODESETS;
    static {
        ...
        JAVASOFT_DEFAULT_CODESETS = new com.sun.corba.se.impl.encoding.CodeSetComponentInfo(charData, wcharData);
    }
