...
final class PerInterface<M> {
    PerInterface(Class<?> mbeanInterface, MBeanIntrospector<M> introspector,
                 com.sun.jmx.mbeanserver.MBeanAnalyzer<M> analyzer, MBeanInfo mbeanInfo) {
     ...
     */
    private class InitMaps implements com.sun.jmx.mbeanserver.MBeanAnalyzer.MBeanVisitor<M> {
