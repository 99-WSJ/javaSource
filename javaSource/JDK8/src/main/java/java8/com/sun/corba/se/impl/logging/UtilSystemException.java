...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/Util.mc on Tue Mar 04 03:47:28 PST 2014
...
public class UtilSystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.UtilSystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.UtilSystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.UtilSystemException wrapper =
            (com.sun.corba.se.impl.logging.UtilSystemException) orb.getLogWrapper( logDomain,
                "UTIL", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.UtilSystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.UtilSystemException wrapper =
            (com.sun.corba.se.impl.logging.UtilSystemException) ORB.staticGetLogWrapper( logDomain,
                "UTIL", factory ) ;
        return wrapper ;
    } 
    ...
    public BAD_OPERATION stubFactoryCouldNotMakeStub( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            ...
            doLog( Level.FINE, "UTIL.stubFactoryCouldNotMakeStub",
                parameters, com.sun.corba.se.impl.logging.UtilSystemException.class, exc ) ;
        }
