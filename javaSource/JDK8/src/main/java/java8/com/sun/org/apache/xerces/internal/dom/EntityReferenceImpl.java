...
import java8.com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl;
import java8.com.sun.org.apache.xerces.internal.dom.EntityImpl;
...
implements EntityReference {
    ...
    public Node cloneNode(boolean deep) {
        com.sun.org.apache.xerces.internal.dom.EntityReferenceImpl er = (com.sun.org.apache.xerces.internal.dom.EntityReferenceImpl)super.cloneNode(deep);
    ...
    protected String getEntityRefValue (){
        ...
        if (firstChild != null){
          if (firstChild.getNodeType() == Node.ENTITY_REFERENCE_NODE){
              value = ((com.sun.org.apache.xerces.internal.dom.EntityReferenceImpl)firstChild).getEntityRefValue();
          }
          ...
          if (firstChild.nextSibling == null){
            ...
            while (next != null){
                ...
                if (next.getNodeType() == Node.ENTITY_REFERENCE_NODE){
                   value = ((com.sun.org.apache.xerces.internal.dom.EntityReferenceImpl)next).getEntityRefValue();
                }
