...
import java8.sun.corba.se.impl.protocol.giopmsgheaders.*;
...
public abstract class MessageBase implements Message{
    ...
    public static com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase readGIOPMessage(ORB orb, CorbaConnection connection)
    {
        com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase msg = readGIOPHeader(orb, connection);
        msg = (com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase)readGIOPBody(orb, connection, (Message)msg);
        return msg;
    }

    public static com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase readGIOPHeader(ORB orb, CorbaConnection connection)
    {
        com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase msg = null;
        ...
        */
        ...
        if (orb.giopDebugFlag) {
            ...
            ((com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase)msg).giopHeader = msgBuf;
        }
                                       ...
                                       Message msg)
    {
        ...
        buf.position(com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase.GIOPMessageHeaderLength);
        int msgSizeMinusHeader =
            msg.getSize() - com.sun.corba.se.impl.protocol.giopmsgheaders.MessageBase.GIOPMessageHeaderLength;
        try {
