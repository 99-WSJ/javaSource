...
public class ArrayNotificationBuffer implements NotificationBuffer {
    ...
    private static final
        HashMap<MBeanServer, com.sun.jmx.remote.internal.ArrayNotificationBuffer> mbsToBuffer =
        new HashMap<MBeanServer, com.sun.jmx.remote.internal.ArrayNotificationBuffer>(1);
    ...
    public static NotificationBuffer getNotificationBuffer(
        ...
        com.sun.jmx.remote.internal.ArrayNotificationBuffer buf;
        boolean create;
        ...
        synchronized (globalLock) {
            ...
            create = (buf == null);
            if (create) {
                buf = new com.sun.jmx.remote.internal.ArrayNotificationBuffer(mbs, queueSize);
    ...
    private class ShareBuffer implements NotificationBuffer {
        ...
        public NotificationResult
            ...
            NotificationBuffer buf = com.sun.jmx.remote.internal.ArrayNotificationBuffer.this;
            return buf.fetchNotifications(filter, startSequenceNumber,
                                          timeout, maxNotifications);
        }

        public void dispose() {
            com.sun.jmx.remote.internal.ArrayNotificationBuffer.this.removeSharer(this);
        }
