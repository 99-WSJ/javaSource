               ...
               org.omg.CORBA.DataOutputStream, org.omg.CORBA.portable.ValueOutputStream
{
    ...
    private static class OutputStreamFactory {
        ...
        public static com.sun.corba.se.impl.encoding.CDROutputStreamBase newOutputStream(
            ...
            case GIOPVersion.VERSION_1_2:
                if (encodingVersion != Message.CDR_ENC_VERSION) {
                    return
                        new com.sun.corba.se.impl.encoding.IDLJavaSerializationOutputStream(encodingVersion);
                }
