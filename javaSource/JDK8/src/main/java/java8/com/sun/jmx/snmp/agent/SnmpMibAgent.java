...
public abstract class SnmpMibAgent
    ...
    public static SnmpMibRequest newMibRequest(SnmpPdu reqPdu,
                                               ...
                                               Object userData)
    {
        return new com.sun.jmx.snmp.agent.SnmpMibRequestImpl(null,
                                      reqPdu,
                                      vblist,
                                      version,
                                      userData,
    ...
    public static SnmpMibRequest newMibRequest(SnmpEngine engine,
        ...
        return new com.sun.jmx.snmp.agent.SnmpMibRequestImpl(engine,
                                      reqPdu,
                                      vblist,
                                      version,
                                      userData,
    ...
    void getBulkWithGetNext(SnmpMibRequest req, int nonRepeat, int maxRepeat)
        ...
        if (L != 0) {
            ...
            com.sun.jmx.snmp.agent.SnmpMibRequestImpl repeatedReq =
                new com.sun.jmx.snmp.agent.SnmpMibRequestImpl(req.getEngine(),
                                       req.getPdu(),
                                       repeaters,
