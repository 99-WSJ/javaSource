...
package java8.com.sun.corba.se.impl.activation;
    ...
    implements Serializable
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            com.sun.corba.se.impl.activation.RepositoryImpl repository = new com.sun.corba.se.impl.activation.RepositoryImpl(orb, new File(db),
                                                           debug);
