...
public class MotifLabelUI extends BasicLabelUI
{
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.motif.MotifLabelUI motifLabelUI =
                (com.sun.java.swing.plaf.motif.MotifLabelUI) appContext.get(MOTIF_LABEL_UI_KEY);
        if (motifLabelUI == null) {
            motifLabelUI = new com.sun.java.swing.plaf.motif.MotifLabelUI();
