...
class LCount
{
    ...
    {
        com.sun.org.apache.xerces.internal.dom.LCount lc=(com.sun.org.apache.xerces.internal.dom.LCount)lCounts.get(evtName);
        if(lc==null)
            lCounts.put(evtName,(lc=new com.sun.org.apache.xerces.internal.dom.LCount()));
        return lc;
    }
} // class LCount
