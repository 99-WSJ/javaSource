 ...
 * under the License.
 */
package java8.sun.org.apache.xml.internal.security.c14n.helper;
...
public class C14nHelper {
     ...
     * @param ctxNode
     * @throws CanonicalizationException
     * @see com.sun.org.apache.xml.internal.security.c14n.helper.C14nHelper#assertNotRelativeNS(Attr)
     */
    public static void checkForRelativeNamespace(Element ctxNode)
        ...
        if (ctxNode != null) {
            ...
            for (int i = 0; i < attributes.getLength(); i++) {
                com.sun.org.apache.xml.internal.security.c14n.helper.C14nHelper.assertNotRelativeNS((Attr) attributes.item(i));
            }
        } else {
