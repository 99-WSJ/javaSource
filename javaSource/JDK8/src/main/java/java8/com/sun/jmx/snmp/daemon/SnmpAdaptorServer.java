...
public class SnmpAdaptorServer extends CommunicatorServer
    ...
    private transient com.sun.jmx.snmp.daemon.SnmpSession informSession   = null;
        ...
        if (s != null) {
            try {
                ...
                SNMP_ADAPTOR_LOGGER.logp(Level.FINER,
                        com.sun.jmx.snmp.daemon.SnmpAdaptorServer.class.getName(),
                        "<static init>",
    ...
    private void createSnmpRequestHandler(com.sun.jmx.snmp.daemon.SnmpAdaptorServer server,
                                          int id,
                                          DatagramSocket s,
                                          DatagramPacket p,
                                          com.sun.jmx.snmp.daemon.SnmpMibTree tree,
                                          ...
                                          MBeanServer f,
                                          ObjectName n) {
        final com.sun.jmx.snmp.daemon.SnmpRequestHandler handler =
            new com.sun.jmx.snmp.daemon.SnmpRequestHandler(this, id, s, p, tree, m, a, factory,
                                   dataFactory, f, n);
    ...
    public static int mapErrorStatus(int errorStatus,
                                     int protocolVersion,
                                     int reqPduType) {
        return com.sun.jmx.snmp.daemon.SnmpSubRequestHandler.mapErrorStatus(errorStatus,
                                                    protocolVersion,
                                                    reqPduType);
    }
    ...
    synchronized void openInformSocketIfNeeded() throws SocketException {
        if (informSession == null) {
            informSession = new com.sun.jmx.snmp.daemon.SnmpSession(this) ;
            if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
                SNMP_ADAPTOR_LOGGER.logp(Level.FINER, dbgTag,
                   "openInformSocketIfNeeded",
    ...
    private void init(InetAddressAcl acl, int p, InetAddress a) {
        ...
        root= new com.sun.jmx.snmp.daemon.SnmpMibTree();
