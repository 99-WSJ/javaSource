...
public class ServerTool
{
    ...
    {
        com.sun.corba.se.impl.activation.ServerTool tool = new com.sun.corba.se.impl.activation.ServerTool();
        tool.run(args);
    }
    ...
    static {
        handlers = new Vector();
        handlers.addElement(new com.sun.corba.se.impl.activation.RegisterServer());
        handlers.addElement(new com.sun.corba.se.impl.activation.UnRegisterServer());
        handlers.addElement(new com.sun.corba.se.impl.activation.GetServerID());
        handlers.addElement(new com.sun.corba.se.impl.activation.ListServers());
        handlers.addElement(new com.sun.corba.se.impl.activation.ListAliases());
        handlers.addElement(new com.sun.corba.se.impl.activation.ListActiveServers());
        handlers.addElement(new com.sun.corba.se.impl.activation.LocateServer());
        handlers.addElement(new com.sun.corba.se.impl.activation.LocateServerForORB());
        handlers.addElement(new com.sun.corba.se.impl.activation.ListORBs());
        handlers.addElement(new com.sun.corba.se.impl.activation.ShutdownServer());
        handlers.addElement(new com.sun.corba.se.impl.activation.StartServer());
        handlers.addElement(new com.sun.corba.se.impl.activation.Help());
        handlers.addElement(new com.sun.corba.se.impl.activation.Quit());
        ...
        try {
            if (cmdArgs.length == 2) {
                if (cmdArgs[0].equals("-serverid"))
                    ...
                    serverId = com.sun.corba.se.impl.activation.ServerTool.getServerIdForAlias( orb, cmdArgs[1] ) ;
            }
        ...
        try {
            ...
            while (i < cmdArgs.length) {
                ...
                if (arg.equals("-serverid")) {
                    ...
                    if (i < cmdArgs.length)
                        serverId = com.sun.corba.se.impl.activation.ServerTool.getServerIdForAlias( orb, cmdArgs[i++] ) ;
                    else
                        return parseError;
...
class ListActiveServers implements CommandHandler
{
    ...
    public boolean processCommand(String[] cmdArgs, ORB orb, PrintStream out)
    {
        ...
        try {
            ...
            com.sun.corba.se.impl.activation.ListServers.sortServers(servers);
            for (int i=0; i < servers.length; i++) {
                try {
                    serverDef = repository.getServer(servers[i]);
                    out.println("\t   " + servers[i] + "\t\t" +
