...
public class SnmpParameters extends SnmpParams implements Cloneable, Serializable {
    ...
    public synchronized boolean equals(Object obj) {
        if (!( obj instanceof com.sun.jmx.snmp.SnmpParameters))
            return false;

        if (this == obj)
            return true ;
        com.sun.jmx.snmp.SnmpParameters param = (com.sun.jmx.snmp.SnmpParameters) obj ;
    ...
    public synchronized Object clone() {
        com.sun.jmx.snmp.SnmpParameters par = null ;
        try {
            par = (com.sun.jmx.snmp.SnmpParameters) super.clone() ;
