...
public abstract class SyntaxTreeNode implements Constants {
    ...
    protected com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode _parent;          // Parent node
    ...
    protected com.sun.org.apache.xalan.internal.xsltc.compiler.QName _qname;                    // The element QName
    ...
    protected static final com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode Dummy = new AbsolutePathPattern(null);
    ...
    public final int getLineNumber() {
        ...
        com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode parent = getParent();
     ...
     */
    protected void setQName(com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname) {
        _qname = qname;
    }
    ...
    protected void setQName(String uri, String prefix, String localname) {
        _qname = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(uri, prefix, localname);
    }
     ...
     */
    protected void setParent(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode parent) {
    ...
    public Stylesheet getStylesheet() {
        if (_stylesheet == null) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode parent = this;
            while (parent != null) {
    ...
    protected final void parseChildren(Parser parser) {
        ...
        for (int i=0; i<count; i++) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode child = (com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode)_contents.elementAt(i);
            parser.getSymbolTable().setCurrentNode(child);
            child.parseContents(parser);
            // if variable or parameter, add it to scope
            final com.sun.org.apache.xalan.internal.xsltc.compiler.QName varOrParamName = updateScope(parser, child);
        ...
        if (locals != null) {
            ...
            for (int i = 0; i < nLocals; i++) {
                parser.removeVariable((com.sun.org.apache.xalan.internal.xsltc.compiler.QName)locals.elementAt(i));
            }
        }
    }
     ...
     */
    protected com.sun.org.apache.xalan.internal.xsltc.compiler.QName updateScope(Parser parser, com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode node) {
        if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Variable) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Variable var = (com.sun.org.apache.xalan.internal.xsltc.compiler.Variable)node;
    ...
    protected Type typeCheckContents(SymbolTable stable) throws TypeCheckError {
        ...
        for (int i = 0; i < n; i++) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode item = (com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode)_contents.elementAt(i);
    ...
    protected void translateContents(ClassGenerator classGen,
        ...
        for (int i = 0; i < n; i++) {
            ...
            final com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode item = (com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode)_contents.elementAt(i);
     ...
     */
    private boolean isSimpleRTF(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode node) {

        Vector contents = node.getContents();
        for (int i = 0; i < contents.size(); i++) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode item = (com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode)contents.elementAt(i);
     ...
     */
    private boolean isAdaptiveRTF(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode node) {
     ...
     */
    private boolean isTextElement(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode node, boolean doExtendedCheck) {
        if (node instanceof ValueOf || node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Number
            || node instanceof Text)
        {
            ...
            for (int i = 0; i < contents.size(); i++) {
                ...
                if (item instanceof Text ||
                     ((item instanceof When || item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Otherwise)
     ...
     */
    protected final void addElement(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode element) {
     ...
     * @param element is the new child node.
     */
    protected final void setFirstElement(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode element) {
     ...
     */
    protected final void removeElement(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode element) {
    ...
    protected final com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode lastChild() {
        ...
        return (com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode)_contents.lastElement();
    }
     ...
     */
    protected void reportError(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode element, Parser parser,
     ...
     * @param message Any additional error message.
     */
    protected  void reportWarning(com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode element, Parser parser,
                                  String errorCode, String message) {
        final ErrorMsg error = new ErrorMsg(errorCode, message, element);
