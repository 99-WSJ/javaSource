...
final class CastExpr extends Expression {
    ...
    public CastExpr(Expression left, Type type) throws TypeCheckError {
        ...
        if ((_left instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) && (_type == Type.Boolean)) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.Step step = (com.sun.org.apache.xalan.internal.xsltc.compiler.Step)_left;
    ...
    public void translateDesynthesized(ClassGenerator classGen,
        ...
        if (_typeTest) {
            ...
            final int idx = cpg.addInterfaceMethodref(DOM_INTF,
                                                      "getExpandedTypeID",
                                                      "(I)I");
            il.append(new SIPUSH((short)((com.sun.org.apache.xalan.internal.xsltc.compiler.Step)_left).getNodeType()));
