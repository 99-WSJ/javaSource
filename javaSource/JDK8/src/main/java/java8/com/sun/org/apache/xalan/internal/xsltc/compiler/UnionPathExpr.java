...
final class UnionPathExpr extends Expression {
    ...
    private void flatten(Vector components) {
        ...
        if (_rest != null) {
            if (_rest instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.UnionPathExpr) {
                ((com.sun.org.apache.xalan.internal.xsltc.compiler.UnionPathExpr)_rest).flatten(components);
            }
            else {
