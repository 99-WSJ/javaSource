...
public class MotifToggleButtonUI extends BasicToggleButtonUI
{
    ...
    public static ComponentUI createUI(JComponent b) {
        ...
        com.sun.java.swing.plaf.motif.MotifToggleButtonUI motifToggleButtonUI =
                (com.sun.java.swing.plaf.motif.MotifToggleButtonUI) appContext.get(MOTIF_TOGGLE_BUTTON_UI_KEY);
        if (motifToggleButtonUI == null) {
            motifToggleButtonUI = new com.sun.java.swing.plaf.motif.MotifToggleButtonUI();
