...
import java8.sun.corba.se.spi.ior.MakeImmutable;
import java8.sun.corba.se.spi.ior.ObjectId;
import java8.sun.corba.se.spi.ior.ObjectKey;
import java8.sun.corba.se.spi.ior.TaggedProfileTemplate;
...
public interface TaggedProfile extends Identifiable, MakeImmutable
{
     ...
     */
    boolean isEquivalent( com.sun.corba.se.spi.ior.TaggedProfile prof ) ;
