...
import com.sun.org.apache.xml.internal.serializer.ExtendedContentHandler;
...
abstract public class ToStream extends SerializerBase
{
    ...
    protected final void flushWriter() throws SAXException
    {
        ...
        if (null != writer)
        {
            try
            {
                if (writer instanceof com.sun.org.apache.xml.internal.serializer.WriterToUTF8Buffered)
                {
                    if (m_shouldFlush)
                         ((com.sun.org.apache.xml.internal.serializer.WriterToUTF8Buffered) writer).flush();
                    else
                         ((com.sun.org.apache.xml.internal.serializer.WriterToUTF8Buffered) writer).flushBuffer();
                }
                if (writer instanceof com.sun.org.apache.xml.internal.serializer.WriterToASCI)
                {
                    if (m_shouldFlush)
                        writer.flush();
                }
    ...
    public OutputStream getOutputStream()
    {
        ...
        if (m_writer instanceof com.sun.org.apache.xml.internal.serializer.WriterToUTF8Buffered)
            return ((com.sun.org.apache.xml.internal.serializer.WriterToUTF8Buffered) m_writer).getOutputStream();
        if (m_writer instanceof com.sun.org.apache.xml.internal.serializer.WriterToASCI)
            return ((com.sun.org.apache.xml.internal.serializer.WriterToASCI) m_writer).getOutputStream();
        else
            return null;
    }
        ...
        boolean shouldFlush)
    {
        ...
        if (null != entitiesFileName)
        {
            ...
            m_charInfo = com.sun.org.apache.xml.internal.serializer.CharInfo.getCharInfo(entitiesFileName, method);
        }
        ...
        throws UnsupportedEncodingException
    {
        ...
        if (encoding.equalsIgnoreCase("UTF-8"))
        {
            ...
            //            }
                ...
                init(
                    new com.sun.org.apache.xml.internal.serializer.WriterToUTF8Buffered(output),
                    format,
                    defaultProperties,
                    true);
        ...
        {
            init(new com.sun.org.apache.xml.internal.serializer.WriterToASCI(output), format, defaultProperties, true);
        }
        else
        {
            Writer osw;
        ...
        throws IOException
    {
        ...
        if (!escLF && com.sun.org.apache.xml.internal.serializer.CharInfo.S_LINEFEED == ch)
        {
            writer.write(m_lineSep, 0, m_lineSepLen);
        }
        else
        ...
        throws IOException, SAXException
    {
        ...
        for (int i = start; i < end; i++)
        {
            ...
            if (com.sun.org.apache.xml.internal.serializer.CharInfo.S_LINEFEED == c && useSystemLineSeparator)
            {
                writer.write(m_lineSep, 0, m_lineSepLen);
            }
...
//            final boolean[] isAsciiClean = m_charInfo.getASCIIClean();
        ...
        boolean fromTextNode) throws IOException
    {
        ...
        if (com.sun.org.apache.xml.internal.serializer.CharInfo.S_LINEFEED == ch && fromTextNode)
        {
            m_writer.write(m_lineSep, 0, m_lineSepLen);
        }
        else
        ...
        if (m_tracer != null)
        {
            try
            {
                ...
                if (nAttrs > 0)
                {
                    ...
                    // StringBuffer
                    Writer writer =
                        new com.sun.org.apache.xml.internal.serializer.ToStream.WritertoStringBuffer(sb);
