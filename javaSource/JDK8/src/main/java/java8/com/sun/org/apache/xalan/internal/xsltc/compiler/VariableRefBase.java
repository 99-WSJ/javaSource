...
class VariableRefBase extends Expression {
    ...
    public void addParentDependency() {
        ...
        if (parent != null) {
            ...
            if (_variable._ignore) {
                if (_variable instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Variable) {
                    var = parent.getSymbolTable()
                                .lookupVariable(_variable._name);
                } else if (_variable instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Param) {
    ...
    public boolean equals(Object obj) {
        return obj == this || (obj instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase)
            && (_variable == ((com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase) obj)._variable);
    }
