...
package java8.com.sun.imageio.plugins.gif;

import com.sun.imageio.plugins.common.LZWCompressor;
import com.sun.imageio.plugins.common.PaletteBuilder;
import com.sun.imageio.plugins.gif.GIFImageWriterSpi;
import java8.sun.imageio.plugins.gif.GIFMetadata;
import java8.sun.imageio.plugins.gif.GIFWritableImageMetadata;
...
public class GIFImageWriter extends ImageWriter {
    ...
    com.sun.imageio.plugins.gif.GIFWritableStreamMetadata.NATIVE_FORMAT_NAME;
     ...
     */
    private com.sun.imageio.plugins.gif.GIFWritableStreamMetadata theStreamMetadata = null;
    ...
    public IIOMetadata getDefaultStreamMetadata(ImageWriteParam param) {
        com.sun.imageio.plugins.gif.GIFWritableStreamMetadata streamMetadata =
    ...
    public ImageWriteParam getDefaultWriteParam() {
        return new com.sun.imageio.plugins.gif.GIFImageWriteParam(getLocale());
    }
      ...
      throws IOException {
        ...
        if (streamMetadata == null) {
            this.theStreamMetadata =
                (com.sun.imageio.plugins.gif.GIFWritableStreamMetadata)getDefaultStreamMetadata(null);
        } else {
            this.theStreamMetadata = new com.sun.imageio.plugins.gif.GIFWritableStreamMetadata();
    ...
    public void write(IIOMetadata sm,
        ...
        if (sm == null) {
            streamMetadata =
                (com.sun.imageio.plugins.gif.GIFWritableStreamMetadata)getDefaultStreamMetadata(p);
        } else {
            streamMetadata =
                (com.sun.imageio.plugins.gif.GIFWritableStreamMetadata)convertStreamMetadata(sm, p);
        }
    ...
    private void write(boolean writeHeader,
        ...
        if (writeHeader) {
            ...
            com.sun.imageio.plugins.gif.GIFWritableStreamMetadata streamMetadata =
                (com.sun.imageio.plugins.gif.GIFWritableStreamMetadata)sm;
    ...
    private void writeHeader(IIOMetadata streamMetadata, int bitsPerPixel)
      throws IOException {
        ...
        com.sun.imageio.plugins.gif.GIFWritableStreamMetadata sm;
        if (streamMetadata instanceof com.sun.imageio.plugins.gif.GIFWritableStreamMetadata) {
            sm = (com.sun.imageio.plugins.gif.GIFWritableStreamMetadata)streamMetadata;
        } else {
            sm = new com.sun.imageio.plugins.gif.GIFWritableStreamMetadata();
            Node root =
