...
public final class FactoryEnumeration {
    ...
    private List<com.sun.naming.internal.NamedWeakReference<Object>> factories;
    private int posn = 0;
     ...
     */
    FactoryEnumeration(List<com.sun.naming.internal.NamedWeakReference<Object>> factories,
                       ClassLoader loader) {
    ...
    public Object next() throws NamingException {
        synchronized (factories) {
            ...
            com.sun.naming.internal.NamedWeakReference<Object> ref = factories.get(posn++);
            ...
            try {
                ...
                ref = new com.sun.naming.internal.NamedWeakReference<>(answer, className);
