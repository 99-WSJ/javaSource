...
package java8.com.sun.org.apache.regexp.internal;

import java8.sun.org.apache.regexp.internal.*;
...
public class RETest
{
    ...
    {
        com.sun.org.apache.regexp.internal.RETest test = new com.sun.org.apache.regexp.internal.RETest();
    ...
    void runAutomatedTests(String testDocument) throws Exception
    {
        ...
        try
        {
            ...
            while (br.ready())
            {
                com.sun.org.apache.regexp.internal.RETestCase testcase = getNextTestCase(br);
                if (testcase != null) {
                    testcase.runTest();
                }
            }
     ...
     * @exception IOException if some io problems occured
     */
    private com.sun.org.apache.regexp.internal.RETestCase getNextTestCase(BufferedReader br) throws IOException
    {
        ...
        return new com.sun.org.apache.regexp.internal.RETestCase(this, tag, expr, matchAgainst, badPattern,
...
final class RETestCase
{
    ...
    final private com.sun.org.apache.regexp.internal.RETest test;
    private RE regexp;

    public RETestCase(com.sun.org.apache.regexp.internal.RETest test, String tag, String pattern,
    ...
    private boolean checkParens()
    {
        ...
        if (com.sun.org.apache.regexp.internal.RETest.showSuccesses)
        {
    ...
    void success(String s)
    {
        if (com.sun.org.apache.regexp.internal.RETest.showSuccesses)
        {
            test.say("" + com.sun.org.apache.regexp.internal.RETest.NEW_LINE + "-----------------------" + com.sun.org.apache.regexp.internal.RETest.NEW_LINE + "");
