...
import java8.com.sun.corba.se.impl.dynamicany.DynFixedImpl;
import java8.com.sun.corba.se.impl.dynamicany.DynValueBoxImpl;
...
public class DynAnyUtil
{
    ...
    {
        if (any == null || ! com.sun.corba.se.impl.dynamicany.DynAnyUtil.isConsistentType(any.type()))
    ...
    static DynAny createMostDerivedDynAny(TypeCode typeCode, ORB orb)
        throws InconsistentTypeCode
    {
        if (typeCode == null || ! com.sun.corba.se.impl.dynamicany.DynAnyUtil.isConsistentType(typeCode))
            throw new InconsistentTypeCode();
