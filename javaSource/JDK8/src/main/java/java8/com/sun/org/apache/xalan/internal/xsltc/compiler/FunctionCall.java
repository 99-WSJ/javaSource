...
class FunctionCall extends com.sun.org.apache.xalan.internal.xsltc.compiler.Expression {
     ...
     */
    com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _thisArgument = null;
    ...
    public FunctionCall(com.sun.org.apache.xalan.internal.xsltc.compiler.QName fname, Vector arguments) {
        _fname = fname;
        _arguments = arguments;
        _type = null;
    }

    public FunctionCall(com.sun.org.apache.xalan.internal.xsltc.compiler.QName fname) {
    ...
    public void setParser(Parser parser) {
        ...
        if (_arguments != null) {
            ...
            for (int i = 0; i < n; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)_arguments.elementAt(i);
     ...
     */
    @Override
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable)
        throws TypeCheckError
    {
        ...
        if (isExtension()) {
            _fname = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(null, null, local);
        ...
        // Handle extension functions (they all have a namespace)
            ...
            try {
                ...
                if (pos > 0) {
                    ...
                    _fname = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(namespace, null, local.substring(pos + 1));
                }
                else {
                    if (_className != null && _className.length() > 0) {
                        try {
                    ...
                    if (extFunction != null) {
                        _fname = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(null, null, extFunction);
                        return typeCheckStandard(stable);
                    }
                    else
                        _fname = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(namespace, null, local);
                }
     ...
     */
    public Type typeCheckStandard(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        if (ptype != null) {
            for (int i = 0; i < n; i++) {
                ...
                if (!argType.identicalTo(exp.getType())) {
                    try {
                        _arguments.setElementAt(new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(exp, argType), i);
                    }
                    catch (TypeCheckError e) {
    ...
    public Type typeCheckConstructor(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError{
     ...
     */
    public Type typeCheckExternal(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        // check if we are calling an instance method
            ...
            if (!_isStatic) {
                ...
                com.sun.org.apache.xalan.internal.xsltc.compiler.Expression firstArg = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)_arguments.elementAt(0);
                ...
                if (hasThisArgument) {
                    _thisArgument = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression) _arguments.elementAt(0);
     ...
     */
    public Vector typeCheckArgs(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        final Vector result = new Vector();
        final Enumeration e = _arguments.elements();
        while (e.hasMoreElements()) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)e.nextElement();
            result.addElement(exp.typeCheck(stable));
        }
        return result;
    }

    protected final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression argument(int i) {
        return (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)_arguments.elementAt(i);
    }
    ...
    protected final void setArgument(int i, com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp) {
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (isStandard() || isExtension()) {
            for (int i = 0; i < n; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = argument(i);
        ...
        // run-time error message for unsupported external functions
            ...
            for (int i = 0; i < n; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression arg = argument(i);
                paramTemp[i].setEnd(
