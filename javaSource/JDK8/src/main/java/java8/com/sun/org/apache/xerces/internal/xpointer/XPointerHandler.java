 ...
 */
package java8.sun.org.apache.xerces.internal.xpointer;
...
public final class XPointerHandler extends XIncludeHandler implements
   ...
   // Has the XPointer resolved the subresource
    ...
    public void parseXPointer(String xpointer) throws XNIException {
        ...
        while (tokens.hasMore()) {
            ...
            case Tokens.XPTRTOKEN_SHORTHAND: {
                ...
                XPointerPart shortHandPointer = new com.sun.org.apache.xerces.internal.xpointer.ShortHandPointer(
                        fSymbolTable);
            ...
            case Tokens.XPTRTOKEN_SCHEMENAME: {
                ...
                if (schemeName.equals(ELEMENT_SCHEME_NAME)) {
                    XPointerPart elementSchemePointer = new com.sun.org.apache.xerces.internal.xpointer.ElementSchemePointer(
    ...
    private void reportError(String key, Object[] arguments)
        ...
        */
        throw new XNIException((fErrorReporter
                                .getMessageFormatter(com.sun.org.apache.xerces.internal.xpointer.XPointerMessageFormatter.XPOINTER_DOMAIN))
    ...
    private void reportWarning(String key, Object[] arguments)
            throws XNIException {
        fXPointerErrorReporter.reportError(
                com.sun.org.apache.xerces.internal.xpointer.XPointerMessageFormatter.XPOINTER_DOMAIN, key, arguments,
    ...
    protected void initErrorReporter() {
        ...
        if (fErrorHandler == null) {
            fErrorHandler = new com.sun.org.apache.xerces.internal.xpointer.XPointerErrorHandler();
        }
        /*
        ...
        fXPointerErrorReporter.putMessageFormatter(
                com.sun.org.apache.xerces.internal.xpointer.XPointerMessageFormatter.XPOINTER_DOMAIN,
