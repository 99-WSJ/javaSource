...
public final class ObjectStreamClassUtil_1_3 {
    ...
    public static long computeSerialVersionUID(final Class cl) {
        ...
        csuid = (com.sun.corba.se.impl.orbutil.ObjectStreamClassUtil_1_3.getSerialVersion(csuid, cl).longValue());
        return csuid;
    }
    ...
    public static long computeStructuralUID(boolean hasWriteObject, Class cl) {
        ...
        try {
            ...
            if ((parent != null) && (parent != Object.class)) {
                ...
                Method hasWriteObjectMethod = com.sun.corba.se.impl.orbutil.ObjectStreamClassUtil_1_3.getDeclaredMethod(parent, "writeObject", args,
                       Modifier.PRIVATE, Modifier.STATIC);
                if (hasWriteObjectMethod != null)
                    hasWriteObjectFlag = true;
                data.writeLong(com.sun.corba.se.impl.orbutil.ObjectStreamClassUtil_1_3.computeStructuralUID(hasWriteObjectFlag, parent));
            }
            ...
            Field[] field = com.sun.corba.se.impl.orbutil.ObjectStreamClassUtil_1_3.getDeclaredFields(cl);
    ...
    private static class MethodSignature implements Comparator {
        ...
        private MethodSignature(Member m) {
            member = m;
            if (isConstructor()) {
                signature = com.sun.corba.se.impl.orbutil.ObjectStreamClassUtil_1_3.getSignature((Constructor)m);
            } else {
                signature = com.sun.corba.se.impl.orbutil.ObjectStreamClassUtil_1_3.getSignature((Method)m);
            }
        }
    }
