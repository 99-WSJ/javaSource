...
package java8.com.sun.corba.se.impl.orbutil;

import com.sun.corba.se.impl.io.ObjectStreamClass;
import com.sun.corba.se.impl.io.ValueUtility;
import java8.sun.corba.se.impl.orbutil.ObjectStreamField;
...
public class ObjectStreamClass_1_3_1 implements Serializable {
     ...
     */
    static final com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 lookup(Class cl)
    {
        com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 desc = lookupInternal(cl);
     ...
     */
    static com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 lookupInternal(Class cl)
    {
        /* Synchronize on the hashtable so no two threads will do
         * this at the same time.
         */
        com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 desc = null;
        synchronized (descriptorFor) {
            ...
            if (desc != null) {
                 ...
                 */
                com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 superdesc = null;
                if (serializable) {
             ...
             */
            desc = new com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1(cl, superdesc,
    ...
    public static final long getSerialVersionUID( Class clazz) {
        com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 theosc = com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1.lookup( clazz );
        if( theosc != null )
        {
     ...
     */
    private ObjectStreamClass_1_3_1(Class cl, com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 superdesc,
    ...
    private static long computeStructuralUID(com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 osc, Class cl) {
     ...
     */
    private static com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 findDescriptorFor(Class cl) {
        ...
        prev = e;
        while (e != null ) {
            com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 desc = (com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1)(e.get());
            if (desc == null) {
     ...
     */
    private com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 superclass;
     ...
     */
    private com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 localClassDesc;
    ...
    {
        ObjectStreamClassEntry(com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 c) {
            //super(c);
            this.c = c;
        }
        ...
        private com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1 c;
    }
    ...
    private static class MethodSignature implements Comparator {
        ...
        private MethodSignature(Member m) {
            member = m;
            if (isConstructor()) {
                signature = com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1.getSignature((Constructor)m);
            } else {
                signature = com.sun.corba.se.impl.orbutil.ObjectStreamClass_1_3_1.getSignature((Method)m);
            }
        }
    }
}
