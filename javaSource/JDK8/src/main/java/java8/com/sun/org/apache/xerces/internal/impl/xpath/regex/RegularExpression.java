...
//Public
    ...
    public boolean matches(char[] target, int start, int end, Match match) {
        ...
        if (com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression.isSet(this.options, XMLSCHEMA_MODE)) {
         ...
         */
            ...
            com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken range = this.firstChar;
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target [matchStart] ;
                ...
                case Op.NRANGE:
                    {
                        ...
                        final com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken tok = op.getToken();
                        if (!tok.match(ch)) {
                            returned = true;
                            break;
                        }
    ...
    transient com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken firstChar = null;
    ...
    void prepare() {
        ...
        */
        ...
        if (!isSet(this.options, PROHIBIT_HEAD_CHARACTER_OPTIMIZATION)
            ...
            com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken firstChar = Token.createRange();
    ...
    private void setPattern(String newPattern, int options, Locale locale) throws ParseException {
        ...
        this.options = options;
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser rp = com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression.isSet(this.options, com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression.XMLSCHEMA_MODE)
                         ? new com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema(locale) : new com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser(locale);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression))
            return false;
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression r = (com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression)obj;
