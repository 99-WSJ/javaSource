...
public class SnmpVarBind implements SnmpDataTypeEnums, Cloneable, Serializable {
     ...
     */
    final public boolean isOidEqual(com.sun.jmx.snmp.SnmpVarBind var) {
     ...
     */
    public void copyValueAndOid(com.sun.jmx.snmp.SnmpVarBind var) {
     ...
     * @param var The <CODE>SnmpVarBind</CODE> clone.
     */
    public void copyValue(com.sun.jmx.snmp.SnmpVarBind var) {
        if (var.isValidValue()) {
    ...
    public Object cloneWithoutValue() {
        ...
        return new com.sun.jmx.snmp.SnmpVarBind(noid) ;
    }
