...
public class StandardMBeanSupport extends MBeanSupport<Method> {
    ...
    com.sun.jmx.mbeanserver.MBeanIntrospector<Method> getMBeanIntrospector() {
        return com.sun.jmx.mbeanserver.StandardMBeanIntrospector.getInstance();
    }
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        if (com.sun.jmx.mbeanserver.StandardMBeanIntrospector.isDefinitelyImmutableInfo(resourceClass))
            return mbi;
