  ...
  implements IncrementalSAXSource
{
  ...
  public IncrementalSAXSource_Xerces()
                throws NoSuchMethodException
        {
            ...
            // Fallback if this fails (implemented in createIncrementalSAXSource) is
                        ...
                        com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces dummy=new com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces(new SAXParser());
  ...
  static public IncrementalSAXSource createIncrementalSAXSource()
        {
                try
                {
                        return new com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces();
                }
                catch(NoSuchMethodException e)
                {
                        // Xerces version mismatch; neither Xerces1 nor Xerces2 succeeded.
                        // Fall back on filtering solution.
                        com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Filter iss=new com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Filter();
  ...
  createIncrementalSAXSource(SAXParser parser) {
                try
                {
                        return new com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces(parser);
                }
                catch(NoSuchMethodException e)
                {
                        // Xerces version mismatch; neither Xerces1 nor Xerces2 succeeded.
