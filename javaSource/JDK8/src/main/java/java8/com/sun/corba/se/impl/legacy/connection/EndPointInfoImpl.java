        ...
        LegacyServerSocketEndPointInfo
{
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof com.sun.corba.se.impl.legacy.connection.EndPointInfoImpl)) {
            return false;
        }
        com.sun.corba.se.impl.legacy.connection.EndPointInfoImpl other = (com.sun.corba.se.impl.legacy.connection.EndPointInfoImpl)obj;
        if (type == null) {
            if (other.type != null) {
                return false;
            }
