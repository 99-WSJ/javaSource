...
final class AbsolutePathPattern extends LocationPathPattern {
    private final com.sun.org.apache.xalan.internal.xsltc.compiler.RelativePathPattern _left; // may be null

    public AbsolutePathPattern(com.sun.org.apache.xalan.internal.xsltc.compiler.RelativePathPattern left) {
        _left = left;
        if (left != null) {
            left.setParent(this);
        }
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (_left != null) {
            if (_left instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.StepPattern) {
