 ...
 */
package java8.com.sun.org.apache.xml.internal.utils;
    ...
    extends org.xml.sax.helpers.NamespaceSupport
{
    ...
    private com.sun.org.apache.xml.internal.utils.Context2 currentContext; // Current point on the double-linked stack
    ...
    public void reset ()
    {
        ...
        currentContext = new com.sun.org.apache.xml.internal.utils.Context2(null);
    ...
    public void pushContext ()
    {
        ...
        com.sun.org.apache.xml.internal.utils.Context2 parentContext=currentContext;
        currentContext = parentContext.getChild();
        if (currentContext == null){
                currentContext = new com.sun.org.apache.xml.internal.utils.Context2(parentContext);
            }
        else{
    ...
    {
        com.sun.org.apache.xml.internal.utils.Context2 parentContext=currentContext.getParent();
    ...
    public Enumeration getPrefixes (String uri)
    {
        ...
        return new com.sun.org.apache.xml.internal.utils.PrefixForUriEnumerator(this,uri,getPrefixes());
    }
...
class PrefixForUriEnumerator implements Enumeration
{
    ...
    private com.sun.org.apache.xml.internal.utils.NamespaceSupport2 nsup;

    // Kluge: Since one can't do a constructor on an
    // anonymous class (as far as I know)...
    PrefixForUriEnumerator(com.sun.org.apache.xml.internal.utils.NamespaceSupport2 nsup, String uri, Enumeration allPrefixes)
    {
        this.nsup=nsup;
        this.uri=uri;
...
final class Context2 {
    ...
    private com.sun.org.apache.xml.internal.utils.Context2 parent = null;
    private com.sun.org.apache.xml.internal.utils.Context2 child = null;

    /**
     * Create a new Namespace context.
     */
    Context2 (com.sun.org.apache.xml.internal.utils.Context2 parent)
    {
        if(parent==null)
            {
     ...
     */
    com.sun.org.apache.xml.internal.utils.Context2 getChild()
    {
        return child;
    }
     ...
     * is the root.
     */
    com.sun.org.apache.xml.internal.utils.Context2 getParent()
    {
        return parent;
    }
     ...
     */
    void setParent (com.sun.org.apache.xml.internal.utils.Context2 parent)
    {
        this.parent = parent;
