...
public final class ValueHandlerImpl implements javax.rmi.CORBA.ValueHandlerMultiFormat {
    ...
    private static byte getMaxStreamFormatVersion() {
        ...
        try {
            ...
            String propValue = (String) AccessController.doPrivileged(
                ...
                public Object run() {
                    return System.getProperty(com.sun.corba.se.impl.io.ValueHandlerImpl.FORMAT_VERSION_PROPERTY);
                }
            });
    ...
    static com.sun.corba.se.impl.io.ValueHandlerImpl getInstance() {
        return new com.sun.corba.se.impl.io.ValueHandlerImpl();
    }

    static com.sun.corba.se.impl.io.ValueHandlerImpl getInstance(boolean isInputStream) {
        return new com.sun.corba.se.impl.io.ValueHandlerImpl(isInputStream);
    }
    ...
    private void write_Array(org.omg.CORBA_2_3.portable.OutputStream out, java.io.Serializable obj, Class type) {
        ...
        if (type.isPrimitive()) {
            ...
            if (type.isInterface()) {
                ...
                } else if (com.sun.corba.se.impl.io.ObjectStreamClassCorbaExt.isAbstractInterface(type)) {
                    callType = kAbstractType;
                }
            }
            ...
            if (componentType.isPrimitive()) {
                ...
                if (componentType.isInterface()) {
                    ...
                    if (java.rmi.Remote.class.isAssignableFrom(componentType)) {
                        ...
                        callType = kAbstractType;
                        loadStubClass = true;
                    } else if (com.sun.corba.se.impl.io.ObjectStreamClassCorbaExt.isAbstractInterface(componentType)) {
