...
class SnmpResponseHandler {
    ...
    com.sun.jmx.snmp.daemon.SnmpQManager snmpq = null;

    // CONSTRUCTORS
    //-------------

    public SnmpResponseHandler(SnmpAdaptorServer adp, com.sun.jmx.snmp.daemon.SnmpQManager s) {
        adaptor = adp;
        snmpq = s;
    }
    ...
    public synchronized void processDatagram(DatagramPacket dgrm) {
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINER, com.sun.jmx.snmp.daemon.SnmpResponseHandler.class.getName(),
        ...
        try {
            ...
            if (pduFactory == null) {
                if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                    SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.daemon.SnmpResponseHandler.class.getName(),
