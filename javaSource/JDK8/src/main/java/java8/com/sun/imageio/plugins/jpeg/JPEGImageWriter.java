...
public class JPEGImageWriter extends ImageWriter {
    ...
    private boolean jfifOK(ImageTypeSpecifier imageType,
        ...
        if (imageMetadata != null) {
            ...
            if (metadata.findMarkerSegment
                (com.sun.imageio.plugins.jpeg.JFIFMarkerSegment.class, true) == null){
                return false;
            }
        }
        return true;
    ...
    private void writeOnThread(IIOMetadata streamMetadata,
        ...
        com.sun.imageio.plugins.jpeg.JFIFMarkerSegment jfif = null;
        com.sun.imageio.plugins.jpeg.AdobeMarkerSegment adobe = null;
        com.sun.imageio.plugins.jpeg.SOFMarkerSegment sof = null;

        if (metadata != null) {
            jfif = (com.sun.imageio.plugins.jpeg.JFIFMarkerSegment) metadata.findMarkerSegment
                (com.sun.imageio.plugins.jpeg.JFIFMarkerSegment.class, true);
            adobe = (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) metadata.findMarkerSegment
                (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment.class, true);
            sof = (com.sun.imageio.plugins.jpeg.SOFMarkerSegment) metadata.findMarkerSegment
        ...
        if (metadata != null) {
            dqt = (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) metadata.findMarkerSegment
                (com.sun.imageio.plugins.jpeg.DQTMarkerSegment.class, true);
            dht = (com.sun.imageio.plugins.jpeg.DHTMarkerSegment) metadata.findMarkerSegment
                (com.sun.imageio.plugins.jpeg.DHTMarkerSegment.class, true);
    ...
    private void checkJFIF(com.sun.imageio.plugins.jpeg.JFIFMarkerSegment jfif,
    ...
    private void checkAdobe(com.sun.imageio.plugins.jpeg.AdobeMarkerSegment adobe,
                            ImageTypeSpecifier type,
                            boolean input) {
        if (adobe != null) {
    ...
    private int [] collectScans(JPEGMetadata metadata,
        ...
        for (Iterator iter = metadata.markerSequence.iterator();
             iter.hasNext();) {
            com.sun.imageio.plugins.jpeg.MarkerSegment seg = (com.sun.imageio.plugins.jpeg.MarkerSegment) iter.next();
    ...
    private JPEGQTable [] collectQTablesFromMetadata
        ...
        while (iter.hasNext()) {
            ...
            if (seg instanceof com.sun.imageio.plugins.jpeg.DQTMarkerSegment) {
                com.sun.imageio.plugins.jpeg.DQTMarkerSegment dqt =
                    (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) seg;
        ...
        if (tables.size() != 0) {
            ...
            for (int i = 0; i < retval.length; i++) {
                retval[i] =
                    new JPEGQTable(((com.sun.imageio.plugins.jpeg.DQTMarkerSegment.Qtable)tables.get(i)).data);
            }
        }
        return retval;
    }
    ...
    private JPEGHuffmanTable[] collectHTablesFromMetadata
        ...
        while (iter.hasNext()) {
            ...
            if (seg instanceof com.sun.imageio.plugins.jpeg.DHTMarkerSegment) {
                com.sun.imageio.plugins.jpeg.DHTMarkerSegment dht =
                    (com.sun.imageio.plugins.jpeg.DHTMarkerSegment) seg;
                for (int i = 0; i < dht.tables.size(); i++) {
                    com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable htable =
                        (com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable) dht.tables.get(i);
        ...
        if (tables.size() != 0) {
            com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable [] htables =
                new com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable[tables.size()];
    ...
    private void writeMetadata() throws IOException {
        if (metadata == null) {
            if (writeDefaultJFIF) {
                com.sun.imageio.plugins.jpeg.JFIFMarkerSegment.writeDefaultJFIF(ios,
                                                   thumbnails,
                                                   iccProfile,
                                                   this);
            }
            if (writeAdobe) {
                com.sun.imageio.plugins.jpeg.AdobeMarkerSegment.writeAdobeSegment(ios, newAdobeTransform);
            }
        } else {
