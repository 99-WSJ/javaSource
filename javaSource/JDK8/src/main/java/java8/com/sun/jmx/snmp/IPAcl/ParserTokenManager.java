...
class ParserTokenManager implements com.sun.jmx.snmp.IPAcl.ParserConstants
{
...
private com.sun.jmx.snmp.IPAcl.ASCII_CharStream input_stream;
private final int[] jjrounds = new int[47];
private final int[] jjstateSet = new int[94];
protected char curChar;
public ParserTokenManager(com.sun.jmx.snmp.IPAcl.ASCII_CharStream stream)
{
   if (com.sun.jmx.snmp.IPAcl.ASCII_CharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ParserTokenManager(com.sun.jmx.snmp.IPAcl.ASCII_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
public void ReInit(com.sun.jmx.snmp.IPAcl.ASCII_CharStream stream)
{
...
public void ReInit(com.sun.jmx.snmp.IPAcl.ASCII_CharStream stream, int lexState)
{
   ReInit(stream);
   SwitchTo(lexState);
}
public void SwitchTo(int lexState)
{
   if (lexState >= 1 || lexState < 0)
      throw new com.sun.jmx.snmp.IPAcl.TokenMgrError("Error: Ignoring invalid lexical state : " + lexState + ". State unchanged.", com.sun.jmx.snmp.IPAcl.TokenMgrError.INVALID_LEXICAL_STATE);
   else
      curLexState = lexState;
}

private final com.sun.jmx.snmp.IPAcl.Token jjFillToken()
{
   com.sun.jmx.snmp.IPAcl.Token t = com.sun.jmx.snmp.IPAcl.Token.newToken(jjmatchedKind);
...
public final com.sun.jmx.snmp.IPAcl.Token getNextToken()
{
  int kind;
  com.sun.jmx.snmp.IPAcl.Token specialToken = null;
  com.sun.jmx.snmp.IPAcl.Token matchedToken;
  int curPos = 0;
  ...
  for (;;)
  {
   ...
   throw new com.sun.jmx.snmp.IPAcl.TokenMgrError(EOFSeen, curLexState, error_line, error_column, error_after, curChar, com.sun.jmx.snmp.IPAcl.TokenMgrError.LEXICAL_ERROR);
  }
}
