...
final class Step extends RelativeLocationPath {
    ...
    public void setParser(Parser parser) {
        ...
        if (_predicates != null) {
            ...
            for (int i = 0; i < n; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate)_predicates.elementAt(i);
    ...
    private boolean hasParentPattern() {
        ...
        return (parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ParentPattern ||
                parent instanceof ParentLocationPath ||
                parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.UnionPathExpr ||
    ...
    private boolean isPredicate() {
        ...
        while (parent != null) {
            ...
            if (parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate) return true;
        }
        return false;
    }
    ...
    public void translatePredicates(ClassGenerator classGen,
        ...
        if (predicateIndex < 0) {
            ...
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate predicate = (com.sun.org.apache.xalan.internal.xsltc.compiler.Predicate) _predicates.get(predicateIndex--);
            ...
            if (predicate.isNodeValueTest()) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Step step = predicate.getStep();
