...
import java8.com.sun.org.apache.xerces.internal.impl.dv.xs.*;
...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    private com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl fItemType;
    private com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[] fMemberTypes;
    ...
    private com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl fBase;
    ...
    protected XSSimpleTypeDecl(com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl base, String name, short validateDV,
    ...
    protected XSSimpleTypeDecl(com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl base, String name, String uri, short finalSet, boolean isImmutable,
    ...
    protected XSSimpleTypeDecl(String name, String uri, short finalSet, com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl itemType, boolean isImmutable,
                               XSObjectList annotations) {
        ...
        fItemType = (com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl)itemType;
    ...
    protected XSSimpleTypeDecl(String name, String uri, short finalSet, com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[] memberTypes,
            XSObjectList annotations) {
        fBase = fAnySimpleType;
        fTypeName = name;
        fTargetNamespace = uri;
    ...
    protected com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl setRestrictionValues(com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl base, String name, String uri, short finalSet,
                                                                                                  XSObjectList annotations) {
    ...
    //set values for list.
    protected com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl setListValues(String name, String uri, short finalSet, com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl itemType,
                                                                                           XSObjectList annotations) {
        //decline to do anything if the object is immutable.
        if(fIsImmutable) return null;
        fBase = fAnySimpleType;
    ...
    protected com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl setUnionValues(String name, String uri, short finalSet, com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[] memberTypes,
                                                                                            XSObjectList annotations) {
        //decline to do anything if the object is immutable.
        if(fIsImmutable) return null;
        fBase = fAnySimpleType;
    ...
    public XSSimpleTypeDefinition getPrimitiveType() {
        if (fVariety == VARIETY_ATOMIC && fValidationDV != DV_ANYSIMPLETYPE) {
            com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl pri = this;
        ...
        if (fVariety == VARIETY_ATOMIC) {
            ...
            try {
                if (fItemType.fVariety == VARIETY_UNION) {
                    com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[] memberTypes = (com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[])validatedInfo.memberTypes;
            ...
            ((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl)validatedInfo.memberType).checkExtraRules(context, validatedInfo);
    ...
    throws InvalidDatatypeValueException{
        ...
        if (fVariety == VARIETY_ATOMIC) {
            ...
            com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[] memberTypes = new com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[countOfTokens];
            for(int i = 0 ; i < countOfTokens ; i ++){
                ...
                memberTypes[i] = (com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl)validatedInfo.memberType;
                if (isUnion)
            ...
            com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl decl;
            for(int i = 0;i < fMemberTypes.length; i++) {
                if(i != 0)
                    typesBuffer.append(" | ");
                decl = fMemberTypes[i];
    ...
    private void setBounded(){
        if(fVariety == VARIETY_ATOMIC){
            ...
            com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl[] memberTypes = this.fMemberTypes;
            short ancestorId = 0 ;
    ...
    private boolean specialCardinalityCheck(){
        if( (fBase.fValidationDV == com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.DV_DATE) || (fBase.fValidationDV == com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.DV_GYEARMONTH)
                || (fBase.fValidationDV == com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.DV_GYEAR) || (fBase.fValidationDV == com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.DV_GMONTHDAY)
                || (fBase.fValidationDV == com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.DV_GDAY) || (fBase.fValidationDV == com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.DV_GMONTH) ){
            return true;
        }
        return false;
    ...
    private boolean isDerivedByAny(String ancestorNS, String ancestorName,
        ...
        while (type != null && type != oldType)  {
            ...
            if (((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type).getVariety() == VARIETY_ABSENT
                    || ((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type).getVariety() == VARIETY_ATOMIC) {
                type = type.getBaseType();
            } else if (((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type).getVariety() == VARIETY_UNION) {
                for (int i = 0; i < ((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type).getMemberTypes().getLength(); i++) {
                    return isDerivedByAny(ancestorNS, ancestorName,
                            (XSTypeDefinition) ((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type)
                            .getMemberTypes().item(i));
                }
            } else if (((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type).getVariety() == VARIETY_LIST) {
                type = ((com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl) type).getItemType();
            }
        }
    ...
    static final com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl fAnySimpleType = new com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl(null, "anySimpleType", DV_ANYSIMPLETYPE, ORDERED_FALSE, false, true, false, true, XSConstants.ANYSIMPLETYPE_DT);

    static final com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl fAnyAtomicType = new com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl(fAnySimpleType, "anyAtomicType", DV_ANYATOMICTYPE, ORDERED_FALSE, false, true, false, true, com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl.ANYATOMICTYPE_DT);
