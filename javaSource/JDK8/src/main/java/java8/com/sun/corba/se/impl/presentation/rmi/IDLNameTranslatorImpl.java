...
public class IDLNameTranslatorImpl implements IDLNameTranslator {
    ...
    public static IDLNameTranslator get( Class interf )
    {
        ...
        return new com.sun.corba.se.impl.presentation.rmi.IDLNameTranslatorImpl(new Class[] { interf } );
    ...
    public static IDLNameTranslator get( Class[] interfaces )
    {
        ...
        return new com.sun.corba.se.impl.presentation.rmi.IDLNameTranslatorImpl(interfaces );
