...
import java8.sun.corba.se.impl.encoding.EncapsInputStream;
...
public class TypeCodeInputStream extends EncapsInputStream implements TypeCodeReader
{
    ...
    public static com.sun.corba.se.impl.encoding.TypeCodeInputStream readEncapsulation(InputStream is, org.omg.CORBA.ORB _orb) {
        // _REVISIT_ Would be nice if we didn't have to copy the buffer!
        com.sun.corba.se.impl.encoding.TypeCodeInputStream encap;
