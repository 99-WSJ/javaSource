...
import java8.sun.corba.se.impl.encoding.BufferManagerReadStream;
import java8.sun.corba.se.impl.encoding.BufferManagerWrite;
import java8.sun.corba.se.impl.encoding.BufferManagerWriteCollect;
import java8.sun.corba.se.impl.encoding.BufferManagerWriteGrow;
...
public class BufferManagerFactory
{
    ...
    public static BufferManagerRead newBufferManagerRead(
        ...
        if (encodingVersion != Message.CDR_ENC_VERSION) {
            if (strategy != com.sun.corba.se.impl.encoding.BufferManagerFactory.GROW) {
        ...
        switch (strategy) {
            case com.sun.corba.se.impl.encoding.BufferManagerFactory.GROW:
                return new BufferManagerReadGrow(orb);
            case com.sun.corba.se.impl.encoding.BufferManagerFactory.COLLECT:
                throw new INTERNAL("Collect strategy invalid for reading");
            case com.sun.corba.se.impl.encoding.BufferManagerFactory.STREAM:
                return new BufferManagerReadStream(orb);
            default:
    ...
    public static BufferManagerWrite newBufferManagerWrite(
        ...
        return com.sun.corba.se.impl.encoding.BufferManagerFactory.newBufferManagerWrite(
