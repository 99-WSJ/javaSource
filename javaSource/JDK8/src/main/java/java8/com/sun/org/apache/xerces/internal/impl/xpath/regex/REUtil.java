...
public final class REUtil {
    ...
    public static RegularExpression createRegex(String pattern, String options)
        ...
        int intOptions = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.parseOptions(options);
        synchronized (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache) {
            int i;
            for (i = 0; i < com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.CACHESIZE; i ++) {
                RegularExpression cached = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache[i];
                if (cached == null) {
                    i = -1;
                    break;
                }
            ...
            if (re != null) {
                if (i != 0) {
                    System.arraycopy(com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache, 0, com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache, 1, i);
                    com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache[0] = re;
                }
            } else {
                re = new RegularExpression(pattern, options);
                System.arraycopy(com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache, 0, com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache, 1, com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.CACHESIZE-1);
                com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.regexCache[0] = re;
            }
        }
        return re;
    ...
    public static boolean matches(String regex, String target) throws ParseException {
        return com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.createRegex(regex, null).matches(target);
    }
    ...
    public static boolean matches(String regex, String options, String target) throws ParseException {
        return com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.createRegex(regex, options).matches(target);
    }
