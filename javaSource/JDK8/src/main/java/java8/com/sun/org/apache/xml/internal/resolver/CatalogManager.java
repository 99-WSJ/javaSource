...
public class CatalogManager {
  ...
  private static com.sun.org.apache.xml.internal.resolver.CatalogManager staticManager = new com.sun.org.apache.xml.internal.resolver.CatalogManager();
  ...
  private synchronized void readProperties() {
    try {
      propertyFileURI = com.sun.org.apache.xml.internal.resolver.CatalogManager.class.getResource("/"+propertyFile);
      InputStream in =
        com.sun.org.apache.xml.internal.resolver.CatalogManager.class.getResourceAsStream("/"+propertyFile);
      if (in==null) {
