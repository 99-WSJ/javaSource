...
import java8.sun.corba.se.impl.encoding.CDRInputStreamBase;
...
public class IDLJavaSerializationInputStream extends CDRInputStreamBase {
    ...
    public CDRInputStreamBase dup() {
        ...
        ((com.sun.corba.se.impl.encoding.IDLJavaSerializationInputStream)result).skipBytes(getPosition());

        // Set mark related data.
        ((com.sun.corba.se.impl.encoding.IDLJavaSerializationInputStream)result).
