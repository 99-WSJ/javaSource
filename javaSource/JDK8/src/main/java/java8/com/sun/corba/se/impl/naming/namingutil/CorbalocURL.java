...
public class CorbalocURL extends INSURLBase
{
    ...
    public CorbalocURL( String aURL ) {
        ...
        if( url != null ) {
            try {
                ...
                url = com.sun.corba.se.impl.naming.namingutil.Utility.cleanEscapes( url );
            } catch( Exception e ) {
    ...
    private IIOPEndpointInfo handleColon( String iiopInfo ) {
       ...
       com.sun.corba.se.impl.naming.namingutil.Utility.validateGIOPVersion( iiopEndpointInfo );
       return iiopEndpointInfo;
    }
