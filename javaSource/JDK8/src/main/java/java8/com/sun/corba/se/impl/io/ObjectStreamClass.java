...
public class ObjectStreamClass implements Serializable {
     ...
     */
    static final com.sun.corba.se.impl.io.ObjectStreamClass lookup(Class cl)
    {
        com.sun.corba.se.impl.io.ObjectStreamClass desc = lookupInternal(cl);
     ...
     */
    static com.sun.corba.se.impl.io.ObjectStreamClass lookupInternal(Class cl)
    {
        /* Synchronize on the hashtable so no two threads will do
         * this at the same time.
         */
        com.sun.corba.se.impl.io.ObjectStreamClass desc = null;
        synchronized (descriptorFor) {
            ...
            if (desc == null) {
                 ...
                 */
                com.sun.corba.se.impl.io.ObjectStreamClass superdesc = null;
                if (serializable) {
                 ...
                 */
                desc = new com.sun.corba.se.impl.io.ObjectStreamClass(cl, superdesc,
    ...
    public static final long getSerialVersionUID( Class clazz) {
        com.sun.corba.se.impl.io.ObjectStreamClass theosc = com.sun.corba.se.impl.io.ObjectStreamClass.lookup( clazz );
        if( theosc != null )
        {
     ...
     */
    private ObjectStreamClass(Class cl, com.sun.corba.se.impl.io.ObjectStreamClass superdesc,
    ...
    private void init() {
      synchronized (lock) {
         ...
         */
         if (isNonSerializable() || isEnum) {
             ...
             AccessController.doPrivileged(new PrivilegedAction() {
                ...
                writeReplaceObjectMethod = com.sun.corba.se.impl.io.ObjectStreamClass.getInheritableMethod(cl,
                    "writeReplace", noTypesList, Object.class);

                readResolveObjectMethod = com.sun.corba.se.impl.io.ObjectStreamClass.getInheritableMethod(cl,
        ...
        actualSuid = com.sun.corba.se.impl.io.ObjectStreamClass.computeStructuralUID(this, cl);
     ...
     */
    private static com.sun.corba.se.impl.io.ObjectStreamClass findDescriptorFor(Class cl) {
        ...
        prev = e;
        while (e != null ) {
            com.sun.corba.se.impl.io.ObjectStreamClass desc = (com.sun.corba.se.impl.io.ObjectStreamClass)(e.get());
            if (desc == null) {
     ...
     */
    private com.sun.corba.se.impl.io.ObjectStreamClass superclass;
     ...
     */
    private com.sun.corba.se.impl.io.ObjectStreamClass localClassDesc;
    ...
    {
        ObjectStreamClassEntry(com.sun.corba.se.impl.io.ObjectStreamClass c) {
            //super(c);
            this.c = c;
        }
        ...
        private com.sun.corba.se.impl.io.ObjectStreamClass c;
    }
    ...
    private static class MethodSignature implements Comparator {
        ...
        private MethodSignature(Member m) {
            member = m;
            if (isConstructor()) {
                signature = com.sun.corba.se.impl.io.ObjectStreamClass.getSignature((Constructor)m);
            } else {
                signature = com.sun.corba.se.impl.io.ObjectStreamClass.getSignature((Method)m);
            }
        }
    }
