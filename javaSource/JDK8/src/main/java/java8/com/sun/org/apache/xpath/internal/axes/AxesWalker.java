 ...
 */
package java8.sun.org.apache.xpath.internal.axes;
        ...
        implements Cloneable, PathComponent, ExpressionOwner
{
  ...
  public Object clone() throws CloneNotSupportedException
  {
    ...
    com.sun.org.apache.xpath.internal.axes.AxesWalker clone = (com.sun.org.apache.xpath.internal.axes.AxesWalker) super.clone();
   ...
   */
  com.sun.org.apache.xpath.internal.axes.AxesWalker cloneDeep(WalkingIterator cloneOwner, Vector cloneList)
     throws CloneNotSupportedException
  {
    com.sun.org.apache.xpath.internal.axes.AxesWalker clone = findClone(this, cloneList);
    if(null != clone)
      return clone;
    clone = (com.sun.org.apache.xpath.internal.axes.AxesWalker)this.clone();
   ...
   */
  static com.sun.org.apache.xpath.internal.axes.AxesWalker findClone(com.sun.org.apache.xpath.internal.axes.AxesWalker key, Vector cloneList)
  {
    if(null != cloneList)
    {
      ...
      for (int i = 0; i < n; i+=2)
      {
        if(key == cloneList.elementAt(i))
          return (com.sun.org.apache.xpath.internal.axes.AxesWalker)cloneList.elementAt(i+1);
      }
    }
    return null;
  }
   ...
   */
  public void setNextWalker(com.sun.org.apache.xpath.internal.axes.AxesWalker walker)
  {
    m_nextWalker = walker;
  }
   ...
   */
  public com.sun.org.apache.xpath.internal.axes.AxesWalker getNextWalker()
  {
    return m_nextWalker;
  }
   ...
   *               step chain, or null.
   */
  public void setPrevWalker(com.sun.org.apache.xpath.internal.axes.AxesWalker walker)
  {
    m_prevWalker = walker;
  }
   ...
   *               step chain, or null.
   */
  public com.sun.org.apache.xpath.internal.axes.AxesWalker getPrevWalker()
  {
    return m_prevWalker;
  }
  ...
  public int nextNode()
  {
    ...
    com.sun.org.apache.xpath.internal.axes.AxesWalker walker = wi().getLastUsedWalker();
    ...
    while (true)
    {
      ...
      else
      {
        ...
        {
          com.sun.org.apache.xpath.internal.axes.AxesWalker prev = walker;
  ...
  public int getLastPos(XPathContext xctxt)
  {
    ...
    com.sun.org.apache.xpath.internal.axes.AxesWalker walker;

    try
    {
      walker = (com.sun.org.apache.xpath.internal.axes.AxesWalker) clone();
    }
    ...
    com.sun.org.apache.xpath.internal.axes.AxesWalker savedWalker = lpi.getLastUsedWalker();
  ...
  public void setExpression(Expression exp)
  {
        ...
        m_nextWalker = (com.sun.org.apache.xpath.internal.axes.AxesWalker)exp;
  }
    ...
    public boolean deepEquals(Expression expr)
    {
      ...
      com.sun.org.apache.xpath.internal.axes.AxesWalker walker = (com.sun.org.apache.xpath.internal.axes.AxesWalker)expr;
   ...
   *  @serial  */
  protected com.sun.org.apache.xpath.internal.axes.AxesWalker m_nextWalker;

  /** The previous walker in the location step chain, or null.
   *  @serial   */
  com.sun.org.apache.xpath.internal.axes.AxesWalker m_prevWalker;
