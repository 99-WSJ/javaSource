...
public class XMLCipher {
    ...
    private static java.util.logging.Logger log =
        java.util.logging.Logger.getLogger(com.sun.org.apache.xml.internal.security.encryption.XMLCipher.class.getName());
     ...
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getInstance(String transformation) throws XMLEncryptionException {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
            log.log(java.util.logging.Level.FINE, "Getting XMLCipher with transformation");
        }
        validateTransformation(transformation);
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(transformation, null, null, null);
    }
     ...
     * @throws XMLEncryptionException
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getInstance(String transformation, String canon)
        throws XMLEncryptionException {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
            log.log(java.util.logging.Level.FINE, "Getting XMLCipher with transformation and c14n algorithm");
        }
        validateTransformation(transformation);
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(transformation, null, canon, null);
    }
     ...
     * @throws XMLEncryptionException
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getInstance(String transformation, String canon, String digestMethod)
        throws XMLEncryptionException {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
            log.log(java.util.logging.Level.FINE, "Getting XMLCipher with transformation and c14n algorithm");
        }
        validateTransformation(transformation);
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(transformation, null, canon, digestMethod);
    }
     ...
     * @throws XMLEncryptionException
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getProviderInstance(String transformation, String provider)
        throws XMLEncryptionException {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
        ...
        validateTransformation(transformation);
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(transformation, provider, null, null);
    }
     ...
     * @throws XMLEncryptionException
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getProviderInstance(
        ...
        validateTransformation(transformation);
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(transformation, provider, canon, null);
    }
    ...
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getProviderInstance(
        ...
        validateTransformation(transformation);
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(transformation, provider, canon, digestMethod);
    }
     ...
     * @throws XMLEncryptionException
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getInstance() throws XMLEncryptionException {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
            log.log(java.util.logging.Level.FINE, "Getting XMLCipher with no arguments");
        }
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(null, null, null, null);
    }
     ...
     * @throws XMLEncryptionException
     */
    public static com.sun.org.apache.xml.internal.security.encryption.XMLCipher getProviderInstance(String provider) throws XMLEncryptionException {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
            log.log(java.util.logging.Level.FINE, "Getting XMLCipher with provider");
        }
        return new com.sun.org.apache.xml.internal.security.encryption.XMLCipher(null, provider, null, null);
    }
    ...
    private OAEPParameterSpec constructOAEPParameters(
        ...
        if (com.sun.org.apache.xml.internal.security.encryption.XMLCipher.RSA_OAEP.equals(encryptionAlgorithm)
            || com.sun.org.apache.xml.internal.security.encryption.XMLCipher.RSA_OAEP_11.equals(encryptionAlgorithm)) {
            ...
            if (com.sun.org.apache.xml.internal.security.encryption.XMLCipher.RSA_OAEP_11.equals(encryptionAlgorithm)) {
    ...
    private Cipher constructCipher(String algorithm, String digestAlgorithm) throws XMLEncryptionException {
        ...
        try {
            ...
            if (com.sun.org.apache.xml.internal.security.encryption.XMLCipher.RSA_OAEP.equals(algorithm)
    ...
    private class Factory {
        ...
        EncryptionMethod newEncryptionMethod(Element element) {
            ...
            if (mgfElement != null && !com.sun.org.apache.xml.internal.security.encryption.XMLCipher.RSA_OAEP.equals(algorithm)) {
