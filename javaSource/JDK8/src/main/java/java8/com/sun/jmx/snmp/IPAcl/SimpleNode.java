...
class SimpleNode implements com.sun.jmx.snmp.IPAcl.Node {
    ...
    public static com.sun.jmx.snmp.IPAcl.Node jjtCreate(int id) {
        return new com.sun.jmx.snmp.IPAcl.SimpleNode(id);
    }

    public static com.sun.jmx.snmp.IPAcl.Node jjtCreate(com.sun.jmx.snmp.IPAcl.Parser p, int id) {
        return new com.sun.jmx.snmp.IPAcl.SimpleNode(p, id);
    }
    ...
    */
    ...
    public void buildTrapEntries(Hashtable<InetAddress, Vector<String>> dest) {
        if (children != null) {
            for (int i = 0; i < children.length; ++i) {
                com.sun.jmx.snmp.IPAcl.SimpleNode n = (com.sun.jmx.snmp.IPAcl.SimpleNode)children[i];
                if (n != null) {
    ...
    public String toString() { return com.sun.jmx.snmp.IPAcl.ParserTreeConstants.jjtNodeName[id]; }
