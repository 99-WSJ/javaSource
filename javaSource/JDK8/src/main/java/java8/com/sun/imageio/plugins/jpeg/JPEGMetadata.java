...
public class JPEGMetadata extends IIOMetadata implements Cloneable {
    ...
    JPEGMetadata(boolean isStream,
        ...
        while (!done) {
            ...
            case JPEG.SOF2:
                ...
                newGuy = new com.sun.imageio.plugins.jpeg.SOFMarkerSegment(buffer);
                break;
            case JPEG.DQT:
                newGuy = new com.sun.imageio.plugins.jpeg.DQTMarkerSegment(buffer);
                break;
            case JPEG.DHT:
                newGuy = new com.sun.imageio.plugins.jpeg.DHTMarkerSegment(buffer);
                break;
            case JPEG.DRI:
            ...
            case JPEG.APP14:
                ...
                if ((buffer.buf[buffer.bufPtr+3] == 'A')
                    ...
                    newGuy = new com.sun.imageio.plugins.jpeg.AdobeMarkerSegment(buffer);
                } else {
                    newGuy = new MarkerSegment(buffer);
                    newGuy.loadData(buffer);
                }
    ...
    JPEGMetadata(ImageWriteParam param, JPEGImageWriter writer) {
        ...
        if (jparam != null) {
            markerSequence.add(new com.sun.imageio.plugins.jpeg.DQTMarkerSegment(jparam.getQTables()));
            markerSequence.add
                (new com.sun.imageio.plugins.jpeg.DHTMarkerSegment(jparam.getDCHuffmanTables(),
                                      jparam.getACHuffmanTables()));
        } else {
            // default tables.
            markerSequence.add(new com.sun.imageio.plugins.jpeg.DQTMarkerSegment(JPEG.getDefaultQTables()));
            markerSequence.add(new com.sun.imageio.plugins.jpeg.DHTMarkerSegment(JPEG.getDefaultHuffmanTables(true),
    ...
    JPEGMetadata(ImageTypeSpecifier imageType,
        ...
        // Adobe
        if (wantAdobe) {
            markerSequence.add(new com.sun.imageio.plugins.jpeg.AdobeMarkerSegment(transform));
        }

        // dqt
        if (wantQTables) {
            markerSequence.add(new com.sun.imageio.plugins.jpeg.DQTMarkerSegment(quality, willSubsample));
        }

        // dht
        if (wantHTables) {
            markerSequence.add(new com.sun.imageio.plugins.jpeg.DHTMarkerSegment(willSubsample));
        }

        // sof
        markerSequence.add(new com.sun.imageio.plugins.jpeg.SOFMarkerSegment(wantProg,
                                                wantExtended,
                                                willSubsample,
                                                componentIDs,
                                                numComponents));
    ...
    protected Object clone() {
        com.sun.imageio.plugins.jpeg.JPEGMetadata newGuy = null;
        try {
            newGuy = (com.sun.imageio.plugins.jpeg.JPEGMetadata) super.clone();
    ...
    protected IIOMetadataNode getStandardChromaNode() {
        ...
        com.sun.imageio.plugins.jpeg.SOFMarkerSegment sof = (com.sun.imageio.plugins.jpeg.SOFMarkerSegment)
            findMarkerSegment(com.sun.imageio.plugins.jpeg.SOFMarkerSegment.class, true);
        if (sof == null) {
        ...
        com.sun.imageio.plugins.jpeg.AdobeMarkerSegment adobe =
            (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) findMarkerSegment(com.sun.imageio.plugins.jpeg.AdobeMarkerSegment.class, true);
        if (adobe != null){
    ...
    private void mergeDQTNode(Node node) throws IIOInvalidTreeException {
        ...
        while (iter.hasNext()) {
            MarkerSegment seg = (MarkerSegment) iter.next();
            if (seg instanceof com.sun.imageio.plugins.jpeg.DQTMarkerSegment) {
                oldDQTs.add(seg);
            }
        }
        if (!oldDQTs.isEmpty()) {
            ...
            for (int i = 0; i < children.getLength(); i++) {
                ...
                int childID = MarkerSegment.getAttributeValue(child,
                                                              ...
                                                              0, 3,
                                                              true);
                com.sun.imageio.plugins.jpeg.DQTMarkerSegment dqt = null;
                int tableIndex = -1;
                for (int j = 0; j < oldDQTs.size(); j++) {
                    com.sun.imageio.plugins.jpeg.DQTMarkerSegment testDQT = (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) oldDQTs.get(j);
                    for (int k = 0; k < testDQT.tables.size(); k++) {
                        com.sun.imageio.plugins.jpeg.DQTMarkerSegment.Qtable testTable =
                            (com.sun.imageio.plugins.jpeg.DQTMarkerSegment.Qtable) testDQT.tables.get(k);
                ...
                if (dqt != null) {
                    ...
                    dqt = (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) oldDQTs.get(oldDQTs.size()-1);
                    dqt.tables.add(dqt.getQtableFromNode(child));
                }
            }
        } else {
            com.sun.imageio.plugins.jpeg.DQTMarkerSegment newGuy = new com.sun.imageio.plugins.jpeg.DQTMarkerSegment(node);
            int firstDHT = findMarkerSegmentPosition(com.sun.imageio.plugins.jpeg.DHTMarkerSegment.class, true);
            int firstSOF = findMarkerSegmentPosition(com.sun.imageio.plugins.jpeg.SOFMarkerSegment.class, true);
    ...
    private void mergeDHTNode(Node node) throws IIOInvalidTreeException {
        ...
        while (iter.hasNext()) {
            MarkerSegment seg = (MarkerSegment) iter.next();
            if (seg instanceof com.sun.imageio.plugins.jpeg.DHTMarkerSegment) {
                oldDHTs.add(seg);
            }
        }
        if (!oldDHTs.isEmpty()) {
            ...
            for (int i = 0; i < children.getLength(); i++) {
                ...
                int childClass = MarkerSegment.getAttributeValue(child,
                                                                 ...
                                                                 0, 1,
                                                                 true);
                com.sun.imageio.plugins.jpeg.DHTMarkerSegment dht = null;
                int tableIndex = -1;
                for (int j = 0; j < oldDHTs.size(); j++) {
                    com.sun.imageio.plugins.jpeg.DHTMarkerSegment testDHT = (com.sun.imageio.plugins.jpeg.DHTMarkerSegment) oldDHTs.get(j);
                    for (int k = 0; k < testDHT.tables.size(); k++) {
                        com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable testTable =
                            (com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable) testDHT.tables.get(k);
                        if ((childID == testTable.tableID) &&
                ...
                if (dht != null) {
                    ...
                    dht = (com.sun.imageio.plugins.jpeg.DHTMarkerSegment) oldDHTs.get(oldDHTs.size()-1);
                    dht.tables.add(dht.getHtableFromNode(child));
                }
            }
        } else {
            com.sun.imageio.plugins.jpeg.DHTMarkerSegment newGuy = new com.sun.imageio.plugins.jpeg.DHTMarkerSegment(node);
            int lastDQT = findMarkerSegmentPosition(com.sun.imageio.plugins.jpeg.DQTMarkerSegment.class, false);
            int firstSOF = findMarkerSegmentPosition(com.sun.imageio.plugins.jpeg.SOFMarkerSegment.class, true);
            int firstSOS = findMarkerSegmentPosition(SOSMarkerSegment.class, true);
            if (lastDQT != -1) {
    ...
    private void insertCOMMarkerSegment(COMMarkerSegment newGuy) {
        ...
        int firstAdobe = findMarkerSegmentPosition(com.sun.imageio.plugins.jpeg.AdobeMarkerSegment.class, true);
        if (lastCOM != -1) {
    ...
    private void mergeAdobeNode(Node node) throws IIOInvalidTreeException {
        ...
        if (adobe != null) {
            ...
            com.sun.imageio.plugins.jpeg.AdobeMarkerSegment newGuy = new com.sun.imageio.plugins.jpeg.AdobeMarkerSegment(node);
     ...
     * at the beginning of the sequence.
     */
    private void insertAdobeMarkerSegment(com.sun.imageio.plugins.jpeg.AdobeMarkerSegment newGuy) {
        boolean hasJFIF =
    ...
    private void mergeSOFNode(Node node) throws IIOInvalidTreeException {
        com.sun.imageio.plugins.jpeg.SOFMarkerSegment sof =
            (com.sun.imageio.plugins.jpeg.SOFMarkerSegment) findMarkerSegment(com.sun.imageio.plugins.jpeg.SOFMarkerSegment.class, true);
        if (sof != null) {
            sof.updateFromNativeNode(node, false);
        } else {
            com.sun.imageio.plugins.jpeg.SOFMarkerSegment newGuy = new com.sun.imageio.plugins.jpeg.SOFMarkerSegment(node);
            int firstSOS = findMarkerSegmentPosition(SOSMarkerSegment.class, true);
            if (firstSOS != -1) {
                markerSequence.add(firstSOS, newGuy);
            } else {
    ...
    private void mergeStandardChromaNode(Node node, NodeList siblings)
        ...
        if (wantAdobe) {
            if ((adobe == null) && !isStream) {
                adobe = new com.sun.imageio.plugins.jpeg.AdobeMarkerSegment(transform);
        ...
        com.sun.imageio.plugins.jpeg.SOFMarkerSegment.ComponentSpec [] oldCompSpecs = null;
        ...
        if (sof != null) {
            ...
            markerSequence.set(markerSequence.indexOf(sof),
                               new com.sun.imageio.plugins.jpeg.SOFMarkerSegment(progressive,
        ...
        if (updateQtables) {
            ...
            if (!tableSegments.isEmpty() && willSubsample) {
                ...
                for (Iterator iter = tableSegments.iterator(); iter.hasNext();) {
                    com.sun.imageio.plugins.jpeg.DQTMarkerSegment testdqt = (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) iter.next();
                    for (Iterator tabiter = testdqt.tables.iterator();
                         tabiter.hasNext();) {
                        com.sun.imageio.plugins.jpeg.DQTMarkerSegment.Qtable tab =
                            (com.sun.imageio.plugins.jpeg.DQTMarkerSegment.Qtable) tabiter.next();
                        if (tab.tableID == 1) {
                            found = true;
                        }
                    }
                ...
                if (!found) {
                    ...
                    com.sun.imageio.plugins.jpeg.DQTMarkerSegment.Qtable table0 = null;
                    for (Iterator iter = tableSegments.iterator(); iter.hasNext();) {
                        com.sun.imageio.plugins.jpeg.DQTMarkerSegment testdqt = (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) iter.next();
                        for (Iterator tabiter = testdqt.tables.iterator();
                             tabiter.hasNext();) {
                    ...
                    com.sun.imageio.plugins.jpeg.DQTMarkerSegment dqt =
                        (com.sun.imageio.plugins.jpeg.DQTMarkerSegment) tableSegments.get(tableSegments.size()-1);
        ...
        if (updateHtables) {
            ...
            if (!tableSegments.isEmpty() && willSubsample) {
                ...
                boolean found = false;
                for (Iterator iter = tableSegments.iterator(); iter.hasNext();) {
                    com.sun.imageio.plugins.jpeg.DHTMarkerSegment testdht = (com.sun.imageio.plugins.jpeg.DHTMarkerSegment) iter.next();
                    for (Iterator tabiter = testdht.tables.iterator();
                         tabiter.hasNext();) {
                        com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable tab =
                            (com.sun.imageio.plugins.jpeg.DHTMarkerSegment.Htable) tabiter.next();
                        if (tab.tableID == 1) {
                            found = true;
                        }
                    }
                ...
                if (!found) {
                    ...
                    com.sun.imageio.plugins.jpeg.DHTMarkerSegment lastDHT =
                        (com.sun.imageio.plugins.jpeg.DHTMarkerSegment) tableSegments.get(tableSegments.size()-1);
        ...
        if (jfif == null) {
            ...
            if (sof != null) {
                ...
                if ((numChannels == 1) || (numChannels == 3)) {
                    ...
                    com.sun.imageio.plugins.jpeg.AdobeMarkerSegment adobe =
                        (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) findMarkerSegment(com.sun.imageio.plugins.jpeg.AdobeMarkerSegment.class,
                                                               true);
                    if (adobe != null) {
    ...
    private void mergeStandardTransparencyNode(Node node)
        ...
        if (!transparencyDone && !isStream) {
            ...
            JFIFMarkerSegment jfif = (JFIFMarkerSegment) findMarkerSegment
                (JFIFMarkerSegment.class, true);
            com.sun.imageio.plugins.jpeg.AdobeMarkerSegment adobe = (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) findMarkerSegment
                (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment.class, true);
            com.sun.imageio.plugins.jpeg.SOFMarkerSegment sof = (com.sun.imageio.plugins.jpeg.SOFMarkerSegment) findMarkerSegment
                (com.sun.imageio.plugins.jpeg.SOFMarkerSegment.class, true);
            ...
            if (sof != null) {
                ...
                if (hadAlpha != wantAlpha) {
                    if (wantAlpha) {  // Adding alpha
                        ...
                        com.sun.imageio.plugins.jpeg.SOFMarkerSegment.ComponentSpec [] newSpecs =
                            new com.sun.imageio.plugins.jpeg.SOFMarkerSegment.ComponentSpec[numChannels];
                        for (int i = 0; i < sof.componentSpecs.length; i++) {
    ...
    void setFromMarkerSequenceNode(Node markerSequenceNode)
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (childName.equals("dqt")) {
                markerSequence.add(new com.sun.imageio.plugins.jpeg.DQTMarkerSegment(node));
            } else if (childName.equals("dht")) {
                markerSequence.add(new com.sun.imageio.plugins.jpeg.DHTMarkerSegment(node));
                ...
                markerSequence.add(new com.sun.imageio.plugins.jpeg.AdobeMarkerSegment(node));
            } else if (childName.equals("unknown")) {
                markerSequence.add(new MarkerSegment(node));
            } else if (childName.equals("sof")) {
                markerSequence.add(new com.sun.imageio.plugins.jpeg.SOFMarkerSegment(node));
    ...
    private boolean isConsistent() {
        com.sun.imageio.plugins.jpeg.SOFMarkerSegment sof =
            (com.sun.imageio.plugins.jpeg.SOFMarkerSegment) findMarkerSegment(com.sun.imageio.plugins.jpeg.SOFMarkerSegment.class,
                                                 true);
        JFIFMarkerSegment jfif =
    ...
    void writeToStream(ImageOutputStream ios,
        ...
        while(iter.hasNext()) {
            ...
            } else if (seg instanceof com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) {
                if (ignoreAdobe == false) {
                    if (newAdobeTransform != JPEG.ADOBE_IMPOSSIBLE) {
                        com.sun.imageio.plugins.jpeg.AdobeMarkerSegment newAdobe =
                            (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) seg.clone();
                        newAdobe.transform = newAdobeTransform;
                        newAdobe.write(ios);
                    } else if (forceJFIF) {
                        // If adobe isn't JFIF compatible, ignore it
                        com.sun.imageio.plugins.jpeg.AdobeMarkerSegment adobe = (com.sun.imageio.plugins.jpeg.AdobeMarkerSegment) seg;
