...
package java8.sun.org.apache.xerces.internal.impl.xpath;
...
public class XPath {
    ...
    private void parseExpression(final NamespaceContext context)
        ...
        // tokens
        final com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens xtokens = new com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens(fSymbolTable);

        // scanner
        com.sun.org.apache.xerces.internal.impl.xpath.XPath.Scanner scanner = new com.sun.org.apache.xerces.internal.impl.xpath.XPath.Scanner(fSymbolTable) {
            protected void addToken(com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens tokens, int token)
                throws XPathException {
                if (
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_ATSIGN ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_ATTRIBUTE ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_QNAME ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_SLASH ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_PERIOD ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_ANY ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_NAMESPACE ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_DOUBLE_SLASH ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_UNION ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_CHILD ||
                    token == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_DOUBLE_COLON
                    ) {
        ...
        while(xtokens.hasMore()) {
            ...
            switch (token) {
                case  com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_UNION :{
                    check(!expectingStep);
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_ATSIGN: {
                    check(expectingStep);
                    Step step = new Step(
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_ANY:
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_NAMESPACE:
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_QNAME: {
                    check(expectingStep);
                    Step step = new Step(
                            new Axis(Axis.CHILD),
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_PERIOD: {
                    check(expectingStep);
                    expectingStep=false;
                    ...
                    if (stepsVector.size()==0) {
                        ...
                        if( xtokens.hasMore()
                         && xtokens.peekToken() == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_DOUBLE_SLASH){
                            // consume '//'
                            xtokens.nextToken();
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_DOUBLE_SLASH:{
                    // this cannot appear in arbitrary position.
                    // it is only allowed right after '.' when
                    // '.' is the first token of a location path.
                    throw new XPathException("c-general-xpath");
                }
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_SLASH: {
                    check(!expectingStep);
                    expectingStep=true;
                    break;
                }
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_ATTRIBUTE: {
                     check(expectingStep);
                     expectingDoubleColon = true;

                     if (xtokens.nextToken() == com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_DOUBLE_COLON){
                         Step step = new Step(
                         new Axis(Axis.ATTRIBUTE),
                                 parseNodeTest(xtokens.nextToken(),xtokens,context));
                         stepsVector.addElement(step);
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_CHILD:{
                    check(expectingStep);
                    expectingDoubleColon = true;
                    break;
                }
                case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_DOUBLE_COLON :{
                    check(expectingStep);
    ...
    private NodeTest parseNodeTest( int typeToken, Tokens xtokens, NamespaceContext context )
        ...
        case com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_QNAME:
            ...
            if (typeToken== com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_NAMESPACE)
...
//        }
    ...
    private static class Scanner {
        ...
        public boolean scanExpr(SymbolTable symbolTable,
                                com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens tokens, String data,
            ...
            while (true) {
                ...
                case CHARTYPE_OPEN_PAREN:       // '('
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPEN_PAREN);
                ...
                case CHARTYPE_CLOSE_PAREN:      // ')'
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_CLOSE_PAREN);
                ...
                case CHARTYPE_OPEN_BRACKET:     // '['
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPEN_BRACKET);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                ...
                case CHARTYPE_CLOSE_BRACKET:    // ']'
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_CLOSE_BRACKET);
                    starIsMultiplyOperator = true;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                ...
                case CHARTYPE_PERIOD:           // '.', '..' or '.' Digits
                    if (currentOffset + 1 == endOffset) {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_PERIOD);
                        starIsMultiplyOperator = true;
                        currentOffset++;
                        break;
                    }
                    ...
                    if (ch == '.') {            // '..'
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_DOUBLE_PERIOD);
                        starIsMultiplyOperator = true;
                        currentOffset += 2;
                    } else if (ch >= '0' && ch <= '9') {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NUMBER);
                        starIsMultiplyOperator = true;
                ...
                case CHARTYPE_ATSIGN:           // '@'
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_ATSIGN);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                    break;
                case CHARTYPE_COMMA:            // ','
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_COMMA);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                ...
                // System.out.println("abort 1b");
                    ...
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_DOUBLE_COLON);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                ...
                case CHARTYPE_SLASH:            // '/' and '//'
                    if (++currentOffset == endOffset) {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_SLASH);
                        starIsMultiplyOperator = false;
                        break;
                    }
                    ch = data.charAt(currentOffset);
                    if (ch == '/') { // '//'
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_DOUBLE_SLASH);
                        starIsMultiplyOperator = false;
                        if (++currentOffset == endOffset) {
                            break;
                        }
                    ...
                    break;
                case CHARTYPE_UNION:            // '|'
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_UNION);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                    break;
                case CHARTYPE_PLUS:             // '+'
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_PLUS);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                    break;
                case CHARTYPE_MINUS:            // '-'
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_MINUS);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                    break;
                case CHARTYPE_EQUAL:            // '='
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_EQUAL);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                ...
                // System.out.println("abort 2b");
                    ...
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_NOT_EQUAL);
                    starIsMultiplyOperator = false;
                    if (++currentOffset == endOffset) {
                        break;
                    }
                ...
                case CHARTYPE_LESS: // '<' and '<='
                    if (++currentOffset == endOffset) {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_LESS);
                        starIsMultiplyOperator = false;
                        break;
                    }
                    ch = data.charAt(currentOffset);
                    if (ch == '=') { // '<='
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_LESS_EQUAL);
                        starIsMultiplyOperator = false;
                        if (++currentOffset == endOffset) {
                            break;
                        }
                ...
                case CHARTYPE_GREATER: // '>' and '>='
                    if (++currentOffset == endOffset) {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_GREATER);
                        starIsMultiplyOperator = false;
                        break;
                    }
                    ch = data.charAt(currentOffset);
                    if (ch == '=') { // '>='
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_GREATER_EQUAL);
                        starIsMultiplyOperator = false;
                        if (++currentOffset == endOffset) {
                            break;
                        }
                ...
                // System.out.println("abort 2d");
                    ...
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_LITERAL);
                    starIsMultiplyOperator = true;
                ...
                // System.out.println("abort 4b");
                    ...
                    addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_VARIABLE_REFERENCE);
                    starIsMultiplyOperator = true;
                ...
                case CHARTYPE_STAR:             // '*'
                    ...
                    if (starIsMultiplyOperator) {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_MULT);
                        starIsMultiplyOperator = false;
                    } else {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_ANY);
                        starIsMultiplyOperator = true;
                    }
                    if (++currentOffset == endOffset) {
                        break;
                ...
                // System.out.println("abort 5b");
                    ...
                    if (starIsMultiplyOperator) {
                        if (nameHandle == fAndSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_AND);
                            starIsMultiplyOperator = false;
                        } else if (nameHandle == fOrSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_OR);
                            starIsMultiplyOperator = false;
                        } else if (nameHandle == fModSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_MOD);
                            starIsMultiplyOperator = false;
                        } else if (nameHandle == fDivSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPERATOR_DIV);
                            starIsMultiplyOperator = false;
                        } else {
                ...
                // System.out.println("abort 8");
                    ...
                    if (ch == '(' && !isNameTestNCName && !isAxisName) {
                        if (nameHandle == fCommentSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NODETYPE_COMMENT);
                        } else if (nameHandle == fTextSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NODETYPE_TEXT);
                        } else if (nameHandle == fPISymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NODETYPE_PI);
                        } else if (nameHandle == fNodeSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NODETYPE_NODE);
                        } else {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_FUNCTION_NAME);
                            tokens.addToken(prefixHandle);
                            tokens.addToken(nameHandle);
                        }
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_OPEN_PAREN);
                    ...
                    if (isAxisName ||
                        ...
                        if (nameHandle == fAncestorSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_ANCESTOR);
                        } else if (nameHandle == fAncestorOrSelfSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF);
                        } else if (nameHandle == fAttributeSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_ATTRIBUTE);
                        } else if (nameHandle == fChildSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_CHILD);
                        } else if (nameHandle == fDescendantSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_DESCENDANT);
                        } else if (nameHandle == fDescendantOrSelfSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF);
                        } else if (nameHandle == fFollowingSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_FOLLOWING);
                        } else if (nameHandle == fFollowingSiblingSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING);
                        } else if (nameHandle == fNamespaceSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_NAMESPACE);
                        } else if (nameHandle == fParentSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_PARENT);
                        } else if (nameHandle == fPrecedingSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_PRECEDING);
                        } else if (nameHandle == fPrecedingSiblingSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_PRECEDING_SIBLING);
                        } else if (nameHandle == fSelfSymbol) {
                            addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_AXISNAME_SELF);
                        } else {
                ...
                // System.out.println("abort 10");
                    ...
                    //
                    if (isNameTestNCName) {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_NAMESPACE);
                        starIsMultiplyOperator = true;
                        tokens.addToken(nameHandle);
                    } else {
                        addToken(tokens, com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.EXPRTOKEN_NAMETEST_QNAME);
                        starIsMultiplyOperator = true;
                        tokens.addToken(prefixHandle);
                        tokens.addToken(nameHandle);
                    }
            ...
            if (com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens.DUMP_TOKENS) {
                tokens.dumpTokens();
            }
            return true;
        }
        ...
        // [31] Digits ::= [0-9]+
        //
        private int scanNumber(com.sun.org.apache.xerces.internal.impl.xpath.XPath.Tokens tokens, String/*byte[]*/ data, int endOffset, int currentOffset/*, EncodingSupport encoding*/) {
            int ch = data.charAt(currentOffset);
            int whole = 0;
            int part = 0;
            while (ch >= '0' && ch <= '9') {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            try {
                ...
                com.sun.org.apache.xerces.internal.impl.xpath.XPath xpath = new com.sun.org.apache.xerces.internal.impl.xpath.XPath(expression, symbolTable, null);
