...
public class Parser implements Constants, ContentHandler {
    ...
    public void setOutput(com.sun.org.apache.xalan.internal.xsltc.compiler.Output output) {
        if (_output != null) {
    ...
    public void addVariable(com.sun.org.apache.xalan.internal.xsltc.compiler.Variable var) {
    ...
    public void removeVariable(com.sun.org.apache.xalan.internal.xsltc.compiler.QName name) {
    ...
    public VariableBase lookupVariable(com.sun.org.apache.xalan.internal.xsltc.compiler.QName name) {
        Object existing = _variableScope.get(name);
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQNameSafe(final String stringRep) {
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQName(final String stringRep) {
        return getQName(stringRep, true, false);
    }

    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQNameIgnoreDefaultNs(final String stringRep) {
        return getQName(stringRep, true, true);
    }

    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQName(final String stringRep, boolean reportError) {
        return getQName(stringRep, reportError, false);
    }

    private com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQName(final String stringRep, boolean reportError,
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQName(String namespace, String prefix, String localname) {
        if (namespace == null || namespace.equals(EMPTYSTRING)) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.QName name = (com.sun.org.apache.xalan.internal.xsltc.compiler.QName)_qNames.get(localname);
            if (name == null) {
                name = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(null, prefix, localname);
            ...
            if (space == null) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.QName name = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(namespace, prefix, localname);
                _namespaces.put(namespace, space = new Hashtable());
                space.put(lexicalQName, name);
                return name;
            }
            else {
                com.sun.org.apache.xalan.internal.xsltc.compiler.QName name = (com.sun.org.apache.xalan.internal.xsltc.compiler.QName)space.get(lexicalQName);
                if (name == null) {
                    name = new com.sun.org.apache.xalan.internal.xsltc.compiler.QName(namespace, prefix, localname);
                    space.put(lexicalQName, name);
                }
                return name;
            }
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQName(String scope, String name) {
        return getQName(scope + name);
    }

    public com.sun.org.apache.xalan.internal.xsltc.compiler.QName getQName(com.sun.org.apache.xalan.internal.xsltc.compiler.QName scope, com.sun.org.apache.xalan.internal.xsltc.compiler.QName name) {
        ...
        try {
            if (stylesheet != null) {
                ...
                while (elements.hasMoreElements()) {
                    ...
                    if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Text) {
        ...
        String local, Attributes attributes)
    {
        ...
        com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname = getQName(uri, prefix, local);
        ...
        if (className != null) {
            ...
            if (uri != null) {
                ...
                if (uri.equals(XSLT_URI)) {
                    node = new com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement(uri, prefix, local, false);
                    com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement element = (com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement)node;
                ...
                // Check if this is an XSLTC extension element
                    ...
                    node = new com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement(uri, prefix, local, true);
                    com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement element = (com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement)node;
                ...
                // Check if this is an extension of some other XSLT processor
                    ...
                    if ((sheet != null) && (sheet.isExtension(uri))) {
                        if (sheet != (SyntaxTreeNode)_parentStack.peek()) {
                            node = new com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement(uri, prefix, local, true);
                            com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement elem = (com.sun.org.apache.xalan.internal.xsltc.compiler.UnsupportedElement)node;
                            ErrorMsg msg =
            ...
            if (node == null) {
                node = new com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement();
                node.setLineNumber(getLineNumber());
            }
        }
        if ((node != null) && (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement)) {
            ((com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement)node).setQName(qname);
        }
        return(node);
    }
    ...
    private void checkForSuperfluousAttributes(SyntaxTreeNode node,
        Attributes attrs)
    {
        com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname = node.getQName();
    ...
    private SyntaxTreeNode parseTopLevel(SyntaxTreeNode parent, String text,
        ...
        try {
            _xpathParser.setScanner(new com.sun.org.apache.xalan.internal.xsltc.compiler.XPathLexer(new StringReader(text)));
...
// System.out.println("e = " + text + " " + node);
    ...
    public void characters(char[] ch, int start, int length) {
        ...
        if (parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Text) {
            ((com.sun.org.apache.xalan.internal.xsltc.compiler.Text)parent).setText(string);
            return;
        }
        ...
        if ((bro != null) && (bro instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Text)) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.Text text = (com.sun.org.apache.xalan.internal.xsltc.compiler.Text)bro;
        ...
        parent.addElement(new com.sun.org.apache.xalan.internal.xsltc.compiler.Text(string));
    }
