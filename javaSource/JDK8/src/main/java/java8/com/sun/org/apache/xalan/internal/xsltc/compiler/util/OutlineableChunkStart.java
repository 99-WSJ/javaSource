...
class OutlineableChunkStart extends MarkerInstruction {
    /**
     * A constant instance of {@link com.sun.org.apache.xalan.internal.xsltc.compiler.util.OutlineableChunkStart}.  As it has no fields,
     * there should be no need to create an instance of this class.
     */
    public static final Instruction OUTLINEABLECHUNKSTART =
                                                new com.sun.org.apache.xalan.internal.xsltc.compiler.util.OutlineableChunkStart();

    /**
     * Private default constructor.  As it has no fields,
     * there should be no need to create an instance of this class.  See
     * {@link com.sun.org.apache.xalan.internal.xsltc.compiler.util.OutlineableChunkStart#OUTLINEABLECHUNKSTART}.
     */
    ...
    public String getName() {
        return com.sun.org.apache.xalan.internal.xsltc.compiler.util.OutlineableChunkStart.class.getName();
    }
