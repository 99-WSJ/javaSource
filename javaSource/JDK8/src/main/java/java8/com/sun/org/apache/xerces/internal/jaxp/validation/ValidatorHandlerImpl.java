...
final class ValidatorHandlerImpl extends ValidatorHandler implements
    DTDHandler, EntityState, PSVIProvider, com.sun.org.apache.xerces.internal.jaxp.validation.ValidatorHelper, XMLDocumentHandler {
    ...
    public ValidatorHandlerImpl(XSGrammarPoolContainer grammarContainer) {
        this(new com.sun.org.apache.xerces.internal.jaxp.validation.XMLSchemaValidatorComponentManager(grammarContainer));
    ...
    public ValidatorHandlerImpl(com.sun.org.apache.xerces.internal.jaxp.validation.XMLSchemaValidatorComponentManager componentManager) {
    ...
    public void validate(Source source, Result result)
        ...
        if (result instanceof SAXResult || result == null) {
            ...
            try {
                ...
                reader.setErrorHandler(errorHandler != null ? errorHandler : com.sun.org.apache.xerces.internal.jaxp.validation.DraconianErrorHandler.getInstance());
    ...
    private class XMLSchemaTypeInfoProvider extends TypeInfoProvider {
        ...
        private void checkState(boolean forElementInfo) {
            if (! (fInStartElement || (fInEndElement && forElementInfo))) {
                throw new IllegalStateException(com.sun.org.apache.xerces.internal.jaxp.validation.JAXPValidationMessageFormatter.formatMessage(fComponentManager.getLocale(),
