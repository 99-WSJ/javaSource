...
class NetMaskImpl extends PrincipalImpl implements Group, Serializable {
    ...
    private byte[] extractSubNet(byte[] b) {
        ...
        if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
            SNMP_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.IPAcl.NetMaskImpl.class.getName(),
        ...
        if(fullyCoveredByte == addrLength) {
            if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
                SNMP_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.IPAcl.NetMaskImpl.class.getName(), "extractSubNet",
   ...
   */
    public boolean equals (Object p) {
        if (p instanceof PrincipalImpl || p instanceof com.sun.jmx.snmp.IPAcl.NetMaskImpl){
            PrincipalImpl received = (PrincipalImpl) p;
            InetAddress addr = received.getAddress();
            if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
                SNMP_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.IPAcl.NetMaskImpl.class.getName(), "equals",
