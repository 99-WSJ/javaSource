...
public class AnyImpl extends Any
{
    ...
    static com.sun.corba.se.impl.corba.AnyImpl convertToNative(ORB orb, Any any) {
        if (any instanceof com.sun.corba.se.impl.corba.AnyImpl) {
            return (com.sun.corba.se.impl.corba.AnyImpl)any;
        } else {
            com.sun.corba.se.impl.corba.AnyImpl anyImpl = new com.sun.corba.se.impl.corba.AnyImpl(orb, any);
    ...
    public AnyImpl(ORB orb, Any obj) {
        ...
        if ((obj instanceof com.sun.corba.se.impl.corba.AnyImpl)) {
            com.sun.corba.se.impl.corba.AnyImpl objImpl = (com.sun.corba.se.impl.corba.AnyImpl)obj;
    ...
    public InputStream create_input_stream()
    {
        ...
        if (com.sun.corba.se.impl.corba.AnyImpl.isStreamed[realType().kind().value()]) {
            return stream.dup();
        } else {
    ...
    public void read_value(InputStream in, TypeCode tc)
    {
        ...
        if (com.sun.corba.se.impl.corba.AnyImpl.isStreamed[kind]) {
