        ...
        OutboundConnectionCache
{
    ...
    protected void registerWithMonitoring()
    {
        ...
        attribute = new
                ...
                MonitoringConstants.CONNECTION_TOTAL_NUMBER_OF_CONNECTIONS_DESCRIPTION)
            {
                public Object getValue() {
                    return new Long(com.sun.corba.se.impl.transport.CorbaOutboundConnectionCacheImpl.this.numberOfConnections());
                }
            };
        ...
        attribute = new
            ...
            {
                public Object getValue() {
                    return new Long(com.sun.corba.se.impl.transport.CorbaOutboundConnectionCacheImpl.this.numberOfIdleConnections());
                }
            };
        thisMO.addAttribute(attribute);
        ...
        attribute = new
            ...
            {
                public Object getValue() {
                    return new Long(com.sun.corba.se.impl.transport.CorbaOutboundConnectionCacheImpl.this.numberOfBusyConnections());
                }
            };
        thisMO.addAttribute(attribute);
    }
