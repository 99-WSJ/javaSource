...
public class SnmpOidTableSupport implements SnmpOidTable {
            ...
            for (int i = 0; ; i++) {
                ...
                if (SNMP_LOGGER.isLoggable(Level.FINER)) {
                    SNMP_LOGGER.logp(Level.FINER,
                            com.sun.jmx.snmp.SnmpOidTableSupport.class.getName(),
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof com.sun.jmx.snmp.SnmpOidTableSupport)) {
            return false;
        }
        com.sun.jmx.snmp.SnmpOidTableSupport val = (com.sun.jmx.snmp.SnmpOidTableSupport) object;
