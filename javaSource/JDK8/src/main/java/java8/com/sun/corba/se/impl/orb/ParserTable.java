...
public class ParserTable {
    private static String MY_CLASS_NAME = com.sun.corba.se.impl.orb.ParserTable.class.getName() ;

    private static com.sun.corba.se.impl.orb.ParserTable myInstance = new com.sun.corba.se.impl.orb.ParserTable() ;

    private ORBUtilSystemException wrapper ;

    public static com.sun.corba.se.impl.orb.ParserTable get()
    {
        return myInstance ;
    }
