...
abstract class XSDAbstractTraverser {
    ...
    XSAnnotationImpl traverseAnnotationDecl(Element annotationDecl, Object[] parentAttrs,
            boolean isGlobal, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDocumentInfo schemaDoc) {
        ...
        if(annotationLocalAttrs != null && !annotationLocalAttrs.isEmpty()) {
            ...
            if (fValidateAnnotations) {
                schemaDoc.addAnnotation(new com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAnnotationInfo(annotation, annotationDecl));
            }
            return new XSAnnotationImpl(annotation, grammar);
        } else {
            if (fValidateAnnotations) {
                schemaDoc.addAnnotation(new com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAnnotationInfo(contents, annotationDecl));
            }
    ...
    XSAnnotationImpl traverseSyntheticAnnotation(Element annotationParent, String initialContent,
            Object[] parentAttrs, boolean isGlobal, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDocumentInfo schemaDoc) {
        ...
        if (annotationLocalAttrs != null && !annotationLocalAttrs.isEmpty()) {
            ...
            final String annotation = contentBuffer.toString();
            if (fValidateAnnotations) {
                schemaDoc.addAnnotation(new com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAnnotationInfo(annotation, annotationParent));
            }
            return new XSAnnotationImpl(annotation, grammar);
        } else {
            if (fValidateAnnotations) {
                schemaDoc.addAnnotation(new com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAnnotationInfo(contents, annotationParent));
            }
            return new XSAnnotationImpl(contents, grammar);
        }
    }
