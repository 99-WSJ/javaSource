...
final class SnmpQManager implements Serializable {
    ...
    private com.sun.jmx.snmp.daemon.SendQ newq ;
    private com.sun.jmx.snmp.daemon.WaitQ waitq ;
    ...
    SnmpQManager() {
        newq = new com.sun.jmx.snmp.daemon.SendQ(20, 5) ;
        waitq = new com.sun.jmx.snmp.daemon.WaitQ(20, 5) ;
    ...
    public synchronized void waitOnThisQueue(long time) {
        if (time == 0 && !isEmpty()) {
            if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.daemon.SnmpQManager.class.getName(),
