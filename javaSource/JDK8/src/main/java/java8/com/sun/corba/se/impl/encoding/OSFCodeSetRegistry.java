...
public final class OSFCodeSetRegistry
{
    ...
    public final static class Entry
    {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.Entry))
                return false;

            com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.Entry other
                = (com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.Entry)obj;
    ...
    public static Entry lookupEntry(int encodingValue) {
        switch(encodingValue) {
            case ISO_8859_1_VALUE:
                return com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.ISO_8859_1;
            case UTF_16_VALUE:
                return com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.UTF_16;
            case UTF_8_VALUE:
                return com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.UTF_8;
            case ISO_646_VALUE:
                return com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.ISO_646;
            case UCS_2_VALUE:
                return com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.UCS_2;
            default:
                return null;
        }
    }
