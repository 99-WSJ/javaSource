...
final class UseAttributeSets extends Instruction {
    ...
    public void addAttributeSets(String setNames) {
        if ((setNames != null) && (!setNames.equals(Constants.EMPTYSTRING))) {
            ...
            while (tokens.hasMoreTokens()) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname =
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        for (int i=0; i<_sets.size(); i++) {
            ...
            final com.sun.org.apache.xalan.internal.xsltc.compiler.QName name = (com.sun.org.apache.xalan.internal.xsltc.compiler.QName)_sets.elementAt(i);
