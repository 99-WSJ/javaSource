...
public class MotifCheckBoxUI extends MotifRadioButtonUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.motif.MotifCheckBoxUI motifCheckBoxUI =
                (com.sun.java.swing.plaf.motif.MotifCheckBoxUI) appContext.get(MOTIF_CHECK_BOX_UI_KEY);
        if (motifCheckBoxUI == null) {
            motifCheckBoxUI = new com.sun.java.swing.plaf.motif.MotifCheckBoxUI();
