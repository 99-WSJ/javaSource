...
import java8.com.sun.jmx.snmp.agent.SnmpMibSubRequest;
import java8.com.sun.jmx.snmp.agent.SnmpTableEntryNotification;
...
public abstract class SnmpMibTable extends SnmpMibNode
    ...
    public void check(SnmpMibSubRequest req, int depth)
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.agent.SnmpMibTable.class.getName(),
            ...
            if (isnew) {
                if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                    SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                            com.sun.jmx.snmp.agent.SnmpMibTable.class.getName(),
    ...
    SnmpOid getNextOid(long[] oid, int pos, Object userData)
        ...
        // variable oid.
        //
        final SnmpOid resOid = new com.sun.jmx.snmp.agent.SnmpEntryOid(oid,pos);
    ...
    final synchronized void findHandlingNode(SnmpVarBind varbind,
        ...
        final SnmpOid entryoid = new com.sun.jmx.snmp.agent.SnmpEntryOid(oid, depth+2);
    ...
    final synchronized long[] findNextHandlingNode(SnmpVarBind varbind,
                                                   ...
                                                   int depth,
                                                   SnmpRequestTree handlers,
                                                   com.sun.jmx.snmp.agent.AcmChecker checker)
        throws SnmpStatusException {
    ...
    private long[] findNextAccessibleOid(SnmpOid entryoid,
                                         ...
                                         com.sun.jmx.snmp.agent.AcmChecker checker, Object data,
                                         long var)
        throws SnmpStatusException {
        final int pduVersion = handlers.getRequestPduVersion();
