...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/IOR.mc on Tue Mar 04 03:47:28 PST 2014
...
public class IORSystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.IORSystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.IORSystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.IORSystemException wrapper =
            (com.sun.corba.se.impl.logging.IORSystemException) orb.getLogWrapper( logDomain,
                "IOR", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.IORSystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.IORSystemException wrapper =
            (com.sun.corba.se.impl.logging.IORSystemException) ORB.staticGetLogWrapper( logDomain,
                "IOR", factory ) ;
        return wrapper ;
    } 
    ...
    public INTERNAL ortNotInitialized( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "IOR.ortNotInitialized",
                parameters, com.sun.corba.se.impl.logging.IORSystemException.class, exc ) ;
        }
