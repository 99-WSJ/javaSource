...
public class WindowsRadioButtonUI extends BasicRadioButtonUI
{
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.windows.WindowsRadioButtonUI windowsRadioButtonUI =
                (com.sun.java.swing.plaf.windows.WindowsRadioButtonUI) appContext.get(WINDOWS_RADIO_BUTTON_UI_KEY);
        if (windowsRadioButtonUI == null) {
            windowsRadioButtonUI = new com.sun.java.swing.plaf.windows.WindowsRadioButtonUI();
