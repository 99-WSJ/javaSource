    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        if (tleft.isSimple() && tright.isSimple()) {
            if (tleft != tright) {
                if (tleft instanceof BooleanType) {
                    _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, Type.Boolean);
                }
                else if (tright instanceof BooleanType) {
                    _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left, Type.Boolean);
                }
                else if (tleft instanceof NumberType ||
                         tright instanceof NumberType) {
                    _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left, Type.Real);
                    _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, Type.Real);
                }
                else {          // both compared as strings
                    _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left,   Type.String);
                    _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, Type.String);
                }
            }
        }
        else if (tleft instanceof ReferenceType) {
            _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, Type.Reference);
        }
        else if (tright instanceof ReferenceType) {
            _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left, Type.Reference);
        }
        ...
        // optimize node/node
            ...
            if (tleft instanceof NodeType) {
                _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left, Type.NodeSet);
            }
            if (tright instanceof NodeType) {
                _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, Type.NodeSet);
            }
