...
public class XSComplexTypeDecl implements XSComplexTypeDefinition, TypeInfo {
   ...
   public void setName(String name) {
    ...
    public XSCMValidator getContentModel(CMBuilder cmBuilder) {
        ...
        if (fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_SIMPLE ||
            fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_EMPTY) {
            return null;
        }
            ...
            if(!(fName.equals(SchemaSymbols.ATTVAL_ANYTYPE)
                ...
                if (fBaseType != null && fBaseType instanceof XSSimpleTypeDecl) {
                    ...
                    return ((XSSimpleTypeDecl) fBaseType).isDOMDerivedFrom(ancestorNS,
                        ...
                        && fBaseType instanceof com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) {
                    return ((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) fBaseType).isDOMDerivedFrom(
    ...
    private boolean isDerivedByRestriction(String ancestorNS,
        ...
        while (type != null && type != oldType) {
            ...
            if (type instanceof XSSimpleTypeDecl) {
                ...
                if (((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) type).getDerivationMethod() != XSConstants.DERIVATION_RESTRICTION) {
                    return false;
                }
            }
            oldType = type;
    ...
    private boolean isDerivedByExtension(String ancestorNS,
        ...
        while (type != null && type != oldType) {
            ...
            if (type instanceof XSSimpleTypeDecl) {
                ...
                // extension.
                if (((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) type).getDerivationMethod() == XSConstants.DERIVATION_EXTENSION) {
