 ...
 */
final class Sort extends com.sun.org.apache.xalan.internal.xsltc.compiler.Instruction implements Closure {

    private Expression     _select;
    private com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue _order;
    private com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue _caseOrder;
    private com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue _dataType;
     ...
     */
    public void addVariable(com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase variableRef) {
    ...
    public void parseContents(Parser parser) {
        ...
        if (!(parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ApplyTemplates) &&
            !(parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ForEach)) {
        ...
        _order = com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue.create(this, val, parser);
        ...
        _dataType = com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue.create(this, val, parser);
  ...
  // _lang = AttributeValue.create(this, val, parser);
    ...
    _caseOrder = com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue.create(this, val, parser);
        ...
        ClassGenerator classGen, MethodGenerator methodGen)
    {
        ...
        for (int i = 0; i < nsorts; i++) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Sort sort = (com.sun.org.apache.xalan.internal.xsltc.compiler.Sort) sortObjects.elementAt(i);
        ...
        for (int level = 0; level < nsorts; level++) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Sort sort = (com.sun.org.apache.xalan.internal.xsltc.compiler.Sort)sortObjects.elementAt(level);
            il.append(DUP);
        ...
        for (int j = 0; j < nsorts; j++) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Sort sort = (com.sun.org.apache.xalan.internal.xsltc.compiler.Sort) sortObjects.get(j);
            final int length = (sort._closureVars == null) ? 0 :
                sort._closureVars.size();

            for (int i = 0; i < length; i++) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase varRef = (com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase) sort._closureVars.get(i);
    ...
    public static String compileSortRecordFactory(Vector sortObjects,
        ...
        String sortRecordClass)
    {
        final XSLTC  xsltc = ((com.sun.org.apache.xalan.internal.xsltc.compiler.Sort)sortObjects.firstElement()).getXSLTC();
        ...
        for (int j = 0; j < nsorts; j++) {
            ...
            for (int i = 0; i < length; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase varRef = (com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase) sort._closureVars.get(i);
  ...
  il.append(new ALOAD(7));
    ...
    + "[" + STRING_SIG
        ...
        for (int i = 0; i < ndups; i++) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase varRef = (com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase) dups.get(i);
            final VariableBase var = varRef.getVariable();
