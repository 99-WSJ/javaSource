...
public final class TypeCodeImpl extends TypeCode
{
    ...
    private com.sun.corba.se.impl.corba.TypeCodeImpl _memberTypes[]  = null; // types of members
    private AnyImpl         _unionLabels[]  = null; // values of union labels
    private com.sun.corba.se.impl.corba.TypeCodeImpl _discriminator  = null; // union discriminator type
    private int             _defaultIndex   = -1;   // union default index
    private int             _length         = 0;    // string/seq/array length
    private com.sun.corba.se.impl.corba.TypeCodeImpl _contentType    = null; // seq/array/alias type
    // fixed
    ...
    private com.sun.corba.se.impl.corba.TypeCodeImpl _concrete_base  = null; // concrete base type
    private short           _memberAccess[] = null; // visibility of ValueMember
    // recursive sequence support
    private com.sun.corba.se.impl.corba.TypeCodeImpl _parent         = null; // the enclosing type code
    private int             _parentOffset   = 0;    // the level of enclosure
    // recursive type code support
    private com.sun.corba.se.impl.corba.TypeCodeImpl _indirectType   = null;
    ...
    // also see the 'convertToNative(ORB orb, TypeCode tc)' function
    {
        ...
        if (tc instanceof com.sun.corba.se.impl.corba.TypeCodeImpl) {
            com.sun.corba.se.impl.corba.TypeCodeImpl tci = (com.sun.corba.se.impl.corba.TypeCodeImpl)tc;
        ...
        try {
            ...
            case TCKind._tk_union:
                // set up member types
                _memberTypes = new com.sun.corba.se.impl.corba.TypeCodeImpl[tc.member_count()];
                for (int i=0; i < tc.member_count(); i++) {
                        ...
                        // for structs and exceptions
    {
        ...
        if ((creationKind == TCKind._tk_struct) || (creationKind == TCKind._tk_except)) {
            ...
            _memberTypes = new com.sun.corba.se.impl.corba.TypeCodeImpl[_memberCount];
    ...
    //
    protected static com.sun.corba.se.impl.corba.TypeCodeImpl convertToNative(ORB orb,
                                                                              TypeCode tc)
    {
        if (tc instanceof com.sun.corba.se.impl.corba.TypeCodeImpl)
            return (com.sun.corba.se.impl.corba.TypeCodeImpl) tc;
        else
            return new com.sun.corba.se.impl.corba.TypeCodeImpl(orb, tc);
    }
    ...
    private com.sun.corba.se.impl.corba.TypeCodeImpl indirectType() {
    ...
    private com.sun.corba.se.impl.corba.TypeCodeImpl tryIndirectType() {
    ...
    private void setIndirectType(com.sun.corba.se.impl.corba.TypeCodeImpl newType) {
    ...
    private void setParent(com.sun.corba.se.impl.corba.TypeCodeImpl parent) {
        _parent = parent;
    }

    private com.sun.corba.se.impl.corba.TypeCodeImpl getParentAtLevel(int level) {
        if (level == 0)
            return this;
    ...
    private com.sun.corba.se.impl.corba.TypeCodeImpl lazy_content_type() {
        if (_contentType == null) {
            if (_kind == TCKind._tk_sequence && _parentOffset > 0 && _parent != null) {
                ...
                com.sun.corba.se.impl.corba.TypeCodeImpl realParent = getParentAtLevel(_parentOffset);
                if (realParent != null && realParent._id != null) {
                    ...
                    _contentType = new com.sun.corba.se.impl.corba.TypeCodeImpl((ORB)_orb, realParent._id);
                }
            }
        }
        return _contentType;
    ...
    */
    ...
    boolean read_value_kind(TypeCodeReader tcis)
    {
        ...
        if (_kind == tk_indirect) {
            ...
            com.sun.corba.se.impl.corba.TypeCodeImpl type = topStream.getTypeCodeAtPosition(indirectTypePosition);
            if (type == null)
                ...
                case TCKind._tk_union:
                    {
                        ...
                        _discriminator = new com.sun.corba.se.impl.corba.TypeCodeImpl((ORB)is.orb());
                        ...
                        for (int i=0; i < _memberCount; i++) {
                            ...
                            _memberTypes[i] = new com.sun.corba.se.impl.corba.TypeCodeImpl((ORB)is.orb());
                ...
                case TCKind._tk_sequence:
                    {
                        ...
                        _contentType = new com.sun.corba.se.impl.corba.TypeCodeImpl((ORB)is.orb());
                ...
                case TCKind._tk_value:
                    {
                        ...
                        // get the type aliased
                        _concrete_base = new com.sun.corba.se.impl.corba.TypeCodeImpl((ORB)is.orb());
        ...
        case TCKind._tk_any:
            {
                ...
                com.sun.corba.se.impl.corba.TypeCodeImpl t = new com.sun.corba.se.impl.corba.TypeCodeImpl((ORB)dst.orb());
