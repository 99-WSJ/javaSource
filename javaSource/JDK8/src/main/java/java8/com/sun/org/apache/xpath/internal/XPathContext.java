...
//  private NodeVector m_currentNodes = new NodeVector();
  ...
  public class XPathExpressionContext implements ExpressionContext
  {
     ...
     */
     ...
     {
       return com.sun.org.apache.xpath.internal.XPathContext.this;
     }
    ...
    {
      return com.sun.org.apache.xpath.internal.XPathContext.this.getErrorListener();
    }
    /**
    ...
    public final XObject getVariableOrParam(com.sun.org.apache.xml.internal.utils.QName qname)
              throws TransformerException
    {
      return m_variableStacks.getVariableOrParam(com.sun.org.apache.xpath.internal.XPathContext.this, qname);
    }
