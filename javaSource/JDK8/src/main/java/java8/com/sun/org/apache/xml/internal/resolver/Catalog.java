...
package java8.sun.org.apache.xml.internal.resolver;
...
public class Catalog {
   ...
   */
  protected void copyReaders(com.sun.org.apache.xml.internal.resolver.Catalog newCatalog) {
   ...
   */
  protected com.sun.org.apache.xml.internal.resolver.Catalog newCatalog() {
    String catalogClass = this.getClass().getName();

    try {
      com.sun.org.apache.xml.internal.resolver.Catalog c = (com.sun.org.apache.xml.internal.resolver.Catalog) (Class.forName(catalogClass).newInstance());
    ...
    com.sun.org.apache.xml.internal.resolver.Catalog c = new com.sun.org.apache.xml.internal.resolver.Catalog();
    c.setCatalogManager(catalogManager);
    copyReaders(c);
    return c;
  }
  ...
  public void parseAllCatalogs()
    ...
    for (int catPos = 0; catPos < catalogs.size(); catPos++) {
      com.sun.org.apache.xml.internal.resolver.Catalog c = null;

      try {
        c = (com.sun.org.apache.xml.internal.resolver.Catalog) catalogs.elementAt(catPos);
    ...
    while (en.hasMoreElements()) {
      ...
      if (e.getEntryType() == DELEGATE_PUBLIC
        ...
        com.sun.org.apache.xml.internal.resolver.Catalog dcat = newCatalog();
