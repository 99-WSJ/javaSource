...
public class Field {
    ...
    /** Field XPath. */
    protected com.sun.org.apache.xerces.internal.impl.xs.identity.Field.XPath fXPath;
    ...
    /** Constructs a field. */
    public Field(com.sun.org.apache.xerces.internal.impl.xs.identity.Field.XPath xpath,
    ...
    public XPathMatcher createMatcher(FieldActivator activator, ValueStore store) {
        return new com.sun.org.apache.xerces.internal.impl.xs.identity.Field.Matcher(fXPath, activator, store);
    ...
    protected class Matcher
        ...
        public Matcher(com.sun.org.apache.xerces.internal.impl.xs.identity.Field.XPath xpath, FieldActivator activator, ValueStore store) {
            super(xpath);
        ...
        protected void matched(Object actualValue, short valueType, ShortList itemValueType, boolean isNil) {
            ...
            fStore.addValue(com.sun.org.apache.xerces.internal.impl.xs.identity.Field.this, actualValue, convertToPrimitiveKind(valueType), convertToPrimitiveKind(itemValueType));
            // once we've stored the value for this field, we set the mayMatch
            // member to false so that, in the same scope, we don't match any more
            // values (and throw an error instead).
            fFieldActivator.setMayMatch(com.sun.org.apache.xerces.internal.impl.xs.identity.Field.this, Boolean.FALSE);
        } // matched(String)
