...
public class PaletteBuilder {
    ...
    public static RenderedImage createIndexedImage(RenderedImage src) {
        com.sun.imageio.plugins.common.PaletteBuilder pb = new com.sun.imageio.plugins.common.PaletteBuilder(src);
        pb.buildPalette();
    ...
    public static IndexColorModel createIndexColorModel(RenderedImage img) {
        com.sun.imageio.plugins.common.PaletteBuilder pb = new com.sun.imageio.plugins.common.PaletteBuilder(img);
        pb.buildPalette();
