...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/Interceptors.mc on Tue Mar 04 03:47:28 PST 2014
...
public class InterceptorsSystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.InterceptorsSystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.InterceptorsSystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.InterceptorsSystemException wrapper =
            (com.sun.corba.se.impl.logging.InterceptorsSystemException) orb.getLogWrapper( logDomain,
                "INTERCEPTORS", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.InterceptorsSystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.InterceptorsSystemException wrapper =
            (com.sun.corba.se.impl.logging.InterceptorsSystemException) ORB.staticGetLogWrapper( logDomain,
                "INTERCEPTORS", factory ) ;
        return wrapper ;
    } 
    ...
    public BAD_PARAM typeOutOfRange( CompletionStatus cs, Throwable t, Object arg0) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "INTERCEPTORS.typeOutOfRange",
                parameters, com.sun.corba.se.impl.logging.InterceptorsSystemException.class, exc ) ;
        }
