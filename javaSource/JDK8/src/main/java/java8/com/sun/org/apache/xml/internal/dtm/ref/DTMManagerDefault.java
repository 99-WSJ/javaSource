          ...
          **************************************************************/
          ...
          if (m_incremental && incremental
            ...
            if (coParser==null ) {
              ...
              if (null == reader) {
                coParser = new com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Filter();
              } else {
                com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Filter filter =
