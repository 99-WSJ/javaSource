...
final class LiteralElement extends Instruction {
    ...
    private com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement _literalElemParent = null;
     ...
     */
    private String translateQName(com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname, SymbolTable stable) {
    ...
    public void parseContents(Parser parser) {
        ...
        if (parent != null && parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement) {
            _literalElemParent = (com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement) parent;
        }
        ...
        for (int i = 0; i < count; i++) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname = parser.getQName(_attributes.getQName(i));
            ...
            if (qname.equals(parser.getUseAttributeSets())) {
                ...
                setFirstAttribute(new com.sun.org.apache.xalan.internal.xsltc.compiler.UseAttributeSets(val, parser));
            }
            ...
            // Handle xsl:exclude-result-prefixes
                ...
                com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralAttribute attr = new com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralAttribute(name, val, parser, this);
                addAttribute(attr);
                attr.setParent(this);
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        while (j < elementCount())  {
            ...
            if (item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Variable) {
    ...
    private boolean checkAttributesUnique() {
         ...
         if (_attributeElements != null) {
             ...
             for (int i = 0; i < numAttrs; i++) {
                 ...
                 if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.UseAttributeSets) {
                     return false;
                 }
                     ...
                     if (attrsTable == null) {
                        attrsTable = new Hashtable();
                         for (int k = 0; k < i; k++) {
                             ...
                             if (n instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralAttribute) {
                                 com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralAttribute literalAttr = (com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralAttribute)n;
                     ...
                     com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue attrName = xslAttr.getName();
                     if (attrName instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValueTemplate) {
                         return false;
                     }
                     else if (attrName instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.SimpleAttributeValue) {
                         com.sun.org.apache.xalan.internal.xsltc.compiler.SimpleAttributeValue simpleAttr = (com.sun.org.apache.xalan.internal.xsltc.compiler.SimpleAttributeValue)attrName;
    ...
    private boolean canProduceAttributeNodes(SyntaxTreeNode node, boolean ignoreXslAttribute) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Text) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Text text = (com.sun.org.apache.xalan.internal.xsltc.compiler.Text)child;
                if (text.isIgnore())
                    continue;
                else
                    return false;
            ...
            else if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralElement
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ValueOf
                || child instanceof XslElement
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Comment
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Number
            ...
            // true in those cases to be safe.
                ...
                return true;
                       ...
                       || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ForEach)
                ...
                for (int k = 0; k < num; k++) {
                    ...
                    if (chooseChild instanceof When || chooseChild instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Otherwise) {
