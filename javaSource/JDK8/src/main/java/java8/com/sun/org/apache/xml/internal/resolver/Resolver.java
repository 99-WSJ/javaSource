...
package java8.com.sun.org.apache.xml.internal.resolver;
...
public class Resolver extends Catalog {
  ...
  public String resolvePublic(String publicId, String systemId)
    ...
    protected String resolveExternalSystem(String systemId, String resolver)
        throws MalformedURLException, IOException {
        com.sun.org.apache.xml.internal.resolver.Resolver r = queryResolver(resolver, "i2l", systemId, null);
        if (r != null) {
    ...
    protected String resolveExternalPublic(String publicId, String resolver)
        throws MalformedURLException, IOException {
        com.sun.org.apache.xml.internal.resolver.Resolver r = queryResolver(resolver, "fpi2l", publicId, null);
        if (r != null) {
     ...
     */
    protected com.sun.org.apache.xml.internal.resolver.Resolver queryResolver(String resolver,
                                                                              String command,
                                                                              String arg1,
                                                                              String arg2) {
        ...
        try {
            ...
            com.sun.org.apache.xml.internal.resolver.Resolver r = (com.sun.org.apache.xml.internal.resolver.Resolver) newCatalog();
    ...
    private synchronized Vector resolveAllSubordinateCatalogs(int entityType,
        ...
        for (int catPos = 0; catPos < catalogs.size(); catPos++) {
            com.sun.org.apache.xml.internal.resolver.Resolver c = null;

            try {
                c = (com.sun.org.apache.xml.internal.resolver.Resolver) catalogs.elementAt(catPos);
            } catch (ClassCastException e) {
                String catfile = (String) catalogs.elementAt(catPos);
                c = (com.sun.org.apache.xml.internal.resolver.Resolver) newCatalog();
