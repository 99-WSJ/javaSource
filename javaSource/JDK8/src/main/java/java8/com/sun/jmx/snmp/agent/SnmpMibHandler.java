...
public interface SnmpMibHandler {
     ...
     * This method is called automatically by {@link SnmpMibAgent#setSnmpAdaptor(com.sun.jmx.snmp.agent.SnmpMibHandler)} and
     ...
     */
    public com.sun.jmx.snmp.agent.SnmpMibHandler addMib(SnmpMibAgent mib) throws IllegalArgumentException;
...
/**
     ...
     * @since 1.5
     */
    public com.sun.jmx.snmp.agent.SnmpMibHandler addMib(SnmpMibAgent mib, SnmpOid[] oids) throws IllegalArgumentException;
     ...
     * @since 1.5
     */
    public com.sun.jmx.snmp.agent.SnmpMibHandler addMib(SnmpMibAgent mib, String contextName)
     ...
     * @since 1.5
     */
    public com.sun.jmx.snmp.agent.SnmpMibHandler addMib(SnmpMibAgent mib, String contextName, SnmpOid[] oids)
        throws IllegalArgumentException;
