...
package java8.sun.jmx.interceptor;
...
public class DefaultMBeanServerInterceptor implements MBeanServerInterceptor {
        ...
        if (withDefaultLoaderRepository) {
            if (MBEANSERVER_LOGGER.isLoggable(Level.FINER)) {
                MBEANSERVER_LOGGER.logp(Level.FINER,
                        com.sun.jmx.interceptor.DefaultMBeanServerInterceptor.class.getName(),
                        "createMBean",
    ...
    private static interface ResourceContext extends RegistrationContext {
        ...
        public static final ResourceContext NONE = new com.sun.jmx.interceptor.DefaultMBeanServerInterceptor.ResourceContext() {
            public void done() {}
