...
final class SnmpTimerServer extends Thread {
    ...
    public SnmpTimerServer (ThreadGroup grp, com.sun.jmx.snmp.daemon.SnmpQManager q) {
    ...
    public void run() {
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINER, com.sun.jmx.snmp.daemon.SnmpTimerServer.class.getName(),
        ...
        while (true) {
            ...
            try {
                ...
                if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                    SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.daemon.SnmpTimerServer.class.getName(),
