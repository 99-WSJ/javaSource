...
class SnmpSubRequestHandler implements SnmpDefinitions, Runnable {
    ...
    protected SnmpSubRequestHandler(SnmpMibAgent agent, SnmpPdu req) {
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINER, com.sun.jmx.snmp.daemon.SnmpSubRequestHandler.class.getName(),
            ...
            try {
                ...
                default:
                    if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                        SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.daemon.SnmpSubRequestHandler.class.getName(),
                            "run", "[" + Thread.currentThread() +
