...
public class MotifRadioButtonUI extends BasicRadioButtonUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.motif.MotifRadioButtonUI motifRadioButtonUI =
                (com.sun.java.swing.plaf.motif.MotifRadioButtonUI) appContext.get(MOTIF_RADIO_BUTTON_UI_KEY);
        if (motifRadioButtonUI == null) {
            motifRadioButtonUI = new com.sun.java.swing.plaf.motif.MotifRadioButtonUI();
