...
final class LogicalExpr extends Expression {
    ...
    public void translateDesynthesized(ClassGenerator classGen,
        ...
        if (_op == AND) {
            ...
            if ((_left instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LogicalExpr) &&
                (((com.sun.org.apache.xalan.internal.xsltc.compiler.LogicalExpr)_left).getOp() == OR)) {
                _left.backPatchTrueList(middle);
            }
            else if (_left instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.NotCall) {
                _left.backPatchTrueList(middle);
            }
            else {
            ...
            if ((_right instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LogicalExpr) &&
                (((com.sun.org.apache.xalan.internal.xsltc.compiler.LogicalExpr)_right).getOp() == OR)) {
                _right.backPatchTrueList(after);
            }
            else if (_right instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.NotCall) {
                _right.backPatchTrueList(after);
            }
            else {
