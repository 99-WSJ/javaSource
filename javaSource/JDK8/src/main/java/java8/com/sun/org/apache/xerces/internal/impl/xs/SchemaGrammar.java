...
package java8.com.sun.org.apache.xerces.internal.impl.xs;
...
import java8.sun.org.apache.xerces.internal.impl.xs.*;
...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
    ...
    public SchemaGrammar(com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar) {
    ...
    // are immutable.
    public static class BuiltinSchemaGrammar extends com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar {
     ...
     */
    public static final class Schema4Annotations extends com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar {
        ...
        private Schema4Annotations() {
            ...
            // fill complex types
            annotationType.setValues("#AnonType_" + SchemaSymbols.ELT_ANNOTATION, fTargetNamespace, com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType,
            ...
            documentationType.setValues("#AnonType_" + SchemaSymbols.ELT_DOCUMENTATION, fTargetNamespace, com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType,
                    XSConstants.DERIVATION_RESTRICTION, XSConstants.DERIVATION_NONE, (short) (XSConstants.DERIVATION_EXTENSION | XSConstants.DERIVATION_RESTRICTION),
            ...
            appinfoType.setValues("#AnonType_" + SchemaSymbols.ELT_APPINFO, fTargetNamespace, com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType,
                    XSConstants.DERIVATION_RESTRICTION, XSConstants.DERIVATION_NONE, (short) (XSConstants.DERIVATION_EXTENSION | XSConstants.DERIVATION_RESTRICTION),
    ...
    public static com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar getS4SGrammar(short schemaVersion) {
        if (schemaVersion == Constants.SCHEMA_VERSION_1_0) {
            return SG_SchemaNS;
        }
        else {
    ...
    public XSModel toXSModel() {
        return new XSModelImpl(new com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[]{this});
    }
    ...
    public XSModel toXSModel(XSGrammar[] grammars) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[] gs = new com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[hasSelf ? len : len+1];
        for (int i = 0; i < len; i++)
            gs[i] = (com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar)grammars[i];
        if (!hasSelf)
            gs[len] = this;
