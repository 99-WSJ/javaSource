 ...
 */
final class Output extends com.sun.org.apache.xalan.internal.xsltc.compiler.TopLevelElement {
    ...
    private void transferAttribute(com.sun.org.apache.xalan.internal.xsltc.compiler.Output previous, String qname) {
        if (!hasAttribute(qname) && previous.hasAttribute(qname)) {
            addAttribute(qname, previous.getAttribute(qname));
        }
    }

    public void mergeOutput(com.sun.org.apache.xalan.internal.xsltc.compiler.Output previous) {
