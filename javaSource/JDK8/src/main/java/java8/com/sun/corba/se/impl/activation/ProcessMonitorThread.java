...
public class ProcessMonitorThread extends Thread {
    ...
    private static com.sun.corba.se.impl.activation.ProcessMonitorThread instance = null;
    ...
    static void start( HashMap serverTable ) {
        ...
        instance = new com.sun.corba.se.impl.activation.ProcessMonitorThread( serverTable,
            sleepTime );
