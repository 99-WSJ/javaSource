...
public final class JmxMBeanServer
    ...
    JmxMBeanServer(String domain, MBeanServer outer,
        ...
        if (instantiator == null) {
            final ModifiableClassLoaderRepository
                clr = new com.sun.jmx.mbeanserver.ClassLoaderRepositorySupport();
            instantiator = new MBeanInstantiator(clr);
        }

        final MBeanInstantiator fInstantiator = instantiator;
        this.secureClr = new
                com.sun.jmx.mbeanserver.SecureClassLoaderRepository(AccessController.doPrivileged(new PrivilegedAction<ClassLoaderRepository>() {
                @Override
        ...
        if (delegate == null)
            delegate = new com.sun.jmx.mbeanserver.MBeanServerDelegateImpl();
        if (outer == null)
            outer = this;
   ...
   /**
        ...
        try {
            ...
            if (MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
                MBEANSERVER_LOGGER.logp(Level.FINEST,
                        com.sun.jmx.mbeanserver.JmxMBeanServer.class.getName(), "initialize",
    ...
    public static MBeanServerDelegate newMBeanServerDelegate() {
        return new com.sun.jmx.mbeanserver.MBeanServerDelegateImpl();
    }
    ...
    public static MBeanServer newMBeanServer(String defaultDomain,
        ...
        //
        return new com.sun.jmx.mbeanserver.JmxMBeanServer(defaultDomain,outer,delegate,null,
