...
public class SnmpEngineId implements Serializable {
     ...
     * </ul>
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(byte[] arr) throws IllegalArgumentException {
        if( (arr == null) || arr.length == 0) return null;
        validateId(arr);
        return new com.sun.jmx.snmp.SnmpEngineId(arr);
    }
    ...
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId() {
        ...
        return new com.sun.jmx.snmp.SnmpEngineId(engineid);
    }
    ...
    *
    */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(String str)
     ...
     * @since 1.5
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(String str, String separator)
        throws IllegalArgumentException, UnknownHostException {
        if(str == null) return null;

        if(str.startsWith("0x") || str.startsWith("0X")) {
            validateId(str);
            return new com.sun.jmx.snmp.SnmpEngineId(str);
        }
        ...
        com.sun.jmx.snmp.SnmpEngineId eng = null;
        try {
            //Deal with address
            try {
            ...
            if(!address.equals(separator)) {
                ...
                try {
                    ...
                    eng = com.sun.jmx.snmp.SnmpEngineId.createEngineId(objAddress,
                                                      objPort,
                                                      objIana);
     ...
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(int port)
     ...
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(InetAddress address, int port)
     ...
     * @return The generated engine Id.
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(int port, int iana) throws UnknownHostException {
        InetAddress address = null;
        address = InetAddress.getLocalHost();
     ...
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(InetAddress addr,
                                                               int port,
                                                               int iana) {
...
engineid[3] = (byte) (iana & 0x000000FF);
     ...
     * @exception UnknownHostException if the provided <CODE>InetAddress </CODE> is null.
     */
    public static com.sun.jmx.snmp.SnmpEngineId createEngineId(int iana, InetAddress addr)
    {
        if(addr == null) throw new IllegalArgumentException("InetAddress is null.");
        byte[] address = addr.getAddress();
    ...
    public boolean equals(Object a) {
        if(!(a instanceof com.sun.jmx.snmp.SnmpEngineId) ) return false;
        return hexString.equals(((com.sun.jmx.snmp.SnmpEngineId) a).toString());
    }
