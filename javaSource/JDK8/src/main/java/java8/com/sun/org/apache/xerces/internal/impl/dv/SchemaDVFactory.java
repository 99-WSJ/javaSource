...
public abstract class SchemaDVFactory {
     ...
     */
    public static synchronized final com.sun.org.apache.xerces.internal.impl.dv.SchemaDVFactory getInstance() throws DVFactoryException {
     ...
     *                                class name or the default class name
     */
    public static synchronized final com.sun.org.apache.xerces.internal.impl.dv.SchemaDVFactory getInstance(String factoryClass) throws DVFactoryException {

        try {
            // if the class name is not specified, use the default one
            return (com.sun.org.apache.xerces.internal.impl.dv.SchemaDVFactory)(ObjectFactory.newInstance(factoryClass, true));
