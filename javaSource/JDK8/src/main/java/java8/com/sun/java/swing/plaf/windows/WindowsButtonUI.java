...
public class WindowsButtonUI extends BasicButtonUI
{
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.windows.WindowsButtonUI windowsButtonUI =
                (com.sun.java.swing.plaf.windows.WindowsButtonUI) appContext.get(WINDOWS_BUTTON_UI_KEY);
        if (windowsButtonUI == null) {
            windowsButtonUI = new com.sun.java.swing.plaf.windows.WindowsButtonUI();
    ...
    public void paint(Graphics g, JComponent c) {
        if (XPStyle.getXP() != null) {
            com.sun.java.swing.plaf.windows.WindowsButtonUI.paintXPButtonBackground(g, c);
        }
        super.paint(g, c);
    }
    ...
    static void paintXPButtonBackground(Graphics g, JComponent c) {
        ...
        if (b.isContentAreaFilled() && xp != null) {
            ...
            if (border != null) {
                ...
                insets = com.sun.java.swing.plaf.windows.WindowsButtonUI.getOpaqueInsets(border, c);
            } else {
                insets = c.getInsets();
            }
            if (insets != null) {
