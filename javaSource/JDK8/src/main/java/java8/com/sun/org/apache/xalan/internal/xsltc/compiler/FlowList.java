...
public final class FlowList {
    ...
    public FlowList(com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList list) {
        _elements = list._elements;
    }

    public com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList add(InstructionHandle bh) {
        if (_elements == null) {
            _elements = new Vector();
        }
        _elements.addElement(bh);
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList append(com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList right) {
        if (_elements == null) {
     ...
     */
    public com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList copyAndRedirect(InstructionList oldList,
                                                                                     InstructionList newList)
    {
        final com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList result = new com.sun.org.apache.xalan.internal.xsltc.compiler.FlowList();
        if (_elements == null) {
            return result;
        }
