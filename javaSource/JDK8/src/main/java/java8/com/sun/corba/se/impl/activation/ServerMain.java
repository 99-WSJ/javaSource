...
public class ServerMain
{
    ...
    */
    ...
    public static void main(String[] args) {
        com.sun.corba.se.impl.activation.ServerMain server = new com.sun.corba.se.impl.activation.ServerMain();
        server.run(args);
    }
    ...
    private void registerCallback( Class serverClass )
    {
        ...
        com.sun.corba.se.impl.activation.ServerCallback serverObj = new com.sun.corba.se.impl.activation.ServerCallback( orb,
    ...
    com.sun.corba.se.spi.activation._ServerImplBase
{
    ...
    private void invokeMethod( Method method )
    {
        if (method != null)
            try {
                ...
                com.sun.corba.se.impl.activation.ServerMain.logError( "could not invoke " + method.getName() +
    ...
    {
        com.sun.corba.se.impl.activation.ServerMain.logInformation( "Shutdown starting" ) ;

        invokeMethod( shutdownMethod ) ;

        orb.shutdown(true);

        com.sun.corba.se.impl.activation.ServerMain.logTerminal( "Shutdown completed", com.sun.corba.se.impl.activation.ServerMain.OK ) ;
    }

    public void install()
    {
        com.sun.corba.se.impl.activation.ServerMain.logInformation( "Install starting" ) ;

        invokeMethod( installMethod ) ;

        com.sun.corba.se.impl.activation.ServerMain.logInformation( "Install completed" ) ;
    }

    public void uninstall()
    {
        com.sun.corba.se.impl.activation.ServerMain.logInformation( "uninstall starting" ) ;

        invokeMethod( uninstallMethod ) ;

        com.sun.corba.se.impl.activation.ServerMain.logInformation( "uninstall completed" ) ;
    }
}
