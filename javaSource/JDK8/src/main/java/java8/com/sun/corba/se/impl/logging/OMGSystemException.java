...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/OMG.mc on Tue Mar 04 03:47:28 PST 2014
...
public class OMGSystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.OMGSystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.OMGSystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.OMGSystemException wrapper =
            (com.sun.corba.se.impl.logging.OMGSystemException) orb.getLogWrapper( logDomain,
                "OMG", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.OMGSystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.OMGSystemException wrapper =
            (com.sun.corba.se.impl.logging.OMGSystemException) ORB.staticGetLogWrapper( logDomain,
                "OMG", factory ) ;
        return wrapper ;
    } 
    ...
    public BAD_CONTEXT idlContextNotFound( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "OMG.idlContextNotFound",
                parameters, com.sun.corba.se.impl.logging.OMGSystemException.class, exc ) ;
        }
