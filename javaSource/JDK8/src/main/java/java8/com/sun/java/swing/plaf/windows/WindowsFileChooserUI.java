...
public class WindowsFileChooserUI extends BasicFileChooserUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new com.sun.java.swing.plaf.windows.WindowsFileChooserUI((JFileChooser) c);
    }
    ...
    private class WindowsFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
        public JFileChooser getFileChooser() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.getFileChooser();
        }

        public BasicDirectoryModel getModel() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.isDirectorySelected();
        }

        public File getDirectory() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.getDirectory();
        }

        public Action getChangeToParentDirectoryAction() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.getChangeToParentDirectoryAction();
        }

        public Action getApproveSelectionAction() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.getNewFolderAction();
        }

        public MouseListener createDoubleClickListener(JList list) {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.createDoubleClickListener(getFileChooser(),
                                                                       list);
        }

        public ListSelectionListener createListSelectionListener() {
            return com.sun.java.swing.plaf.windows.WindowsFileChooserUI.this.createListSelectionListener(getFileChooser());
        }
    }
    ...
    private void updateUseShellFolder() {
        ...
        if (FilePane.usesShellFolder(fc)) {
            if (placesBar == null && !UIManager.getBoolean("FileChooser.noPlacesBar")) {
                placesBar = new WindowsPlacesBar(fc, com.sun.java.swing.plaf.windows.XPStyle.getXP() != null);
