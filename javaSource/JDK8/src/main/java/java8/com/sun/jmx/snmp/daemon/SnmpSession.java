...
class SnmpSession implements SnmpDefinitions, Runnable {
    ...
    void waitForResponse(SnmpInformRequest req, long waitTime) {
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.daemon.SnmpSession.class.getName(),
    ...
    public void run() {
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINER, com.sun.jmx.snmp.daemon.SnmpSession.class.getName(),
