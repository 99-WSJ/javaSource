...
public abstract class NodeImpl
    ...
    protected com.sun.org.apache.xerces.internal.dom.NodeImpl ownerNode; // typically the parent but not always!
    ...
    public Node cloneNode(boolean deep) {
        ...
        com.sun.org.apache.xerces.internal.dom.NodeImpl newnode;
        try {
            newnode = (com.sun.org.apache.xerces.internal.dom.NodeImpl)clone();
        }
    ...
    public short compareDocumentPosition(Node other) throws DOMException {
        ...
        try {
            com.sun.org.apache.xerces.internal.dom.NodeImpl node = (com.sun.org.apache.xerces.internal.dom.NodeImpl) other;
            ...
            otherOwnerDoc !=null)
 {
        ...
        if (thisAncestor != otherAncestor) {
          ...
          thisAncestorNum = ((com.sun.org.apache.xerces.internal.dom.NodeImpl)thisAncestor).getNodeNumber();
          otherAncestorNum = ((com.sun.org.apache.xerces.internal.dom.NodeImpl)otherAncestor).getNodeNumber();
          ...
          if (thisNode == otherNode)
{
    ...
    public boolean isDefaultNamespace(String namespaceURI){
        ...
        case Node.ELEMENT_NODE: {
            ...
            if (this.hasAttributes()) {
                ...
                com.sun.org.apache.xerces.internal.dom.NodeImpl attr = (com.sun.org.apache.xerces.internal.dom.NodeImpl)elem.getAttributeNodeNS("http://www.w3.org/2000/xmlns/", "xmlns");
                if (attr != null) {
            ...
            com.sun.org.apache.xerces.internal.dom.NodeImpl ancestor = (com.sun.org.apache.xerces.internal.dom.NodeImpl)getElementAncestor(this);
            if (ancestor != null) {
        ...
        case Node.DOCUMENT_NODE:{
                return((com.sun.org.apache.xerces.internal.dom.NodeImpl)((Document)this).getDocumentElement()).isDefaultNamespace(namespaceURI);
            }
    ...
    public String lookupPrefix(String namespaceURI){
        ...
        case Node.DOCUMENT_NODE:{
                return((com.sun.org.apache.xerces.internal.dom.NodeImpl)((Document)this).getDocumentElement()).lookupPrefix(namespaceURI);
            }
    ...
    public String lookupNamespaceURI(String specifiedPrefix) {
        ...
        case Node.DOCUMENT_NODE : {
                return((com.sun.org.apache.xerces.internal.dom.NodeImpl)((Document)this).getDocumentElement()).lookupNamespaceURI(specifiedPrefix);
            }
        case Node.ENTITY_NODE :
        case Node.NOTATION_NODE:
        case Node.DOCUMENT_FRAGMENT_NODE:
