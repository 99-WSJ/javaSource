...
public class POAImpl extends ObjectAdapterBase implements POA
{
    ...
    */
    ...
    private int uniquePOAId ;       // ID for this POA that is unique relative
                                    ...
                                    // lifetime as the ORB.
    private com.sun.corba.se.impl.oa.poa.POAImpl parent;         // The POA that created this POA.
    ...
    static com.sun.corba.se.impl.oa.poa.POAImpl makeRootPOA(ORB orb )
    {
        POAManagerImpl poaManager = new POAManagerImpl( getPOAFactory( orb ),
            orb.getPIHandler() ) ;

        com.sun.corba.se.impl.oa.poa.POAImpl result = new com.sun.corba.se.impl.oa.poa.POAImpl( ORBConstants.ROOT_POA_NAME,
    ...
    private POAImpl(String name, com.sun.corba.se.impl.oa.poa.POAImpl parent, ORB orb, int initialState )
    {
        super( orb ) ;
        ...
        com.sun.corba.se.impl.oa.poa.POAImpl poaImpl = this ;
        int ctr = numLevels - 1 ;
        while (poaImpl != null) {
    ...
    static class DestroyThread extends Thread {
        ...
        private boolean debug ;
        private com.sun.corba.se.impl.oa.poa.POAImpl thePoa ;
        ...
        public void doIt(com.sun.corba.se.impl.oa.poa.POAImpl thePoa, boolean wait )
        {
            if (debug) {
                ORBUtility.dprint( this,
        ...
        // destroying poa.
        private boolean prepareForDestruction( com.sun.corba.se.impl.oa.poa.POAImpl poa,
            Set destroyedPOATemplates )
        {
            com.sun.corba.se.impl.oa.poa.POAImpl[] childPoas = null ;
            ...
            try {
                ...
                childPoas = (com.sun.corba.se.impl.oa.poa.POAImpl[])poa.children.values().toArray(
                    new com.sun.corba.se.impl.oa.poa.POAImpl[0] );
            } finally {
                poa.unlock() ;
            }
        ...
        public void performDestroy(com.sun.corba.se.impl.oa.poa.POAImpl poa, Set destroyedPOATemplates )
        {
            ...
            com.sun.corba.se.impl.oa.poa.POAImpl parent = poa.parent ;
        ...
        private void completeDestruction(com.sun.corba.se.impl.oa.poa.POAImpl poa, com.sun.corba.se.impl.oa.poa.POAImpl parent,
                                         Set destroyedPOATemplates )
        {
            if (debug) {
                ORBUtility.dprint( this,
 ...
 //*******************************************************************
        ...
        InvalidPolicy
    {
        try {
            ...
            com.sun.corba.se.impl.oa.poa.POAImpl poa = (com.sun.corba.se.impl.oa.poa.POAImpl)(children.get(name)) ;

            if (poa == null) {
                poa = new com.sun.corba.se.impl.oa.poa.POAImpl( name, this, getORB(), STATE_START ) ;
            }
    ...
    {
        com.sun.corba.se.impl.oa.poa.POAImpl found = null ;
        ...
        found = (com.sun.corba.se.impl.oa.poa.POAImpl) children.get(name);
        ...
        if (found != null) {
            ...
            try {
                ...
                if (activate && (activator != null)) {
                    ...
                    // returns.
                    found = new com.sun.corba.se.impl.oa.poa.POAImpl( name, this, getORB(), STATE_INIT ) ;
    ...
    {
        return new com.sun.corba.se.impl.oa.poa.ThreadPolicyImpl(value);
    }
