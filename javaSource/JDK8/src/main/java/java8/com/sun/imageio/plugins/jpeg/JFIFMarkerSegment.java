...
class JFIFMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
    ...
    protected Object clone() {
        com.sun.imageio.plugins.jpeg.JFIFMarkerSegment newGuy = (com.sun.imageio.plugins.jpeg.JFIFMarkerSegment) super.clone();
    ...
    static void writeDefaultJFIF(ImageOutputStream ios,
        ...
        com.sun.imageio.plugins.jpeg.JFIFMarkerSegment jfif = new com.sun.imageio.plugins.jpeg.JFIFMarkerSegment();
     ...
     */
    class JFIFExtensionMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
        int code;
        JFIFThumb thumb;
    ...
    class JFIFThumbJPEG extends JFIFThumb {
        ...
        JFIFThumbJPEG(BufferedImage thumb) throws IllegalThumbException {
            ...
            try {
                ...
                com.sun.imageio.plugins.jpeg.MarkerSegment jfif = metadata.findMarkerSegment
        ...
        int getWidth() {
            ...
            com.sun.imageio.plugins.jpeg.SOFMarkerSegment sof =
                (com.sun.imageio.plugins.jpeg.SOFMarkerSegment) thumbMetadata.findMarkerSegment
    ...
    static void writeICC(ICC_Profile profile, ImageOutputStream ios)
        ...
        for (int i = 0; i < numChunks; i++) {
            ...
            ios.write(0xff);
            ios.write(JPEG.APP2);
            com.sun.imageio.plugins.jpeg.MarkerSegment.write2bytes(ios, segLength);
     ...
     */
    class ICCMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
