...
import java8.sun.corba.se.impl.util.IdentityHashtableEntry;
...
public final class IdentityHashtable extends Dictionary {
    ...
    public Enumeration keys() {
        return new com.sun.corba.se.impl.util.IdentityHashtableEnumerator(table, true);
    }
    ...
    public Enumeration elements() {
        return new com.sun.corba.se.impl.util.IdentityHashtableEnumerator(table, false);
    }
