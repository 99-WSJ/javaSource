...
public class WindowsCheckBoxUI extends WindowsRadioButtonUI
{
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.windows.WindowsCheckBoxUI windowsCheckBoxUI =
                (com.sun.java.swing.plaf.windows.WindowsCheckBoxUI) appContext.get(WINDOWS_CHECK_BOX_UI_KEY);
        if (windowsCheckBoxUI == null) {
            windowsCheckBoxUI = new com.sun.java.swing.plaf.windows.WindowsCheckBoxUI();
