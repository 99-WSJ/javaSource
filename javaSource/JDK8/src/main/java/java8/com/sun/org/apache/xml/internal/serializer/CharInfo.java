 ...
 */
package java8.com.sun.org.apache.xml.internal.serializer;
...
final class CharInfo
{
    ...
    private CharInfo(String entitiesResource, String method, boolean internal)
    {
        ...
        if (entities != null) {
            ...
            try {
                if (internal) {
                    is = com.sun.org.apache.xml.internal.serializer.CharInfo.class.getResourceAsStream(entitiesResource);
                } else {
...
//    }
    ...
    private static com.sun.org.apache.xml.internal.serializer.CharInfo getCharInfoBasedOnPrivilege(
        final String entitiesFileName, final String method,
        final boolean internal){
            return (com.sun.org.apache.xml.internal.serializer.CharInfo) AccessController.doPrivileged(
                new PrivilegedAction() {
                        public Object run() {
                            return new com.sun.org.apache.xml.internal.serializer.CharInfo(entitiesFileName,
                              method, internal);}
            });
    }
    ...
    {
        com.sun.org.apache.xml.internal.serializer.CharInfo charInfo = (com.sun.org.apache.xml.internal.serializer.CharInfo) m_getCharInfoCache.get(entitiesFileName);
        if (charInfo != null) {
            return charInfo;
        }
