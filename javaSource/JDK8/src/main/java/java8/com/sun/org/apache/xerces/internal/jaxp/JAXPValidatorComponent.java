...
final class JAXPValidatorComponent
    extends com.sun.org.apache.xerces.internal.jaxp.TeeXMLDocumentFilterImpl implements XMLComponent {
    ...
    private final class SAX2XNI extends DefaultHandler {
        ...
        private XMLDocumentHandler handler() {
            return com.sun.org.apache.xerces.internal.jaxp.JAXPValidatorComponent.this.getDocumentHandler();
        }
