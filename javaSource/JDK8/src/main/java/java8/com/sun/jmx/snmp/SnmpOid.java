...
public class SnmpOid extends SnmpValue {
     ...
     */
    public com.sun.jmx.snmp.SnmpOid toOid() {
        long[] ids = new long[componentCount] ;
        for (int i = 0 ; i < componentCount ; i++) {
            ids[i] = components[i] ;
        }
        return new com.sun.jmx.snmp.SnmpOid(ids) ;
    }
     ...
     */
    public static com.sun.jmx.snmp.SnmpOid toOid(long[] index, int start) throws SnmpStatusException {
        try {
     ...
     */
    public static void appendToOid(com.sun.jmx.snmp.SnmpOid source, com.sun.jmx.snmp.SnmpOid dest) {
    ...
    public Object clone() {
        try {
            com.sun.jmx.snmp.SnmpOid obj = (com.sun.jmx.snmp.SnmpOid)super.clone() ;
     ...
     */
    public void append(com.sun.jmx.snmp.SnmpOid oid) {
    ...
    public void addToOid(String s) throws SnmpStatusException {
        com.sun.jmx.snmp.SnmpOid suffix= new com.sun.jmx.snmp.SnmpOid(s);
        this.append(suffix);
    }
    ...
    public void addToOid(long []oid) throws SnmpStatusException {
        com.sun.jmx.snmp.SnmpOid suffix= new com.sun.jmx.snmp.SnmpOid(oid);
        this.append(suffix);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof com.sun.jmx.snmp.SnmpOid) {
            com.sun.jmx.snmp.SnmpOid oid = (com.sun.jmx.snmp.SnmpOid)o ;
   ...
   /**
     ...
     */
    public int compareTo(com.sun.jmx.snmp.SnmpOid other) {
        int result = 0 ;
        int i = 0 ;
