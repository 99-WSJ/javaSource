    ...
    implements RequestPartitioningComponent
{
    ...
    {
        if (!(obj instanceof com.sun.corba.se.impl.ior.iiop.RequestPartitioningComponentImpl))
            return false ;

        com.sun.corba.se.impl.ior.iiop.RequestPartitioningComponentImpl other =
            (com.sun.corba.se.impl.ior.iiop.RequestPartitioningComponentImpl)obj ;
