...
public class XMLStringDefault implements XMLString
{
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.trim());
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.substring(beginIndex));
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.substring(beginIndex, endIndex));
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.concat(str));
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.toLowerCase(locale));
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.toLowerCase());
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.toUpperCase(locale));
  }
  ...
  {
    return new com.sun.org.apache.xml.internal.utils.XMLStringDefault(m_str.toUpperCase());
  }
