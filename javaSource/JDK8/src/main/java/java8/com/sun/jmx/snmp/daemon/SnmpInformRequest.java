...
public class SnmpInformRequest implements SnmpDefinitions {
     ...
     */
    private static com.sun.jmx.snmp.daemon.SnmpRequestCounter requestCounter = new com.sun.jmx.snmp.daemon.SnmpRequestCounter();
     ...
     */
    private transient com.sun.jmx.snmp.daemon.SnmpSession informSession;
     ...
     */
    SnmpInformRequest(com.sun.jmx.snmp.daemon.SnmpSession session,
        ...
        while (true) {
            try {
                ...
                if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                    SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, com.sun.jmx.snmp.daemon.SnmpInformRequest.class.getName(),
    ...
    synchronized SnmpPdu constructPduPacket() {
        ...
        try {
            ...
            if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
                SNMP_ADAPTOR_LOGGER.logp(Level.FINER, com.sun.jmx.snmp.daemon.SnmpInformRequest.class.getName(),
