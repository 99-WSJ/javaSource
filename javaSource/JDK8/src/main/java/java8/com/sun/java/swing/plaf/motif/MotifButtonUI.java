...
public class MotifButtonUI extends BasicButtonUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.motif.MotifButtonUI motifButtonUI =
                (com.sun.java.swing.plaf.motif.MotifButtonUI) appContext.get(MOTIF_BUTTON_UI_KEY);
        if (motifButtonUI == null) {
            motifButtonUI = new com.sun.java.swing.plaf.motif.MotifButtonUI();
