...
public class FreezableList extends AbstractList {
    ...
    public boolean equals( Object obj )
    {
        ...
        if (!(obj instanceof com.sun.corba.se.impl.ior.FreezableList))
            return false ;

        com.sun.corba.se.impl.ior.FreezableList other = (com.sun.corba.se.impl.ior.FreezableList)obj ;
    ...
    public List subList(int fromIndex, int toIndex)
    {
        ...
        List result = new com.sun.corba.se.impl.ior.FreezableList( list, immutable ) ;
        return result ;
    }
}
