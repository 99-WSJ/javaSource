...
public class ObjectKeyFactoryImpl implements ObjectKeyFactory
{
    ...
    * and the ID.
    */
    private com.sun.corba.se.impl.ior.Handler fullKey = new com.sun.corba.se.impl.ior.Handler() {
    ...
    */
    private com.sun.corba.se.impl.ior.Handler oktempOnly = new com.sun.corba.se.impl.ior.Handler() {
        public ObjectKeyTemplate handle( int magic, int scid,
            InputStream is, OctetSeqHolder osh ) {
                ObjectKeyTemplate oktemp = null ;
    ...
    */
    private ObjectKeyTemplate create( InputStream is, com.sun.corba.se.impl.ior.Handler handler,
        OctetSeqHolder osh )
    {
        ObjectKeyTemplate oktemp = null ;
