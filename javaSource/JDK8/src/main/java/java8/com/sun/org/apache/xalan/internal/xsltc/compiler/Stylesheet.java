...
public final class Stylesheet extends SyntaxTreeNode {
     ...
     * imported (if any).
     */
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet _importedFrom = null;

    /**
     * Reference to the stylesheet from which this stylesheet was
     * included (if any).
     */
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet _includedFrom = null;
    ...
    public void numberFormattingUsed() {
         ...
         */
        com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet parent = getParentStylesheet();
    ...
    public void setImportPrecedence(final int precedence) {
        ...
        while (elements.hasMoreElements()) {
            ...
            if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Include) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet included = ((com.sun.org.apache.xalan.internal.xsltc.compiler.Include)child).getIncludedStylesheet();
    ...
    public int getMinimumDescendantPrecedence() {
        if (_minimumDescendantPrecedence == -1) {
            ...
            for (int i = 0; i < inclImpCount; i++) {
                int prec = ((com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet)_includedStylesheets.elementAt(i))
    ...
    public void setParentStylesheet(com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet parent) {
    ...
    public void setImportingStylesheet(com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet parent) {
        _importedFrom = parent;
        parent.addIncludedStylesheet(this);
    }

    public void setIncludingStylesheet(com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet parent) {
        _includedFrom = parent;
        parent.addIncludedStylesheet(this);
    }

    public void addIncludedStylesheet(com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet child) {
    ...
    private com.sun.org.apache.xalan.internal.xsltc.compiler.QName makeStylesheetName(String prefix) {
    ...
    public void parseContents(Parser parser) {
        ...
        */
        ...
        final com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet sheet = stable.addStylesheet(_name, this);
        if (sheet != null) {
    ...
    public void processModes() {
        if (_defaultMode == null)
            _defaultMode = new com.sun.org.apache.xalan.internal.xsltc.compiler.Mode(null, this, Constants.EMPTYSTRING);
        _defaultMode.processPatterns(_keys);
        final Enumeration modes = _modes.elements();
        while (modes.hasMoreElements()) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Mode mode = (com.sun.org.apache.xalan.internal.xsltc.compiler.Mode)modes.nextElement();
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Mode getMode(com.sun.org.apache.xalan.internal.xsltc.compiler.QName modeName) {
        if (modeName == null) {
            if (_defaultMode == null) {
                _defaultMode = new com.sun.org.apache.xalan.internal.xsltc.compiler.Mode(null, this, Constants.EMPTYSTRING);
            }
            ...
            com.sun.org.apache.xalan.internal.xsltc.compiler.Mode mode = (com.sun.org.apache.xalan.internal.xsltc.compiler.Mode)_modes.get(modeName);
            if (mode == null) {
                final String suffix = Integer.toString(_nextModeSerial++);
                _modes.put(modeName, mode = new com.sun.org.apache.xalan.internal.xsltc.compiler.Mode(modeName, this, suffix));
            }
            return mode;
        }
    }
    ...
    private void compileConstructor(ClassGenerator classGen, Output output) {
        ...
        if (_numberFormattingUsed) {
            constructor.markChunkStart();
            com.sun.org.apache.xalan.internal.xsltc.compiler.DecimalFormatting.translateDefaultDFS(classGen, constructor);
            constructor.markChunkEnd();
        }
    ...
    private String compileTopLevel(ClassGenerator classGen) {
        ...
        while (elements.hasMoreElements()) {
            final Object element = elements.nextElement();
            // xsl:decimal-format
            if (element instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.DecimalFormatting) {
                ((com.sun.org.apache.xalan.internal.xsltc.compiler.DecimalFormatting)element).translate(classGen,toplevel);
            }
            // xsl:strip/preserve-space
            else if (element instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Whitespace) {
                whitespaceRules.addAll(((com.sun.org.apache.xalan.internal.xsltc.compiler.Whitespace)element).getRules());
            }
        }

        // Translate all whitespace strip/preserve rules
        if (whitespaceRules.size() > 0) {
            com.sun.org.apache.xalan.internal.xsltc.compiler.Whitespace.translateRules(whitespaceRules,classGen);
        }
    ...
    public int addParam(com.sun.org.apache.xalan.internal.xsltc.compiler.Param param) {
        _globals.addElement(param);
        return _globals.size() - 1;
    }

    public int addVariable(com.sun.org.apache.xalan.internal.xsltc.compiler.Variable global) {
    ...
    public Vector getAllValidTemplates() {
        ...
        if (_allValidTemplates == null) {
           ...
           templates.addAll(_templates);
            ...
            for (int i = 0; i < size; i++) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet included =(com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet)_includedStylesheets.elementAt(i);
