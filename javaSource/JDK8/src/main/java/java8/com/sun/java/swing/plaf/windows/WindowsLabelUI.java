...
public class WindowsLabelUI extends BasicLabelUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        com.sun.java.swing.plaf.windows.WindowsLabelUI windowsLabelUI =
                (com.sun.java.swing.plaf.windows.WindowsLabelUI) appContext.get(WINDOWS_LABEL_UI_KEY);
        if (windowsLabelUI == null) {
            windowsLabelUI = new com.sun.java.swing.plaf.windows.WindowsLabelUI();
