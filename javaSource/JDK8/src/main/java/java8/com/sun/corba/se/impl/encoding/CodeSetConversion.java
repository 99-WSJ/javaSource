...
public class CodeSetConversion
{
    ...
    private int selectEncoding(CodeSetComponentInfo.CodeSetComponent client,
        ...
        if (serverNative == 0) {
            if (server.conversionCodeSets.length > 0)
                ...
                return com.sun.corba.se.impl.encoding.CodeSetConversion.FALLBACK_CODESET;
        }
    ...
    public CodeSetComponentInfo.CodeSetContext negotiate(CodeSetComponentInfo client,
        ...
        if (charData == com.sun.corba.se.impl.encoding.CodeSetConversion.FALLBACK_CODESET) {
        ...
        if (wcharData == com.sun.corba.se.impl.encoding.CodeSetConversion.FALLBACK_CODESET) {
    ...
    private static class CodeSetConversionHolder {
        static final com.sun.corba.se.impl.encoding.CodeSetConversion csc = new com.sun.corba.se.impl.encoding.CodeSetConversion() ;
    }

    /**
     * CodeSetConversion is a singleton, and this is the access point.
     */
    public final static com.sun.corba.se.impl.encoding.CodeSetConversion impl() {
