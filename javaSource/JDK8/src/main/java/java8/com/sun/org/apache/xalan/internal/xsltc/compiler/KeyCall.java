...
final class KeyCall extends FunctionCall {
     ...
     */
    public KeyCall(com.sun.org.apache.xalan.internal.xsltc.compiler.QName fname, Vector arguments) {
    ...
    public void addParentDependency() {
        ...
        while (node != null && node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.TopLevelElement == false) {
            node = node.getParent();
        }

        com.sun.org.apache.xalan.internal.xsltc.compiler.TopLevelElement parent = (com.sun.org.apache.xalan.internal.xsltc.compiler.TopLevelElement) node;
        if (parent != null) {
   ...
   /**
    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        if (_name != null) {
            ...
            if (_name instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralExpr) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralExpr literal = (com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralExpr) _name;
                _resolvedQName =
                    getParser().getQNameIgnoreDefaultNs(literal.getValue());
            }
            else if (nameType instanceof StringType == false) {
                _name = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_name, Type.String);
            }
        }
        ...
        if (_valueType != Type.NodeSet
            ...
            _value = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_value, Type.String);
            _valueType = _value.typeCheck(stable);
        }
