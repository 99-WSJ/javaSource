...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/Naming.mc on Tue Mar 04 03:47:28 PST 2014

package java8.com.sun.corba.se.impl.logging;
...
public class NamingSystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.NamingSystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.NamingSystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.NamingSystemException wrapper =
            (com.sun.corba.se.impl.logging.NamingSystemException) orb.getLogWrapper( logDomain,
                "NAMING", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.NamingSystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.NamingSystemException wrapper =
            (com.sun.corba.se.impl.logging.NamingSystemException) ORB.staticGetLogWrapper( logDomain,
                "NAMING", factory ) ;
        return wrapper ;
    } 
    ...
    public BAD_PARAM transientNameServerBadPort( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "NAMING.transientNameServerBadPort",
                parameters, com.sun.corba.se.impl.logging.NamingSystemException.class, exc ) ;
        }
