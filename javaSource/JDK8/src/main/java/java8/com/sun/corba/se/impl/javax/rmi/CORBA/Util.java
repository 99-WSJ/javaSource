...
package java8.sun.corba.se.impl.javax.rmi.CORBA; // Util (sed marker, don't remove!)
...
public class Util implements javax.rmi.CORBA.UtilDelegate
{
    ...
    private static com.sun.corba.se.impl.javax.rmi.CORBA.KeepAlive keepAlive = null;
    ...
    private static com.sun.corba.se.impl.javax.rmi.CORBA.Util instance = null;

    public Util() {
        setInstance(this);
    }

    private static void setInstance( com.sun.corba.se.impl.javax.rmi.CORBA.Util util ) {
        assert instance == null : "Instance already defined";
        instance = util;
    }

    public static com.sun.corba.se.impl.javax.rmi.CORBA.Util getInstance() {
        return instance;
    }
        ...
        synchronized (exportedServants) {
            ...
            if (lookupTie(target) == null) {
                ...
                if (keepAlive == null) {
                    ...
                    // it up...
                    keepAlive = (com.sun.corba.se.impl.javax.rmi.CORBA.KeepAlive)AccessController.doPrivileged(new PrivilegedAction() {
                        public Object run() {
                            return new com.sun.corba.se.impl.javax.rmi.CORBA.KeepAlive();
                        }
                    });
                    keepAlive.start();
                }
