...
public class FunctionOneArg extends Function implements ExpressionOwner
{
  ...
  public boolean deepEquals(Expression expr)
  {
        ...
        if(null != m_arg0)
        {
                if(null == ((com.sun.org.apache.xpath.internal.functions.FunctionOneArg)expr).m_arg0)
                        return false;

                if(!m_arg0.deepEquals(((com.sun.org.apache.xpath.internal.functions.FunctionOneArg)expr).m_arg0))
                        return false;
        }
        else if(null != ((com.sun.org.apache.xpath.internal.functions.FunctionOneArg)expr).m_arg0)
                return false;
