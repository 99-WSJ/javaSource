...
package java8.sun.org.apache.xalan.internal.xsltc.cmdline.getopt;
...
public class GetOpt{
    ...
    */
    public int getNextOption() throws com.sun.org.apache.xalan.internal.xsltc.cmdline.getopt.IllegalArgumentException,
            com.sun.org.apache.xalan.internal.xsltc.cmdline.getopt.MissingOptArgException
    {
        int retval = -1;
        if(theOptionsIterator.hasNext()){
            ...
            if(!theOptionMatcher.match(c)) {
                ErrorMsg msg = new ErrorMsg(ErrorMsg.ILLEGAL_CMDLINE_OPTION_ERR,
                                            new Character(c));
                throw (new com.sun.org.apache.xalan.internal.xsltc.cmdline.getopt.IllegalArgumentException(msg.toString()));
            }
            else if(shouldHaveArg && (arg == null)) {
                ErrorMsg msg = new ErrorMsg(ErrorMsg.CMDLINE_OPT_MISSING_ARG_ERR,
                                            new Character(c));
                throw (new com.sun.org.apache.xalan.internal.xsltc.cmdline.getopt.MissingOptArgException(msg.toString()));
            }
            retval = c;
        }
        return retval;
