...
public class ThreadContext implements Cloneable {
    ...
    private /*final*/ com.sun.jmx.snmp.ThreadContext previous;
    private /*final*/ String key;
    private /*final*/ Object value;

    private ThreadContext(com.sun.jmx.snmp.ThreadContext previous, String key, Object value) {
    ...
    public static Object get(String key) throws IllegalArgumentException {
        com.sun.jmx.snmp.ThreadContext context = contextContaining(key);
        if (context == null)
            return null;
        else
     ...
     * @exception IllegalArgumentException if <code>key</code> is null.
     */
    private static com.sun.jmx.snmp.ThreadContext contextContaining(String key)
            throws IllegalArgumentException {
        if (key == null)
            throw new IllegalArgumentException("null key");
        for (com.sun.jmx.snmp.ThreadContext context = getContext();
             context != null;
...
//  }
     ...
     * @exception IllegalArgumentException if <code>key</code> is null.
     */
    public static com.sun.jmx.snmp.ThreadContext push(String key, Object value)
            throws IllegalArgumentException {
        if (key == null)
            throw new IllegalArgumentException("null key");

        com.sun.jmx.snmp.ThreadContext oldContext = getContext();
        if (oldContext == null)
            oldContext = new com.sun.jmx.snmp.ThreadContext(null, null, null);  // make sentinel
        com.sun.jmx.snmp.ThreadContext newContext = new com.sun.jmx.snmp.ThreadContext(oldContext, key, value);
     ...
     */
    public static void restore(com.sun.jmx.snmp.ThreadContext oldContext)
    ...
    public void setInitialContext(com.sun.jmx.snmp.ThreadContext context)
            throws IllegalArgumentException {
    ...
    private static ThreadLocal<com.sun.jmx.snmp.ThreadContext> localContext =
            new ThreadLocal<com.sun.jmx.snmp.ThreadContext>();
}
