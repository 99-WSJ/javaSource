...
class ParserForXMLSchema extends com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser {
     ...
     */
    protected com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken parseCharacterClass(boolean useNrange) throws ParseException {
        this.setContext(S_INBRACKETS);
        this.next();                            // '['
        boolean nrange = false;
        boolean wasDecoded = false;                     // used to detect if the last - was escaped.
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken base = null;
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken tok;
            ...
            if (type == T_BACKSOLIDUS) {
                switch (c) {
                  ...
                  case 'P':
                    ...
                    com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken tok2 = this.processBacksolidus_pP(c);
                ...
                com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken range2 = this.parseCharacterClass(false);
    ...
    protected com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken parseSetOperations() throws ParseException {
    ...
    Token getTokenForShorthand(int ch) {
        switch (ch) {
          case 'd':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isDigit", true);
          case 'D':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isDigit", false);
          case 'w':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isWord", true);
          case 'W':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isWord", false);
          case 's':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isSpace", true);
          case 'S':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isSpace", false);
          case 'c':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isNameChar", true);
          case 'C':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isNameChar", false);
          case 'i':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isInitialNameChar", true);
          case 'I':
            return com.sun.org.apache.xerces.internal.impl.xpath.regex.ParserForXMLSchema.getRange("xml:isInitialNameChar", false);
          default:
    ...
    static synchronized protected com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken getRange(String name, boolean positive) {
        if (ranges == null) {
        ...
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken tok = positive ? (com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken)ranges.get(name)
            : (com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken)ranges2.get(name);
        return tok;
    }
