...
public class MBeanInstantiator {
        ...
        try {
            ...
            if (MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
                MBEANSERVER_LOGGER.logp(Level.FINEST,
                        com.sun.jmx.mbeanserver.MBeanInstantiator.class.getName(),
   ...
   /**
    ...
    static Class<?> loadClass(String className, ClassLoader loader)
        ...
        try {
            if (loader == null)
                loader = com.sun.jmx.mbeanserver.MBeanInstantiator.class.getClassLoader();
            if (loader != null) {
    ...
    static Class<?>[] loadSignatureClasses(String signature[],
        ...
        final ClassLoader aLoader =
           (loader==null? com.sun.jmx.mbeanserver.MBeanInstantiator.class.getClassLoader():loader);
        final int length= signature.length;
        final Class<?> tab[]=new Class<?>[length];
