...
public class SnmpMibOid extends SnmpMibNode implements Serializable {
    ...
    void registerNode(long[] oid, int cursor ,SnmpMibNode node)
        ...
        if (pos  == nbChildren) {
            ...
            //       + String.valueOf(var) + " position= " + cursor);
            com.sun.jmx.snmp.agent.SnmpMibOid child= new com.sun.jmx.snmp.agent.SnmpMibOid();
            ...
            if ( (cursor + 1) == oid.length ) {
                ...
                if (child != null && node != null) {
                    ...
                    if (node instanceof SnmpMibGroup) {
                        ...
                        //
                        ((com.sun.jmx.snmp.agent.SnmpMibOid)child).exportChildren((com.sun.jmx.snmp.agent.SnmpMibOid)node);
                        children.setElementAt(node,pos);
                        return;

                    } else if ((node instanceof com.sun.jmx.snmp.agent.SnmpMibOid) &&
                             (child instanceof SnmpMibGroup)) {
                        // `node' is a temporary node, and `child' is a
                        //  group => keep child and export the node's
                        //  subtree to `child'.
                        //
                        ((com.sun.jmx.snmp.agent.SnmpMibOid)node).exportChildren((com.sun.jmx.snmp.agent.SnmpMibOid)child);
                        return;
                    } else if (node instanceof com.sun.jmx.snmp.agent.SnmpMibOid) {
                ...
                if (child == null)
                    throw new IllegalAccessException();
                ((com.sun.jmx.snmp.agent.SnmpMibOid)child).registerNode(oid, cursor + 1, node);
            }
        }
    }
     ...
     *
     **/
    void exportChildren(com.sun.jmx.snmp.agent.SnmpMibOid brother)
        throws IllegalAccessException {
