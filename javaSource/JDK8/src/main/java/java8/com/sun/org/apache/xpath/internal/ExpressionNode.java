...
public interface ExpressionNode extends SourceLocator
{
  /** This pair of methods are used to inform the node of its
    parent. */
  public void exprSetParent(com.sun.org.apache.xpath.internal.ExpressionNode n);
  public com.sun.org.apache.xpath.internal.ExpressionNode exprGetParent();

  /** This method tells the node to add its argument to the node's
    list of children.  */
  public void exprAddChild(com.sun.org.apache.xpath.internal.ExpressionNode n, int i);

  /** This method returns a child node.  The children are numbered
     from zero, left to right. */
  public com.sun.org.apache.xpath.internal.ExpressionNode exprGetChild(int i);
