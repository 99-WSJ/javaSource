...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/ORBUtil.mc on Tue Mar 04 03:47:28 PST 2014
...
public class ORBUtilSystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.ORBUtilSystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.ORBUtilSystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.ORBUtilSystemException wrapper =
            (com.sun.corba.se.impl.logging.ORBUtilSystemException) orb.getLogWrapper( logDomain,
                "ORBUTIL", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.ORBUtilSystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.ORBUtilSystemException wrapper =
            (com.sun.corba.se.impl.logging.ORBUtilSystemException) ORB.staticGetLogWrapper( logDomain,
                "ORBUTIL", factory ) ;
        return wrapper ;
    } 
    ...
    public BAD_OPERATION adapterIdNotAvailable( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "ORBUTIL.adapterIdNotAvailable",
                parameters, com.sun.corba.se.impl.logging.ORBUtilSystemException.class, exc ) ;
        }
