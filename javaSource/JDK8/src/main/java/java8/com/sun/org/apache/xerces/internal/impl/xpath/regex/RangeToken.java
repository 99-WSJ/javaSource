...
package java8.com.sun.org.apache.xerces.internal.impl.xpath.regex;

import com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression;
import java8.sun.org.apache.xerces.internal.impl.xpath.regex.Token;
...
final class RangeToken extends Token implements java.io.Serializable {
    ...
    boolean sorted;
    boolean compacted;
    com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken icaseCache = null;
    int[] map = null;
    int nonMapIndex;
    ...
    protected void mergeRanges(Token token) {
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken tok = (com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken)token;
        this.sortRanges();
        tok.sortRanges();
        if (tok.ranges == null)
            return;
    ...
    static Token complementRanges(Token token) {
        ...
        if (last == UTF16_MAX)
            len -= 2;
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken ret = Token.createRange();
    ...
    synchronized com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken getCaseInsensitiveToken() {
        if (this.icaseCache != null)
            return this.icaseCache;

        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken uppers = this.type == Token.RANGE ? Token.createRange() : Token.createNRange();
        ...
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken lowers = this.type == Token.RANGE ? Token.createRange() : Token.createNRange();
