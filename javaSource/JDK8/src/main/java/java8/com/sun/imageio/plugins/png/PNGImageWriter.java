...
final class ChunkStream extends ImageOutputStreamImpl {
    ...
    private com.sun.imageio.plugins.png.CRC crc = new com.sun.imageio.plugins.png.CRC();
...
public class PNGImageWriter extends ImageWriter {
    ...
    public ImageWriteParam getDefaultWriteParam() {
        return new com.sun.imageio.plugins.png.PNGImageWriteParam(getLocale());
    }
    ...
    private void write_IHDR() throws IOException {
        // Write IHDR chunk
        com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.IHDR_TYPE, stream);
...
"Only interlace methods 0 (node) and 1 (adam7) are defined in PNG 1.1");
    ...
    private void write_cHRM() throws IOException {
        if (metadata.cHRM_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.cHRM_TYPE, stream);
    ...
    private void write_gAMA() throws IOException {
        if (metadata.gAMA_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.gAMA_TYPE, stream);
    ...
    private void write_iCCP() throws IOException {
        if (metadata.iCCP_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.iCCP_TYPE, stream);
    ...
    private void write_sBIT() throws IOException {
        if (metadata.sBIT_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.sBIT_TYPE, stream);
...
"The chunk will not be written.");
    ...
    private void write_sRGB() throws IOException {
        if (metadata.sRGB_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.sRGB_TYPE, stream);
...
"The chunk will not be written");
            ...
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.PLTE_TYPE, stream);
    ...
    private void write_hIST() throws IOException, IIOException {
        if (metadata.hIST_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.hIST_TYPE, stream);
    ...
    private void write_tRNS() throws IOException, IIOException {
        if (metadata.tRNS_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.tRNS_TYPE, stream);
            int colorType = metadata.IHDR_colorType;
...
"The chunk will not be written.");
    ...
    private void write_bKGD() throws IOException {
        if (metadata.bKGD_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.bKGD_TYPE, stream);
...
"The chunk will not be written.");
    ...
    private void write_pHYs() throws IOException {
        if (metadata.pHYs_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.pHYs_TYPE, stream);
    ...
    private void write_sPLT() throws IOException {
        if (metadata.sPLT_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.sPLT_TYPE, stream);
    ...
    private void write_tIME() throws IOException {
        if (metadata.tIME_present) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.tIME_TYPE, stream);
    ...
    private void write_tEXt() throws IOException {
        ...
        while (keywordIter.hasNext()) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.tEXt_TYPE, stream);
    ...
    private void write_iTXt() throws IOException {
        ...
        while (keywordIter.hasNext()) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.iTXt_TYPE, stream);
    ...
    private void write_zTXt() throws IOException {
        ...
        while (keywordIter.hasNext()) {
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.zTXt_TYPE, stream);
            String keyword = (String)keywordIter.next();
            cs.writeBytes(keyword);
            cs.writeByte(0);
    ...
    private void writeUnknownChunks() throws IOException {
        ...
        while (typeIter.hasNext() && dataIter.hasNext()) {
            ...
            com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(chunkType(type), stream);
    ...
    private void write_IDAT(RenderedImage image) throws IOException {
        com.sun.imageio.plugins.png.IDATOutputStream ios = new com.sun.imageio.plugins.png.IDATOutputStream(stream, 32768);
        try {
    ...
    private void writeIEND() throws IOException {
        com.sun.imageio.plugins.png.ChunkStream cs = new com.sun.imageio.plugins.png.ChunkStream(PNGImageReader.IEND_TYPE, stream);
        cs.finish();
    }
