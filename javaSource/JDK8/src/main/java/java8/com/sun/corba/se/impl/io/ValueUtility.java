...
public class ValueUtility {
    ...
    public static FullValueDescription translate(ORB orb, ObjectStreamClass osc, ValueHandler vh){
        ...
        // Set FVD is_abstract
        result.is_abstract = com.sun.corba.se.impl.io.ObjectStreamClassCorbaExt.isAbstractInterface(className);
                                                    ...
                                                    IdentityKeyValueStack createdIDs)
    {
        if ( c.isArray() ) {
            ...
            if ( componentClass.isPrimitive() ){
                embeddedType
                    = com.sun.corba.se.impl.io.ValueUtility.getPrimitiveTypeCodeForClass(orb,
                                                                componentClass,
                                                                vh);
            } else {
