...
public class XMLGregorianCalendarImpl
    ...
    public int compare(XMLGregorianCalendar rhs) {
        ...
        com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl P = (com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl) lhs;
        com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl Q = (com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl) rhs;
        ...
        if (P.getTimezone() == Q.getTimezone()) {
            ...
            P = (com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl) P.normalize();
            Q = (com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl) Q.normalize();
            return internalCompare(P, Q);
        } else if (P.getTimezone() != DatatypeConstants.FIELD_UNDEFINED) {
            ...
            if (Q.getTimezone() != 0) {
                Q = (com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl) Q.normalizeToTimezone(Q.getTimezone());
            }
    ...
    public static XMLGregorianCalendar parse(String lexicalRepresentation) {
                ...
                return new com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl(lexicalRepresentation);
    }
   ...
   public Object clone() {
       ...
       return new com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl(getEonAndYear(),
                        this.month, this.day,
