...
public class SnmpVarBindList extends Vector<SnmpVarBind> {
     ...
     */
    public SnmpVarBindList(com.sun.jmx.snmp.SnmpVarBindList list) {
        super(list.size(), 5) ;
     ...
     */
    public synchronized void addVarBindList(com.sun.jmx.snmp.SnmpVarBindList list) {
     ...
     */
    public synchronized boolean removeVarBindList(com.sun.jmx.snmp.SnmpVarBindList list) {
        boolean result = true;
        for (int i = 0; i < list.size(); i++) {
     ...
     */
    public synchronized com.sun.jmx.snmp.SnmpVarBindList splitAt(int pos) {
        com.sun.jmx.snmp.SnmpVarBindList splitVb = null ;
        if (pos > elementCount)
            return splitVb ;
        splitVb = new com.sun.jmx.snmp.SnmpVarBindList() ; // size() - atPosition) ;
        int max= size();
     ...
     */
    public synchronized com.sun.jmx.snmp.SnmpVarBindList cloneWithValue() {
        com.sun.jmx.snmp.SnmpVarBindList newvb = new com.sun.jmx.snmp.SnmpVarBindList() ;
     ...
     * @return The <CODE>SnmpVarBindList</CODE> clone.
     */
    public synchronized com.sun.jmx.snmp.SnmpVarBindList cloneWithoutValue() {
        com.sun.jmx.snmp.SnmpVarBindList newvb = new com.sun.jmx.snmp.SnmpVarBindList() ;
        int max = this.size();
     ...
     */
    @Override
    public synchronized com.sun.jmx.snmp.SnmpVarBindList clone() {
