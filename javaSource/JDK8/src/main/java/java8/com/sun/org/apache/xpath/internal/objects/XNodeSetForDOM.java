...
public class XNodeSetForDOM extends XNodeSet
{
  ...
  {
        super(val);
        if(val instanceof com.sun.org.apache.xpath.internal.objects.XNodeSetForDOM)
        m_origObj = ((com.sun.org.apache.xpath.internal.objects.XNodeSetForDOM)val).m_origObj;
  }
