...
public abstract class MXBeanMappingFactory {
     ...
     */
    public static final com.sun.jmx.mbeanserver.MXBeanMappingFactory DEFAULT =
     ...
     */
    public abstract MXBeanMapping mappingForType(Type t, com.sun.jmx.mbeanserver.MXBeanMappingFactory f)
    throws OpenDataException;
}
