...
public final class Utility {
    ...
    {
        com.sun.corba.se.impl.util.StubEntry entry = null;
        ...
        synchronized (tieToStubCache) {
            ...
            if (cached == null) {
                ...
                if (cached != CACHE_MISS) {
                    // It's a stub.
                    entry = (com.sun.corba.se.impl.util.StubEntry) cached;
     ...
     */
    private static com.sun.corba.se.impl.util.StubEntry loadStubAndUpdateCache (
        ...
        String remoteCodebase, boolean onlyMostDerived)
    {
        ...
        if (stub == null) {
            ...
            // Update the cache...
            entry = new com.sun.corba.se.impl.util.StubEntry(stub,onlyMostDerived);
    ...
    public static void purgeStubForTie (Tie tie) {
        com.sun.corba.se.impl.util.StubEntry entry;
        synchronized (tieToStubCache) {
            entry = (com.sun.corba.se.impl.util.StubEntry)tieToStubCache.remove(tie);
        }
        if (entry != null) {
            synchronized (stubToTieCache) {
        ...
        throws ClassNotFoundException
    {
        ...
        String className = com.sun.corba.se.impl.util.Utility.stubNameFromRepID(repID);
