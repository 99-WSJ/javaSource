...
//            throw new InconsistencyException("No metrics for Font " + font());
  ...
  public static void paintMenuItem(Graphics g, JComponent c,
                                   ...
                                   int defaultTextIconGap)
    {
        ...
        if(acceleratorText != null && !acceleratorText.equals("")) {
            ...
            if (parent != null && parent instanceof JComponent) {
                ...
                Integer maxValueInt = (Integer) p.getClientProperty(com.sun.java.swing.plaf.motif.MotifGraphicsUtils.MAX_ACC_WIDTH);
        ...
        )
    {
        ...
        if( com.sun.java.swing.plaf.motif.MotifGraphicsUtils.isLeftToRight(c) ) {
