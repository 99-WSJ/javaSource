...
public final class OldJIDLObjectKeyTemplate extends OldObjectKeyTemplateBase
{
    ...
    byte patchVersion = com.sun.corba.se.impl.ior.OldJIDLObjectKeyTemplate.NULL_PATCH_VERSION;
    ...
    public void write(ObjectId objectId, OutputStream os)
    {
        ...
        if (patchVersion != com.sun.corba.se.impl.ior.OldJIDLObjectKeyTemplate.NULL_PATCH_VERSION)
