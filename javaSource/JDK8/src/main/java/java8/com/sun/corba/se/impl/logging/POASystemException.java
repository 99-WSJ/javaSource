...
// Generated from input file d:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8/2238/corba/src/share/classes/com/sun/corba/se/spi/logging/data/POA.mc on Tue Mar 04 03:47:28 PST 2014
...
public class POASystemException extends LogWrapperBase {
    ...
    private static LogWrapperFactory factory = new LogWrapperFactory() {
        ...
        {
            return new com.sun.corba.se.impl.logging.POASystemException( logger ) ;
        }
    } ;
    
    public static com.sun.corba.se.impl.logging.POASystemException get(ORB orb, String logDomain )
    {
        com.sun.corba.se.impl.logging.POASystemException wrapper =
            (com.sun.corba.se.impl.logging.POASystemException) orb.getLogWrapper( logDomain,
                "POA", factory ) ;
        return wrapper ;
    } 
    
    public static com.sun.corba.se.impl.logging.POASystemException get(String logDomain )
    {
        com.sun.corba.se.impl.logging.POASystemException wrapper =
            (com.sun.corba.se.impl.logging.POASystemException) ORB.staticGetLogWrapper( logDomain,
                "POA", factory ) ;
        return wrapper ;
    } 
    ...
    public BAD_INV_ORDER servantManagerAlreadySet( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "POA.servantManagerAlreadySet",
                parameters, com.sun.corba.se.impl.logging.POASystemException.class, exc ) ;
        }
